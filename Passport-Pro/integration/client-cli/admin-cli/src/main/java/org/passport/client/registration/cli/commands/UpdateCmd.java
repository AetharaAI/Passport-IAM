...
import org.passport.client.cli.common.AttributeOperation;
import org.passport.client.cli.config.ConfigData;
import org.passport.client.registration.cli.CmdStdinContext;
import org.passport.client.registration.cli.EndpointType;
import org.passport.client.registration.cli.EndpointTypeConverter;
import org.passport.client.registration.cli.ReflectionUtil;
...
import static org.passport.client.cli.common.AttributeOperation.Type.DELETE;
import static org.passport.client.cli.common.AttributeOperation.Type.SET;
import static org.passport.client.cli.util.ConfigUtil.credentialsAvailable;
import static org.passport.client.cli.util.ConfigUtil.getRegistrationToken;
import static org.passport.client.cli.util.ConfigUtil.loadConfig;
import static org.passport.client.cli.util.ConfigUtil.saveMergeConfig;
import static org.passport.client.cli.util.ConfigUtil.setRegistrationToken;
import static org.passport.client.cli.util.HttpUtil.APPLICATION_JSON;
import static org.passport.client.cli.util.HttpUtil.doGet;
import static org.passport.client.cli.util.HttpUtil.doPut;
import static org.passport.client.cli.util.HttpUtil.urlencode;
import static org.passport.client.cli.util.IoUtil.printOut;
import static org.passport.client.cli.util.IoUtil.readFully;
import static org.passport.client.cli.util.IoUtil.warnfErr;
import static org.passport.client.cli.util.OsUtil.PROMPT;
import static org.passport.client.cli.util.ParseUtil.parseKeyVal;
import static org.passport.client.registration.cli.EndpointType.DEFAULT;
import static org.passport.client.registration.cli.EndpointType.OIDC;
import static org.passport.client.registration.cli.KcRegMain.CMD;
