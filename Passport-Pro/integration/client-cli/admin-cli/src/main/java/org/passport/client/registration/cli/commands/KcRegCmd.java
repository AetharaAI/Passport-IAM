...
public class KcRegCmd extends BaseGlobalOptionsCmd {
    ...
    public static String usage() {
        ...
        out.println("Passport Client Registration CLI");
        out.println();
        ...
        out.println("  get           Get configuration of existing client in Passport or OIDC format, or adapter install configuration");
