 ...
 */
package org.passport.client.admin.cli;

import org.passport.client.admin.cli.commands.KcAdmCmd;
...
public class KcAdmMain {
    ...
    public static final String DEFAULT_CONFIG_FILE_PATH = System.getProperty("user.home") + "/.passport/kcadm.config";

    public static final String DEFAULT_CONFIG_FILE_STRING = OsUtil.OS_ARCH.isWindows() ? "%HOMEDRIVE%%HOMEPATH%\\.passport\\kcadm.config" : "~/.passport/kcadm.config";
