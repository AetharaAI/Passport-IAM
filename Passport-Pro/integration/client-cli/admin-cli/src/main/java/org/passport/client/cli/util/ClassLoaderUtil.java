...
public class ClassLoaderUtil {
    ...
    public static ClassLoader resolveClassLoader(String libDir) {
        ...
        String[] validJarPrefixes = bcFipsJarPresent ?  new String[] {"passport-crypto-fips1402", "bc-fips", "bctls-fips","bcutil-fips"} : new String[] {"passport-crypto-default", "bcprov-jdk18on"};
