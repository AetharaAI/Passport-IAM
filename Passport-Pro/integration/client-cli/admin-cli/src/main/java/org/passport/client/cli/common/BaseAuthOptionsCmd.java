...
import org.passport.client.cli.config.ConfigHandler;
import org.passport.client.cli.config.FileConfigHandler;
import org.passport.client.cli.config.InMemoryConfigHandler;
import org.passport.client.cli.config.RealmConfigData;
import org.passport.client.cli.util.AuthUtil;
import org.passport.client.cli.util.ConfigUtil;
import org.passport.client.cli.util.HttpUtil;
import org.passport.common.util.IoUtils;

import picocli.CommandLine.Option;

import static org.passport.client.cli.config.FileConfigHandler.setConfigFile;
import static org.passport.client.cli.util.ConfigUtil.DEFAULT_CLIENT;
import static org.passport.client.cli.util.ConfigUtil.checkServerInfo;
...
public abstract class BaseAuthOptionsCmd extends BaseGlobalOptionsCmd {
    ...
    protected void globalOptions(PrintWriter out) {
        ...
        if (commandState.isTokenGlobal()) {
            out.println("    --token               Token to use to invoke on Passport.  Other credential may be ignored if this flag is set.");
        }
