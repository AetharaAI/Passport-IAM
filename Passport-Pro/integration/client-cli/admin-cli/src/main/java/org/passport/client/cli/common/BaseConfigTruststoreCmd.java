...
public class BaseConfigTruststoreCmd extends BaseAuthOptionsCmd {
    ...
    public String help() {
        ...
        out.println();
        out.println("Command to configure a global truststore to use when using https to connect to Passport server.");
        out.println();
        ...
        out.println("  " + PROMPT + " " + getCommand() + " config truststore " + OS_ARCH.path("~/.passport/truststore.jks"));
        out.println();
        out.println("Specify a truststore, and password - truststore will automatically be used without prompting for password:");
        out.println("  " + PROMPT + " " + getCommand() + " config truststore --trustpass " + OS_ARCH.envVar("PASSWORD") + " " + OS_ARCH.path("~/.passport/truststore.jks"));
        out.println();
