...
import org.passport.client.cli.util.HttpUtil;
...
import static org.passport.client.cli.util.HttpUtil.doPost;
import static org.passport.client.cli.util.IoUtil.printErr;
import static org.passport.client.cli.util.IoUtil.printOut;
import static org.passport.client.cli.util.IoUtil.readFully;
import static org.passport.client.cli.util.OsUtil.OS_ARCH;
...
import static org.passport.client.registration.cli.EndpointType.SAML2;
import static org.passport.client.registration.cli.KcRegMain.CMD;
import static org.passport.common.util.IoUtils.readPasswordFromConsole;
...
public class CreateCmd extends AbstractAuthOptionsCmd {
    ...
    protected String help() {
        ...
        out.println("Supported formats include Passport default format, OIDC format, and SAML SP Metadata.");
        out.println();
