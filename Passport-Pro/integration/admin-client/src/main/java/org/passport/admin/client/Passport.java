...
import org.passport.admin.client.resource.BearerAuthFilter;
import org.passport.admin.client.resource.DPoPAuthFilter;
import org.passport.admin.client.resource.RealmResource;
import org.passport.admin.client.resource.RealmsResource;
import org.passport.admin.client.resource.ServerInfoResource;
import org.passport.admin.client.spi.ResteasyClientProvider;
import org.passport.admin.client.token.TokenManager;

import static org.passport.OAuth2Constants.PASSWORD;

/**
 * Provides a Passport client. By default, this implementation uses a the default RestEasy client builder settings.
 * To customize the underling client, use a {@link PassportBuilder} to create a Passport client.
 *
 ...
 * @see PassportBuilder
 */
public class Passport implements AutoCloseable {
    ...
    private static ResteasyClientProvider createDefaultResteasyClientProvider() {
        try {
            return (ResteasyClientProvider) Passport.class.getClassLoader().loadClass("org.passport.admin.client.spi.ResteasyClientClassicProvider").getDeclaredConstructor().newInstance();
    ...
    Passport(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, String grantType, Client resteasyClient, String authtoken, String scope, boolean useDPoP) {
    ...
    /**
     *
     * Creates the java admin client instance to be used to call admin REST API against Passport server.
     *
     * @param serverUrl Passport server URL
     ...
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext, Object customJacksonProvider, boolean disableTrustManager, String authToken, String scope) {
        return new Passport(serverUrl, realm, username, password, clientId, clientSecret, PASSWORD, newRestEasyClient(customJacksonProvider, sslContext, disableTrustManager), authToken, scope, false);
    }
     ...
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext, Object customJacksonProvider, boolean disableTrustManager, String authToken) {
        return new Passport(serverUrl, realm, username, password, clientId, clientSecret, PASSWORD, newRestEasyClient(customJacksonProvider, sslContext, disableTrustManager), authToken, null, false);
    }

    /**
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext, Object customJacksonProvider) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String username, String password, String clientId, SSLContext sslContext) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String clientId, String authToken) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static Passport getInstance(String serverUrl, String realm, String clientId, String authToken, SSLContext sllSslContext) {
    ...
    /**
     * Closes the underlying client. After calling this method, this <code>Passport</code> instance cannot be reused.
     */
    @Override
    public void close() {
        closed = true;
