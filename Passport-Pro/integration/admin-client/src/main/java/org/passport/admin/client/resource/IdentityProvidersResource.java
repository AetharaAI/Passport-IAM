...
public interface IdentityProvidersResource {
     ...
     *
     * @param type Type of identity provider. See the class org.passport.models.IdentityProviderType for the available values. When parameter is omitted, there is no filtering by type.
     *             This parameter is available since Passport 26.5.0
     * @param capability Capability of identity provider. Used just if type is omitted. See the class org.passport.models.IdentityProviderCapability for the available values. When parameter is omitted, there is no filtering by capability.
     *                   This parameter is available since Passport 26.5.0
     ...
     *                  Parameter available since Passport server 26. Will be ignored on older Passport versions with the default value false
     * @return The list of providers.
     */
    @GET
    @Path("instances")
