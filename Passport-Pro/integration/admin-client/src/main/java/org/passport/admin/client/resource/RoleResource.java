...
public interface RoleResource {
     ...
     * parameters.</p>
     *
     * @param briefRepresentation If the user should be returned in brief or full representation. Parameter available since Passport server 26. Will be ignored on older Passport versions with the default value false.
     * @param firstResult Pagination offset
     * @param maxResults Pagination size
     * @return a list of users with the given role
     */
