...
package org.passport.admin.client.resource;
...
import org.passport.representations.idm.LDAPCapabilityRepresentation;
...
import org.passport.representations.idm.TestLdapConnectionRepresentation;
...
public interface RealmResource {
     ...
     * @param direction The direction to sort events by. Available values are "asc" or "desc". The parameter is supported since Passport 26.2
     * @return events
     * @since Passport 26.2. Use method {@link #getEvents(List, String, String, String, String, String, Integer, Integer)} for the older versions of the Passport server
     */
    @Path("events")
    @GET
    @Produces(MediaType.APPLICATION_JSON)
     ...
     * @param user User id
     * @param ipAddress IP address
     * @param dateFrom time in Epoch timestamp. The parameter is supported since Passport 26.2
     * @param dateTo time in Epoch timestamp. The parameter is supported since Passport 26.2
     * @param firstResult Paging offset
     * @param maxResults Maximum results size (defaults to 100)
     * @param direction The direction to sort events by. Available values are "asc" or "desc". The parameter is supported since Passport 26.2
     * @return events
     ...
     * @param direction The direction to sort events by. Available values are "asc" or "desc". The parameter is supported since Passport 26.2
     * @return admin events
     * @since Passport 26.2. Use method {@link #getAdminEvents(List, String, String, String, String, String, List, String, String, Integer, Integer)} for the older versions of the Passport server
     */
    @GET
    @Path("admin-events")
    @Produces(MediaType.APPLICATION_JSON)
     ...
     * @param offline Parameter available since Passport server 24.0.2. Will be ignored on older Passport versions with the default value false.
