...
package org.passport.admin.client.token;
...
import org.passport.admin.client.Config;
import org.passport.admin.client.Passport;
import org.passport.admin.client.resource.BasicAuthFilter;
...
import static org.passport.OAuth2Constants.CLIENT_ID;
import static org.passport.OAuth2Constants.GRANT_TYPE;
...
import static org.passport.OAuth2Constants.USERNAME;
...
public class TokenManager {
    ...
    public TokenManager(Config config, Client client) {
        ...
        this.tokenService = Passport.getClientProvider().targetProxy(target, TokenService.class);
