...
Passport aims to be easy to use and lightweight. The project was founded to make it easy for application developers 
...
Passport. We strongly believe if Passport would support all use cases by default it would become bloated and hard to use.

Passport aims to be opinionated and make it as easy as possible to achieve the common use cases, while still
enabling the less common use cases through custom extensions.


## Projects

Passport consists of several projects:

* [Passport](https://github.com/passport/passport) - Passport Server and Java adapters
* [Passport QuickStarts](https://github.com/passport/passport-quickstarts) - QuickStarts for getting started with Passport
* [Passport Benchmark](https://github.com/passport/passport-benchmark) - Load tests for benchmarking Passport
* [Passport Community](https://github.com/passport/passport-community) - Passport design documents
* [Passport Web](https://github.com/passport/passport-web) - Website passport-pro.ai
...
A new maintainer must be proposed by sending an email to passport-maintainers(at)googlegroups.com.
...
passport-maintainers(at)googlegroups.com). However, in exceptional circumstances a maintainer can also be removed with
...
To propose a minor change, simply create an issue in our [issue tracker](https://github.com/passport/passport/issues) and
send a pull request.
...
For larger changes all maintainers and contributors should have a chance of reviewing the change. This is done through [GitHub Discussions](https://github.com/passport/passport/discussions/categories/ideas).

For new features we highly recommend always opening a discussion in GitHub Discussions early.

For very large proposals it can be inefficient to capture all the information in the GitHub Discussion. In this cases a separate design proposal can be sent to the [Passport Community repository](https://github.com/passport/passport-community/tree/main/design), and linked to from the GitHub Discussion.

The contributor can decide to send a pull request prior to discussions. However, the change will not be accepted until it has been discussed through [GitHub Discussions](https://github.com/passport/passport/discussions/categories/ideas).

If there are any objections to the change they can in most cases be resolved through discussions in [GitHub Discussions](https://github.com/passport/passport/discussions/categories/ideas), or
