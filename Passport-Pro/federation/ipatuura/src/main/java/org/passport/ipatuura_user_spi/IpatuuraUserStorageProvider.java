...
package org.passport.ipatuura_user_spi;
...
import org.passport.ipatuura_user_spi.authenticator.IpatuuraAuthenticator;
import org.passport.ipatuura_user_spi.schemas.SCIMError;
import org.passport.ipatuura_user_spi.schemas.SCIMUser;
...
public class IpatuuraUserStorageProvider implements UserStorageProvider, UserLookupProvider, CredentialInputValidator,
    ...
    public IpatuuraUserStorageProvider(PassportSession session, ComponentModel model, Ipatuura ipatuura,
    ...
    public UserModel getUserByUsername(RealmModel realm, String username) {
        ...
        if (user != null) {
            logger.debug("User already exists in passport");
            return user;
        } else {
            return createUserInPassport(realm, username);
        }
    }

    protected UserModel createUserInPassport(RealmModel realm, String username) {
        ...
        logger.debugv("Creating SCIM user {0} in passport", username);
    ...
    public boolean isValid(RealmModel realm, UserModel user, CredentialInput input) {
        ...
        /*
         * The password can either be validated locally in passport (tried first) or in the SCIM server
         */
