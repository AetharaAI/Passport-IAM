...
import org.passport.ipatuura_user_spi.schemas.SCIMSearchRequest;
...
public class Ipatuura {
    ...
    public Ipatuura(PassportSession session, ComponentModel model) {
        this.model = model;
    ...
    /*
     * Passport UserRegistrationProvider addUser() method only provides username as input, here we provide mostly dummy values
