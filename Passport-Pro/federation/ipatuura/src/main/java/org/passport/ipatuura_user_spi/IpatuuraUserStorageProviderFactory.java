...
public class IpatuuraUserStorageProviderFactory implements UserStorageProviderFactory<IpatuuraUserStorageProvider>, EnvironmentDependentProviderFactory {
    ...
    @Override
    public void validateConfiguration(PassportSession session, RealmModel realm, ComponentModel config)
    ...
    @Override
    public IpatuuraUserStorageProvider create(PassportSession session, ComponentModel model) {
