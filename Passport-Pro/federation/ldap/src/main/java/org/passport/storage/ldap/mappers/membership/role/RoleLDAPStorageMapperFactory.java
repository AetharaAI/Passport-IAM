...
public class RoleLDAPStorageMapperFactory extends AbstractLDAPStorageMapperFactory {
    ...
    private static List<ProviderConfigProperty> getProps(ComponentModel parent) {
        ...
        config.property().name(RoleMapperConfig.USER_ROLES_RETRIEVE_STRATEGY)
                ...
                .helpText("If true, then LDAP role mappings will be mapped to realm role mappings in Passport. Otherwise it will be mapped to client role mappings")
    ...
    public String getHelpText() {
        return "Used to map role mappings of roles from some LDAP DN to Passport role mappings of either realm roles or client roles of particular client";
    }
    ...
    public Map<String, Object> getTypeMetadata() {
        ...
        metadata.put("fedToPassportSyncMessage", "sync-ldap-roles-to-passport");
        metadata.put("passportToFedSyncSupported", true);
        metadata.put("passportToFedSyncMessage", "sync-passport-roles-to-ldap");
