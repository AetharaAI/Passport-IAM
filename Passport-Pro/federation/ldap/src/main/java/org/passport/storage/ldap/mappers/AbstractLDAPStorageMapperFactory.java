...
public abstract class AbstractLDAPStorageMapperFactory implements LDAPStorageMapperFactory<LDAPStorageMapper> {
    ...
    @Override
    public LDAPStorageMapper create(PassportSession session, ComponentModel model) {
    ...
    public Map<String, Object> getTypeMetadata() {
        ...
        metadata.put("fedToPassportSyncSupported", false);
        metadata.put("passportToFedSyncSupported", false);
