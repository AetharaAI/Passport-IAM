...
public class GroupMapperConfig extends CommonLDAPGroupMapperConfig {
    ...
    // Flag whether group inheritance from LDAP should be propagated to Passport group inheritance.
    ...
    // Name of attributes of the LDAP group object, which will be mapped as attributes of Group in Passport
    public static final String MAPPED_GROUP_ATTRIBUTES = "mapped.group.attributes";

    // During sync of groups from LDAP to Passport, we will keep just those Passport groups, which still exists in LDAP. Rest will be deleted
    ...
    // Passport group path the LDAP groups are added to (default: top level "/")
