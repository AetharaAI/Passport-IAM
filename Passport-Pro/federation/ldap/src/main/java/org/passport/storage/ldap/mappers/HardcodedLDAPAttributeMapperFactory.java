...
import org.passport.provider.ConfigurationValidationHelper;
...
public class HardcodedLDAPAttributeMapperFactory extends AbstractLDAPStorageMapperFactory {
    ...
    public String getHelpText() {
        return "This mapper is supported just if syncRegistrations is enabled. When new user is registered in Passport, he will be written to the LDAP with the hardcoded value of some specified attribute.";
    }
