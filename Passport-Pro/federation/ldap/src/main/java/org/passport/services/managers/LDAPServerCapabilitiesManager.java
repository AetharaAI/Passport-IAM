...
import org.passport.storage.ldap.idm.store.ldap.LDAPContextManager;
import org.passport.storage.ldap.idm.store.ldap.LDAPIdentityStore;
import org.passport.storage.ldap.mappers.membership.group.GroupTreeResolver;
...
public class LDAPServerCapabilitiesManager {
    ...
    public static Set<LDAPCapabilityRepresentation> queryServerCapabilities(TestLdapConnectionRepresentation config, PassportSession session,
                                                                            RealmModel realm) {
    ...
    public static void testLDAP(TestLdapConnectionRepresentation config, PassportSession session, RealmModel realm) throws javax.naming.NamingException {
