...
/**
 * A {@link InitialLdapContext} that binds instances of this class with the {@link PassportSession} so that any resource
...
public final class SessionBoundInitialLdapContext extends InitialLdapContext {
    ...
    public SessionBoundInitialLdapContext(PassportSession session, Hashtable<?, ?> environment, Control[] connCtls) throws NamingException {
