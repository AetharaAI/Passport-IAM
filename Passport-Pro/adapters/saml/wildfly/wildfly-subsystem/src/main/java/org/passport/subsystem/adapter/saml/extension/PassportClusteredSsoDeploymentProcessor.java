 ...
 * @author hmlnarik
 */
public class PassportClusteredSsoDeploymentProcessor implements DeploymentUnitProcessor {

    private static final Logger LOG = Logger.getLogger(PassportClusteredSsoDeploymentProcessor.class);

    private static final String DEFAULT_CACHE_CONTAINER = "web";
    private static final String SSO_CACHE_CONTAINER_NAME_PARAM_NAME = "passport.sessionIdMapperUpdater.infinispan.containerName";
    private static final String SSO_CACHE_NAME_PARAM_NAME = "passport.sessionIdMapperUpdater.infinispan.cacheName";

    @Override
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        final DeploymentUnit deploymentUnit = phaseContext.getDeploymentUnit();

        if (isPassportSamlAuthMethod(deploymentUnit) && isDistributable(deploymentUnit)) {
    ...
    public static boolean isPassportSamlAuthMethod(final DeploymentUnit deploymentUnit) {
        ...
        return loginConfig != null && Objects.equals(loginConfig.getAuthMethod(), "PASSPORT-SAML");
    }
