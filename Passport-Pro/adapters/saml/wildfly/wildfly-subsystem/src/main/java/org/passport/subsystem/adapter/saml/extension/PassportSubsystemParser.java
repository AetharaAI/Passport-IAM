 ...
 */
class PassportSubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<SubsystemMarshallingContext> {
    ...
    public void readElement(final XMLExtendedStreamReader reader, final List<ModelNode> list) throws XMLStreamException {
        ...
        ModelNode addPassportSub = Util.createAddOperation(PathAddress.pathAddress(PassportSamlExtension.PATH_SUBSYSTEM));
        list.add(addPassportSub);
    ...
    void readSecureDeployment(XMLExtendedStreamReader reader, List<ModelNode> list) throws XMLStreamException {
        ...
        PathAddress addr = PathAddress.pathAddress(
                PathElement.pathElement(ModelDescriptionConstants.SUBSYSTEM, PassportSamlExtension.SUBSYSTEM_NAME),
    ...
    void readIdentityProvider(List<ModelNode> list, XMLExtendedStreamReader reader, PathAddress parentAddr) throws XMLStreamException {
        ...
        for (int i = 0; i < reader.getAttributeCount(); i++) {
            ...
            if (Constants.XML.ENTITY_ID.equals(name)
                    // don't break if encountering this noop attr from client-adapter/core passport_saml_adapter_1_6.xsd
    ...
    public void writeContent(final XMLExtendedStreamWriter writer, final SubsystemMarshallingContext context) throws XMLStreamException {
        context.startSubsystemElement(PassportSamlExtension.CURRENT_NAMESPACE, false);
