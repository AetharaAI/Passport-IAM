 ...
 */
package org.passport.adapters.cloned;
...
import org.passport.adapters.saml.config.parsers.PassportSamlAdapterV1QNames;
...
public class HttpAdapterUtilsTest {
    ...
    public void testExtractKeysFromSamlDescriptor() throws ParsingException {
        ...
        assertThat(res.get(PassportSamlAdapterV1QNames.ATTR_SIGNING.getQName().getLocalPart()), notNullValue());
        assertThat(res.get(PassportSamlAdapterV1QNames.ATTR_SIGNING.getQName().getLocalPart()).size(), equalTo(2));
        ...
        ki = res.get(PassportSamlAdapterV1QNames.ATTR_SIGNING.getQName().getLocalPart()).get(0);
        ...
        ki = res.get(PassportSamlAdapterV1QNames.ATTR_SIGNING.getQName().getLocalPart()).get(1);
        assertThat(ki.getContent().size(), equalTo(2));
        assertThat((Iterable<? super XMLStructure>) ki.getContent(), x509DataMatcher);
        assertThat((Iterable<? super XMLStructure>) ki.getContent(), keyNameMatcher);
