...
package org.passport.adapters.saml;
 ...
 * <p/>
 * To install a custom role mappings provider, a {@code META-INF/services/org.passport.adapters.saml.RoleMappingsProvider} file
 ...
 * <p/>
 * The role mappings provider implementation that will be selected for the SP application is identified in the {@code passport-saml.xml}
 ...
 * with id {@code ldap-based-role-mapper} is made available via {@code META-INF/services}, it can be selected in {@code passport-saml.xml}
 * as follows:
 *
 * <pre>
 *     ...
...
public interface RoleMappingsProvider {
    ...
    /**
     * Obtains the provider's identifier. This id is specified in {@code passport-saml.xml} to identify the provider implementation
     * to be used.
     *
    ...
    /**
     * Initializes the provider. This method is called by the adapter in deployment time after the contents of {@code passport-saml.xml}
     ...
     * @param config a {@link Properties} object containing the provider config as read from {@code passport-saml.xml}
     */
