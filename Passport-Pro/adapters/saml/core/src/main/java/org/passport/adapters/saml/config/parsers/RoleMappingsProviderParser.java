 ...
 */
public class RoleMappingsProviderParser extends AbstractPassportSamlAdapterV1Parser<SP.RoleMappingsProviderConfig> {
    ...
    private RoleMappingsProviderParser() {
        super(PassportSamlAdapterV1QNames.ROLE_MAPPINGS_PROVIDER);
    }
    ...
    protected SP.RoleMappingsProviderConfig instantiateElement(XMLEventReader xmlEventReader, StartElement element) throws ParsingException {
        ...
        providerConfig.setId(StaxParserUtil.getRequiredAttributeValueRP(element, PassportSamlAdapterV1QNames.ATTR_ID));
        providerConfig.setConfiguration(new Properties());
        return providerConfig;
    }

    @Override
    protected void processSubElement(XMLEventReader xmlEventReader, SP.RoleMappingsProviderConfig target, PassportSamlAdapterV1QNames element, StartElement elementDetail) throws ParsingException {
        switch(element) {
            case PROPERTY:
                final String name = StaxParserUtil.getRequiredAttributeValueRP(elementDetail, PassportSamlAdapterV1QNames.ATTR_NAME);
                final String value = StaxParserUtil.getRequiredAttributeValueRP(elementDetail, PassportSamlAdapterV1QNames.ATTR_VALUE);
