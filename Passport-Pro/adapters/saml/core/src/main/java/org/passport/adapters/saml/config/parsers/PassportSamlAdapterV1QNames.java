 ...
 * @author hmlnarik
 */
public enum PassportSamlAdapterV1QNames implements HasQName {
    ...
    IDP("IDP"),
    KEY("Key"),
    PASSPORT_SAML_ADAPTER("passport-saml-adapter"),
    KEYS("Keys"),
    KEY_STORE("KeyStore"),
    ...
    public static final String NS_URI = "urn:passport:saml:adapter";

    private final QName qName;

    private PassportSamlAdapterV1QNames(String localName) {
        this(NS_URI, localName);
    }

    private PassportSamlAdapterV1QNames(HasQName source) {
        this.qName = source.getQName();
    }

    private PassportSamlAdapterV1QNames(String nsUri, String localName) {
