...
public class RoleMappingsProviderUtils {
     ...
     * that was configured in {@code passport-saml.xml}. The selected provider is then initialized with the specified
     * {@link SamlDeployment}, {@link ResourceLoader} and configuration as specified in {@code passport-saml.xml}. If no
     ...
     * @param providerConfig the provider configuration properties as configured in {@code passport-saml.xml}. Can contain
