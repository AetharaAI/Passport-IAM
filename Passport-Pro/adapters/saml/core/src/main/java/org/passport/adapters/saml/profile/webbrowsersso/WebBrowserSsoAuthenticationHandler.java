...
package org.passport.adapters.saml.profile.webbrowsersso;
...
import org.passport.adapters.saml.profile.AbstractSamlAuthenticationHandler;
import org.passport.adapters.saml.profile.SamlAuthenticationHandler;
import org.passport.adapters.saml.profile.SamlInvocationContext;
    ...
    protected AuthOutcome logoutRequest(LogoutRequestType request, String relayState) {
        ...
        if (deployment.getIDP().getSingleLogoutService().signResponse()) {
            ...
            binding.signatureAlgorithm(deployment.getSignatureAlgorithm())
                    ...
                    .signDocument();
            // TODO: As part of PASSPORT-3810, add KeyID to the SAML document
            //   <related DocumentBuilder>.addExtension(new PassportKeySamlExtensionGenerator(<key ID>));
        }
