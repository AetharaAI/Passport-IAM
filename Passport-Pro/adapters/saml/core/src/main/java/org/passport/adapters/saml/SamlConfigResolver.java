...
import org.passport.adapters.spi.HttpFacade.Request;

/**
 * On multi-tenant scenarios, Passport will defer the resolution of a
 ...
 * SamlDeployment. Based on this SamlDeployment, Passport will resume
 ...
 * passport-saml.xml to the build() method.
 *
