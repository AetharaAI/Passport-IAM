...
import org.passport.adapters.spi.AuthenticationError;
import org.passport.adapters.spi.HttpFacade;
import org.passport.adapters.spi.LogoutError;
...
class ElytronHttpFacade implements HttpFacade {
    ...
    static {
        ...
        String prop = System.getProperty("org.passport.adapters.elytronweb.ELYWEB-163.workaround");
        if (prop != null) {
