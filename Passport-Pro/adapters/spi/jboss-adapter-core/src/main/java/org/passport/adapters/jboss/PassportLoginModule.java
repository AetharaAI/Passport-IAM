...
package org.passport.adapters.jboss;
...
import org.passport.adapters.spi.PassportAccount;
 ...
 * @version $Revision: 1 $
 */
public class PassportLoginModule extends AbstractServerLoginModule {
    protected static Logger log = Logger.getLogger(PassportLoginModule.class);
    ...
    public boolean login() throws LoginException {
        log.debug("PassportLoginModule.login()");
        if (super.login()) {
        ...
        if (credential != null && (credential instanceof PassportAccount)) {
            log.debug("Found Account");
            PassportAccount account = (PassportAccount)credential;
