...
public class MigrateTo4_0_0 implements Migration {
    ...
    protected void migrateRealm(PassportSession session, RealmModel realm, boolean json) {
        ...
        realm.getComponentsStream(realm.getId(), "org.passport.services.clientregistration.policy.ClientRegistrationPolicy")
        ...
        if (offlineAccessRole == null) {
            ...
            offlineAccessScope = PassportModelUtils.getClientScopeByName(realm, OAuth2Constants.OFFLINE_ACCESS);
