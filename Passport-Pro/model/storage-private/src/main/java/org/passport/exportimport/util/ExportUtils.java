...
public class ExportUtils {
    ...
    public static RealmRepresentation exportRealm(PassportSession session, RealmModel realm, boolean includeUsers, boolean internal) {
        ExportOptions opts = new ExportOptions(includeUsers, true, true, false, false);
        return exportRealm(session, realm, opts, internal);
    }

    public static RealmRepresentation exportRealm(PassportSession session, RealmModel realm, ExportOptions options, boolean internal) {
        ...
        rep.setPassportVersion(Version.VERSION);
     ...
     */
    public static ClientRepresentation exportClient(PassportSession session, ClientModel client) {
     ...
     */
    public static UserRepresentation exportUser(PassportSession session, RealmModel realm, UserModel user, ExportOptions options, boolean internal) {
    ...
    public static void exportUsersToStream(PassportSession session, RealmModel realm, List<UserModel> usersToExport, ObjectMapper mapper, OutputStream os) throws IOException {
        exportUsersToStream(session, realm, usersToExport, mapper, os, new ExportOptions());
    }

    public static void exportUsersToStream(PassportSession session, RealmModel realm, List<UserModel> usersToExport, ObjectMapper mapper, OutputStream os, ExportOptions options) throws IOException {
    ...
    public static void exportFederatedUsersToStream(PassportSession session, RealmModel realm, List<String> usersToExport, ObjectMapper mapper, OutputStream os) throws IOException {
        exportFederatedUsersToStream(session, realm, usersToExport, mapper, os, new ExportOptions());
    }

    public static void exportFederatedUsersToStream(PassportSession session, RealmModel realm, List<String> usersToExport, ObjectMapper mapper, OutputStream os, ExportOptions options) throws IOException {
        JsonFactory factory = mapper.getFactory();
        JsonGenerator generator = factory.createGenerator(os, JsonEncoding.UTF8);
        try {
            if (mapper.isEnabled(SerializationFeature.INDENT_OUTPUT)) {
     ...
     * @return fully exported user representation
     */
    public static UserRepresentation exportFederatedUser(PassportSession session, RealmModel realm, String id, ExportOptions options) {
    ...
    private static UserFederatedStorageProvider userFederatedStorage(PassportSession session) {
