...
package org.passport.models.session;
...
public class PersistentUserSessionAdapter implements OfflineUserSessionModel {
    ...
    public PersistentUserSessionAdapter(PassportSession session, PersistentUserSessionModel model, RealmModel realm, String userId, Map<String, AuthenticatedClientSessionModel> clientSessions) {
