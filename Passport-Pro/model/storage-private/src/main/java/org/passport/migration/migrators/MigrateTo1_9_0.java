...
public class MigrateTo1_9_0 implements Migration {
    ...
    public void migrate(PassportSession session) {
        ...
        if (realm != null && realm.getDisplayNameHtml() != null && realm.getDisplayNameHtml().equals("<strong>Passport</strong>")) {
            realm.setDisplayNameHtml("<div class=\"kc-logo-text\"><span>Passport</span></div>");
        }
    }
