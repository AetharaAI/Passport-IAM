...
public class MigrateTo2_1_0 implements Migration {
    ...
    // PASSPORT-3244: Required Action "Configure Totp" should be "Configure OTP"
    ...
    // PASSPORT-3338: Changes to how role policy config is stored"
    private void migrateRolePolicies(RealmModel realm, PassportSession session) {
