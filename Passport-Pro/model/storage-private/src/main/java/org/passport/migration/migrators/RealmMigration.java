...
public abstract class RealmMigration implements Migration {
    ...
    @Override
    public void migrateImport(PassportSession session, RealmModel realm, RealmRepresentation rep,
            boolean skipUserDependent) {
        migrateRealm(session, realm);
    }

    public abstract void migrateRealm(PassportSession session, RealmModel realm);
}
