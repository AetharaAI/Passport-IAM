...
public class PersistentAuthenticatedClientSessionAdapter implements AuthenticatedClientSessionModel {
    ...
    public PersistentAuthenticatedClientSessionAdapter(PassportSession session, AuthenticatedClientSessionModel clientSession) {
    ...
    public PersistentAuthenticatedClientSessionAdapter(PassportSession session, PersistentClientSessionModel model, RealmModel realm, ClientModel client, UserSessionModel userSession) {
        this.session = session;
        this.model = model;
        this.realm = realm;
        this.client = client;
