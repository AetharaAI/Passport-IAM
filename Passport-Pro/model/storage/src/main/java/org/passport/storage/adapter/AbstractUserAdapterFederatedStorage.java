...
public abstract class AbstractUserAdapterFederatedStorage extends UserModelDefaultMethods {
    ...
    public AbstractUserAdapterFederatedStorage(PassportSession session, RealmModel realm, ComponentModel storageProviderModel) {
    ...
    public abstract static class Streams extends AbstractUserAdapterFederatedStorage implements UserModel {
        ...
        public Streams(final PassportSession session, final RealmModel realm, final ComponentModel storageProviderModel) {
