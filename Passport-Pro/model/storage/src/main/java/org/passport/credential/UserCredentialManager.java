...
import org.passport.storage.AbstractStorageManager;
 ...
 */
public class UserCredentialManager extends AbstractStorageManager<UserStorageProvider, UserStorageProviderModel> implements org.passport.models.UserCredentialManager {
    ...
    /**
     * It is not recommended to use this method directly from your user-storage providers! Please use {@link org.passport.models.UserProvider#getUserCredentialManager(UserModel) session.users().getUserCredentialManager(user)} instead.
     */
    public UserCredentialManager(PassportSession session, RealmModel realm, UserModel user) {
