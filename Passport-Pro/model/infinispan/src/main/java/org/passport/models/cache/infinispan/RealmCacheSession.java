...
import org.passport.models.cache.CachedRealmModel;
import org.passport.models.cache.infinispan.entities.CachedClient;
import org.passport.models.cache.infinispan.entities.CachedClientRole;
import org.passport.models.cache.infinispan.entities.CachedClientScope;
import org.passport.models.cache.infinispan.entities.CachedGroup;
import org.passport.models.cache.infinispan.entities.CachedRealm;
import org.passport.models.cache.infinispan.entities.CachedRealmRole;
import org.passport.models.cache.infinispan.entities.CachedRole;
import org.passport.models.cache.infinispan.entities.ClientListQuery;
import org.passport.models.cache.infinispan.entities.ClientScopeListQuery;
import org.passport.models.cache.infinispan.entities.GroupListQuery;
import org.passport.models.cache.infinispan.entities.GroupNameQuery;
import org.passport.models.cache.infinispan.entities.RealmListQuery;
import org.passport.models.cache.infinispan.entities.RoleByNameQuery;
import org.passport.models.cache.infinispan.entities.RoleListQuery;
...
public class RealmCacheSession implements CacheRealmProvider {
    ...
    public RealmCacheSession(RealmCacheManager cache, PassportSession session) {
        this.cache = cache;
    ...
    private RealmAdapter prepareCachedRealm(String id, PassportSession session) {
        CachedRealm cached = cache.get(id, CachedRealm.class);
        RealmAdapter adapter;
        if (cached == null) {
    ...
    public RealmModel getRealmByName(String name) {
        ...
        if (query != null) {
            ...
            return cache.computeSerialized(session, cacheKey, (key, passportSession) -> prepareCachedRealmByName(name, key));
        }
    }
    ...
    public ClientModel getClientById(RealmModel realm, String id) {
        ...
        if (cached != null) {
            ...
            adapter = cache.computeSerialized(session, id, (key, passportSession) -> prepareCachedClientById(realm, id));
            if (adapter == null) {
                return adapter;
            }
        }
    ...
    public ClientModel getClientByClientId(RealmModel realm, String clientId) {
        ...
        if (query != null) {
            ...
            return cache.computeSerialized(session, cacheKey, (key, passportSession) -> prepareCachedClientByClientId(realm, clientId, key));
        }
    }
