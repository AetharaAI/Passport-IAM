...
package org.passport.models.cache.infinispan.authorization.entities;
...
import org.passport.models.cache.infinispan.entities.AbstractRevisioned;
...
public class CachedPolicy extends AbstractRevisioned implements InResourceServer {
    ...
    public Map<String, String> getConfig(PassportSession session, Supplier<Policy> policy) {
    ...
    public Set<String> getAssociatedPoliciesIds(PassportSession session, Supplier<Policy> policy) {
        return this.associatedPoliciesIds.get(session, policy);
    }

    public Set<String> getResourcesIds(PassportSession session, Supplier<Policy> policy) {
        return this.resourcesIds.get(session, policy);
    }

    public Set<String> getResourceNames(PassportSession session, Supplier<Policy> policy) {
        return this.resourcesNames.get(session, policy);
    }

    public Set<String> getScopesIds(PassportSession session, Supplier<Policy> policy) {
