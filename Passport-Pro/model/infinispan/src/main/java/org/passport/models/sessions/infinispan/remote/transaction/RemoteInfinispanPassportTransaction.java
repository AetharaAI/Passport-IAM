...
class RemoteInfinispanPassportTransaction<K, V, R extends ConditionalRemover<K, V>> implements NonBlockingTransaction {
    ...
    RemoteInfinispanPassportTransaction(RemoteCache<K, V> cache, R conditionalRemover) {
