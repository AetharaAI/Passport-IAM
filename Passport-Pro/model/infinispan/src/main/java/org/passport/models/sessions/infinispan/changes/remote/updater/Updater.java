 ...
 */
package org.passport.models.sessions.infinispan.changes.remote.updater;
...
public interface Updater<K, V> extends BiFunction<K, V, V> {
    ...
    /**
     * @return {@code true} if the entity was removed during the Passport transaction and it should be removed from
     * Infinispan.
     */
    boolean isDeleted();

    /**
     * @return {@code true} if the entity was created during the Passport transaction. Allows some optimization like
     * put-if-absent.
     */
    boolean isCreated();
