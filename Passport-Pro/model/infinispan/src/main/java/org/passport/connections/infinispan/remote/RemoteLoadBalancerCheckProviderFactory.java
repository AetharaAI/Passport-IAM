...
package org.passport.connections.infinispan.remote;
...
import org.passport.health.LoadBalancerCheckProviderFactory;
...
public class RemoteLoadBalancerCheckProviderFactory implements LoadBalancerCheckProviderFactory, EnvironmentDependentProviderFactory {
    ...
    @Override
    public LoadBalancerCheckProvider create(PassportSession session) {
        return provider;
    }
