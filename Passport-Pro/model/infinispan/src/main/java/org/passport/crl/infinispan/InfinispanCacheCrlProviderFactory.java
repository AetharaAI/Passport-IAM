...
package org.passport.crl.infinispan;
...
import org.passport.models.cache.CacheCrlProvider;
import org.passport.models.cache.CacheCrlProviderFactory;
...
public class InfinispanCacheCrlProviderFactory implements CacheCrlProviderFactory {
    ...
    @Override
    public CacheCrlProvider create(PassportSession session) {
        lazyInit(session);
