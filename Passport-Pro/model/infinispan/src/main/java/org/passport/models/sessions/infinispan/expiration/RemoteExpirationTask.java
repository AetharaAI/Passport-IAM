...
class RemoteExpirationTask extends BaseExpirationTask {
    ...
    RemoteExpirationTask(PassportSessionFactory factory, ScheduledExecutorService scheduledExecutorService, int intervalSeconds, Consumer<Duration> onTaskExecuted, RemoteCache<String, String> workCache, String nodeName) {
