...
import org.passport.models.cache.infinispan.entities.CachedFederatedIdentityLinks;
import org.passport.models.cache.infinispan.entities.CachedUser;
import org.passport.models.cache.infinispan.entities.CachedUserConsent;
import org.passport.models.cache.infinispan.entities.CachedUserConsents;
import org.passport.models.cache.infinispan.entities.UserListQuery;
...
import org.passport.storage.CacheableStorageProviderModel;
...
import static org.passport.organization.utils.Organizations.isReadOnlyOrganizationMember;
...
public class UserCacheSession implements UserCache, OnCreateComponent, OnUpdateComponent, UserProfileDecorator {
    ...
    public UserCacheSession(UserCacheManager cache, PassportSession session) {
        this.cache = cache;
    ...
    private PassportTransaction getTransaction() {
    ...
    public Stream<FederatedIdentityModel> getFederatedIdentitiesStream(RealmModel realm, UserModel user) {
        ...
        if (cachedLinks == null) {
            ...
            cache.addRevisioned(cachedLinks, startupRevision); // this is Passport's internal store, cache indefinitely
    ...
    public UserConsentModel getConsentByClient(RealmModel realm, String userId, String clientId) {
        ...
        if (cached == null) {
            ...
            cache.addRevisioned(cached, startupRevision); // this is from Passport's internal store, cache indefinitely
        }
