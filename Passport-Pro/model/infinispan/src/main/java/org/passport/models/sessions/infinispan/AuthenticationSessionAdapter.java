...
public class AuthenticationSessionAdapter implements AuthenticationSessionModel {
    ...
    public AuthenticationSessionAdapter(PassportSession session, RootAuthenticationSessionModel parent, SessionEntityUpdater<AuthenticationSessionEntity> updater, String tabId) {
