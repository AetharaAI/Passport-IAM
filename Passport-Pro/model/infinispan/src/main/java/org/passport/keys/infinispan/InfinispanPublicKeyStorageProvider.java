...
public class InfinispanPublicKeyStorageProvider implements PublicKeyStorageProvider {
    ...
    public InfinispanPublicKeyStorageProvider(PassportSession session, Cache<String, PublicKeysEntry> keys, Map<String, FutureTask<PublicKeysEntry>> tasksInProgress,
    ...
    protected PassportTransaction getAfterTransaction() {
