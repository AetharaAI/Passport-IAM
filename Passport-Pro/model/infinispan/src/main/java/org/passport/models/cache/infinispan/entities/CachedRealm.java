...
import org.passport.common.util.ConcurrentMultivaluedHashMap;
...
public class CachedRealm extends AbstractExtendableRevisioned {
    ...
    public OAuth2DeviceConfig getOAuth2DeviceConfig(PassportSession session, Supplier<RealmModel> modelSupplier) {
    ...
    public List<String> getDefaultDefaultClientScopes(PassportSession session, Supplier<RealmModel> modelSupplier) {
        return defaultDefaultClientScopes.get(session, modelSupplier);
    }

    public List<String> getOptionalDefaultClientScopes(PassportSession session, Supplier<RealmModel> modelSupplier) {
