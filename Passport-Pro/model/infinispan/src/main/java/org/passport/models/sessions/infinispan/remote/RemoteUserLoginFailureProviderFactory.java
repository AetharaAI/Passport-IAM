...
import org.passport.models.sessions.infinispan.changes.remote.updater.loginfailures.LoginFailuresUpdater;
...
import org.passport.models.sessions.infinispan.remote.transaction.LoginFailureChangeLogTransaction;
...
public class RemoteUserLoginFailureProviderFactory implements UserLoginFailureProviderFactory<RemoteUserLoginFailureProvider>, UpdaterFactory<LoginFailureKey, LoginFailureEntity, LoginFailuresUpdater>, EnvironmentDependentProviderFactory, RemoteChangeLogTransaction.SharedState<LoginFailureKey, LoginFailureEntity>, ServerInfoAwareProviderFactory {
    ...
    @Override
    public RemoteUserLoginFailureProvider create(PassportSession session) {
    ...
    private LoginFailureChangeLogTransaction createAndEnlistTransaction(PassportSession session) {
