...
public class DefaultJGroupsCertificateProviderFactory implements JGroupsCertificateProviderFactory {
    ...
    @Override
    public JGroupsCertificateProvider create(PassportSession session) {
        if (provider == null) {
            postInit(session.getPassportSessionFactory());
        }
        return provider;
    }
    ...
    @Override
    public synchronized void postInit(PassportSessionFactory factory) {
        if (provider != null) {
            return;
        }
    ...
    private JGroupsCertificateProvider createProvider(PassportSessionFactory factory) {
