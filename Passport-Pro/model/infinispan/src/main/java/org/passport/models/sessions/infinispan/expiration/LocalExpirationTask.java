...
class LocalExpirationTask extends BaseExpirationTask implements Predicate<RealmModel> {
    ...
    LocalExpirationTask(PassportSessionFactory factory, ScheduledExecutorService scheduledExecutorService, int intervalSeconds, Consumer<Duration> onTaskExecuted) {
