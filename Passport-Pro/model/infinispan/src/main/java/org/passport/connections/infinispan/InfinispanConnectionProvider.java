...
public interface InfinispanConnectionProvider extends Provider {
     ...
     * @deprecated The logic in {@link TopologyInfo} is not used anymore in Passport. To get the node or site name, use {@link #getNodeInfo()}.
     */
     ...
     */
    static <K, V> RemoteCache<K, V> getRemoteCache(PassportSessionFactory factory, String cacheName) {
