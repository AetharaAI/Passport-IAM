...
public abstract class SessionClusterEvent implements ClusterEvent {
    ...
    public static <T extends SessionClusterEvent> T createEvent(Class<T> eventClass, String eventKey, PassportSession session, String realmId) {
        try {
    ...
    void setData(PassportSession session, String eventKey, String realmId) {
