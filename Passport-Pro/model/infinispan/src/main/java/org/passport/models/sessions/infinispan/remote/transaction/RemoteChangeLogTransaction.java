...
import org.passport.models.sessions.infinispan.changes.remote.updater.Expiration;
import org.passport.models.sessions.infinispan.changes.remote.updater.Updater;
import org.passport.models.sessions.infinispan.changes.remote.updater.UpdaterFactory;
import org.passport.models.sessions.infinispan.transaction.DatabaseUpdate;
import org.passport.models.sessions.infinispan.transaction.NonBlockingTransaction;
...
/**
 * A {@link PassportTransaction} implementation that keeps track of changes made to entities stored in a Infinispan
 * cache.
 *
