...
import org.passport.models.cache.infinispan.entities.InRealm;
...
public class CachedOrganization extends AbstractRevisioned implements InRealm {
    ...
    public MultivaluedHashMap<String, String> getAttributes(PassportSession session, Supplier<OrganizationModel> organizationModel) {
