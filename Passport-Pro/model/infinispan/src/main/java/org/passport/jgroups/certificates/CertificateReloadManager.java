...
public class CertificateReloadManager implements Lifecycle {
    ...
    public CertificateReloadManager(PassportSessionFactory sessionFactory) {
    ...
    public void rotateCertificate() {
        ...
        lock.lock();
        try (lock) {
            PassportModelUtils.runJobInTransaction(sessionFactory, CertificateReloadManager::replaceCertificateInTransaction);
    ...
    public void reloadCertificate() {
        ...
        try (lock) {
            ...
            PassportModelUtils.runJobInTransaction(sessionFactory, CertificateReloadManager::loadCertificateInTransaction);
        } catch (RuntimeException e) {
    ...
    private void scheduleNextRotation() {
        ...
        try (lock) {
            ...
            var delay = PassportModelUtils.runJobInTransactionWithResult(sessionFactory, CertificateReloadManager::nextRotationDelay);
    ...
    private static void replaceCertificateInTransaction(PassportSession session) {
        session.getProvider(JGroupsCertificateProvider.class).rotateCertificate();
    }

    private static void loadCertificateInTransaction(PassportSession session) {
        session.getProvider(JGroupsCertificateProvider.class).reloadCertificate();
    }

    private static Duration nextRotationDelay(PassportSession session) {
