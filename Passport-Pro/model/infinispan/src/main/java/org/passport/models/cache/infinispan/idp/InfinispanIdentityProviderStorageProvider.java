 ...
 */
package org.passport.models.cache.infinispan.idp;
...
import org.passport.models.cache.infinispan.RealmCacheManager;
import org.passport.models.cache.infinispan.RealmCacheSession;
import org.passport.organization.OrganizationProvider;

import static org.passport.models.IdentityProviderStorageProvider.LoginFilter.getLoginPredicate;
...
public class InfinispanIdentityProviderStorageProvider implements IdentityProviderStorageProvider {
    ...
    public InfinispanIdentityProviderStorageProvider(PassportSession session) {
