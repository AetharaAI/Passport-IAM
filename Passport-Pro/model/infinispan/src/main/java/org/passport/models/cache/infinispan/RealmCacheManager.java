...
import org.passport.models.cache.infinispan.events.RealmCacheInvalidationEvent;
...
public class RealmCacheManager extends CacheManager {
    ...
    /**
     * Compute a cached realm and ensure that this happens only once with the current Passport instance.
     ...
     */
    public <T> T computeSerialized(PassportSession session, String id, BiFunction<String, PassportSession, T> compute) {
