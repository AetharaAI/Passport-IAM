...
public class PersisterLastSessionRefreshStoreFactory extends AbstractLastSessionRefreshStoreFactory {
    ...
    public PersisterLastSessionRefreshStore createAndInit(PassportSession kcSession, boolean offline) {
    ...
    public PersisterLastSessionRefreshStore createAndInit(PassportSession kcSession,
