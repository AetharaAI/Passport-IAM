...
public class CachedUser extends AbstractExtendableRevisioned implements InRealm  {
    ...
    public String getFirstAttribute(PassportSession session, String name, Supplier<UserModel> userModel) {
    ...
    public MultivaluedHashMap<String, String> getAttributes(PassportSession session, Supplier<UserModel> userModel) {
        return lazyLoadedAttributes.get(session, userModel);
    }

    public Set<String> getRequiredActions(PassportSession session, Supplier<UserModel> userModel) {
        return this.requiredActions.get(session, userModel);
    }

    public Set<String> getRoleMappings(PassportSession session, Supplier<UserModel> userModel) {
    ...
    public Set<String> getGroups(PassportSession session, Supplier<UserModel> userModel) {
    ...
    public List<CredentialModel> getStoredCredentials(PassportSession session, Supplier<UserModel> userModel) {
