...
public class OrganizationAdapter implements OrganizationModel {
    ...
    public OrganizationAdapter(PassportSession session, CachedOrganization cached, Supplier<OrganizationProvider> delegate, InfinispanOrganizationProvider organizationCache) {
