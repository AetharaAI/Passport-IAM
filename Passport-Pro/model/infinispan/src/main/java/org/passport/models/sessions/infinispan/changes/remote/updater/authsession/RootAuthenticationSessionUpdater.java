 ...
 */
package org.passport.models.sessions.infinispan.changes.remote.updater.authsession;
...
import org.passport.models.sessions.infinispan.AuthenticationSessionAdapter;
import org.passport.models.sessions.infinispan.SessionEntityUpdater;
...
public class RootAuthenticationSessionUpdater extends BaseUpdater<String, RootAuthenticationSessionEntity> implements RootAuthenticationSessionModel {
    ...
    public synchronized void initialize(PassportSession session, RealmModel realm, int authSessionsLimit) {
