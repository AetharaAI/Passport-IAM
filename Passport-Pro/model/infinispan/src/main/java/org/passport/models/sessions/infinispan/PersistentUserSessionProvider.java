...
import org.passport.models.OfflineUserSessionModel;
...
import org.passport.models.session.PersistentUserSessionAdapter;
...
import org.passport.models.sessions.infinispan.changes.JpaChangesPerformer;
import org.passport.models.sessions.infinispan.changes.MergedUpdate;
import org.passport.models.sessions.infinispan.changes.PersistentSessionUpdateTask;
...
import org.passport.models.sessions.infinispan.changes.SessionUpdatesList;
...
import org.passport.models.sessions.infinispan.entities.SessionEntity;
...
import org.passport.models.sessions.infinispan.stream.Mappers;
...
import org.passport.models.sessions.infinispan.util.FuturesHelper;
import org.passport.models.sessions.infinispan.util.SessionExpirationPredicates;
...
import static org.passport.models.Constants.SESSION_NOTE_LIGHTWEIGHT_USER;
import static org.passport.models.sessions.infinispan.changes.ClientSessionPersistentChangelogBasedTransaction.createAuthenticatedClientSessionInstance;
...
public class PersistentUserSessionProvider implements UserSessionProvider, SessionRefreshStore, ClientSessionManager {
    ...
    public PersistentUserSessionProvider(PassportSession session,
    ...
    private static UserSessionEntity createUserSessionEntityInstance(UserSessionModel userSession) {
        ...
        if (userSession instanceof OfflineUserSessionModel offlineUserSession) {
            ...
            // see related JIRA - PASSPORT-5350 and corresponding test
     ...
     * in a future version of Passport.
     */
     ...
     * As this is assumed to run once during the upgrade to Passport 25, this should be safe to assume.
     */
