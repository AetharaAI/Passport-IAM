...
public class CachedResource extends AbstractRevisioned implements InResourceServer {
    ...
    public Set<String> getUris(PassportSession session, Supplier<Resource> source) {
    ...
    public Set<String> getScopesIds(PassportSession session, Supplier<Resource> source) {
        return this.scopesIds.get(session, source);
    }

    public Map<String, List<String>> getAttributes(PassportSession session, Supplier<Resource> source) {
