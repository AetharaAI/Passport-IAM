...
public interface UpdaterFactory<K, V, T extends Updater<K, V>> {
    ...
    /**
     * Creates an {@link Updater} for an entity created by the current Passport transaction.
     *
    ...
    /**
     * Deletes a entity that was not previous read by the Passport transaction.
     *
     * @param key The Infinispan key.
