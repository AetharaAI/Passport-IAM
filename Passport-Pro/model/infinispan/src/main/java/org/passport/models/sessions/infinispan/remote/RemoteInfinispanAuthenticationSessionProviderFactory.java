...
import org.passport.models.sessions.infinispan.changes.remote.updater.UpdaterFactory;
import org.passport.models.sessions.infinispan.changes.remote.updater.authsession.RootAuthenticationSessionUpdater;
...
import static org.passport.models.sessions.infinispan.InfinispanAuthenticationSessionProviderFactory.DEFAULT_AUTH_SESSIONS_LIMIT;
...
public class RemoteInfinispanAuthenticationSessionProviderFactory implements AuthenticationSessionProviderFactory<RemoteInfinispanAuthenticationSessionProvider>, UpdaterFactory<String, RootAuthenticationSessionEntity, RootAuthenticationSessionUpdater>, EnvironmentDependentProviderFactory, RemoteChangeLogTransaction.SharedState<String, RootAuthenticationSessionEntity>, ServerInfoAwareProviderFactory {
    ...
    @Override
    public RemoteInfinispanAuthenticationSessionProvider create(PassportSession session) {
    ...
    private AuthenticationSessionChangeLogTransaction createAndEnlistTransaction(PassportSession session) {
