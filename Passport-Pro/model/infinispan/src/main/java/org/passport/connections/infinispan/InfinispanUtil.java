...
public class InfinispanUtil {
     ...
     */
    @Deprecated
    public static TopologyInfo getTopologyInfo(PassportSession session) {
    ...
    /**
     * Replaces the {@link TimeService} in infinispan with the one that respects Passport {@link Time}.
     *
     * @param cacheManager The {@link EmbeddedCacheManager} to inject the Passport {@link Time}.
     * @return Runnable to revert replacement of the infinispan time service
     */
    public static Runnable setTimeServiceToPassportTime(EmbeddedCacheManager cacheManager) {
        TimeService previousTimeService = replaceComponent(cacheManager, TimeService.class, PASSPORT_TIME_SERVICE, true);
        ...
        return () -> {
            ...
            logger.info("Revert set PassportIspnTimeService to the infinispan cacheManager");
    ...
    public static final TimeService PASSPORT_TIME_SERVICE = new EmbeddedTimeService() {
