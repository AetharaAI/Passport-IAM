...
import org.passport.exportimport.util.MultipleStepsExportProvider;
...
public class DirExportProvider extends MultipleStepsExportProvider<DirExportProvider> {
    ...
    public DirExportProvider(PassportSessionFactory sessionFactory) {
    ...
    private File getRootDirectory() {
        if (rootDirectory == null) {
            if (dir == null) {
                rootDirectory = new File(Platform.getPlatform().getTmpDirectory(), "passport-export");
            } else {
    ...
    @Override
    protected void writeUsers(String fileName, PassportSession session, RealmModel realm, List<UserModel> users) throws IOException {
        File file = new File(getRootDirectory(), fileName);
    ...
    @Override
    protected void writeFederatedUsers(String fileName, PassportSession session, RealmModel realm, List<String> users) throws IOException {
        File file = new File(getRootDirectory(), fileName);
        FileOutputStream os = new FileOutputStream(file);
