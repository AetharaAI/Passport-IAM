...
package org.passport.exportimport.singlefile;
...
public class SingleFileImportProvider extends AbstractFileBasedImportProvider {
    ...
    public SingleFileImportProvider(PassportSessionFactory factory, File file, Strategy strategy) {
    ...
    public void importModel() throws IOException {
        ...
        new ExportImportSessionTask() {
            ...
            @Override
            protected void runExportImportTask(PassportSession session) {
