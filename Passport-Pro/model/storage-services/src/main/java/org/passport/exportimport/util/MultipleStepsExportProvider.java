...
import org.passport.exportimport.UsersExportStrategy;
import org.passport.exportimport.util.ExportImportSessionTask.Mode;
...
public abstract class MultipleStepsExportProvider<T extends MultipleStepsExportProvider<?>> implements ExportProvider {
    ...
    protected final PassportSessionFactory factory;

    private String realmId;
    private int usersPerFile = 50;
    private UsersExportStrategy usersExportStrategy;

    public MultipleStepsExportProvider(PassportSessionFactory factory) {
    ...
    public void exportModel() {
        if (realmId != null) {
            ...
            new ExportImportSessionTask() {
                @Override
                protected void runExportImportTask(PassportSession session) throws IOException {
    ...
    protected void exportRealmImpl(final String realmName) {
        ...
        new ExportImportSessionTask() {
            ...
            private <U> void exportUsers(final String realmName, PassportSession session, RealmModel realm, Stream<U> users, boolean federated)
                    throws IOException {
            ...
            private <U> void flushUsers(final String realmName, PassportSession session, RealmModel realm,
    ...
    protected abstract void writeUsers(String fileName, PassportSession session, RealmModel realm, List<UserModel> users) throws IOException;
    protected abstract void writeFederatedUsers(String fileName, PassportSession session, RealmModel realm, List<String> users) throws IOException;
