...
import org.passport.exportimport.ExportProviderFactory;
...
import static org.passport.exportimport.ExportImportConfig.DEFAULT_USERS_EXPORT_STRATEGY;
...
public class DirExportProviderFactory implements ExportProviderFactory {
    ...
    @Override
    public ExportProvider create(PassportSession session) {
        ...
        return new DirExportProvider(session.getPassportSessionFactory())
                .withDir(dir)
