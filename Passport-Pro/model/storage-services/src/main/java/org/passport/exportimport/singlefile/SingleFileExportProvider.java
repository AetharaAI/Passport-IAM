...
public class SingleFileExportProvider implements ExportProvider {
    ...
    public SingleFileExportProvider(PassportSessionFactory factory) {
    ...
    private void exportRealm(PassportSession session, final String realmName) throws IOException {
