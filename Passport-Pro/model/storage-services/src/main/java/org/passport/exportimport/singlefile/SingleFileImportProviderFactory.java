...
import org.passport.exportimport.ImportProviderFactory;
...
import static org.passport.exportimport.ExportImportConfig.DEFAULT_STRATEGY;
...
public class SingleFileImportProviderFactory implements ImportProviderFactory {
    ...
    @Override
    public ImportProvider create(PassportSession session, Map<String, String> overrides) {
        ...
        return new SingleFileImportProvider(session.getPassportSessionFactory(), new File(fileName), strategy);
    }
