...
public class ImportUtils {
    ...
    public static void importRealms(PassportSession session, Collection<RealmRepresentation> realms, Strategy strategy) {
     ...
     */
    @Deprecated
    public static boolean importRealm(PassportSession session, RealmRepresentation rep, Strategy strategy, boolean skipUserDependent) {
     ...
     * @return newly imported realm (or existing realm if ignoreExisting is true and realm of this name already exists)
     */
    public static boolean importRealm(PassportSession session, RealmRepresentation rep, Strategy strategy, Runnable userImport) {
    ...
    public static void importUsersFromStream(PassportSession session, String realmName, ObjectMapper mapper, InputStream is, boolean federated, Consumer<PassportSession> onUserCreated) throws IOException {
        RealmProvider model = session.realms();
