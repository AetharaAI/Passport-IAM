...
import org.passport.events.EventStoreProviderFactory;
...
public class JpaEventStoreProviderFactory implements EventStoreProviderFactory, InvalidationHandler {
    ...
    @Override
    public EventStoreProvider create(PassportSession session) {
    ...
    @Override
    public void invalidate(PassportSession session, InvalidableObjectType type, Object... params) {
