...
import org.passport.models.jpa.entities.UserAttributeEntity;
import org.passport.models.jpa.entities.UserConsentClientScopeEntity;
import org.passport.models.jpa.entities.UserConsentEntity;
import org.passport.models.jpa.entities.UserEntity;
import org.passport.models.jpa.entities.UserGroupMembershipEntity;
import org.passport.models.jpa.entities.UserRoleMappingEntity;
...
import org.passport.storage.jpa.JpaHashUtils;
import org.passport.utils.StringUtil;

import static org.passport.models.jpa.PaginationUtils.paginateQuery;
import static org.passport.storage.jpa.JpaHashUtils.predicateForFilteringUsersByAttributes;
...
public class JpaUserProvider implements UserProvider, UserCredentialStore, JpaUserPartialEvaluationProvider {
    ...
    public JpaUserProvider(PassportSession session, EntityManager em) {
    ...
    public UserModel addUser(RealmModel realm, String username) {
        return addUser(realm, PassportModelUtils.generateId(), username.toLowerCase(), true, true);
    }
    ...
    private UserConsentModel toConsentModel(RealmModel realm, UserConsentEntity entity) {
        ...
        if (grantedClientScopeEntities != null) {
            for (UserConsentClientScopeEntity grantedClientScope : grantedClientScopeEntities) {
                ClientScopeModel grantedClientScopeModel = PassportModelUtils.findClientScopeById(realm, client, grantedClientScope.getScopeId());
    ...
    protected void ensureEmailConstraint(List<UserEntity> users, RealmModel realm) {
        ...
        if (users.size() > 1) {
            ...
            throw new ModelDuplicateException("Multiple users with email '" + user.getEmail() + "' exist in Passport.");
        }
