...
package org.passport.connections.jpa.entityprovider;
 ...
 * 
 * A JPA Entity Provider can supply extra JPA entities that the Passport system should include in it's entity manager. The
