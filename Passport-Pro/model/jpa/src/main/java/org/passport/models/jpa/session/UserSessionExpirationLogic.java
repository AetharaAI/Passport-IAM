...
package org.passport.models.jpa.session;
...
import static org.passport.models.jpa.session.JpaSessionUtil.offlineToString;
import static org.passport.models.utils.PassportModelUtils.runJobInTransactionWithResult;
...
final class UserSessionExpirationLogic {
     ...
     *
     * @param sessionFactory The {@link PassportSessionFactory}, used to start transactions.
     ...
     */
    public static void expireOfflineSessions(PassportSessionFactory sessionFactory, RealmModel realm, int currentTime, RealmExpiration expiration, int batchSize) {
     ...
     * @param batchSize      Sets the maximum number of user sessions to delete in a single transaction.
     */
    public static void expireRegularSessions(PassportSessionFactory sessionFactory, RealmModel realm, int currentTime, RealmExpiration expiration, boolean rememberMe, int batchSize) {
        long start = System.nanoTime();
     ...
     */
    public static void migrateRememberMe(PassportSessionFactory sessionFactory, RealmModel realm, RealmExpiration expiration, int currentTime, int batchSize) {
        long start = System.nanoTime();
     ...
     */
    public static void deleteInvalidSessions(PassportSessionFactory sessionFactory, RealmModel realm, int batchSize) {
        long start = System.nanoTime();
        final String realmId = realm.getId();
        final String realmName = realm.getName();
    ...
    private static void createUserSessionDeletedEvent(PassportSession session, RealmModel realm, UserSessionAndUser data, String reason) {
    ...
    private static boolean findAndRemoveSessions(PassportSession session, String realmId, int batchSize, boolean offline, String eventReason, String queryName, Consumer<TypedQuery<Object[]>> queryParameters, List<UserSessionAndUser> expiredSessions) {
    ...
    private static int handleResultsToRemove(PassportSession session, EntityManager em, String realmId, boolean offline, String eventReason, Collection<UserSessionAndUser> expiredSessions) {
    ...
    private static void runInBatches(PassportSessionFactory sessionFactory, PassportSessionTaskWithResult<Boolean> task, Runnable afterBatchAction) {
        boolean hasMore;
        do {
