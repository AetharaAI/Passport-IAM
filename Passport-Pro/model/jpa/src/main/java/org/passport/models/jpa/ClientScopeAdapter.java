...
import org.passport.models.jpa.entities.ClientScopeAttributeEntity;
...
public class ClientScopeAdapter implements ClientScopeModel, JpaModel<ClientScopeEntity> {
    ...
    public ClientScopeAdapter(RealmModel realm, EntityManager em, PassportSession session, ClientScopeEntity entity) {
