...
package org.passport.connections.jpa.updater.liquibase.lock;
...
public class LiquibaseDBLockProvider implements DBLockProvider {
    ...
    public LiquibaseDBLockProvider(LiquibaseDBLockProviderFactory factory, PassportSession session) {
    ...
    private void lazyInit() {
        if (!initialized) {
            ...
            JpaConnectionProviderFactory jpaProviderFactory = (JpaConnectionProviderFactory) session.getPassportSessionFactory().getProviderFactory(JpaConnectionProvider.class);
