...
package org.passport.models.jpa.entities;
...
public class UserEntity {
    ...
    protected String emailConstraint = PassportModelUtils.generateId();
    ...
    public void setEmail(String email, boolean allowDuplicate) {
        this.email = email;
        this.emailConstraint = email == null || allowDuplicate ? PassportModelUtils.generateId() : email;
    }
