...
package org.passport.connections.jpa.updater.liquibase;
...
public class LiquibaseJpaUpdaterProvider implements JpaUpdaterProvider {
    ...
    public LiquibaseJpaUpdaterProvider(PassportSession session) {
    ...
    protected void updateChangeSet(PassportLiquibase liquibase, Writer exportWriter) throws LiquibaseException, SQLException {
