...
import org.passport.models.IdentityProviderShowInAccountConsole;
...
import org.passport.models.jpa.entities.IdentityProviderEntity;
import org.passport.models.jpa.entities.IdentityProviderMapperEntity;
...
import static org.passport.models.IdentityProviderModel.ALIAS;
import static org.passport.models.IdentityProviderModel.ALIAS_NOT_IN;
import static org.passport.models.IdentityProviderModel.AUTHENTICATE_BY_DEFAULT;
import static org.passport.models.IdentityProviderModel.DISPLAY_NAME;
import static org.passport.models.IdentityProviderModel.ENABLED;
import static org.passport.models.IdentityProviderModel.FIRST_BROKER_LOGIN_FLOW_ID;
import static org.passport.models.IdentityProviderModel.HIDE_ON_LOGIN;
import static org.passport.models.IdentityProviderModel.LINK_ONLY;
import static org.passport.models.IdentityProviderModel.ORGANIZATION_ID;
import static org.passport.models.IdentityProviderModel.ORGANIZATION_ID_NOT_NULL;
import static org.passport.models.IdentityProviderModel.POST_BROKER_LOGIN_FLOW_ID;
import static org.passport.models.IdentityProviderModel.SEARCH;
import static org.passport.models.IdentityProviderModel.SHOW_IN_ACCOUNT_CONSOLE;
...
public class JpaIdentityProviderStorageProvider implements IdentityProviderStorageProvider {
    ...
    public JpaIdentityProviderStorageProvider(PassportSession session) {
    ...
    public IdentityProviderModel create(IdentityProviderModel identityProvider) {
        ...
        if (identityProvider.getInternalId() == null) {
            entity.setInternalId(PassportModelUtils.generateId());
        } else {
    ...
    public void update(IdentityProviderModel identityProvider) {
        ...
        session.getPassportSessionFactory().publish(new RealmModel.IdentityProviderUpdatedEvent() {
    ...
    public boolean remove(String alias) {
        ...
        if (entity != null) {
            ...
            RealmModel realm = this.getRealm();
            session.getPassportSessionFactory().publish(new RealmModel.IdentityProviderRemovedEvent() {
    ...
    public IdentityProviderMapperModel createMapper(IdentityProviderMapperModel model) {
        ...
        entity.setId(model.getId() == null ? PassportModelUtils.generateId() : model.getId());
    ...
    private IdentityProviderModel getModelFromProviderFactory(String providerId) {
        ...
        IdentityProviderFactory factory = (IdentityProviderFactory) session.getPassportSessionFactory().getProviderFactory(IdentityProvider.class, providerId);
        if (factory == null) {
            factory = (IdentityProviderFactory) session.getPassportSessionFactory().getProviderFactory(SocialIdentityProvider.class, providerId);
        }
