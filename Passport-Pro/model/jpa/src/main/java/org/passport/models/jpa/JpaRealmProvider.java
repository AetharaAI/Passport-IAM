...
package org.passport.models.jpa;
...
import org.passport.models.GroupModel.GroupCreatedEvent;
import org.passport.models.GroupModel.GroupPathChangeEvent;
import org.passport.models.GroupModel.GroupUpdatedEvent;
...
import org.passport.models.delegate.ClientModelLazyDelegate;
import org.passport.models.jpa.entities.ClientAttributeEntity;
import org.passport.models.jpa.entities.ClientEntity;
import org.passport.models.jpa.entities.ClientScopeClientMappingEntity;
import org.passport.models.jpa.entities.ClientScopeEntity;
import org.passport.models.jpa.entities.GroupAttributeEntity;
import org.passport.models.jpa.entities.GroupEntity;
import org.passport.models.jpa.entities.RealmEntity;
import org.passport.models.jpa.entities.RealmLocalizationTextsEntity;
import org.passport.models.jpa.entities.RoleEntity;
...
public class JpaRealmProvider implements RealmProvider, ClientProvider, ClientScopeProvider, GroupProvider, RoleProvider, DeploymentStateProvider {
    ...
    public JpaRealmProvider(PassportSession session, EntityManager em, Set<String> clientSearchableAttributes, Set<String> groupSearchableAttributes) {
    ...
    public RealmModel createRealm(String name) {
        return createRealm(PassportModelUtils.generateId(), name);
    }
    ...
    public RealmModel createRealm(String id, String name) {
        ...
        session.getPassportSessionFactory().publish(new RealmModel.RealmCreationEvent() {
            @Override
    ...
    public boolean removeRealm(String id) {
        ...
        session.getPassportSessionFactory().publish(new RealmModel.RealmRemovedEvent() {
            @Override
    ...
    public RoleModel addRealmRole(RealmModel realm, String name) {
       return addRealmRole(realm, PassportModelUtils.generateId(), name);
    ...
    public RoleModel addClientRole(ClientModel client, String name) {
        return addClientRole(client, PassportModelUtils.generateId(), name);
    }
    ...
    public boolean removeRole(RoleModel role) {
        ...
        session.getPassportSessionFactory().publish(roleRemovedEvent(role));
    ...
    public void moveGroup(RealmModel realm, GroupModel group, GroupModel toParent) {
        ...
        String newPath = PassportModelUtils.buildGroupPath(group);
        String previousPath = PassportModelUtils.buildGroupPath(group, previousParent);
    ...
    public ClientModel addClient(RealmModel realm, String clientId) {
        return addClient(realm, PassportModelUtils.generateId(), clientId);
    }
    ...
    public ClientModel addClient(RealmModel realm, String id, String clientId) {
        ...
        session.getPassportSessionFactory().publish(new ClientModel.ClientCreationEvent() {
            @Override
    ...
    public boolean removeClient(RealmModel realm, String id) {
        ...
        session.getPassportSessionFactory().publish(new ClientModel.ClientRemovedEvent() {
            @Override
    ...
    public ClientScopeModel addClientScope(RealmModel realm, String id, String name) {
        ...
        entity.setId(id);
        name = PassportModelUtils.convertClientScopeName(name);
        entity.setName(name);
        entity.setRealmId(realm.getId());
        em.persist(entity);

        ClientScopeModel clientScope = new ClientScopeAdapter(realm, em, session, entity);
        session.getPassportSessionFactory().publish(new ClientScopeModel.ClientScopeCreatedEvent() {
    ...
    public boolean removeClientScope(RealmModel realm, String id) {
        ...
        session.getPassportSessionFactory().publish(new ClientScopeModel.ClientScopeRemovedEvent() {
    ...
    public void addClientScopes(RealmModel realm, ClientModel client, Set<ClientScopeModel> clientScopes, boolean defaultScope) {
        List<String> acceptedClientProtocols = PassportModelUtils.getAcceptedClientScopeProtocols(client);
