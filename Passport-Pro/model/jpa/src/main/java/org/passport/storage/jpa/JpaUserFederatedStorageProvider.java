 ...
 */
package org.passport.storage.jpa;
...
import org.passport.credential.UserCredentialStore;
...
import org.passport.models.jpa.JpaUserCredentialStore;
...
import org.passport.storage.jpa.entity.BrokerLinkEntity;
import org.passport.storage.jpa.entity.FederatedUser;
import org.passport.storage.jpa.entity.FederatedUserAttributeEntity;
import org.passport.storage.jpa.entity.FederatedUserConsentClientScopeEntity;
import org.passport.storage.jpa.entity.FederatedUserConsentEntity;
import org.passport.storage.jpa.entity.FederatedUserCredentialEntity;
import org.passport.storage.jpa.entity.FederatedUserGroupMembershipEntity;
import org.passport.storage.jpa.entity.FederatedUserRequiredActionEntity;
import org.passport.storage.jpa.entity.FederatedUserRequiredActionEntity.Key;
import org.passport.storage.jpa.entity.FederatedUserRoleMappingEntity;
...
public class JpaUserFederatedStorageProvider implements
    ...
    public JpaUserFederatedStorageProvider(PassportSession session, EntityManager em) {
    ...
    private void persistAttributeValue(RealmModel realm, String userId, String name, String value) {
        ...
        attr.setId(PassportModelUtils.generateId());
        attr.setName(name);
        attr.setValue(value);
    ...
    public void addConsent(RealmModel realm, String userId, UserConsentModel consent) {
        ...
        consentEntity.setId(PassportModelUtils.generateId());
    ...
    public CredentialModel createCredential(RealmModel realm, String userId, CredentialModel cred) {
        ...
        String id = cred.getId() == null ? PassportModelUtils.generateId() : cred.getId();
        entity.setId(id);
        entity.setCreatedDate(cred.getCreatedDate());
        entity.setType(cred.getType());
        entity.setCredentialData(cred.getCredentialData());
