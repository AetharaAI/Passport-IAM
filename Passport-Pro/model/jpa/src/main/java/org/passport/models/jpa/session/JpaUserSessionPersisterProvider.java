...
import org.passport.models.session.PersistentClientSessionModel;
import org.passport.models.session.PersistentUserSessionAdapter;
import org.passport.models.session.PersistentUserSessionModel;
...
import static org.passport.models.jpa.session.JpaSessionUtil.offlineFromString;
...
public class JpaUserSessionPersisterProvider implements UserSessionPersisterProvider {
    ...
    public JpaUserSessionPersisterProvider(PassportSession session, EntityManager em, int expirationBatch) {
    ...
    public void removeExpired(RealmModel realm) {
        ...
        final PassportSessionFactory sessionFactory = session.getPassportSessionFactory();
