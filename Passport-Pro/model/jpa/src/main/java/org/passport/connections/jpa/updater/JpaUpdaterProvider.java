...
package org.passport.connections.jpa.updater;
...
public interface JpaUpdaterProvider extends Provider {
    ...
    /**
     * Checks whether Passport database is up to date with the most recent changesets
     * @param connection DB connection
