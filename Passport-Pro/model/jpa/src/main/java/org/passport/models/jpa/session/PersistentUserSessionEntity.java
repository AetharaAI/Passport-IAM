...
import org.passport.storage.jpa.KeyUtils;
...
@NamedQueries({
        ...
        @NamedQuery(name = "findUserSessionsByRealmAndTypeReadOnly",
                query = "SELECT new org.passport.models.jpa.session.ImmutablePersistentUserSessionEntity(sess.userSessionId, sess.realmId, sess.userId, sess.createdOn, sess.lastSessionRefresh, sess.brokerSessionId, sess.offline, sess.data, sess.rememberMe)" +
                        " FROM PersistentUserSessionEntity sess" +
