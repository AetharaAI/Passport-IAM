...
package org.passport.connections.jpa.util;
...
public class JpaUtils {
    ...
    public static EntityManagerFactory createEntityManagerFactory(PassportSession session, String unitName, Map<String, Object> properties, boolean jta) {
     ...
     */
    public static List<Class<?>> getProvidedEntities(PassportSession session) {
