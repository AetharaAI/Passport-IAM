...
@NamedQueries({
        ...
        @NamedQuery(name = "findClientSessionsOrderedByIdExactReadOnly",
                query = "SELECT new org.passport.models.jpa.session.ImmutablePersistentClientSessionEntity(sess.userSessionId, sess.clientId, sess.clientStorageProvider, sess.externalClientId, sess.offline, sess.data, sess.realmId, sess.timestamp)" +
                        " FROM PersistentClientSessionEntity sess" +
