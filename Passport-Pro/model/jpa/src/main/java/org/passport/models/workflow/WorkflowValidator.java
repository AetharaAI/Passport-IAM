...
import org.passport.models.workflow.expression.ConditionNameCollector;
import org.passport.models.workflow.expression.ConditionTypeCollector;
...
public class WorkflowValidator {
    ...
    public static void validateWorkflow(PassportSession session, WorkflowProvider provider, WorkflowRepresentation rep) throws WorkflowInvalidStateException {
    ...
    public static void validateWorkflowConditionType(PassportSession session, String condition, ResourceType workflowType) throws WorkflowInvalidStateException {
    ...
    private static void validateStep(PassportSession session, WorkflowStepRepresentation step) throws WorkflowInvalidStateException {
        ...
        WorkflowStepProviderFactory<WorkflowStepProvider> factory = (WorkflowStepProviderFactory<WorkflowStepProvider>) session
                .getPassportSessionFactory().getProviderFactory(WorkflowStepProvider.class, step.getUses());
    ...
    private static void validateConditionExpression(PassportSession session, String expression, String fieldName) throws WorkflowInvalidStateException {
