...
import org.passport.models.jpa.entities.GroupRoleMappingEntity;
...
import static org.passport.common.util.CollectionUtil.collectionEquals;
...
public class GroupAdapter implements GroupModel , JpaModel<GroupEntity> {
    ...
    public GroupAdapter(PassportSession session, RealmModel realm, EntityManager em, GroupEntity group) {
    ...
    public boolean escapeSlashesInGroupPath() {
        return PassportModelUtils.escapeSlashesInGroupPath(session);
    }
