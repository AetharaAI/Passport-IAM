...
import org.passport.authorization.store.AuthorizationStoreFactory;
...
public class JPAAuthorizationStoreFactory implements AuthorizationStoreFactory {
    ...
    @Override
    public StoreFactory create(PassportSession session) {
    ...
    private EntityManager getEntityManager(PassportSession session) {
