...
public class JpaUpdate13_0_0_MigrateDefaultRoles extends CustomPassportTask {
    ...
    protected void generateStatementsImpl() throws CustomChangeException {
        ...
        for (Map.Entry<String, String> entry : realmIdsAndNames.entrySet()) {
            ...
            statements.add(
                ...
                new InsertStatement(null, null, database.correctObjectName("PASSPORT_ROLE", Table.class))
    ...
    private boolean isRoleNameAvailable(String realmId, String roleName) throws CustomChangeException {
        try (PreparedStatement statement = jdbcConnection.prepareStatement("SELECT ID FROM " + getTableName("PASSPORT_ROLE") + 
