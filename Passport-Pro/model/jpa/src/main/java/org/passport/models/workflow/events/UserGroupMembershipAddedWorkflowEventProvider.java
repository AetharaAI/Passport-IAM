...
public class UserGroupMembershipAddedWorkflowEventProvider extends AbstractWorkflowEventProvider {
    ...
    public UserGroupMembershipAddedWorkflowEventProvider(final PassportSession session, final String configParameter, final String providerId) {
    ...
    public boolean evaluate(WorkflowExecutionContext context) {
        ...
        if (super.configParameter != null) {
            ...
            if (groupEvent instanceof GroupMemberJoinEvent joinEvent) {
                return groupName.equals(PassportModelUtils.buildGroupPath(joinEvent.getGroup()));
            } else {
                return false;
            }
        } else {
