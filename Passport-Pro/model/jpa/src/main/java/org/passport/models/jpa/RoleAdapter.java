...
import org.passport.models.jpa.entities.CompositeRoleEntity;
import org.passport.models.jpa.entities.RoleAttributeEntity;
...
public class RoleAdapter implements RoleModel, JpaModel<RoleEntity> {
    ...
    public RoleAdapter(PassportSession session, RealmModel realm, EntityManager em, RoleEntity role) {
        this.em = em;
        this.realm = realm;
        this.role = role;
    ...
    public boolean hasRole(RoleModel role) {
        return this.equals(role) || PassportModelUtils.searchFor(role, this, new HashSet<>());
    }
