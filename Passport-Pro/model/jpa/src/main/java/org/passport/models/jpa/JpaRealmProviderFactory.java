...
import org.passport.models.RealmProviderFactory;
...
public class JpaRealmProviderFactory implements RealmProviderFactory, ProviderEventListener {
    ...
    @Override
    public JpaRealmProvider create(PassportSession session) {
    ...
    public void onEvent(ProviderEvent event) {
        if (event instanceof RoleContainerModel.RoleRemovedEvent) {
            ...
            ((JpaRealmProvider) e.getPassportSession().getProvider(RealmProvider.class)).preRemove(realm, role);
        }
    }
