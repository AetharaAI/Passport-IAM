...
The rolling-update:v2 feature only supports rolling updates of Passport patch releases, therefore database changes
...
```
./mvnw -pl model/jpa org.passport:db-compatibility-verifier-maven-plugin:999.0.0-SNAPSHOT:supported \
...
```
./mvnw -pl model/jpa org.passport:db-compatibility-verifier-maven-plugin:999.0.0-SNAPSHOT:unsupported \
  -Ddb.verify.changeset.id=<id> \
  -Ddb.verify.changeset.author=<author> \
  -Ddb.verify.changeset.filename=<filename>
```
