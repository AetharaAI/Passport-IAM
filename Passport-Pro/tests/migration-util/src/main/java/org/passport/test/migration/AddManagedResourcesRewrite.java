...
public class AddManagedResourcesRewrite extends TestRewrite {
    ...
    public void rewrite() {
        ...
        addImport("org.passport.testframework.annotations.InjectRealm");
        addImport("org.passport.testframework.realm.ManagedRealm");
        ...
        if (assertAdminEvents) {
            addImport("org.passport.testframework.annotations.InjectAdminEvents");
            addImport("org.passport.testframework.events.AdminEvents");
