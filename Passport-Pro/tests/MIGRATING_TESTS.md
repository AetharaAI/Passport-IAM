...
starts from [`testsuite/integration-arquillian/tests/base/src/test/java/org/passport/testsuite`](../testsuite/integration-arquillian/tests/base/src/test/java/org/passport/testsuite).

When run, the script copies the test class and rewrites or adds common test statements, such as:
- adds the `@PassportIntegrationTest` annotation
...
[`tests/base/src/test/java/org/passport/tests`](../tests/base/src/test/java/org/passport/tests).
