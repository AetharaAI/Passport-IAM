package org.passport.tests.utils;
...
import org.passport.keys.AbstractEcKeyProviderFactory;
import org.passport.keys.GeneratedEcdhKeyProviderFactory;
...
public class KeyUtils {
    ...
    /**
     * @return key sizes, which are expected to be supported by Passport server for {@link org.passport.keys.GeneratedRsaKeyProviderFactory} and {@link org.passport.keys.GeneratedRsaEncKeyProviderFactory}.
     */
...
//    }
    ...
    /**
     * @return Lowest key size supported by Passport server for {@link org.passport.keys.GeneratedRsaKeyProviderFactory}.
