...
Passport when you run the test from the IDE.

Add `@PassportIntegrationTest` to the class.
...
Remove extends `AbstractPassportTest` as the new test framework provides injection of resources needed by the test there
is no need for the `AbstractPassportTest` and tests should instead inject what they need.
...
| org.passport.testsuite.Assert               | org.passport.tests.utils.Assert                                                         |
| org.junit.Test                              | org.junit.jupiter.api.Test                                                              |
| org.passport.testsuite.admin.ApiUtil        | org.passport.testframework.util.ApiUtil and org.passport.tests.utils.admin.AdminApiUtil |
| org.passport.testsuite.util.AdminEventPaths | org.passport.tests.utils.admin.AdminEventPaths                                          |
