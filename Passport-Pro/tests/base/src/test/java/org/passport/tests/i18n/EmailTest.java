...
import org.passport.testframework.ui.page.LoginPasswordResetPage;
...
public class EmailTest {
    ...
    public void updatePasswordFromAdmin() {
        ...
        try {
            ...
            SimpleHttpResponse responseGet = simpleHttp.doPut(passportUrls.getAdmin() + "/realms/" + realm.getName() + "/users/" + testUser.toRepresentation().getId() + "/execute-actions-email")
