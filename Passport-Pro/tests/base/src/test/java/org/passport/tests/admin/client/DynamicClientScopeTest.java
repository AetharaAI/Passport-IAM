...
import org.passport.tests.utils.matchers.Matchers;
...
@PassportIntegrationTest(config = DynamicClientScopeTest.DynamicClientScopeServerConfig.class)
public class DynamicClientScopeTest extends AbstractClientScopeTest {
    ...
    public static class DynamicClientScopeServerConfig implements PassportServerConfig {
