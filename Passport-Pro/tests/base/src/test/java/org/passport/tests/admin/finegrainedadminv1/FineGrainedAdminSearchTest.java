...
import org.passport.services.resources.admin.fgap.ClientPermissionManagement;
import org.passport.services.resources.admin.fgap.GroupPermissionManagement;
...
public class FineGrainedAdminSearchTest extends AbstractFineGrainedAdminTest {
    ...
    public void testUserPagination() {
        ...
        try (Passport client = adminClientFactory.create().realm(REALM_NAME)
