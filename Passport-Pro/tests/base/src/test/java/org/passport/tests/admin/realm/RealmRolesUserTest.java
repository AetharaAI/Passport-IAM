...
public class RealmRolesUserTest extends AbstractRealmRolesTest {
    ...
    /**
     * PASSPORT-2035 Verifies that Users assigned to Role are being properly retrieved as members in API endpoint for role membership
     */
    @Test
    ...
    /**
     * PASSPORT-2035  Verifies that Role with no users assigned is being properly retrieved without members in API endpoint for role membership
     */
    @Test
    ...
    /**
     * PASSPORT-2035 Verifies that Role Membership is ok after user removal
     */
    @Test
