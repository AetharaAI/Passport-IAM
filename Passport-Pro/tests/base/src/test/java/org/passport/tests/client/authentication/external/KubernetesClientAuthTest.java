...
import org.passport.broker.kubernetes.KubernetesIdentityProviderFactory;
...
@PassportIntegrationTest(config = KubernetesClientAuthTest.KubernetesServerConfig.class)
