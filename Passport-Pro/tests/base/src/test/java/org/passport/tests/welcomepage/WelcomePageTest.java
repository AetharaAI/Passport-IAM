...
@PassportIntegrationTest(config = WelcomePageTest.WelcomePageTestConfig.class)
@TestMethodOrder(OrderAnnotation.class)
public class WelcomePageTest {

    // force the creation of a new server
    static class WelcomePageTestConfig implements PassportServerConfig {
        @Override
    ...
    public void localAccessNoAdminNorServiceAccount() {
        ...
        Assertions.assertTrue(welcomePage.getWelcomeDescription().startsWith("To get started with Passport, you first create an administrative user"));
    ...
    private URL getFakeLoginRedirect() throws MalformedURLException {
        PassportUriBuilder uriBuilder = PassportUriBuilder.fromUri("http://localhost:8080/realms/master/protocol/openid-connect/auth");
