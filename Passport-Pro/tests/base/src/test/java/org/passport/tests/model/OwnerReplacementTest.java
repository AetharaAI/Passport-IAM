...
public class OwnerReplacementTest {
    ...
    @InjectRealm(fromJson = "/org/passport/tests/testrealm.json")
    ...
    @TestOnServer
    public void componentsTest(PassportSession session1) {
        doTest(session1,
    ...
    @TestOnServer
    public void requiredActionProvidersTest(PassportSession session1) {
        doTest(session1,
    ...
    @TestOnServer
    public void authenticationFlowsTest(PassportSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @TestOnServer
    public void authenticationExecutionsTest(PassportSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @TestOnServer
    public void authenticationConfigsTest(PassportSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
    ...
    @TestOnServer
    public void clientInitialAccessTest(PassportSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @TestOnServer
    public void rolesTest(PassportSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @TestOnServer
    public void userSessionsTest(PassportSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    private void doTest(PassportSession session1,
                               BiFunction<PassportSession, RealmModel, String> realm1ObjectIdProducer,
                               TriConsumer<PassportSession, RealmModel, String> testLookupRealm1ObjectInRealm2,
                               TetraConsumer<PassportSession, RealmModel, RealmModel, String> updaterRealm1ObjectInRealm2,
                               TriConsumer<PassportSession, RealmModel, String> testUpdateFailed,
                               TetraConsumer<PassportSession, RealmModel, RealmModel, String> removeRealm1ObjectInRealm2,
                               TriConsumer<PassportSession, RealmModel, String> testRemoveFailed
    ) {

        // Transaction 1 - Lookup object of realm1
        AtomicReference<String> realm1ObjectId = new AtomicReference<>();
        PassportModelUtils.runJobInTransaction(session1.getPassportSessionFactory(), (PassportSession session) -> {
