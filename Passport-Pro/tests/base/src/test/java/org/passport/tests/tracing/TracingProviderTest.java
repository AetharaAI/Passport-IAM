package org.passport.tests.tracing;
...
@PassportIntegrationTest(config = TracingProviderTest.ServerConfigWithTracing.class)
public class TracingProviderTest {
    ...
    public void parentSpan() {
        runOnServerTracing(tracing -> {
            ...
            assertThat(readableSpan.getAttribute(AttributeKey.stringKey("code.namespace")), is("org.passport.testframework.remote.providers.runonserver.RunOnServerRealmResourceProvider"));
            assertThat(readableSpan.getAttribute(CodeAttributes.CODE_FUNCTION_NAME), is("org.passport.testframework.remote.providers.runonserver.RunOnServerRealmResourceProvider.runOnServer"));
    ...
    public static class ServerConfigWithTracing implements PassportServerConfig {
        ...
        public PassportServerConfigBuilder configure(PassportServerConfigBuilder config) {
            return config
                    ...
                    .option("log-level", "INFO,org.passport.quarkus.runtime.tracing:debug");
        }
    }
}
