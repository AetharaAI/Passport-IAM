...
import org.passport.protocol.oidc.mappers.AddressMapper;
...
public class ClientModelTest {
    ...
    private PassportSession currentSession;
    ...
    @TestOnServer
    public void testClientRoleRemovalAndClientScope(PassportSession session) {
        // Client "from" has a role.  Assign this role to a scope to client "scoped".  Delete the role and make sure
        // cache gets cleared

        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientRoleRemove1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientRoleRemove2) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientRoleRemove3) -> {
    ...
    @TestOnServer
    public void testClientRoleRemovalAndClientScopeSameTx(PassportSession session) {
        // Client "from" has a role.  Assign this role to a scope to client "scoped".  Delete the role and make sure
        // cache gets cleared

        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientRoleRemoveTx1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientRoleRemoveTx2) -> {
    ...
    @TestOnServer
    public void testRealmRoleRemovalAndClientScope(PassportSession session) {
        // Client "from" has a role.  Assign this role to a scope to client "scoped".  Delete the role and make sure
        // cache gets cleared

        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionRealmRoleRemove1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionRealmRoleRemove2) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionRealmRoleRemove3) -> {
    ...
    @TestOnServer
    public void testCircularClientScopes(PassportSession session) {

        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionCircuilarClient1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionCircuilarClient2) -> {
    ...
    @TestOnServer
    public void persist(PassportSession session) {
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionPersist) -> {
    ...
    @TestOnServer
    public void json(PassportSession session) {
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionJson) -> {
    ...
    @TestOnServer
    public void testAddApplicationWithId(PassportSession session) {
        final String id = PassportModelUtils.generateId();
        String newClientId = PassportModelUtils.runJobInTransactionWithResult(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionAppWithId1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionAppWithId2) -> {
    ...
    @TestOnServer
    public void testClientScopesBinding(PassportSession session) {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientScopeBind1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientScopeBind2) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionClientScopeBind3) -> {
    ...
    @TestOnServer
    public void testDefaultDefaultClientScopes(PassportSession session) {
        AtomicReference<ClientScopeModel> scope1Atomic = new AtomicReference<>();
        AtomicReference<ClientScopeModel> scope2Atomic = new AtomicReference<>();
        AtomicReference<ClientScopeModel> scope3Atomic = new AtomicReference<>();

        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionDefaultClientScope1) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionDefaultClientScope2) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionDefaultClientScope3) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionDefaultClientScope4) -> {
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), session.getContext(), (PassportSession sessionDefaultClientScope5) -> {
