...
public class FineGrainedAdminRestTest extends AbstractFineGrainedAdminTest {
    ...
    public void testRestEvaluation() throws Exception {
        ...
        {
            try (Passport realmClient = adminClientFactory.create()
        ...
        {
            Passport realmClient = adminClientFactory.create()
        ...
        {
            try (Passport realmClient = adminClientFactory
        ...
        // PASSPORT-11261 : user creation via fine grain admin

        {
            try (Passport realmClient = adminClientFactory.create().realm(REALM_NAME)
                ...
                UserRepresentation newGroupMemberWithoutGroup = UserConfigBuilder.create()
                        .username("new-group-member").email("new-group-member@passport-pro.ai").name("New", "Member").build();
                ...
                UserRepresentation newGroupMemberWithNonExistentGroup = UserConfigBuilder.create()
                        .username("new-group-member").email("new-group-member@passport-pro.ai").name("New", "Member").groups("wrong-group").build();
                ...
                UserRepresentation newGroupMemberOfNotManagedGroup = UserConfigBuilder.create()
                        .username("new-group-member").email("new-group-member@passport-pro.ai").name("New", "Member").groups("restricted-group").build();
                ...
                UserRepresentation newGroupMember = UserConfigBuilder.create()
                        .username("new-group-member").email("new-group-member@passport-pro.ai").name("New", "Member").groups("top").build();
