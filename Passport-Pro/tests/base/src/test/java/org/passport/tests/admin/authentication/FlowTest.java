...
import static org.passport.tests.utils.matchers.Matchers.body;
import static org.passport.tests.utils.matchers.Matchers.statusCodeIs;
...
public class FlowTest extends AbstractAuthenticationTest {
    ...
    // PASSPORT-3681: Delete top flow doesn't delete all subflows
    @Test
    ...
    public void testAddRemoveFlow() {
        ...
        // This tests against a regression in PASSPORT-16656
