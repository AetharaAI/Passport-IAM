 ...
 * @version $Revision: 1 $
 */
@PassportIntegrationTest(config = AuthzCleanupTest.AuthzCleanupServerConfig.class)
public class AuthzCleanupTest {

    @InjectRealm(config = AuthzCleanupRealmConfig.class)
    ManagedRealm managedRealm;

    @InjectRunOnServer(permittedPackages = "org.passport.tests")
    ...
    public static void setup(PassportSession session) {
    ...
    public static class AuthzCleanupServerConfig implements PassportServerConfig {
