...
public class CompositeRolesModelTest {
    ...
    @TestOnServer
    public void testNoClientID(PassportSession session) {
    ...
    @TestOnServer
    public void testComposites(PassportSession session) {

        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), (PassportSession session5) -> {
