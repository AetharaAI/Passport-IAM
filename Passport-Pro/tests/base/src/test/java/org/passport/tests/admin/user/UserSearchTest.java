...
import org.passport.userprofile.validator.UsernameProhibitedCharactersValidator;
...
public class UserSearchTest extends AbstractUserTest {
    ...
    public void searchByIdp() {
        ...
        final String idp1User1PassportId = createUser(idp1User1Username, "idp1user1@localhost");
        ...
        addFederatedIdentity(idp1User1PassportId, identityProviderAlias1, link1_1);

        // create second IDP1 User with link
        final String idp1User2Username = "idp1user2";
        final String idp1User2PassportId = createUser(idp1User2Username, "idp1user2@localhost");
        ...
        addFederatedIdentity(idp1User2PassportId, identityProviderAlias1, link1_2);

        // create IDP2 user with link
        final String idp2UserUsername = "idp2user";
        final String idp2UserPassportId = createUser(idp2UserUsername, "idp2user@localhost");
        ...
        addFederatedIdentity(idp2UserPassportId, identityProviderAlias2, link2);
    ...
    public void searchByIdpAndEnabled() {
        ...
        final String disabledUserPassportId = createUser(disabledUser);
        ...
        addFederatedIdentity(disabledUserPassportId, identityProviderAlias, disabledUserLink);
        ...
        final String enabledUserPassportId = createUser(enabledUser);
        ...
        addFederatedIdentity(enabledUserPassportId, identityProviderAlias, enabledUserLink);
    ...
    public void countUsersNotServiceAccount() {
        ...
        // PASSPORT-5660, should not consider service accounts
