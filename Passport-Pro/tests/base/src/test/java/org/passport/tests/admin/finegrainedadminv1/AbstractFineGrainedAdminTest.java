...
public class AbstractFineGrainedAdminTest {
    ...
    public static void setupPolices(PassportSession session) {
    ...
    public static void setupUsers(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName(REALM_NAME);
        ...
        GroupModel group =  PassportModelUtils.findGroupByPath(session, realm, "top");
    ...
    private static void setupTokenExchange(PassportSession session) {
    ...
    public static class FineGrainedAdminServerConf implements PassportServerConfig {
