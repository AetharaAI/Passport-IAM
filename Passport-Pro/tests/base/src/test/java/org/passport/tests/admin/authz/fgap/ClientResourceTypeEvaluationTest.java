...
import org.passport.representations.idm.authorization.ClientScopePolicyRepresentation;
...
import org.passport.representations.idm.authorization.RegexPolicyRepresentation;
...
import static org.passport.authorization.fgap.AdminPermissionsSchema.CLIENTS;
...
import static org.passport.authorization.fgap.AdminPermissionsSchema.MAP_ROLES_COMPOSITE;
...
public class ClientResourceTypeEvaluationTest extends AbstractPermissionTest {
    ...
    public void testCreateClientsRequireManageScope() {
        ...
        newClient.setClientId(PassportModelUtils.generateId());
