...
import static org.passport.models.Constants.ADMIN_CLI_CLIENT_ID;
...
public class AdminConsoleWhoAmILocaleTest {
    ...
    @Test
    public void testLocaleRealmI18nEnabledPassportLocaleCookie() throws Exception {
        AccessTokenResponse response = accessToken(oAuthClientLocaleOn, ADMIN_CLI_CLIENT_ID, SECRET, USER_WITHOUT_LOCALE, PASSWORD);

        JsonNode whoAmI = getHttpJsonResponse(whoAmiUrl(managedRealmOn), response, new BasicHeader("Cookie", "PASSPORT_LOCALE=" + EXTRA_LOCALE));
    ...
    private String whoAmiUrl(ManagedRealm realm, String currentRealm) {
        StringBuilder sb = new StringBuilder()
                .append(passportUrls.getBaseUrl())
                .append("/admin/")
