...
public class MultipleRealmsTest {
    ...
    public static void createObjects(PassportSession session, RealmModel realm) {
    ...
    @TestOnServer
    public void testUsers(PassportSession session) {
        AtomicReference<UserModel> r1user1Atomic = new AtomicReference<>();

        String[] res = PassportModelUtils.runJobInTransactionWithResult(session.getPassportSessionFactory(), (PassportSession sessionTestUser1) -> {
            PassportSession currentSession = sessionTestUser1;

            RealmModel realm1 = currentSession.realms().createRealm(PassportModelUtils.generateId(), "realm1");
            ...
            RealmModel realm2 = currentSession.realms().createRealm(PassportModelUtils.generateId(), "realm2");
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), (PassportSession sessionTestUser2) -> {
            PassportSession currentSession = sessionTestUser2;
        ...
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), (PassportSession sessionTestUser3) -> {
            PassportSession currentSession = sessionTestUser3;
    ...
    @TestOnServer
    public void testGetById(PassportSession session) {
        String[] res = PassportModelUtils.runJobInTransactionWithResult(session.getPassportSessionFactory(), (PassportSession sessionById) -> {
            PassportSession currentSession = sessionById;
    ...
    private void removeRealm(PassportSession session, String realmId) {
        PassportModelUtils.runJobInTransaction(session.getPassportSessionFactory(), (PassportSession sessionTestUser3) -> {
