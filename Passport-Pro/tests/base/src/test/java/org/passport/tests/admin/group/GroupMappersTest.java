...
public class GroupMappersTest extends AbstractGroupTest {
    ...
    public void testGroupMappersWithSlash() {
        ...
        MatcherAssert.assertThat(groups.get("groups"), Matchers.containsInAnyOrder(
                PassportModelUtils.buildGroupPath(GroupProvider.DEFAULT_ESCAPE_SLASHES, TOP_GROUP, LEVEL_2_GROUP),
                PassportModelUtils.buildGroupPath(GroupProvider.DEFAULT_ESCAPE_SLASHES, TOP_GROUP, "child/slash")));
    }
