...
public class UsersTest {
    ...
    @InjectRunOnServer(permittedPackages = {"org.passport.tests", "org.passport.admin"})
    ...
    public void searchUserMatchUsersCount() {
        createUser("john.doe", "John", "Doe Smith", "john.doe@passport-pro.ai");
        String search = "jo do";
    ...
    /**
     * https://issues.redhat.com/browse/PASSPORT-15146
     */
    @Test
