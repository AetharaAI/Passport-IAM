 ...
 * @version $Revision: 1 $
 */
@PassportIntegrationTest(config = IllegalAdminUpgradeTest.IllegalAdminPassportServerConf.class)
public class IllegalAdminUpgradeTest {
    ...
    public static class IllegalAdminPassportServerConf implements PassportServerConfig {
