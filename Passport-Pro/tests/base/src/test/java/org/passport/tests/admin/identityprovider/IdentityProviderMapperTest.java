...
import org.passport.representations.idm.IdentityProviderMapperTypeRepresentation;
...
import org.passport.testsuite.broker.oidc.OverwrittenMappersTestIdentityProviderFactory;
...
@PassportIntegrationTest(config = IdentityProviderMapperTest.IdentityProviderMapperServerConf.class)
public class IdentityProviderMapperTest extends AbstractIdentityProviderTest {
    ...
    public void testMapperTypes() {
        ...
        */
        ...
        create(createRep("passport-oidc", "passport-oidc"));
        provider = managedRealm.admin().identityProviders().get("passport-oidc");
        mapperTypes = provider.getMapperTypes();
        assertMapperTypes(mapperTypes, "passport-oidc-role-to-role-idp-mapper", "oidc-user-attribute-idp-mapper", "oidc-role-idp-mapper", "oidc-username-idp-mapper", "oidc-advanced-group-idp-mapper", "oidc-advanced-role-idp-mapper", "oidc-user-session-note-idp-mapper");
    ...
    public void mapperTypesCanBeOverwritten() {
        String kcOidcProviderId = "passport-oidc";
        ...
        /*
         * in the test provider, we have overwritten the mapper types to be the same as supported by "passport-oidc", so
         * the "passport-oidc" mappers are the expected mappers for the test provider
         */
    ...
    public static class IdentityProviderMapperServerConf implements PassportServerConfig {

        @Override
        public PassportServerConfigBuilder configure(PassportServerConfigBuilder builder) {
            return builder.dependency("org.passport.tests", "passport-tests-custom-providers");
        }
    }
}
