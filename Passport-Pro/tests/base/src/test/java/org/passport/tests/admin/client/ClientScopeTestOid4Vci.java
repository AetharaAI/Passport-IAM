 ...
 */
@PassportIntegrationTest(config = ClientScopeTestOid4Vci.DefaultServerConfigWithOid4Vci.class)
public class ClientScopeTestOid4Vci extends AbstractClientScopeTest {
    ...
    public static class DefaultServerConfigWithOid4Vci implements PassportServerConfig {
