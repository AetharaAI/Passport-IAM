...
import org.passport.testframework.ui.page.AbstractLoginPage;
import org.passport.testframework.ui.page.ErrorPage;
import org.passport.testframework.ui.page.LoginExpiredPage;
import org.passport.testframework.ui.page.LoginPage;
import org.passport.testframework.ui.page.LoginPasswordUpdatePage;
import org.passport.testframework.ui.page.OAuthGrantPage;
import org.passport.testframework.ui.page.TermsAndConditionsPage;
import org.passport.testframework.ui.webdriver.ManagedWebDriver;
import org.passport.tests.common.BasicUserConfig;
import org.passport.testsuite.forms.ClickThroughAuthenticator;
 ...
 */
@PassportIntegrationTest(config = LoginPageTest.ServerConfig.class)
public class LoginPageTest {
    ...
    public void languageUserUpdatesOnErrorPageStateCheckerTest() throws URISyntaxException {
        ...
        String newUrl = PassportUriBuilder.fromUri(new URI(currentUrl))
    ...
    protected static class ServerConfig implements PassportServerConfig {
