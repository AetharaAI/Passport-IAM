...
import org.passport.services.resources.admin.AdminAuth.Resource;
...
public class PermissionsTest extends AbstractPermissionsTest {
    ...
    public void roles() {
        ...
        invoke(realm -> realm.roles().get("sample-role").getClientRoleComposites(PassportModelUtils.generateId()), Resource.REALM, false);
    }
    ...
    public void rolesById() {
        ...
        invoke(realm -> realm.rolesById().getClientRoleComposites(role.getId(), PassportModelUtils.generateId()), Resource.REALM, false, true);
    }
    ...
    public void users() {
        ...
        invoke(realm -> realm.users().get(user.getId()).getOfflineSessions(PassportModelUtils.generateId()), Resource.USER, false);
