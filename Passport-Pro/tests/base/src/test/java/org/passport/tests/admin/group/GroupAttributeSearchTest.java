...
@PassportIntegrationTest(config = GroupAttributeSearchTest.GroupSearchServerConfig.class)
public class GroupAttributeSearchTest {
    ...
    public static class GroupSearchServerConfig implements PassportServerConfig {
