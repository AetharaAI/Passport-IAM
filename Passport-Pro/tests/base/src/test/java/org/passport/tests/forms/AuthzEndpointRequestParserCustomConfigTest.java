package org.passport.tests.forms;
 ...
 */
@PassportIntegrationTest(config = AuthzEndpointRequestParserCustomConfigTest.AuthzEndpointRequestParserConfig.class)
public class AuthzEndpointRequestParserCustomConfigTest extends AuthzEndpointRequestParserTest {
    ...
    public static class AuthzEndpointRequestParserConfig implements PassportServerConfig {
