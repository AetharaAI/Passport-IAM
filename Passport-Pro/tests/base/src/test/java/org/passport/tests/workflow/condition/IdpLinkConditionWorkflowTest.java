...
package org.passport.tests.workflow.condition;
...
import org.passport.models.workflow.WorkflowStep;
...
public class IdpLinkConditionWorkflowTest extends AbstractWorkflowTest {
    ...
    private static final String IDP_OIDC_PROVIDER_ID = PassportOIDCIdentityProviderFactory.PROVIDER_ID;
