...
import org.passport.testsuite.actions.DummyConfigurableRequiredActionFactory;
import org.passport.testsuite.actions.DummyRequiredActionFactory;
 ...
 */
@PassportIntegrationTest(config = RequiredActionsTest.CustomProvidersServerConfig.class)
public class RequiredActionsTest extends AbstractAuthenticationTest {
    ...
    public static class CustomProvidersServerConfig implements PassportServerConfig {
