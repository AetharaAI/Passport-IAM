...
public class ClientDescriptionConverterTest {
    ...
    // https://issues.jboss.org/browse/PASSPORT-4040
    @Test
    public void testOrganizationDetailsMetadata() throws IOException {
        try (InputStream is = ClientDescriptionConverterTest.class.getResourceAsStream("PASSPORT-4040-sharefile-metadata.xml")) {
