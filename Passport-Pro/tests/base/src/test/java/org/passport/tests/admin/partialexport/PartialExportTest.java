package org.passport.tests.admin.partialexport;
...
public class PartialExportTest {
    ...
    private void checkSecretsAreMasked(RealmRepresentation rep) {
        ...
        List<ComponentExportRepresentation> keys = components.get("org.passport.keys.KeyProvider");
        ...
        List<ComponentExportRepresentation> userStorage = components.get("org.passport.storage.UserStorageProvider");
