...
import org.passport.services.resources.admin.AuthenticationManagementResource;

import static org.passport.models.utils.DefaultAuthenticationFlows.BROWSER_FLOW;
import static org.passport.models.utils.DefaultAuthenticationFlows.DIRECT_GRANT_FLOW;
import static org.passport.models.utils.DefaultAuthenticationFlows.FIRST_BROKER_LOGIN_FLOW;
import static org.passport.models.utils.DefaultAuthenticationFlows.REGISTRATION_FLOW;
import static org.passport.models.utils.DefaultAuthenticationFlows.RESET_CREDENTIALS_FLOW;
...
public class FlowUtil {
    ...
    private FlowUtil(PassportSession session, RealmModel realm) {
    ...
    public static FlowUtil inCurrentRealm(PassportSession session) {
     ...
     */
    public static void setAuthenticatorConfig(PassportSession session, String flowId, String authenticatorId, String key, String value) {
