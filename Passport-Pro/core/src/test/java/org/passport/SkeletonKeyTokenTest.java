...
public class SkeletonKeyTokenTest {
    ...
    public void testSerialization() throws Exception {
        ...
        PassportSecurityContext ctx = new PassportSecurityContext(encoded, token, encodedIdToken, idToken);
        PassportPrincipal principal = new PassportPrincipal("joe", ctx);
        ...
        principal = (PassportPrincipal)ois.readObject();
        ctx = principal.getPassportSecurityContext();
        token = ctx.getToken();
