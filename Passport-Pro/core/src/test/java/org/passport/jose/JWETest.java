...
import org.passport.jose.jwe.JWEKeyStorage;
import org.passport.jose.jwe.JWEUtils;
import org.passport.jose.jwe.alg.JWEAlgorithmProvider;
import org.passport.jose.jwe.enc.AesCbcHmacShaJWEEncryptionProvider;
import org.passport.jose.jwe.enc.AesGcmJWEEncryptionProvider;
...
/**
 * This is not tested in passport-core. The subclasses should be created in the crypto modules to make sure it is tested with corresponding modules (bouncycastle VS bouncycastle-fips)
 *
