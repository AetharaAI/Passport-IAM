...
public interface AuthorizationDetailsParser {
     ...
     * Usually it is supposed to be registered at the startup of the application. If implementing Passport provider <em>AuthorizationDetailsProcessor</em>, it might
