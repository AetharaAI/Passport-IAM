...
import org.passport.jose.jws.crypto.HMACProvider;
...
public class JWSBuilder {
    ...
    protected String encodeHeader(String sigAlgName) {
        ...
        if (org.passport.crypto.Algorithm.Ed25519.equals(sigAlgName) || org.passport.crypto.Algorithm.Ed448.equals(sigAlgName)) {
            builder.append("\"alg\":\"").append(org.passport.crypto.Algorithm.EdDSA).append("\"");
