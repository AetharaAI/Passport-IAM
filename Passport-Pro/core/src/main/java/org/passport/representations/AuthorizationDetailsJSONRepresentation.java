...
public class AuthorizationDetailsJSONRepresentation implements Serializable {
    ...
    // The internal Passport's type for static scopes as a RAR request object
    public static final String STATIC_SCOPE_RAR_TYPE = "https://passport-pro.ai/auth-type/static-oauth2-scope";

    // The internal Passport's type for dynamic scopes as a RAR request object
    public static final String DYNAMIC_SCOPE_RAR_TYPE = "https://passport-pro.ai/auth-type/dynamic-oauth2-scope";
