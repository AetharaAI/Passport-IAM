...
package org.passport.representations.adapters.config;

/**
 * Configuration options relevant for configuring http client that can be used by adapter.
 *
 * NOTE: keep in sync with adapters/saml/core/src/main/java/org/passport/adapters/AdapterHttpClientConfig.java until unified.
 *
 * @author hmlnarik
 */
