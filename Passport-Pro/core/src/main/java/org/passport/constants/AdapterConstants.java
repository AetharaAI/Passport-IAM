...
package org.passport.constants;
...
public interface AdapterConstants {
    ...
    // This param name is defined again in Passport Subsystem class
    // org.passport.subsystem.extensionPassportAdapterConfigDeploymentProcessor.  We have this value in
    // two places to avoid dependency between Passport Subsystem and Keyclaok Undertow Integration.
    String AUTH_DATA_PARAM_NAME = "org.passport.json.adapterConfig";

    // Attribute passed in codeToToken request from adapter to Passport and saved in ClientSession. Contains ID of HttpSession on adapter
    public static final String CLIENT_SESSION_STATE = "client_session_state";

    // Attribute passed in codeToToken request from adapter to Passport and saved in ClientSession. Contains hostname of adapter where HttpSession is served
    ...
    public static final String PASSPORT_ADAPTER_STATE_COOKIE = "PASSPORT_ADAPTER_STATE";
