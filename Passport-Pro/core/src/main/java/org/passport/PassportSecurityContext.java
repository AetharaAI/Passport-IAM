 ...
 * @version $Revision: 1 $
 */
public class PassportSecurityContext implements Serializable {
    ...
    public PassportSecurityContext() {
    }

    public PassportSecurityContext(String tokenString, AccessToken token, String idTokenString, IDToken idToken) {
