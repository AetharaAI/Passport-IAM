...
public class Config {
    ...
    public static class SystemPropertiesConfigProvider implements ConfigProvider {
        ...
        public String getProvider(String spi) {
            return System.getProperties().getProperty("passport." + spi + ".provider");
        }

        @Override
        public String getDefaultProvider(String spi) {
            return System.getProperties().getProperty("passport." + spi + ".provider.default");
        }
    ...
    public static class SystemPropertiesScope extends AbstractScope {
        ...
        @Override
        public Scope root() {
            return new SystemPropertiesScope("passport.");
        }
