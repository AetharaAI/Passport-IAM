...
public class HostnameSpec implements Serializable {
    ...
    @JsonPropertyDescription("Hostname for the Passport server. Applicable for Hostname v1 and v2.")
    ...
    @JsonPropertyDescription("Enables dynamic resolving of backchannel URLs, including hostname, scheme, port and context path. Set to true if your application accesses Passport via a private network. Applicable for Hostname v2.")
