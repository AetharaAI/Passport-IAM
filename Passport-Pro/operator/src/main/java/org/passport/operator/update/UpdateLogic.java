...
/**
 * An API to implement to handle Passport CR updates.
 * <p>
...
public interface UpdateLogic {
     ...
     * {@link StatefulSet}.
     * <p>
     * The method should use {@link org.passport.operator.ContextUtils#storeUpdateType(Context, UpdateType, String)} to store
     * its decision. If no prior {@link StatefulSet} is present, no decision is required and
     * {@link org.passport.operator.ContextUtils#storeUpdateType(Context, UpdateType, String)} must not be invoked.
     * <p>
     ...
     * it can proceed.
     */
    Optional<UpdateControl<Passport>> decideUpdate();

    /**
     * Updates the Passport CR status.
     *
     * @param statusAggregator The {@link PassportStatusAggregator} to update.
     */
    void updateStatus(PassportStatusAggregator statusAggregator);
