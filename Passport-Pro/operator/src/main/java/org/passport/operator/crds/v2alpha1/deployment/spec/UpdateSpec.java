...
public class UpdateSpec {
    ...
    public static UpdateStrategy getUpdateStrategy(Passport passport) {
        return CRDUtils.passportSpecOf(passport)
                .map(PassportSpec::getUpdateSpec)
                .map(UpdateSpec::getStrategy)
                .orElse(DEFAULT);
    }

    public static Optional<String> getRevision(Passport passport) {
        return CRDUtils.passportSpecOf(passport)
                .map(PassportSpec::getUpdateSpec)
