...
public final class ContextUtils {
    ...
    public static void storeDistConfigurator(Context<?> context, PassportDistConfigurator distConfigurator) {
        context.managedWorkflowAndDependentResourceContext().put(DIST_CONFIGURATOR_KEY, distConfigurator);
    }

    public static PassportDistConfigurator getDistConfigurator(Context<?> context) {
        return context.managedWorkflowAndDependentResourceContext().getMandatory(DIST_CONFIGURATOR_KEY, PassportDistConfigurator.class);
    }

    public static void storePassport(Context<PassportRealmImport> context, Passport existingPassport) {
        context.managedWorkflowAndDependentResourceContext().put(PASSPORT, existingPassport);
    }

    public static Passport getPassport(Context<?> context) {
        return context.managedWorkflowAndDependentResourceContext().getMandatory(PASSPORT, Passport.class);
    }
}
