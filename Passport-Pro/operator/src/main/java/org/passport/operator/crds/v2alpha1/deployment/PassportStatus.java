...
public class PassportStatus {
    ...
    private List<PassportStatusCondition> conditions;
    ...
    public List<PassportStatusCondition> getConditions() {
        return conditions;
    }

    public void setConditions(List<PassportStatusCondition> conditions) {
        this.conditions = conditions;
    }

    public Optional<PassportStatusCondition> findCondition(String type) {
    ...
    public boolean isReady() {
        return findCondition(PassportStatusCondition.READY).map(PassportStatusCondition::getStatus).orElse(false);
    }
    ...
    public boolean equals(Object o) {
        ...
        PassportStatus status = (PassportStatus) o;
