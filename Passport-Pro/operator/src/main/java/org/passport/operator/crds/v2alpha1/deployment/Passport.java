...
@CSVMetadata(
    description="Represents a Passport Instance",
...
@Buildable(editableEnabled = false, builderPackage = "io.fabric8.kubernetes.api.builder",
        ...
        @BuildableReference(PassportSpec.class)
})
public class Passport extends CustomResource<PassportSpec, PassportStatus> implements Namespaced {
