...
@CSVMetadata(
    description="Represents a Passport Realm Import",
    displayName="PassportRealmImport"
)
...
@Buildable(editableEnabled = false, builderPackage = "io.fabric8.kubernetes.api.builder",
        ...
        @BuildableReference(PassportRealmImportSpec.class)
})
...
public class PassportRealmImport extends CustomResource<PassportRealmImportSpec, PassportRealmImportStatus> implements Namespaced {
