...
public class WatchedResourcesTest {
    ...
    public static final String PASSPORT_WATCHING_ANNOTATION = "operator.passport-pro.ai/watching-secrets";
    public static final String PASSPORT_WATCHING_CONFIGMAPS_ANNOTATION = "operator.passport-pro.ai/watching-configmaps";
    public static final String PASSPORT_MISSING_SECRETS_ANNOTATION = "operator.passport-pro.ai/missing-secrets";
    public static final String PASSPORT_MISSING_CONFIGMAPS_ANNOTATION = "operator.passport-pro.ai/missing-configmaps";
