...
import org.passport.operator.crds.v2alpha1.deployment.spec.TelemetrySpecBuilder;
import org.passport.operator.crds.v2alpha1.deployment.spec.TracingSpec;
import org.passport.operator.crds.v2alpha1.deployment.spec.TracingSpecBuilder;
...
import static org.passport.operator.controllers.PassportDeploymentDependentResource.KC_TELEMETRY_RESOURCE_ATTRIBUTES;
...
public class TracingDeploymentTest extends BaseOperatorTest {
    ...
    public void telemetryAndTracingSpec() {
        ...
        var telemetrySpec = new TelemetrySpecBuilder()
                ...
                .withServiceName("my-best-passport-telemetry")
                .withProtocol("http/protobuf")
                .withResourceAttributes(Map.of(
                        "something.a", "passport-rocks-telemetry",
                        "something.b", "passport-rocks2-telemetry"))
                .build();

        var tracingSpec = new TracingSpecBuilder()
                .withEnabled()
                .withEndpoint("http://0.0.0.0:4317")
                .withServiceName("my-best-passport")
                .withProtocol("http/protobuf")
                .withSamplerType("parentbased_traceidratio")
                .withSamplerRatio(0.01)
                .withCompression("gzip")
                .withResourceAttributes(Map.of(
                        "something.a", "passport-rocks",
                        "something.b", "passport-rocks2"))
                .build();
        ...
        assertThat(telemetryServiceName).isEqualTo("my-best-passport-telemetry");
        ...
        assertThat(telemetryResourceAttributes).contains("something.a=passport-rocks-telemetry");
        assertThat(telemetryResourceAttributes).contains("something.b=passport-rocks2-telemetry");
        ...
        assertThat(serviceName).isEqualTo("my-best-passport");
        ...
        assertThat(resourceAttributes).contains("something.a=passport-rocks");
        assertThat(resourceAttributes).contains("something.b=passport-rocks2");
