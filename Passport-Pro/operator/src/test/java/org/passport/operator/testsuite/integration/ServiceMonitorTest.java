...
import org.passport.operator.crds.v2alpha1.deployment.spec.ServiceMonitorSpecBuilder;
...
public class ServiceMonitorTest extends BaseOperatorTest {
    ...
    public void testServiceMonitorDisabledNoMetrics() {
        ...
        CRAssert.assertPassportStatusCondition(
                ...
                PassportServiceMonitorDependentResource.WARN_METRICS_NOT_ENABLED);
    }
    ...
    public void testServiceMonitorCreatedWithMetricsEnabled() {
        ...
        assertThat(k8sclient.resource(sm).patch().getSpec().getScrapeProtocols())
                .doesNotContain(PassportServiceMonitorDependentResource.OPEN_METRICS_PROTOCOL);

        Awaitility.await().untilAsserted(() -> {
            assertThat(getServiceMonitor(kc).getSpec().getScrapeProtocols())
                    .contains(PassportServiceMonitorDependentResource.OPEN_METRICS_PROTOCOL);
        });
    }
    ...
    static ServiceMonitor getServiceMonitor(Passport kc) {
