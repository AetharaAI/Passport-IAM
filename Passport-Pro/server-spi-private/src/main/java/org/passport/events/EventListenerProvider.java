 ...
 *
 * This interface provides a way to listen to events that happen during the passport run.
 * <p/>
 ...
 * via the {@link org.passport.models.PassportTransactionManager#enlistAfterCompletion(PassportTransaction)} method, so
