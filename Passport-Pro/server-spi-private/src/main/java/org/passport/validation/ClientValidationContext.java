...
public class ClientValidationContext extends DefaultValidationContext<ClientModel> {
    public ClientValidationContext(Event event, PassportSession session, ClientModel objectToValidate) {
    ...
    public static class OIDCContext extends ClientValidationContext {
        ...
        public OIDCContext(Event event, PassportSession session, ClientModel objectToValidate, OIDCClientRepresentation oidcClient) {
            super(event, session, objectToValidate);
