...
public interface CredentialAction {
    ...
    /**
     * @return credential type, which this action is able to register. This should refer to the same value as returned by {@link org.passport.credential.CredentialProvider#getType} of the
     * corresponding credential provider and {@link AuthenticatorFactory#getReferenceCategory()} of the corresponding authenticator
     */
    String getCredentialType(PassportSession session, AuthenticationSessionModel authenticationSession);
}
