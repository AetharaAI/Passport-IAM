 ...
 *
 * This interface is for verifying client credentials from request. On the adapter side, you must also implement org.passport.protocol.oidc.client.authentication.ClientCredentialsProvider , which is supposed
 * to add the client credentials to the request, which will ClientAuthenticator verify on server side
 *
 * @see org.passport.authentication.authenticators.client.ClientIdAndSecretAuthenticator
 * @see org.passport.authentication.authenticators.client.JWTClientAuthenticator
 *
