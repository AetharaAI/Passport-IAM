...
public interface RequiredActionFactory extends ProviderFactory<RequiredActionProvider> {
    ...
    /**
     * Allows users to validate the provided configuration for this required action. Users can throw a {@link org.passport.models.ModelValidationException} to indicate that the configuration is invalid.
     ...
     * @param model
     */
    default void validateConfig(PassportSession session, RealmModel realm, RequiredActionConfigModel model) {
