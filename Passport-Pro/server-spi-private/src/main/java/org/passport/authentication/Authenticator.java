...
public interface Authenticator extends Provider {
     ...
     * @return
     */
    boolean configuredFor(PassportSession session, RealmModel realm, UserModel user);

    /**
     * Set actions to configure authenticator
     *
     */
    void setRequiredActions(PassportSession session, RealmModel realm, UserModel user);

    /**
     * Overwrite this if the authenticator is associated with
     * @return
     */
    default List<RequiredActionFactory> getRequiredActions(PassportSession session) {
     ...
     * @return
     */
    default boolean areRequiredActionsEnabled(PassportSession session, RealmModel realm) {
