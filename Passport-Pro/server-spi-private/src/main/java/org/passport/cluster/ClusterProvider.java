...
public interface ClusterProvider extends Provider {
     ...
     * @deprecated use {@link ClusterProvider#notify(String, ClusterEvent, boolean)} instead. {@link DCNotify} is deprecated. For removal in Passport 27.
     */
     ...
     * @deprecated use {@link ClusterProvider#notify(String, Collection, boolean)} instead. {@link DCNotify} is deprecated. For removal in Passport 27.
     */
    @Deprecated(since = "26.3", forRemoval = true)
     ...
     * @deprecated For removal in Passport 27.
     */
    @Deprecated(since = "26.3", forRemoval = true)
    enum DCNotify {
