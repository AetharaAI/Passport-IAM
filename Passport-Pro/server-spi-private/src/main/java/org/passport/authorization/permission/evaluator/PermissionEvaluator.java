...
/**
 * An {@link PermissionEvaluator} represents a source of {@link org.passport.authorization.permission.ResourcePermission}, responsible for emitting these permissions
 * to a consumer in order to evaluate the authorization policies based on a {@link org.passport.authorization.policy.evaluation.EvaluationContext}.
 *
