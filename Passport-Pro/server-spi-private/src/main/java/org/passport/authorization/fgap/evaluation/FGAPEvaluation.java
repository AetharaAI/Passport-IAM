...
import org.passport.authorization.policy.evaluation.Realm;

import static org.passport.authorization.fgap.AdminPermissionsSchema.SCHEMA;
...
class FGAPEvaluation implements Evaluation {
    ...
    private Resource getResourceTypeResource(Policy policy, String resourceType) {
        return SCHEMA.getResourceTypeResource(getAuthorizationProvider().getPassportSession(), policy.getResourceServer(), resourceType);
    }
}
