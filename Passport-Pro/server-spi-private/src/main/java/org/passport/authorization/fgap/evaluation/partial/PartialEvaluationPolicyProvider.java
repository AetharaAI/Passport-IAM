 ...
 * {@link org.passport.common.Profile.Feature#ADMIN_FINE_GRAINED_AUTHZ} feature.
 */
public interface PartialEvaluationPolicyProvider {
     ...
     */
    Stream<Policy> getPermissions(PassportSession session, ResourceType resourceType, ResourceType groupResourceType, UserModel subject);
     ...
     */
    boolean evaluate(PassportSession session, Policy policy, UserModel subject);
}
