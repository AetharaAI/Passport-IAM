...
package org.passport.authorization.fgap.evaluation.partial;
...
import static org.passport.authorization.fgap.AdminPermissionsSchema.isSkipEvaluation;
...
public final class PartialEvaluator {
    ...
    public List<Predicate> getPredicates(PassportSession session, ResourceType resourceType, PartialEvaluationStorageProvider storage, RealmModel realm, CriteriaBuilder builder, CriteriaQuery<?> queryBuilder, Path<?> path) {
    ...
    private PartialEvaluationContext runEvaluation(PassportSession session, UserModel adminUser, ResourceType resourceType, ResourceType groupResourceType, PartialEvaluationStorageProvider storage, CriteriaBuilder builder, CriteriaQuery<?> queryBuilder, Path<?> path) {
    ...
    private PartialEvaluationContext createEvaluationContext(PassportSession session, ResourceType resourceType, Set<String> allowedResources, Set<String> deniedResources, PartialEvaluationStorageProvider storage, CriteriaBuilder builder, CriteriaQuery<?> queryBuilder, Path<?> path, UserModel adminUser) {
    ...
    private List<PartialEvaluationPolicyProvider> getPartialEvaluationPolicyProviders(PassportSession session) {
    ...
    private boolean shouldSkipPartialEvaluation(PassportSession session, UserModel user, ResourceType resourceType) {
        if (user == null) {
            return true;
        }
    ...
    private ClientModel getRealmManagementClient(PassportSession session) {
