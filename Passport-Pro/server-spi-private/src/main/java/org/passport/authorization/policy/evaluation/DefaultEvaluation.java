...
package org.passport.authorization.policy.evaluation;
    ...
    private Realm createRealm() {
        return new Realm() {
            ...
            public boolean isUserInGroup(String id, String groupId, boolean checkParent) {
                ...
                GroupModel group = PassportModelUtils.findGroupByPath(session, realm, groupId);
            ...
            private UserModel getUser(String id, PassportSession session) {
            ...
            public boolean isGroupInRole(String id, String role) {
                PassportSession session = authorizationProvider.getPassportSession();
                RealmModel realm = session.getContext().getRealm();
                GroupModel group = PassportModelUtils.findGroupByPath(session, realm, id);
            ...
            public List<String> getUserRealmRoles(String id) {
                return getUser(id, authorizationProvider.getPassportSession()).getRoleMappingsStream()
            ...
            public List<String> getUserGroups(String id) {
                return getUser(id, authorizationProvider.getPassportSession()).getGroupsStream()
            ...
            public Map<String, List<String>> getUserAttributes(String id) {
                return Collections.unmodifiableMap(getUser(id, authorizationProvider.getPassportSession()).getAttributes());
            }
        };
    }
