...
/**
 * A {@link PermissionTicketStore} is responsible to manage the persistence of {@link org.passport.authorization.model.PermissionTicket} instances.
 *
...
public interface PermissionTicketStore {
    ...
    /**
     * Returns a list of {@link PermissionTicket} associated with the {@link org.passport.authorization.model.Resource resource}.
     *
    ...
    /**
     * Returns a list of {@link PermissionTicket} associated with the {@link org.passport.authorization.model.Scope scope}.
     *
     *
     * @param resourceServer the resource server. Cannot be {@code null}.
