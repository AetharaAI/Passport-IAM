 ...
 */
package org.passport.models.light;
...
import org.passport.storage.adapter.AbstractInMemoryUserAdapter;
...
public class LightweightUserAdapter extends AbstractInMemoryUserAdapter {
    ...
    public LightweightUserAdapter(PassportSession session, String id) {
        super(session, null, ID_PREFIX + (id == null ? SecretGenerator.getInstance().randomString(16) : id));
    }

    public LightweightUserAdapter(PassportSession session, RealmModel realm, String id) {
    ...
    public static LightweightUserAdapter fromString(PassportSession session, RealmModel realm, String serializedForm) {
