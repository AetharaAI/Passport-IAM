...
public final class Constants {
    ...
    public static final String DEFAULT_WEBAUTHN_POLICY_RP_ENTITY_NAME = "passport";
    ...
    /**
     * If set as an attribute in the {@link PassportSession}, indicates that the storage should batch write operations.
     */
    public static final String STORAGE_BATCH_ENABLED = "org.passport.storage.batch_enabled";

    /**
     * If {@code #STORAGE_BATCH_ENABLED} is set, indicates the batch size.
     */
    public static final String STORAGE_BATCH_SIZE = "org.passport.storage.batch_size";
    ...
    public static final String SESSION_NOTE_LIGHTWEIGHT_USER = "passport.userModel";
