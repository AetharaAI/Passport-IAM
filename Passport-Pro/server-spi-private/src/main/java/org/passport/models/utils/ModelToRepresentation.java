...
import org.passport.broker.provider.util.IdentityProviderTypeUtil;
...
import org.passport.credential.CredentialMetadata;
...
import org.passport.events.admin.AuthDetails;
...
import org.passport.models.RequiredActionConfigModel;
import org.passport.models.RequiredActionProviderModel;
import org.passport.models.RequiredCredentialModel;
...
import org.passport.representations.account.CredentialMetadataRepresentation;
import org.passport.representations.account.LocalizedMessage;
import org.passport.representations.idm.AdminEventRepresentation;
import org.passport.representations.idm.AuthDetailsRepresentation;
...
import org.passport.representations.idm.RealmEventsConfigRepresentation;
import org.passport.representations.idm.RealmRepresentation;
import org.passport.representations.idm.RequiredActionConfigRepresentation;
...
import org.passport.representations.idm.UserSessionRepresentation;
...
import static org.passport.models.UserModel.IS_TEMP_ADMIN_ATTR_NAME;
...
public class ModelToRepresentation {
    ...
    public static String buildGroupPath(GroupModel group) {
        return PassportModelUtils.buildGroupPath(group);
    }
    ...
    @Deprecated
    public static Stream<GroupRepresentation> toGroupHierarchy(PassportSession session, RealmModel realm, boolean full) {
     ...
     * There is a GroupUtil class in the passport-services module to handle normal search operations
     */
    ...
    public static UserRepresentation toRepresentation(PassportSession session, RealmModel realm, UserModel user) {
        return toRepresentation(session, realm, user, new UserRepresentation(), true);
    }

    public static UserRepresentation toRepresentation(PassportSession session, RealmModel realm, UserModel user, UserRepresentation rep, boolean setUserAttributes) {
    ...
    public static RealmRepresentation toRepresentation(PassportSession session, RealmModel realm, boolean internal) {
        return toRepresentation(session, realm, internal, false);
    }

    public static RealmRepresentation toRepresentation(PassportSession session, RealmModel realm, boolean internal, boolean export) {
        RealmRepresentation rep = new RealmRepresentation();
        rep.setId(realm.getId());
        rep.setRealm(realm.getName());
        rep.setDisplayName(realm.getDisplayName());
    ...
    public static void exportGroups(PassportSession session, RealmModel realm, RealmRepresentation rep) {
        rep.setGroups(toGroupHierarchy(session, realm, true).collect(Collectors.toList()));
    }

    public static void exportAuthenticationFlows(PassportSession session, RealmModel realm, RealmRepresentation rep) {
    ...
    public static ClientRepresentation toRepresentation(ClientModel clientModel, PassportSession session) {
    ...
    private static boolean isRealmClient(String clientId, RealmModel realm, PassportSession session) {
    ...
    public static IdentityProviderRepresentation toRepresentation(PassportSession session, RealmModel realm, IdentityProviderModel identityProviderModel) {
        return toRepresentation(session, realm, identityProviderModel, false);
    }

    public static IdentityProviderRepresentation toRepresentation(PassportSession session, RealmModel realm, IdentityProviderModel identityProviderModel, boolean export) {
    ...
    public static AuthenticationFlowRepresentation toRepresentation(PassportSession session, RealmModel realm, AuthenticationFlowModel model) {
    ...
    public static AuthenticationExecutionExportRepresentation toRepresentation(PassportSession session, RealmModel realm, AuthenticationExecutionModel model) {
    ...
    public static ComponentRepresentation toRepresentation(PassportSession session, ComponentModel component, boolean internal) {
    ...
    public static ResourceRepresentation toRepresentation(Resource model, ResourceServer resourceServer, AuthorizationProvider authorization, Boolean deep) {
        ...
        if (owner.getId().equals(resourceServer.getClientId())) {
            ...
            UserModel userModel = passportSession.users().getUserById(realm, owner.getId());
    ...
    public static PermissionTicketRepresentation toRepresentation(PermissionTicket ticket, AuthorizationProvider authorization, boolean returnNames) {
        ...
        if (returnNames) {
            ...
            PassportSession passportSession = authorization.getPassportSession();
            RealmModel realm = authorization.getRealm();
            UserModel userOwner = passportSession.users().getUserById(realm, ticket.getOwner());
            UserModel requester = passportSession.users().getUserById(realm, ticket.getRequester());
    ...
    public static ResourceServerRepresentation toResourceServerRepresentation(PassportSession session, ClientModel client) {
        AuthorizationProviderFactory providerFactory = (AuthorizationProviderFactory) session.getPassportSessionFactory().getProviderFactory(AuthorizationProvider.class);
