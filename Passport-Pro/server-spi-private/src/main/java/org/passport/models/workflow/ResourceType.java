...
public enum ResourceType {
    ...
    private final BiFunction<PassportSession, String, ?> resourceResolver;
    private final BiFunction<PassportSession, Event, String> resourceIdResolver;

    ResourceType(BiFunction<PassportSession, String, ?> resourceResolver,
                 BiFunction<PassportSession, Event, String> resourceIdResolver) {
        this.resourceResolver = resourceResolver;
        this.resourceIdResolver = resourceIdResolver;
    }

    public Object resolveResource(PassportSession session, String id) {
        return resourceResolver.apply(session, id);
    }

    public String resolveResourceId(PassportSession session, Event event) {
        return resourceIdResolver.apply(session, event);
    }

    private static String findClientResourceId(PassportSession session, String clientClientId) {
