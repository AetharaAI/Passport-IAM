...
public class StripSecretsUtils {
    ...
    private static final Map<Class<?>, BiConsumer<PassportSession, Object>> REPRESENTATION_FORMATTER = new HashMap<>();
    ...
    protected interface GetComponentPropertiesFn {
        Map<String, ProviderConfigProperty> getComponentProperties(PassportSession session, String providerType, String providerId);
    }
    ...
    public static <T> T stripSecrets(PassportSession session, T representation) {
        BiConsumer<PassportSession, Object> formatter = REPRESENTATION_FORMATTER.get(representation.getClass());
    ...
    private static ComponentRepresentation stripComponent(PassportSession session, ComponentRepresentation rep) {
    ...
    private static void stripRealm(PassportSession session, RealmRepresentation rep) {
        stripRealm(session, rep, ComponentUtil::getComponentConfigProperties);
    }
    protected static void stripRealm(PassportSession session, RealmRepresentation rep, GetComponentPropertiesFn fnGetConfigProperties) {
        stripRealm(rep);
    ...
    private static ComponentExportRepresentation stripComponentExport(PassportSession session, String providerType, ComponentExportRepresentation rep) {
        return stripComponentExport(session, providerType, rep, ComponentUtil::getComponentConfigProperties);
    }
    private static ComponentExportRepresentation stripComponentExport(PassportSession session, String providerType, ComponentExportRepresentation rep, GetComponentPropertiesFn fnGetConfigProperties) {
