...
import static org.passport.representations.workflows.WorkflowConstants.CONFIG_ERROR;
...
public class Workflow {
    ...
    public Workflow(PassportSession session, ComponentModel c) {
    ...
    public Workflow(PassportSession session, String id, Map<String, List<String>> config) {
        this.session = session;
        this.realm = session.getContext().getRealm();
        this.id = id;
