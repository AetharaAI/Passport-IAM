...
public class DefaultAuthenticationFlows {
    ...
    public static void firstBrokerLoginFlow(RealmModel realm, boolean migrate) {
        ...
        firstBrokerLogin.setDescription("Actions taken after first broker login with identity provider account, which is not yet linked to any Passport account");
        ...
        if (migrate) {
            ...
            if (browserFlow != null) {
                ...
                PassportModelUtils.deepFindAuthenticationExecutions(realm, browserFlow, browserExecutions);
