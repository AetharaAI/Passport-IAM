...
import static org.passport.models.AdminRoles.IMPERSONATION;
...
public class ImpersonationConstants {
    ...
    public static void setupMasterRealmRole(RealmProvider model, RealmModel realm) {
        ...
        ClientModel realmAdminApp = adminRealm.getClientByClientId(PassportModelUtils.getMasterRealmAdminManagementClientId(realm.getName()));
    ...
    public static void setupImpersonationService(PassportSession session, RealmModel realm) {
