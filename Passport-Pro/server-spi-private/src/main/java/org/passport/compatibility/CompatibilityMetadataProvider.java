 ...
 * <p>
 * Implementations should return all metadata required to determine if it is possible to update from one Passport
...
public interface CompatibilityMetadataProvider {
     ...
     * the default implementation shipped in Passport.
     */
