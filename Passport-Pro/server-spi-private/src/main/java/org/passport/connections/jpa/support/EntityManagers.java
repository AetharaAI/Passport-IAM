...
package org.passport.connections.jpa.support;
...
public class EntityManagers {
    ...
    static void forEachEntityManager(PassportSession session, Consumer<EntityManager> op) {
        try {
    ...
    static Stream<EntityManagerProxy> getEntityManagerProxies(PassportSession session) {
     ...
     */
    public static void flush(PassportSession session, boolean clear) {
     ...
     * within the batch. Most of Passport's JPA code however persists and flushes together.
     *
     ...
     */
    public static void runInBatch(PassportSession session, Runnable runnable, boolean nestedEntityManagers) {
