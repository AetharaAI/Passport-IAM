...
public class TracingProviderUtil {
    ...
    public static TracingProvider getTracingProvider(PassportSession session) {
    ...
    public static TracingProvider getTracingProvider() {
        var session = PassportSessionUtil.getPassportSession();
        if (session == null) {
