...
public class ImportRealmFromRepresentationEvent implements ProviderEvent {
    ...
    public ImportRealmFromRepresentationEvent(PassportSession session, RealmRepresentation realmRepresentation) {
        this.session = session;
        this.realmRepresentation = realmRepresentation;
    }

    public static RealmModel fire(PassportSession session, RealmRepresentation rep) {
