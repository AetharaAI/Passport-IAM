...
public class PartialImportRealmFromRepresentationEvent implements ProviderEvent {
    ...
    public PartialImportRealmFromRepresentationEvent(PassportSession session, PartialImportRepresentation rep, RealmModel realm) {
        this.session = session;
        this.rep = rep;
        this.realm = realm;
    }

    public static PartialImportResults fire(PassportSession session, PartialImportRepresentation rep, RealmModel realm) {
