...
public class StoreMigrateRepresentationEvent implements ProviderEvent {
    ...
    public StoreMigrateRepresentationEvent(PassportSession session, RealmModel realm, RealmRepresentation rep, boolean skipUserDependent) {
    ...
    public static void fire(PassportSession session, RealmModel realm, RealmRepresentation rep, boolean skipUserDependent) {
        session.getPassportSessionFactory().publish(new StoreMigrateRepresentationEvent(session, realm, rep, skipUserDependent));
    }
