...
public class DefaultPasswordPolicyManagerProvider implements PasswordPolicyManagerProvider {
    ...
    public DefaultPasswordPolicyManagerProvider(PassportSession session) {
    ...
    private List<PasswordPolicyProvider> getProviders(PassportSession session) {
        return getProviders(session.getContext().getRealm(), session);

    }

    private List<PasswordPolicyProvider> getProviders(RealmModel realm, PassportSession session) {
