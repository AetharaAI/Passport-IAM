...
public class AuthenticationRequest {
    ...
    public AuthenticationRequest(PassportSession session, RealmModel realm, AuthenticationSessionModel authSession, HttpRequest httpRequest, UriInfo uriInfo, IdentityBrokerState state, String redirectUri) {
