...
import org.passport.connections.httpclient.SafeInputStream;
 ...
 *
 * @deprecated An updated version of SimpleHttp is available in {@link org.passport.http.simple.SimpleHttp}. This
 * version will be deleted in Passport 27.0
 */
@Deprecated
public class SimpleHttp {
    ...
    public static SimpleHttp doDelete(String url, PassportSession session) {
    ...
    public static SimpleHttp doGet(String url, PassportSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doPost(String url, PassportSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doPut(String url, PassportSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doHead(String url, PassportSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doPatch(String url, PassportSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
