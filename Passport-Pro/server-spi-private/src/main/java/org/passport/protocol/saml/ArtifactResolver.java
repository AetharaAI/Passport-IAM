...
public interface ArtifactResolver extends Provider {
     ...
     *
     * @param session PassportSession for searching for client corresponding client
     ...
     */
    ClientModel selectSourceClient(PassportSession session, String artifact) throws ArtifactResolverProcessingException;
