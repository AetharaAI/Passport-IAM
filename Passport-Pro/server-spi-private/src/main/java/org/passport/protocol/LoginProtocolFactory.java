...
public interface LoginProtocolFactory extends ProviderFactory<LoginProtocol> {
    ...
    Object createProtocolEndpoint(PassportSession session, EventBuilder event);
     ...
     */
    default void validateClientScope(PassportSession session, ClientScopeRepresentation clientScope) throws WebApplicationException {
    }

    /**
     * Test if the clientScope is valid for particular client. Usually called during protocol requests
     */
    default boolean isValidClientScope(PassportSession session, ClientModel client, ClientScopeModel clientScope) {
        return true;
    }
     ...
     */
    default void validateClientScopeAssignment(PassportSession session, ClientScopeModel clientScope, boolean defaultScope, RealmModel realm) {
