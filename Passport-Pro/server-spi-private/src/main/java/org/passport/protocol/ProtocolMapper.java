...
public interface ProtocolMapper extends Provider, ProviderFactory<ProtocolMapper>,ConfiguredProvider {
     ...
     */
    default void validateConfig(PassportSession session, RealmModel realm, ProtocolMapperContainerModel client, ProtocolMapperModel mapperModel) throws ProtocolMapperConfigException {
    };
     ...
     */
    default ProtocolMapperModel getEffectiveModel(PassportSession session, RealmModel realm, ProtocolMapperModel protocolMapperModel) {
