...
public interface OAuth2GrantType extends Provider {
     ...
     */
    default boolean isTokenAllowed(PassportSession session, AccessToken token) {
        return true;
    }
    ...
    public static class Context {
        ...
        public Context(PassportSession session, Object clientConfig, Map<String, String> clientAuthAttributes,
