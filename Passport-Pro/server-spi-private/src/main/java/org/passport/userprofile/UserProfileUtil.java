...
import org.passport.representations.idm.UserProfileAttributeGroupMetadata;
...
public class UserProfileUtil {
     ...
     */
    public static AttributeGroupMetadata lookupUserMetadataGroup(PassportSession session) {
    ...
    public static org.passport.representations.idm.UserProfileMetadata createUserProfileMetadata(PassportSession session, UserProfile profile) {
        ...
        return new org.passport.representations.idm.UserProfileMetadata(attributes, groups);
    }

    private static UserProfileAttributeMetadata toRestMetadata(AttributeMetadata am, PassportSession session, UserProfile profile) {
        String group = null;
    ...
    private static Map<String, Map<String, Object>> toValidatorMetadata(AttributeMetadata am, PassportSession session){
