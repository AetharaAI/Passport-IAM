...
import static org.passport.userprofile.UserProfileUtil.createUserProfileMetadata;
    ...
    private <R extends AbstractUserRepresentation> R createUserRepresentation(boolean full) {
        ...
        if (context.isAdminContext()) {
            ...
            if (full) {
                ...
                rep = (R) new org.passport.representations.idm.UserRepresentation();
            }
        } else {
            // by default, we build the simplest representation without exposing much information about users
            rep = (R) new org.passport.representations.account.UserRepresentation();
        }
