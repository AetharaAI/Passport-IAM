 ...
 * accessing the attribute set of a user is based on the configuration (see {@link org.passport.representations.userprofile.config.UPConfig})
 * and the constraints associated with a given context.
 *
 * <p>The {@link UserProfileContext} represents the different areas in Passport where users, and their attributes are managed.
...
public interface UserProfile {
     ...
     * the same from the {@link UserModel} as they are based on the configurations set in the {@link org.passport.representations.userprofile.config.UPConfig} and
