...
public class MigrationUtils {
    ...
    public static void migrateOldOfflineToken(PassportSession session, RealmModel realm, ClientModel client, UserModel user) throws OAuthErrorException {
        ClientScopeModel offlineScope = PassportModelUtils.getClientScopeByName(realm, OAuth2Constants.OFFLINE_ACCESS);
    ...
    public static void setDefaultClientAuthenticatorType(ClientModel s) {
        s.setClientAuthenticatorType(PassportModelUtils.getDefaultClientAuthenticatorType());
    }
