...
public interface Cors extends Provider {
    ...
    Cors allowedOrigins(PassportSession session, ClientModel client);
    ...
    /**
     * Add the CORS headers to the current {@link org.passport.http.HttpResponse}.
     */
    void add();

    /**
     * <p>Add the CORS headers to the current server {@link org.passport.http.HttpResponse} and returns a {@link Response} based
