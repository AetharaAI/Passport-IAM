...
public final class CookieType {
    ...
    public static final CookieType[] OLD_UNUSED_COOKIES = new CookieType[] {
            ...
            CookieType.create("PASSPORT_IDENTITY_LEGACY").build(),
            CookieType.create("PASSPORT_SESSION_LEGACY").build()
    };
    ...
    public static final CookieType IDENTITY = CookieType.create("PASSPORT_IDENTITY")
            .scope(CookieScope.FEDERATION)
            .build();

    public static final CookieType LOCALE = CookieType.create("PASSPORT_LOCALE")
            .scope(CookieScope.FEDERATION)
            .defaultMaxAge(CookieMaxAge.SESSION)
            .build();

    public static final CookieType LOGIN_HINT = CookieType.create("PASSPORT_REMEMBER_ME")
            .scope(CookieScope.FEDERATION)
            .defaultMaxAge(CookieMaxAge.YEAR)
            .build();

    public static final CookieType SESSION = CookieType.create("PASSPORT_SESSION")
            .scope(CookieScope.FEDERATION_JS)
            .build();
