...
public interface StickySessionEncoderProvider extends Provider {
     ...
     * <p>
     * The route is computed by the {@code sessionId}, i.e., the Passport instance where it is cached.
     *
    ...
    /**
     * @return true if information about route should be attached to the sticky session cookie by Passport. Otherwise,
    ...
    /**
     * @param sessionId The session ID.
     * @param route     The router, i.e., the Passport instance where the session is cached. It can be {@code null} if
