...
import static org.passport.policy.BlacklistPasswordPolicyProviderFactory.FileBasedPasswordBlacklist;
...
public class BlacklistPasswordPolicyProviderTest {
    ...
    public void testUpperCaseInFile() {
        FileBasedPasswordBlacklist blacklist =
                new FileBasedPasswordBlacklist(Paths.get("src/test/java/org/passport/policy"), "short_blacklist.txt");
        blacklist.lazyInit();
