...
public class PassportModelUtilsTest {
    ...
    public void testGenerateId() {
        ...
        final String shortId = PassportModelUtils.generateShortId(UUID.fromString(id));
    ...
    public void testGenerateShortId() {
        final String shortId = PassportModelUtils.generateShortId();
        final UUID uuid = fromShortId(shortId);
        Assert.assertEquals(shortId, PassportModelUtils.generateShortId(uuid));
    }
