package org.passport.testframework.config;
...
import org.passport.testframework.injection.ValueTypeAlias;
    ...
    private static ConfigSource initTestConfigSource() {
        try {
            ...
            if (testConfigFile != null) {
                ...
                testConfig = Thread.currentThread().getContextClassLoader().getResource("passport-test.properties");
            }
