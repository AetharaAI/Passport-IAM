...
import org.passport.testframework.injection.predicates.DependencyPredicates;
import org.passport.testframework.injection.predicates.InstanceContextPredicates;
import org.passport.testframework.injection.predicates.RequestedInstancePredicates;
import org.passport.testframework.injection.predicates.TestFrameworkExecutorPredicates;
...
public class Registry implements AutoCloseable {
    ...
    private void findRequestedInstances(Object testInstance, Method testMethod) {
        ...
        RequestedInstance requestedServerInstance = createRequestedInstance(testClass.getAnnotations(), PassportServer.class);
