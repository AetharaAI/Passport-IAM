...
* There is an associated GitHub Issue linked to the PR
  * A GitHub Issue is not required if the PR is not introducing a new feature or enhancement to Passport, or is resolving a bug where released versions of Passport are not affected
