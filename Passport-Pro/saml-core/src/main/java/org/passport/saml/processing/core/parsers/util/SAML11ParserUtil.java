 ...
 */
package org.passport.saml.processing.core.parsers.util;
...
import org.passport.dom.saml.v1.assertion.SAML11ActionType;
import org.passport.dom.saml.v1.assertion.SAML11AttributeStatementType;
import org.passport.dom.saml.v1.assertion.SAML11AttributeType;
import org.passport.dom.saml.v1.assertion.SAML11AudienceRestrictionCondition;
import org.passport.dom.saml.v1.assertion.SAML11AuthenticationStatementType;
import org.passport.dom.saml.v1.assertion.SAML11AuthorityBindingType;
import org.passport.dom.saml.v1.assertion.SAML11AuthorizationDecisionStatementType;
import org.passport.dom.saml.v1.assertion.SAML11ConditionsType;
import org.passport.dom.saml.v1.assertion.SAML11DecisionType;
import org.passport.dom.saml.v1.assertion.SAML11SubjectConfirmationType;
import org.passport.dom.saml.v1.assertion.SAML11SubjectLocalityType;
import org.passport.dom.saml.v1.assertion.SAML11SubjectStatementType;
import org.passport.dom.saml.v1.assertion.SAML11SubjectType;
import org.passport.dom.saml.v1.protocol.SAML11AttributeQueryType;
import org.passport.dom.saml.v1.protocol.SAML11AuthenticationQueryType;
import org.passport.dom.saml.v1.protocol.SAML11AuthorizationDecisionQueryType;
import org.passport.dom.saml.v2.assertion.SubjectConfirmationDataType;
import org.passport.dom.xmlsec.w3.xmldsig.DSAKeyValueType;
import org.passport.dom.xmlsec.w3.xmldsig.KeyInfoType;
import org.passport.dom.xmlsec.w3.xmldsig.KeyValueType;
...
import org.passport.saml.common.PicketLinkLogger;
import org.passport.saml.common.PicketLinkLoggerFactory;
...
import org.passport.saml.common.constants.WSTrustConstants;
import org.passport.saml.common.exceptions.ParsingException;
import org.passport.saml.common.util.StaxParserUtil;
import org.passport.saml.processing.core.parsers.saml.SAML11SubjectParser;
import org.passport.saml.processing.core.saml.v1.SAML11Constants;
...
public class SAML11ParserUtil {
    ...
    /**
     * Parse the {@link org.passport.dom.saml.v1.assertion.SAML11SubjectConfirmationType}
     *
     * @param xmlEventReader
     *
     * @return
    ...
    /**
     * Parse {@link org.passport.dom.saml.v1.assertion.SAML11ConditionsType}
     *
     * @param xmlEventReader
     *
     * @return
     ...
     * @return
     *
     * @throws org.passport.saml.common.exceptions.ParsingException
     */
