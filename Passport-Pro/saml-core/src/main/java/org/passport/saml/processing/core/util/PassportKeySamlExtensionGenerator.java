 ...
 * @author hmlnarik
 */
public class PassportKeySamlExtensionGenerator implements SamlProtocolExtensionsAwareBuilder.NodeGenerator {

    public static final String NS_URI = "urn:passport:ext:key:1.0";
    ...
    public PassportKeySamlExtensionGenerator(String keyId) {
        this.keyId = keyId;
    }
    ...
    /**
     * Checks that the given element is indeed a Passport extension {@code KeyInfo} element and
