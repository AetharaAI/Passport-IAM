 ...
 */
package org.passport.saml.processing.core.parsers.saml;
...
import org.passport.common.util.DerUtils;
...
import org.passport.dom.saml.v2.metadata.IndexedEndpointType;
...
import org.passport.dom.saml.v2.metadata.LocalizedURIType;
import org.passport.dom.saml.v2.metadata.PDPDescriptorType;
import org.passport.dom.saml.v2.metadata.RequestedAttributeType;
...
import org.passport.dom.xmlsec.w3.xmldsig.DSAKeyValueType;
import org.passport.dom.xmlsec.w3.xmldsig.KeyInfoType;
import org.passport.dom.xmlsec.w3.xmldsig.RSAKeyValueType;
import org.passport.dom.xmlsec.w3.xmldsig.X509CertificateType;
import org.passport.dom.xmlsec.w3.xmldsig.X509DataType;
import org.passport.dom.xmlsec.w3.xmlenc.EncryptionMethodType;
...
public class SAMLParserTest {
    ...
    public void testSaml20EncryptedAssertionsSignedReceivedWithRedirectBinding() throws Exception {
        ...
        assertThat(el.getNamespaceURI(), is("urn:passport:ext:key:1.0"));
    ...
    public void testSaml20EncryptedAssertionWithNewlines() throws Exception {
        SAMLDocumentHolder holder = assertParsed("PASSPORT-4489-encrypted-assertion-with-newlines.xml", SAMLDocumentHolder.class);
    ...
    public void testSaml20EncryptedAssertionsSignedTwoExtensionsReceivedWithRedirectBinding() throws Exception {
        ...
        assertThat(el.getNamespaceURI(), is("urn:passport:ext:what:1.0"));
    ...
    public void testSaml20AuthnResponseNonAsciiNameDefaultUtf8() throws Exception {
        ResponseType rt = assertParsed("PASSPORT-3971-utf-8-no-header-authnresponse.xml", ResponseType.class);
    ...
    public void testSaml20AuthnResponseNonAsciiNameDefaultLatin2() throws Exception {
        ResponseType rt = assertParsed("PASSPORT-3971-8859-2-in-header-authnresponse.xml", ResponseType.class);
        assertThat(rt.getAssertions().size(), is(1));
        final AssertionType assertion = rt.getAssertions().get(0).getAssertion();
    ...
    public void testOrganizationDetailsMetadata() throws Exception {
        assertParsed("PASSPORT-4040-sharefile-metadata.xml", EntityDescriptorType.class);
    }

    @Test
    public void testProxyRestrictionTagHandling() throws Exception {
        assertParsed("PASSPORT-6412-response-with-proxy-restriction.xml", ResponseType.class);
    }
    ...
    public void testSaml20MetadataEntityDescriptorAdfsIdP() throws Exception {
        assertParsed("PASSPORT-4809-IdPMetadata_test.xml", EntityDescriptorType.class);
    }

    @Test
    public void testAttributeProfileMetadata() throws Exception {
        assertParsed("PASSPORT-4236-AttributeProfile-element.xml", EntityDescriptorType.class);
    }

    @Test
    public void testEmptyAttributeValue() throws Exception {
        ResponseType resp = assertParsed("PASSPORT-4790-Empty-attribute-value.xml", ResponseType.class);
    ...
    public void testEmptyAttributeValueLast() throws Exception {
        assertParsed("PASSPORT-4790-Empty-attribute-value-last.xml", ResponseType.class);
    }
    ...
    @Test //https://issues.jboss.org/browse/PASSPORT-7316
    public void testAuthnRequestOptionalIsPassive() throws Exception {
        AuthnRequestType req = assertParsed("PASSPORT-7316-noAtrributes.xml", AuthnRequestType.class);

        assertThat("Not null!", req.isIsPassive(), nullValue());
        assertThat("Not null!", req.isForceAuthn(), nullValue());

        req = assertParsed("PASSPORT-7316-withTrueAttributes.xml", AuthnRequestType.class);
        ...
        req = assertParsed("PASSPORT-7316-withFalseAttributes.xml", AuthnRequestType.class);
    ...
    public void testAuthnRequestScoping() throws Exception {
        assertParsed("PASSPORT-6109-authnrequest-scoping.xml", AuthnRequestType.class);
    }
