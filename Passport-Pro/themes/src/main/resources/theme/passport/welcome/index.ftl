...
<html lang="en">
  <head>
    ...
    <title>Welcome to Passport-Pro</title>
      ...
      <div class="pf-v5-c-login__container">
        <header class="pf-v5-c-login__header">
          <div class="pf-v5-c-brand">
            <img src="${resourcesPath}/logo.svg" alt="Passport-Pro Logo" class="kc-brand">
          </div>
          <div class="passport-tagline">
            Passport — Making your Agents and Agentic Systems Legal, Trusted, verified. Mint yours today.
          </div>
        </header>
        <#if adminConsoleEnabled && (bootstrap || successMessage?has_content)>
          <main class="pf-v5-c-login__main">
            <header class="pf-v5-c-login__main-header">
              <#if localUser>
                <h1 class="pf-v5-c-title pf-m-2xl">Create Infrastructure Administrator</h1>
                <#if !successMessage?has_content>
                  <p class="pf-v5-c-login__main-header-desc">To get started with Passport-Pro, you first create your master identity.</p>
                </#if>
              <#else>
                <h1 class="pf-v5-c-title pf-m-3xl">Local access required</h1>
                <p class="pf-v5-c-login__main-header-desc">You will need local access to initialize Passport-Pro.</p>
              </#if>
            </header>
