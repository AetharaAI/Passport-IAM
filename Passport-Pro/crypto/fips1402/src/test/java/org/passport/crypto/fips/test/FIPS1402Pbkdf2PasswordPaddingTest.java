...
import org.passport.credential.hash.AbstractPbkdf2PasswordHashProviderFactory;
import org.passport.credential.hash.PasswordHashProvider;
import org.passport.credential.hash.PasswordHashSpi;
...
import org.passport.rule.RunInThreadRule;
...
public class FIPS1402Pbkdf2PasswordPaddingTest {
    ...
    private void testPasswordVerification(String password, boolean shouldEnableApprovedModeForVerification, int maxPaddingLength) {
        ...
        System.setProperty("passport." + PasswordHashSpi.NAME + "." + Pbkdf2Sha256PasswordHashProviderFactory.ID + "." + AbstractPbkdf2PasswordHashProviderFactory.MAX_PADDING_LENGTH_PROPERTY,
