...
package org.passport.crypto.fips;
...
public class BCFIPSOCSPProvider extends OCSPProvider {
    ...
    protected OCSPResp getResponse(PassportSession session, OCSPReq ocspReq, URI responderUri) throws IOException {
     ...
     */
    @Override
    protected OCSPRevocationStatus check(PassportSession session, X509Certificate cert, X509Certificate issuerCertificate, List<URI> responderURIs, X509Certificate responderCert, Date date) throws CertPathValidatorException {
