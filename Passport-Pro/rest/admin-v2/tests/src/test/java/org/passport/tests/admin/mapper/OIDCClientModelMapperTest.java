...
import org.passport.models.mapper.OIDCClientModelMapper;
...
@PassportIntegrationTest(config = OIDCClientModelMapperTest.ServerConfig.class)
public class OIDCClientModelMapperTest {
    ...
    @TestOnServer
    public void fromModel_mapsLoginFlows(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsAuthForConfidentialClient(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_noAuthForPublicClient(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsWebOrigins(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsServiceAccountRoles(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_emptyServiceAccountRolesWhenServiceAccountDisabled(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsLoginFlows(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsFlowsToFalseWhenNotInSet(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsConfidentialClientAuth(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsPublicClientWhenNoAuth(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_handlesNullEnabled(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
