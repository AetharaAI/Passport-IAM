...
import org.passport.services.error.ViolationExceptionResponse;
...
import static org.passport.services.cors.Cors.ACCESS_CONTROL_ALLOW_METHODS;
import static org.passport.services.cors.Cors.ORIGIN_HEADER;
...
@PassportIntegrationTest(config = ClientApiV2Test.AdminV2Config.class)
public class ClientApiV2Test {
    ...
    private void setAuthHeader(HttpMessage request, Passport adminClient) {
    ...
    public static class AdminV2Config implements PassportServerConfig {
        @Override
