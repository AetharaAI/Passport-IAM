...
package org.passport.tests.admin.mapper;
...
import org.passport.models.mapper.ClientModelMapper;
import org.passport.models.mapper.SAMLClientModelMapper;
import org.passport.representations.admin.v2.BaseClientRepresentation;
import org.passport.representations.admin.v2.SAMLClientRepresentation;
...
@PassportIntegrationTest(config = SAMLClientModelMapperTest.ServerConfig.class)
public class SAMLClientModelMapperTest {
    ...
    @TestOnServer
    public void fromModel_mapsBasicFields(PassportSession session) {
    ...
    @TestOnServer
    public void fromModel_mapsRoles(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsNameIdSettings(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsSignatureSettings(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsBindingAndLogoutSettings(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_mapsEcpFlow(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void fromModel_nullBooleanAttributesReturnNull(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsBasicFields(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsNameIdSettings(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsSignatureSettings(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsBindingAndLogoutSettings(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_setsEcpFlow(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_doesNotSetNullAttributes(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void toModel_handlesFalseBooleansCorrectly(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName("master");
        session.getContext().setRealm(realm);
    ...
    @TestOnServer
    public void close_doesNotThrow(PassportSession session) {
        SAMLClientModelMapper mapper = (SAMLClientModelMapper) session.getProvider(ClientModelMapper.class, SAMLClientRepresentation.PROTOCOL);
