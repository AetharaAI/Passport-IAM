...
import org.passport.services.resources.admin.UserProfileResource;
...
public class UIRealmResource {
    ...
    public UIRealmResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
