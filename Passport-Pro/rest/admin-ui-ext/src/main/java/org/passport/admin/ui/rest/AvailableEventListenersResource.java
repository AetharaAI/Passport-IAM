...
import org.passport.admin.ui.rest.model.EventListener;
import org.passport.admin.ui.rest.model.ProviderMapper;
...
public class AvailableEventListenersResource {
    ...
    public AvailableEventListenersResource(PassportSession session, AdminPermissionEvaluator auth) {
    ...
    public final List<EventListener> listAvailableEventListeners() {
        ...
        session.getPassportSessionFactory().getProviderFactoriesStream(EventListenerProvider.class).forEach(
               providerFactory -> {
