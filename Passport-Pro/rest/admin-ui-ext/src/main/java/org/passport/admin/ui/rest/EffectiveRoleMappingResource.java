...
import static org.passport.admin.ui.rest.model.RoleMapper.convertToModel;

public class EffectiveRoleMappingResource extends RoleMappingResource {
    public EffectiveRoleMappingResource(PassportSession session, RealmModel realm, AdminPermissionEvaluator auth) {
