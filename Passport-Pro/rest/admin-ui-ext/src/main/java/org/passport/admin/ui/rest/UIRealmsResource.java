...
import org.passport.admin.ui.rest.model.RealmNameRepresentation;
...
import org.passport.services.resources.admin.fgap.RealmsPermissionEvaluator;
...
public class UIRealmsResource {
    ...
    public UIRealmsResource(PassportSession session, AdminPermissionEvaluator auth) {
