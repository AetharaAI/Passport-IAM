package org.passport.test.saml.adapter.galleon.pack.layer.metadata;
...
public class PassportSamlAdapterLayerMetaDataTestCase {
    ...
    private static final String WEB_XML = "<web-app>" +
                "  <login-config>" +
                "    <auth-method>PASSPORT-SAML</auth-method>" +
                "  </login-config>" +
                "</web-app>";
    @BeforeClass
    ...
    @Test
    public void testPassportDetected() throws Exception {
        ...
        Assert.assertTrue(foundLayers.toString(), foundLayers.contains("passport-saml") && 
                foundLayers.contains("passport-client-saml") && 
                !foundLayers.contains("passport-client-saml-ejb"));
    }
    
    @Test
    public void testPassportEJBDetected() throws Exception {
