...
/**
 * <p>Provides a way for obtaining the PassportSession
 *
 * @author <a href="mailto:psilva@redhat.com">Pedro Igor</a>
 *
 * @deprecated use org.passport.util.PassportSessionUtil instead
 */
@Deprecated
public final class Resteasy {
     ...
     * <br> Should only be used to obtain the PassportSession
     *
