...
public class StackUtil {
    ...
    private static final Logger LOG = Logger.getLogger("org.passport.STACK_TRACE");
     ...
     *
     * @return If the logger {@code org.passport.STACK_TRACE} is set to trace
    ...
    private static final Pattern IGNORED = Pattern.compile("sun\\.|"
      ...
      + "io\\.undertow\\.|"
      + "picocli\\.|"
      + "org.passport.testsuite.model.PassportModelTest\\."
    );
