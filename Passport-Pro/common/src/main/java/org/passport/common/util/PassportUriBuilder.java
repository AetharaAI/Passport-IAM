...
package org.passport.common.util;
 ...
 * @version $Revision: 1 $
 */
public class PassportUriBuilder {
    ...
    public static PassportUriBuilder fromUri(URI uri) {
        return new PassportUriBuilder().uri(uri);
    }

    public static PassportUriBuilder fromUri(String uriTemplate) {
        // default fromUri manages template params {}
        return new PassportUriBuilder().uri(uriTemplate, true);
    }

    public static PassportUriBuilder fromUri(String uri, boolean template) {
        return new PassportUriBuilder().uri(uri, template);
    }

    public static PassportUriBuilder fromPath(String path) throws IllegalArgumentException {
        return new PassportUriBuilder().path(path);
    }


    public PassportUriBuilder clone() {
        PassportUriBuilder impl = new PassportUriBuilder();
        impl.host = host;
        impl.scheme = scheme;
        impl.port = port;
    ...
    public static URI relativize(URI from, URI to) {
        ...
        PassportUriBuilder builder = PassportUriBuilder.fromPath("");
     ...
     * @return
     */
    public static PassportUriBuilder fromTemplate(String uriTemplate) {
        PassportUriBuilder impl = new PassportUriBuilder();
     ...
     * @return
     */
    public PassportUriBuilder uriTemplate(String uriTemplate) {
    ...
    protected PassportUriBuilder parseHierarchicalUri(String uri, Map<String,String> match, boolean template) {
    ...
    public PassportUriBuilder uri(String uri) throws IllegalArgumentException {
        // default uri manages template params {}
        return uri(uri, true);
    }

    public PassportUriBuilder uri(String uri, boolean template) throws IllegalArgumentException {
    ...
    public PassportUriBuilder uri(URI uri) throws IllegalArgumentException {
    ...
    public PassportUriBuilder scheme(String scheme) throws IllegalArgumentException {
        this.scheme = scheme;
        return this;
    }

    public PassportUriBuilder schemeSpecificPart(String ssp) throws IllegalArgumentException {
    ...
    public PassportUriBuilder userInfo(String ui) {
        this.userInfo = ui;
        return this;
    }

    public PassportUriBuilder host(String host) throws IllegalArgumentException {
        if (host != null && host.equals("")) throw new IllegalArgumentException("invalid host");
        this.host = host;
        return this;
    }

    public PassportUriBuilder port(int port) throws IllegalArgumentException {
     ...
     *
     * For example:
     * - PassportUriBuilder.fromUri("https://localhost:443/path").buildAsString() will return "https://localhost/path" (port not preserved)
     * - PassportUriBuilder.fromUri("https://localhost:443/path").preserveDefaultPort().buildAsString() will return "https://localhost:443/path" (port is preserved even if default port)
     * - PassportUriBuilder.fromUri("https://localhost/path").preserveDefaultPort().buildAsString() will return "https://localhost/path" (port not included even if "preserveDefaultPort" as it was not in the original URL)
     */
    public PassportUriBuilder preserveDefaultPort() {
    ...
    public PassportUriBuilder path(String segment) throws IllegalArgumentException {
        if (segment == null) throw new IllegalArgumentException("path was null");
        path = paths(true, path, segment);
        return this;
    }

    public PassportUriBuilder replaceMatrix(String matrix) throws IllegalArgumentException {
    ...
    public PassportUriBuilder replaceQuery(String query) throws IllegalArgumentException {
        // default replaceQuery manages template params {}
        return replaceQuery(query, true);
    }

    public PassportUriBuilder replaceQuery(String query, boolean template) throws IllegalArgumentException {
    ...
    public PassportUriBuilder fragment(String fragment) throws IllegalArgumentException {
        // default fragment manages template params {}
        return fragment(fragment, true);
    }

    public PassportUriBuilder fragment(String fragment, boolean template) throws IllegalArgumentException {
        if (fragment == null) {
            this.fragment = null;
            return this;
        }
     ...
     * @return
     */
    public PassportUriBuilder encodedFragment(String fragment) {
     ...
     * @return
     */
    public PassportUriBuilder substitutePathParam(String name, Object value, boolean isEncoded) {
        if (path != null) {
    ...
    public PassportUriBuilder matrixParam(String name, Object... values) throws IllegalArgumentException {
    ...
    public PassportUriBuilder queryParam(String name, Object... values) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("name parameter is null");
        if (values == null) throw new IllegalArgumentException("values parameter is null");
    ...
    public PassportUriBuilder replaceQueryParam(String name, Object... values) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("name parameter is null");
    ...
    public PassportUriBuilder segment(String... segments) throws IllegalArgumentException {
    ...
    public PassportUriBuilder replacePath(String path) {
        // default replacePath manages template expression {}
        return replacePath(path, true);
    }

    public PassportUriBuilder replacePath(String path, boolean template) {
        if (path == null) {
            this.path = null;
            return this;
        }
    ...
    public PassportUriBuilder replaceUserInfo(String userInfo, boolean template) {
        if (userInfo == null) {
            this.userInfo = null;
            return this;
        }
    ...
    public PassportUriBuilder resolveTemplate(String name, Object value) throws IllegalArgumentException {
    ...
    public PassportUriBuilder resolveTemplates(Map<String, Object> templateValues) throws IllegalArgumentException {
    ...
    public PassportUriBuilder resolveTemplate(String name, Object value, boolean encodeSlashInPath) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("name param is null");
        if (value == null) throw new IllegalArgumentException("value param is null");
        HashMap<String, Object> vals = new HashMap<String, Object>();
        vals.put(name, value);
    ...
    public PassportUriBuilder resolveTemplates(Map<String, Object> templateValues, boolean encodeSlashInPath) throws IllegalArgumentException {
        if (templateValues == null) throw new IllegalArgumentException("templateValues param null");
        String str = buildString(templateValues, false, true, encodeSlashInPath);
        return fromTemplate(str);
    }

    public PassportUriBuilder resolveTemplatesFromEncoded(Map<String, Object> templateValues) throws IllegalArgumentException {
        if (templateValues == null) throw new IllegalArgumentException("templateValues param null");
