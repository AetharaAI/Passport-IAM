...
public class ProfileTest {
    ...
    public void checkFailureIfDependencyDisabled() {
        ...
        properties.setProperty("passport.profile.feature.account_api", "disabled");
    ...
    public void checkSuccessIfFeatureDisabledWithDisabledDependencies() {
        Properties properties = new Properties();
        properties.setProperty("passport.profile.feature.account", "disabled");
        properties.setProperty("passport.profile.feature.account_api", "disabled");
    ...
    public void checkErrorOnBadConfig() {
        Properties properties = new Properties();
        properties.setProperty("passport.profile.feature.account_api", "invalid");

        Assert.assertEquals("Invalid config value 'invalid' for feature key passport.profile.feature.account_api",
                assertThrows(ProfileException.class,
                        () -> Profile.configure(new PropertiesProfileConfigResolver(properties))).getMessage());
    }
    ...
    public void wrongProfileInProperties() {
        Properties properties = new Properties();
        properties.setProperty("passport.profile", "experimental");

        Assert.assertEquals("Invalid profile 'experimental' specified via 'passport.profile' property",
                assertThrows(ProfileException.class,
                        () -> Profile.configure(new PropertiesProfileConfigResolver(properties))).getMessage());
    }
    ...
    public void enablePreviewWithProperties() {
        Properties properties = new Properties();
        properties.setProperty("passport.profile", "preview");
        Profile.configure(new PropertiesProfileConfigResolver(properties));
