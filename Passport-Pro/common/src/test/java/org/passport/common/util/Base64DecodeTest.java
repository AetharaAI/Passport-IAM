 ...
 *
 * @author <a href="mailto:passport-hc@halfbrodt.org">Hans-Christian Halfbrodt</a>
 */
public class Base64DecodeTest {
    ...
    public void decode_doNotUseGzip() throws IOException {
        // Input has gzip magic byte by coincidence and should not be gunzipped. (PASSPORT-18914)
        // high level string variant
