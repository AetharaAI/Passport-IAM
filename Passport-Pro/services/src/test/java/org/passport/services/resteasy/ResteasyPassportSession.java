...
public class ResteasyPassportSession extends DefaultPassportSession {

    public ResteasyPassportSession(DefaultPassportSessionFactory factory) {
        super(factory);
    }

    @Override
    protected DefaultPassportContext createPassportContext(PassportSession session) {
        return new ResteasyPassportContext(session);
    }
