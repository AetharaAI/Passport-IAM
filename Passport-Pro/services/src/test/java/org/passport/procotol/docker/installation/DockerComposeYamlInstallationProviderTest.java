package org.passport.procotol.docker.installation;
...
import org.passport.protocol.docker.installation.DockerComposeYamlInstallationProvider;
...
import static org.passport.protocol.docker.installation.DockerComposeYamlInstallationProvider.ROOT_DIR;
...
public class DockerComposeYamlInstallationProviderTest {
    ...
    public void writeToRealZip() throws IOException {
        ...
        FileUtils.writeByteArrayToFile(new File("target/passport-docker-compose-yaml.zip"), responseBytes);
    }
