...
public class OpenshiftV4IdentityProviderTest {
    ...
    private final String TEST_OAUTH_METADATA_FILE = "/org/passport/test/social/openshift/OpenshiftV4-oauth-metadata.json";
    ...
    public void testExtractingConfigProperties() {
        ...
        new OpenshiftV4IdentityProvider(null, config) {
            @Override
            InputStream getOauthMetadataInputStream(PassportSession session, String baseUrl) {
