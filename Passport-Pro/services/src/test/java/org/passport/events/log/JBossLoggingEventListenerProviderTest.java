 ...
 */
package org.passport.events.log;
...
public class JBossLoggingEventListenerProviderTest {
    ...
    private static void test(Map<String, String> config, AdminEvent adminEvent, boolean includeRepresentation, Consumer<String> assertMessage) {
        PassportSession session = createSession(config);
        Logger logger = Logger.getLogger("org.passport.events");
    ...
    private static PassportSession createSession(Map<String, String> config) {
        ...
        sessionFactory.init();
        PassportSession session = new ResteasyPassportSession(sessionFactory);
