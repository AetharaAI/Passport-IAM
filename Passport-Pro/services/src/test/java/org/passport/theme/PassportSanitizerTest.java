...
/**
 * Test the PassportEscape utility.
 * 
 * @author Stan Silvert
 */
public class PassportSanitizerTest {
    private final PassportSanitizerMethod kcEscape = new PassportSanitizerMethod();
    
    @Test
    public void testEscapes() throws Exception {
        List<String> html = new ArrayList<>();

        html.add("<div class=\"kc-logo-text\"><script>alert('foo');</script><span>Passport</span></div>");
        String expectedResult = "<div class=\"kc-logo-text\"><span>Passport</span></div>";
        ...
        html.set(0, "<div class=\"kc-logo-text\"><span>Passport</span></div><svg onload=alert(document.cookie);>");
        expectedResult = "<div class=\"kc-logo-text\"><span>Passport</span></div>";
        assertResult(expectedResult, html);
