...
## Passport Realm Assumptions:
 ...
 - Passport server is started with the 'docker' feature enabled.  I.E. -Dpassport.profile.feature.docker=enabled
 ...
 ** Remember that users for the `docker login` command must be configured and available in the passport realm that hosts the docker client.