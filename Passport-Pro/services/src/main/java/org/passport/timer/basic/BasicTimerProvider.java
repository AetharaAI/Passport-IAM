...
package org.passport.timer.basic;
...
public class BasicTimerProvider implements TimerProvider {
    ...
    public BasicTimerProvider(PassportSession session, Timer timer, int transactionTimeout, BasicTimerProviderFactory factory) {
    ...
    public void scheduleTask(ScheduledTask scheduledTask, long intervalMillis, String taskName) {
        ScheduledTaskRunner scheduledTaskRunner = new ScheduledTaskRunner(session.getPassportSessionFactory(), scheduledTask, transactionTimeout);
     ...
     * including its reference to {@link PassportSession}.
     */
