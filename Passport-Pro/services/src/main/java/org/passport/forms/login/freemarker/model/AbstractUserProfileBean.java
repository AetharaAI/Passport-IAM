...
import org.passport.userprofile.AttributeValidatorMetadata;
...
public abstract class AbstractUserProfileBean {
     ...
     */
    protected void init(PassportSession session, boolean writeableOnly) {
    ...
    /**
     * Create UserProfile instance of the relevant type. Is called from {@link #init(PassportSession, boolean)}.
     * 
