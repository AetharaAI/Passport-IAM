...
import org.passport.authentication.authenticators.browser.RecoveryAuthnCodesFormAuthenticator;
import org.passport.authentication.forms.RegistrationPage;
import org.passport.authentication.requiredactions.util.UpdateProfileContext;
import org.passport.authentication.requiredactions.util.UserUpdateProfileContext;
...
import org.passport.forms.login.LoginFormsPages;
import org.passport.forms.login.LoginFormsProvider;
import org.passport.forms.login.MessageType;
import org.passport.forms.login.freemarker.model.AuthenticationContextBean;
import org.passport.forms.login.freemarker.model.AuthenticationSessionBean;
import org.passport.forms.login.freemarker.model.ClientBean;
import org.passport.forms.login.freemarker.model.CodeBean;
import org.passport.forms.login.freemarker.model.EmailBean;
import org.passport.forms.login.freemarker.model.FrontChannelLogoutBean;
import org.passport.forms.login.freemarker.model.IdentityProviderBean;
import org.passport.forms.login.freemarker.model.IdpReviewProfileBean;
import org.passport.forms.login.freemarker.model.LoginBean;
import org.passport.forms.login.freemarker.model.LogoutConfirmBean;
import org.passport.forms.login.freemarker.model.OAuthGrantBean;
import org.passport.forms.login.freemarker.model.OrganizationBean;
import org.passport.forms.login.freemarker.model.PasswordPoliciesBean;
import org.passport.forms.login.freemarker.model.ProfileBean;
import org.passport.forms.login.freemarker.model.RealmBean;
import org.passport.forms.login.freemarker.model.RecoveryAuthnCodeInputLoginBean;
import org.passport.forms.login.freemarker.model.RecoveryAuthnCodesBean;
import org.passport.forms.login.freemarker.model.RegisterBean;
import org.passport.forms.login.freemarker.model.RequiredActionUrlFormatterMethod;
import org.passport.forms.login.freemarker.model.SAMLPostFormBean;
import org.passport.forms.login.freemarker.model.TotpBean;
import org.passport.forms.login.freemarker.model.TotpLoginBean;
import org.passport.forms.login.freemarker.model.UrlBean;
import org.passport.forms.login.freemarker.model.VerifyProfileBean;
import org.passport.forms.login.freemarker.model.X509ConfirmBean;
...
import org.passport.organization.forms.login.freemarker.model.OrganizationAwareIdentityProviderBean;
...
import org.passport.theme.beans.AdvancedMessageFormatterMethod;
import org.passport.theme.beans.LocaleBean;
import org.passport.theme.beans.MessageBean;
import org.passport.theme.beans.MessageFormatterMethod;
import org.passport.theme.beans.MessagesPerFieldBean;
import org.passport.theme.freemarker.FreeMarkerProvider;
import org.passport.userprofile.UserProfileContext;
import org.passport.utils.MediaType;
import org.passport.utils.MediaTypeMatcher;

import org.jboss.logging.Logger;

import static org.passport.models.UserModel.RequiredAction.UPDATE_PASSWORD;
import static org.passport.organization.utils.Organizations.resolveOrganization;
...
public class FreeMarkerLoginFormsProvider implements LoginFormsProvider {
    ...
    public FreeMarkerLoginFormsProvider(PassportSession session) {
