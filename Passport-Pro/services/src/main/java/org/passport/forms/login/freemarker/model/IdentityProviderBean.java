...
import org.passport.models.OrderedModel;
...
public class IdentityProviderBean {
    ...
    public IdentityProviderBean(PassportSession session, RealmModel realm, URI baseURI, AuthenticationFlowContext context) {
    ...
    protected IdentityProvider createIdentityProvider(RealmModel realm, URI baseURI, IdentityProviderModel identityProvider) {
        ...
        String displayName = PassportModelUtils.getIdentityProviderDisplayName(session, identityProvider);
     ...
     */
    protected String getExistingIDP(PassportSession session, AuthenticationFlowContext context) {
     ...
     */
    protected Set<String> getLinkedBrokerAliases(PassportSession session, RealmModel realm, AuthenticationFlowContext context) {
