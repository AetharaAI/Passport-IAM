 ...
 * instances on {@link #create(PassportSession)}.
 * <p/>
 ...
 * override the {@link #getId()} method so that the custom factory has its own id and as such can be configured in the passport
 * server.
 * <p/>
...
public abstract class AbstractVaultProviderFactory implements VaultProviderFactory {
    ...
    /**
     * Obtains the name of realm from the {@link PassportSession}.
     *
     * @param session a reference to the {@link PassportSession}.
     * @return the name of the realm.
     */
    protected String getRealmName(PassportSession session) {
