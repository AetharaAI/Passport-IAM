...
import static org.passport.utils.RegexUtils.valueMatchesRegex;
...
public class ClaimToUserSessionNoteMapper extends AbstractClaimMapper {
    ...
    private static final String[] COMPATIBLE_PROVIDERS = {PassportOIDCIdentityProviderFactory.PROVIDER_ID,
