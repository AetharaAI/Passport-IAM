 ...
 * @author Pedro Igor
 */
public class PassportOIDCIdentityProviderFactory extends AbstractIdentityProviderFactory<PassportOIDCIdentityProvider> {

    public static final String PROVIDER_ID = "passport-oidc";

    @Override
    public String getName() {
        return "Passport OpenID Connect";
    }
