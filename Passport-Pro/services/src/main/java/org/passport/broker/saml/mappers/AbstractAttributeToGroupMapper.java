 ...
 * attribute into a {@code Passport} group.
 *
...
public abstract class AbstractAttributeToGroupMapper extends AbstractIdentityProviderMapper {
    ...
    private GroupModel getGroup(PassportSession session, final RealmModel realm, final IdentityProviderMapperModel mapperModel) {
        String groupPath = mapperModel.getConfig().get(ConfigConstants.GROUP);
        GroupModel group = PassportModelUtils.findGroupByPath(session, realm, groupPath);
