...
public abstract class AbstractClaimToGroupMapper extends AbstractClaimMapper {
    ...
    @Override
    public void importNewUser(PassportSession session, RealmModel realm, UserModel user,
    ...
    @Override
    public void updateBrokeredUser(PassportSession session, RealmModel realm, UserModel user,
            IdentityProviderMapperModel mapperModel, BrokeredIdentityContext context) {
