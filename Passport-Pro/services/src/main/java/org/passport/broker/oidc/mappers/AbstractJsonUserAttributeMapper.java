...
import org.passport.broker.provider.AbstractIdentityProviderMapper;
...
import static org.passport.utils.JsonUtils.splitClaimPath;

/**
 * Abstract class for Social Provider mappers which allow mapping of JSON user profile field into Passport user
...
public abstract class AbstractJsonUserAttributeMapper extends AbstractIdentityProviderMapper {
	...
	protected static final Logger LOGGER_DUMP_USER_PROFILE = Logger.getLogger("org.passport.social.user_profile_dump");
	 ...
	 *
	 * @see #preprocessFederatedIdentity(PassportSession, RealmModel, IdentityProviderMapperModel, BrokeredIdentityContext)
