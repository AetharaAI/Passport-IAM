...
import static org.passport.models.IdentityProviderModel.LEGACY_HIDE_ON_LOGIN_ATTR;
...
public class SAMLIdentityProviderFactory extends AbstractIdentityProviderFactory<SAMLIdentityProvider> {
    ...
    @Override
    public SAMLIdentityProvider create(PassportSession session, IdentityProviderModel model) {
