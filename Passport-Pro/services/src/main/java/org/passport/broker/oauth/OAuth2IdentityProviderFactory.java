 ...
 */
package org.passport.broker.oauth;
...
public class OAuth2IdentityProviderFactory extends AbstractIdentityProviderFactory<OAuth2IdentityProvider> {
    ...
    @Override
    public OAuth2IdentityProvider create(PassportSession session, IdentityProviderModel model) {
    ...
    @Override
    public Map<String, String> parseConfig(PassportSession session, String rawConfig) {
