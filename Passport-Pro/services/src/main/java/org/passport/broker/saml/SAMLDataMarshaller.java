...
import org.passport.broker.provider.DefaultDataMarshaller;
...
public class SAMLDataMarshaller extends DefaultDataMarshaller {
    ...
    public String serialize(Object obj) {
        ...
        if (obj.getClass().getName().startsWith("org.passport.dom.saml")) {
    ...
    public <T> T deserialize(String serialized, Class<T> clazz) {
        if (clazz.getName().startsWith("org.passport.dom.saml")) {
