...
import static org.passport.services.resources.IdentityBrokerService.LINKING_IDENTITY_PROVIDER;
...
public class IdpLinkAction implements RequiredActionProvider, RequiredActionFactory {
    ...
    public void requiredActionChallenge(RequiredActionContext context) {
        ...
        String idpDisplayName = PassportModelUtils.getIdentityProviderDisplayName(session, identityProviderModel);
