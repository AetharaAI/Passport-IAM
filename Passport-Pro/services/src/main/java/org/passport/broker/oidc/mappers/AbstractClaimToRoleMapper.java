 ...
 * claim into a {@code Passport} role.
 *
...
public abstract class AbstractClaimToRoleMapper extends AbstractClaimMapper {
    ...
    public void updateBrokeredUser(PassportSession session, RealmModel realm, UserModel user, IdentityProviderMapperModel mapperModel, BrokeredIdentityContext context) {
        ...
        // PASSPORT-8730 if a previous mapper has already granted the same role, skip the checks so we don't accidentally remove a valid role.
