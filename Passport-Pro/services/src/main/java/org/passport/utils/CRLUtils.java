...
public final class CRLUtils {
     ...
     */
    public static void check(X509Certificate[] certs, X509CRL crl, PassportSession session) throws GeneralSecurityException {
    ...
    private static X509Certificate findCRLSignatureCertificateInTruststore(PassportSession session, X509Certificate[] certs, X509CRL crl) throws GeneralSecurityException {
