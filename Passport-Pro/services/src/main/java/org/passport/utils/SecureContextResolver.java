...
import org.passport.device.DeviceRepresentationProvider;
...
public class SecureContextResolver {
     ...
     */
    public static boolean isSecureContext(PassportSession session) {
    ...
    static boolean isSecureContext(URI uri, Supplier<DeviceRepresentation> deviceRepresentationSupplier) {
        ...
        // See:
        // - https://github.com/passport/passport/issues/33557
