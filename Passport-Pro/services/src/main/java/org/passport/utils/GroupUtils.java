...
import org.passport.services.resources.admin.fgap.GroupPermissionEvaluator;
...
public class GroupUtils {
     ...
     * provided groups
     * @param session The active passport session
     ...
     */
    public static Stream<GroupRepresentation> populateGroupHierarchyFromSubGroups(PassportSession session, RealmModel realm, Stream<GroupModel> groups, boolean full, GroupPermissionEvaluator groupEvaluator, boolean subGroupsCount) {
    ...
    //From org.passport.admin.ui.rest.GroupsResource
