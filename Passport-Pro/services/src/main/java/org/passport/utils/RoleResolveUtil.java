...
public class RoleResolveUtil {
     ...
     */
    public static AccessToken.Access getResolvedRealmRoles(PassportSession session, ClientSessionContext clientSessionCtx, boolean createIfMissing) {
     ...
     * @return can return null (just in case that createIfMissing is false)
     */
    public static AccessToken.Access getResolvedClientRoles(PassportSession session, ClientSessionContext clientSessionCtx, String clientId, boolean createIfMissing) {
        AccessToken rolesToken = getAndCacheResolvedRoles(session, clientSessionCtx);
     ...
     */
    public static Map<String, AccessToken.Access> getAllResolvedClientRoles(PassportSession session, ClientSessionContext clientSessionCtx) {
        return getAndCacheResolvedRoles(session, clientSessionCtx).getResourceAccess();
    }

    private static AccessToken getAndCacheResolvedRoles(PassportSession session, ClientSessionContext clientSessionCtx) {
