...
import org.passport.jose.JOSE;
import org.passport.jose.JOSEParser;
...
import org.passport.protocol.oidc.mappers.LogoutTokenMapper;
...
public class DefaultTokenManager implements TokenManager {
    ...
    public DefaultTokenManager(PassportSession session) {
    ...
    private <T> T verifyJWS(ClientModel client, Class<T> clazz, JWSInput jws) {
        try {
            ...
            if (signatureProvider == null) {
                if (jws.getHeader().getAlgorithm().equals(org.passport.jose.jws.Algorithm.none)) {
