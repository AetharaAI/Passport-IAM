...
package org.passport.connections.httpclient;
...
/**
 * The default {@link HttpClientFactory} for {@link HttpClientProvider HttpClientProvider's} used by Passport for outbound HTTP calls.
 * <p>
...
public class DefaultHttpClientFactory implements HttpClientFactory {
    ...
    private static final String configScope = "passport.connectionsHttpClient.default.";
    ...
    @Override
    public HttpClientProvider create(PassportSession session) {
        lazyInit(session);
