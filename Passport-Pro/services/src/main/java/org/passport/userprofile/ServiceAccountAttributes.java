 ...
 * attributes by setting a {@link org.passport.representations.userprofile.config.UPConfig.UnmanagedAttributePolicy} or
...
public class ServiceAccountAttributes extends DefaultAttributes {
    ...
    public ServiceAccountAttributes(UserProfileContext context, Map<String, ?> attributes, UserModel user,
                                    UserProfileMetadata profileMetadata, PassportSession session) {
