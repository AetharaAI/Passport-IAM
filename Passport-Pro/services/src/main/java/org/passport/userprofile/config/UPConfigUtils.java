 ...
 */
package org.passport.userprofile.config;
...
import org.passport.validate.Validators;

import static org.passport.common.util.ObjectUtil.isBlank;
import static org.passport.userprofile.UserProfileUtil.isRootAttribute;
...
public class UPConfigUtils {
    ...
    private static final String SYSTEM_DEFAULT_CONFIG_RESOURCE = "passport-default-user-profile.json";
     ...
     * <p>
     * Configuration is not validated, use {@link #validate(PassportSession, UPConfig)} to validate it and get list of errors.
     *
     ...
     */
    public static List<String> validate(PassportSession session, UPConfig config) {
    ...
    private static List<String> validateAttributes(PassportSession session, UPConfig config) {
     ...
     */
    private static void validateAttribute(PassportSession session, UPAttribute attributeConfig, Set<String> groups, List<String> errors, Set<String> attNamesCache) {
    ...
    private static void validateDefaultValue(PassportSession session, UPAttribute attributeConfig, List<String> errors) {
    ...
    private static void validateScopes(Set<String> scopes, String propertyName, String attributeName, List<String> errors, PassportSession session) {
        if (scopes == null) {
            return;
        }
     ...
     * @param errors to add error message in if something is invalid
     */
    private static void validateValidationConfig(PassportSession session, String validator, Map<String, Object> validatorConfig, String attributeName, List<String> errors) {
