 ...
 */
package org.passport.authorization.protection.resource;
...
public class ResourceService {
    ...
    public ResourceService(PassportSession session, ResourceServer resourceServer, Identity identity, ResourceSetService resourceManager) {
