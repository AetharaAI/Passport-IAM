...
public class ClientModelIdentity implements Identity {
    ...
    public ClientModelIdentity(PassportSession session, ClientModel client) {
        this(session, client, null);
    }

    public ClientModelIdentity(PassportSession session, ClientModel client, AccessToken token) {
