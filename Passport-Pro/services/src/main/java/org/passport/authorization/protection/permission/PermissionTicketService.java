...
public class PermissionTicketService {
    ...
    public PermissionTicketService(PassportIdentity identity, ResourceServer resourceServer, AuthorizationProvider authorization) {
    ...
    public Response create(PermissionTicketRepresentation representation) {
        ...
        if(representation.getRequester() != null)
            user = this.authorization.getPassportSession().users().getUserById(this.authorization.getRealm(), representation.getRequester());
        else 
            user = this.authorization.getPassportSession().users().getUserByUsername(this.authorization.getRealm(), representation.getRequesterName());
    ...
    private String getUserId(String userIdOrName) {
        UserProvider userProvider = authorization.getPassportSession().users();
