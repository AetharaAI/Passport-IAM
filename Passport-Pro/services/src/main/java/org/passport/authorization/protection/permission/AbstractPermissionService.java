 ...
 */
package org.passport.authorization.protection.permission;
...
public class AbstractPermissionService {
    ...
    public AbstractPermissionService(PassportIdentity identity, ResourceServer resourceServer, AuthorizationProvider authorization) {
    ...
    private String createPermissionTicket(List<PermissionRequest> request) {
        ...
        String audience = Urls.realmIssuer(this.authorization.getPassportSession().getContext().getUri().getBaseUri(), this.authorization.getRealm().getName());
        ...
        return this.authorization.getPassportSession().tokens().encode(token);
    }
}