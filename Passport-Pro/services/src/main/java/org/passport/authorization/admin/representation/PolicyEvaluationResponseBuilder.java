 ...
 */
package org.passport.authorization.admin.representation;
...
import org.passport.authorization.admin.PolicyEvaluationService.EvaluationDecisionCollector;
...
import org.passport.representations.idm.authorization.DecisionEffect;
...
import org.passport.representations.idm.authorization.PolicyEvaluationResponse.PolicyResultRepresentation;
...
public class PolicyEvaluationResponseBuilder {
    public static PolicyEvaluationResponse build(EvaluationDecisionCollector decision, ResourceServer resourceServer, AuthorizationProvider authorization, PassportIdentity identity, PolicyEvaluationRequest request) {
