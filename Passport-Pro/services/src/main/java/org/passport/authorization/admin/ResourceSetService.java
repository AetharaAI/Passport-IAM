...
import static org.passport.models.utils.RepresentationToModel.toModel;
...
public class ResourceSetService {
    ...
    public ResourceSetService(PassportSession session, ResourceServer resourceServer, AuthorizationProvider authorization, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    public Response find(@QueryParam("_id") String id,
        ...
        if (owner != null && !"".equals(owner.trim())) {
            ...
            if (clientModel != null) {
                ...
                UserModel user = authorization.getPassportSession().users().getUserByUsername(realm, owner);
