 ...
 */
package org.passport.authorization.protection.policy;
...
import org.passport.authorization.admin.PermissionService;
import org.passport.authorization.admin.PolicyTypeResourceService;
...
public class UserManagedPermissionService {
    ...
    public UserManagedPermissionService(PassportIdentity identity, ResourceServer resourceServer, AuthorizationProvider authorization, AdminEventBuilder eventBuilder) {
