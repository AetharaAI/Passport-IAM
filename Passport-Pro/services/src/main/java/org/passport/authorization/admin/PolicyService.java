...
public class PolicyService {
    ...
    public Response create(String payload) {
        ...
        audit(representation, representation.getId(), OperationType.CREATE, authorization.getPassportSession());
    ...
    private void audit(AbstractPolicyRepresentation resource, String id, OperationType operation, PassportSession session) {
        if (id != null) {
    ...
    private void checkIfSupportedPolicyType(String type) throws BadRequestException {
        if (AdminPermissionsSchema.SCHEMA.isSupportedPolicyType(authorization.getPassportSession(), resourceServer, type)) {
            return;
        }
