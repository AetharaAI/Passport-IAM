...
public class GeneratedAesKeyProviderFactory extends AbstractGeneratedSecretKeyProviderFactory<AbstractGeneratedSecretKeyProvider> {
    ...
    @Override
    public GeneratedAesKeyProvider create(PassportSession session, ComponentModel model) {
        return new GeneratedAesKeyProvider(model);
    }

    @Override
    public boolean createFallbackKeys(PassportSession session, KeyUse keyUse, String algorithm) {
