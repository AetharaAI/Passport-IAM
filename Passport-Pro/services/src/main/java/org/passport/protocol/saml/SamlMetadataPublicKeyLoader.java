...
public class SamlMetadataPublicKeyLoader extends SamlAbstractMetadataPublicKeyLoader {
    ...
    public SamlMetadataPublicKeyLoader(PassportSession session, String metadataUrl) {
        this(session, metadataUrl, true);
    }

    public SamlMetadataPublicKeyLoader(PassportSession session, String metadataUrl, boolean forIdP) {
        super(forIdP);
