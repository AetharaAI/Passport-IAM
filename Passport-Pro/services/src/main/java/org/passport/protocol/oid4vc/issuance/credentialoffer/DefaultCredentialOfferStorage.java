...
/**
 * Default implementation of {@link CredentialOfferStorage} that uses Passport's
 * {@link org.passport.models.SingleUseObjectProvider} for storage.
 * 
...
class DefaultCredentialOfferStorage implements CredentialOfferStorage {
    ...
    @Override
    public void putOfferState(PassportSession session, CredentialOfferState entry) {
    ...
    @Override
    public CredentialOfferState findOfferStateByNonce(PassportSession session, String nonce) {
    ...
    @Override
    public CredentialOfferState findOfferStateByCode(PassportSession session, String code) {
    ...
    @Override
    public CredentialOfferState findOfferStateByCredentialId(PassportSession session, String credId) {
    ...
    public void replaceOfferState(PassportSession session, CredentialOfferState entry) {
        String entryJson = JsonSerialization.valueAsString(entry);
    ...
    @Override
    public void removeOfferState(PassportSession session, CredentialOfferState entry) {
