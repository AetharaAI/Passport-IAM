...
package org.passport.protocol.saml.profile.ecp;
...
public class SamlEcpProfileService extends SamlService {
    ...
    public SamlEcpProfileService(PassportSession session, EventBuilder event, DestinationValidator destinationValidator) {
