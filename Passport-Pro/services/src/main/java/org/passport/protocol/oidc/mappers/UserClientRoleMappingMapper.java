...
public class UserClientRoleMappingMapper extends AbstractUserRoleMappingMapper {
    ...
    @Override
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, PassportSession session, ClientSessionContext clientSessionCtx) {
