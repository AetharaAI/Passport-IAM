...
package org.passport.protocol.saml.profile.util;
...
public final class Soap {
    ...
    public static class SoapMessageBuilder {
         ...
         * @deprecated Use {@link #call(String,PassportSession)} to use SimpleHttp configuration
         */
        @Deprecated
         ...
         * @throws SOAPException Raised if there's a problem performing the SOAP call
         */
        public SOAPMessage call(String url, PassportSession session) throws SOAPException {
