...
public class ProtocolMapperUtils {
    ...
    public static String getUserModelValue(UserModel user, String propertyName) {
        ...
        // as earlier versions of Passport where applying this behavior.
     ...
     *
     * @param session A PassportSession
     * @return The builtin locale mapper.
     */
    public static ProtocolMapperModel findLocaleMapper(PassportSession session) {
        return session.getPassportSessionFactory().getProviderFactoriesStream(LoginProtocol.class)
    ...
    public static Stream<Entry<ProtocolMapperModel, ProtocolMapper>> getSortedProtocolMappers(PassportSession session, ClientSessionContext ctx) {
        return getSortedProtocolMappers(session, ctx, entry -> true);
    }

    public static Stream<Entry<ProtocolMapperModel, ProtocolMapper>> getSortedProtocolMappers(PassportSession session, ClientSessionContext ctx, Predicate<Entry<ProtocolMapperModel, ProtocolMapper>> filter) {
    ...
    public static boolean isEnabled(PassportSession session, ProtocolMapperModel mapper) {
        return session.getPassportSessionFactory().getProviderFactory(ProtocolMapper.class, mapper.getProtocolMapper()) != null;
    }
}
