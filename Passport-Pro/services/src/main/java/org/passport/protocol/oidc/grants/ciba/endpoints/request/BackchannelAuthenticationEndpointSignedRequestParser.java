...
package org.passport.protocol.oidc.grants.ciba.endpoints.request;
...
class BackchannelAuthenticationEndpointSignedRequestParser extends BackchannelAuthenticationEndpointRequestParser {
    ...
    public BackchannelAuthenticationEndpointSignedRequestParser(PassportSession session, String signedAuthReq, ClientModel client, CibaConfig config) throws Exception {
