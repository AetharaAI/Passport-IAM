...
import static org.passport.protocol.oidc.par.endpoints.ParEndpoint.PAR_CREATED_TIME;
...
public class AuthzEndpointParParser extends AuthzEndpointRequestParser {
    ...
    public AuthzEndpointParParser(PassportSession session, ClientModel client, String requestUri) {
        super(session);
