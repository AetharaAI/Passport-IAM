...
import org.passport.validation.ValidationContext;
...
public class CibaClientValidation {
    ...
    private static boolean isSupportedBackchannelAuthenticationRequestSigningAlg(PassportSession session, String alg) {
