...
import static org.passport.services.util.DefaultClientSessionContext.fromClientSessionAndScopeParameter;
...
public class PreAuthorizedCodeGrantType extends OAuth2GrantTypeBase {
     ...
     */
    @Override
    public boolean isTokenAllowed(PassportSession session, AccessToken token) {
