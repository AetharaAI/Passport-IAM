...
package org.passport.protocol.oidc.encode;
...
import org.passport.protocol.oidc.grants.OAuth2GrantTypeFactory;
...
public class DefaultTokenContextEncoderProviderFactory implements TokenContextEncoderProviderFactory {
    ...
    private PassportSessionFactory sessionFactory;
    ...
    @Override
    public TokenContextEncoderProvider create(PassportSession session) {
