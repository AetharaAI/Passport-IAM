...
import static org.passport.models.ClientSecretConstants.CLIENT_ROTATED_SECRET;
import static org.passport.models.ClientSecretConstants.CLIENT_ROTATED_SECRET_CREATION_TIME;
import static org.passport.models.ClientSecretConstants.CLIENT_ROTATED_SECRET_EXPIRATION_TIME;
import static org.passport.models.ClientSecretConstants.CLIENT_SECRET_AUTHENTICATION_ALLOWED_METHOD;
import static org.passport.models.ClientSecretConstants.CLIENT_SECRET_CREATION_TIME;
import static org.passport.models.ClientSecretConstants.CLIENT_SECRET_EXPIRATION;
import static org.passport.models.ClientSecretConstants.CLIENT_SECRET_REMAINING_EXPIRATION_TIME;
...
public class OIDCClientSecretConfigWrapper extends AbstractClientConfigWrapper {
    ...
    public String getClientRotatedSecret(PassportSession session) {
    ...
    public boolean validateSecret(PassportSession session, String secret) {
    ...
    public boolean validateRotatedSecret(PassportSession session, String secret) {
    ...
    public ReadOnlyRotatedSecretClientModel toRotatedClientModel(PassportSession session) throws InvalidObjectException {
    ...
    public class ReadOnlyRotatedSecretClientModel extends ClientModelLazyDelegate {
        ...
        private ReadOnlyRotatedSecretClientModel(PassportSession session, ClientModel clientModel) {
            super(() -> clientModel);
