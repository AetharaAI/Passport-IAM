...
import org.passport.protocol.oidc.ext.OIDCExtProviderFactory;
...
public class CibaRootEndpoint implements OIDCExtProvider, OIDCExtProviderFactory, EnvironmentDependentProviderFactory {
    ...
    public CibaRootEndpoint(PassportSession session) {
    ...
    /**
     * The callback endpoint used by authentication devices to notify Passport about the end-user authentication status.
     *
     * @return
     */
    @Path("/auth/callback")
    ...
    @Override
    public OIDCExtProvider create(PassportSession session) {
