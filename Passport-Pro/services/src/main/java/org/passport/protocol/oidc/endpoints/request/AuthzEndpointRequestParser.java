 ...
 * {@value org.passport.protocol.oidc.OIDCProviderConfig#DEFAULT_ADDITIONAL_REQ_PARAMS_MAX_NUMBER} parameters with each
 * having a total size of {@value org.passport.protocol.oidc.OIDCProviderConfig#DEFAULT_ADDITIONAL_REQ_PARAMS_MAX_SIZE}.
...
public abstract class AuthzEndpointRequestParser {
    ...
    protected AuthzEndpointRequestParser(PassportSession passportSession) {
        OIDCLoginProtocol loginProtocol = (OIDCLoginProtocol) passportSession.getProvider(LoginProtocol.class, OIDCLoginProtocol.LOGIN_PROTOCOL);
