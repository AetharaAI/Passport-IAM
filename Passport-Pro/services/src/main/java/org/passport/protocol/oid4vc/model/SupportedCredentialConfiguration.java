 ...
 */
package org.passport.protocol.oid4vc.model;
...
public class SupportedCredentialConfiguration {
     ...
     */
    public static SupportedCredentialConfiguration parse(PassportSession passportSession,
        ...
        ProofTypesSupported proofTypesSupported = ProofTypesSupported.parse(passportSession,
        ...
        CredentialMetadata credentialMetadata = CredentialMetadata.parse(passportSession, credentialScope);
        credentialConfiguration.setCredentialMetadata(credentialMetadata);

        CredentialBuildConfig credentialBuildConfig = CredentialBuildConfig.parse(passportSession,
