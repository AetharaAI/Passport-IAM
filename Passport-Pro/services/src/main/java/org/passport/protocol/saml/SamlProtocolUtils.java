...
public class SamlProtocolUtils {
     ...
     */
    public static void verifyDocumentSignature(PassportSession session, ClientModel client, Document document) throws VerificationException {
     ...
     * @throws VerificationException
     */
    public static PublicKey getEncryptionKey(PassportSession session, ClientModel client) throws VerificationException {
     ...
     * @throws VerificationException
     */
    public static PublicKey getEncryptionKey(PassportSession session, SamlClient samlClient) throws VerificationException {
    ...
    public static void setupEncryption(PassportSession session, SamlClient samlClient, BaseSAML2BindingBuilder<?> bindingBuilder) throws VerificationException {
    ...
    public static KeyLocator createKeyLocatorForClient(PassportSession session, ClientModel client, KeyUse use) throws VerificationException {
        return createKeyLocatorForClient(session, new SamlClient(client), use);
    }

    public static KeyLocator createKeyLocatorForClient(PassportSession session, SamlClient samlClient, KeyUse use) throws VerificationException {
