package org.passport.protocol.docker.installation.compose;
...
public class DockerComposeYamlFile {
     ...
     * @param authServerUrl Root URL for Passport, commonly something like http://localhost:8080/auth for dev environments
     * @param realmName Name of the realm for which the docker client is configured
     * @param serviceId Docker's Service ID, corresponds to Passport's client ID
     */
