...
public class BackchannelAuthenticationEndpointRequestParserProcessor {
    ...
    public static BackchannelAuthenticationEndpointRequest parseRequest(EventBuilder event, PassportSession session, ClientModel client, MultivaluedMap<String, String> requestParams, CibaConfig config) {
        try {
