...
import org.passport.protocol.ClientData;
...
import org.passport.protocol.saml.mappers.NameIdMapperHelper;
import org.passport.protocol.saml.mappers.SAMLAttributeStatementMapper;
import org.passport.protocol.saml.mappers.SAMLLoginResponseMapper;
import org.passport.protocol.saml.mappers.SAMLNameIdMapper;
import org.passport.protocol.saml.mappers.SAMLRoleListMapper;
...
import org.passport.saml.SAML2ErrorResponseBuilder;
...
public class SamlProtocol implements LoginProtocol {
    ...
    @Override
    public SamlProtocol setSession(PassportSession session) {
    ...
    public AttributeStatementType populateAttributeStatements(List<ProtocolMapperProcessor<SAMLAttributeStatementMapper>> attributeStatementMappers, PassportSession session, UserSessionModel userSession,
    ...
    public void populateRoles(ProtocolMapperProcessor<SAMLRoleListMapper> roleListMapper, PassportSession session, UserSessionModel userSession,
    ...
    protected String getSAMLNameId(
            List<ProtocolMapperProcessor<SAMLNameIdMapper>> samlNameIdMappers, String nameIdFormat, PassportSession session,
    ...
    public static String getLogoutServiceUrl(PassportSession session, ClientModel client, String bindingType, boolean backChannelLogout) {
        ...
        try {
            ...
            if (!SAML_POST_BINDING.equals(logoutBindingType)) {
                if (samlClient.requiresRealmSignature() && samlClient.addExtensionsElementWithKeyInfo()) {
                    ...
                    String keyName = samlClient.getXmlSigKeyInfoKeyNameTransformer().getKeyName(keys.getKid(), keys.getCertificate());
                    extensions = new NodeGenerator[]{new PassportKeySamlExtensionGenerator(keyName)};
                }
            }
    ...
    private Response artifactRedirect(String redirectUri, String artifact, String relayState) {
        PassportUriBuilder builder = PassportUriBuilder.fromUri(redirectUri)
                .replaceQuery(null)
