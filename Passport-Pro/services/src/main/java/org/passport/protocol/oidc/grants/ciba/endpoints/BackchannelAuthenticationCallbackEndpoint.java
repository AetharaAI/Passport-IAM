...
import org.passport.protocol.oidc.grants.ciba.channel.AuthenticationChannelResponse.Status;
...
public class BackchannelAuthenticationCallbackEndpoint extends AbstractCibaEndpoint {
    ...
    public BackchannelAuthenticationCallbackEndpoint(PassportSession session, EventBuilder event) {
        super(session, event);
