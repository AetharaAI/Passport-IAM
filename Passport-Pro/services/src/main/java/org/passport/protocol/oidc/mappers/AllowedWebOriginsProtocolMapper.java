...
import org.passport.protocol.oidc.utils.WebOriginsUtils;
...
public class AllowedWebOriginsProtocolMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, TokenIntrospectionTokenMapper {
    ...
    private void setWebOrigin(AccessToken token, PassportSession session, ClientSessionContext clientSessionCtx) {
