...
import org.passport.protocol.oid4vc.OID4VCEnvironmentProviderFactory;
import org.passport.protocol.oidc.rar.AuthorizationDetailsProcessorFactory;
...
public class OID4VCAuthorizationDetailsProcessorFactory implements AuthorizationDetailsProcessorFactory, OID4VCEnvironmentProviderFactory {
    ...
    @Override
    public OID4VCAuthorizationDetailsProcessor create(PassportSession session) {
