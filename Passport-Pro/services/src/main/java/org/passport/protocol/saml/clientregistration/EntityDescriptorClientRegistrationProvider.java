...
package org.passport.protocol.saml.clientregistration;
...
import org.passport.protocol.saml.EntityDescriptorDescriptionConverter;
...
public class EntityDescriptorClientRegistrationProvider extends AbstractClientRegistrationProvider {
    ...
    public EntityDescriptorClientRegistrationProvider(PassportSession session) {
        super(session);
    }
