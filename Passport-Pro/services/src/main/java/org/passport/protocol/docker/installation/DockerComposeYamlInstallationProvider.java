...
import org.passport.protocol.docker.installation.compose.DockerComposeZipContent;
...
public class DockerComposeYamlInstallationProvider implements ClientInstallationProvider {
    ...
    public static final String ROOT_DIR = "passport-docker-compose-yaml/";
    ...
    public String getFilename() {
        return "passport-docker-compose-yaml.zip";
    }
