...
import org.passport.services.clientpolicy.context.TokenIntrospectContext;
...
public class TokenIntrospectionEndpoint {
    ...
    public TokenIntrospectionEndpoint(PassportSession session, EventBuilder event) {
    ...
    @POST
    @NoCache
    @Produces({MediaType.APPLICATION_JSON, org.passport.utils.MediaType.APPLICATION_JWT})
