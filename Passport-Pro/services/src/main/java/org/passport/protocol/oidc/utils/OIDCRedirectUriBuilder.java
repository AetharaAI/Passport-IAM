...
public abstract class OIDCRedirectUriBuilder {
    ...
    protected final PassportUriBuilder uriBuilder;

    protected OIDCRedirectUriBuilder(PassportUriBuilder uriBuilder) {
    ...
    public static OIDCRedirectUriBuilder fromUri(String baseUri, OIDCResponseMode responseMode, PassportSession session, AuthenticatedClientSessionModel clientSession) {
        PassportUriBuilder uriBuilder = PassportUriBuilder.fromUri(baseUri);
    ...
    private static class QueryRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        protected QueryRedirectUriBuilder(PassportUriBuilder uriBuilder) {
            super(uriBuilder);
        }
    ...
    private static class FragmentRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        protected FragmentRedirectUriBuilder(PassportUriBuilder uriBuilder) {
            super(uriBuilder);
    ...
    private static class FormPostRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        protected FormPostRedirectUriBuilder(PassportUriBuilder uriBuilder) {
            super(uriBuilder);
        }
    ...
    private static class JWTRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        public JWTRedirectUriBuilder(PassportUriBuilder uriBuilder, OIDCResponseMode responseMode, PassportSession session, AuthenticatedClientSessionModel clientSession) {
            super(uriBuilder);
