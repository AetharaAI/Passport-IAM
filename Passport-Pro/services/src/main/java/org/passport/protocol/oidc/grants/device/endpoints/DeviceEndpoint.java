...
import org.passport.models.OAuth2DeviceUserCodeProvider;
...
import org.passport.protocol.oidc.endpoints.request.AuthorizationEndpointRequestParserProcessor;
import org.passport.protocol.oidc.grants.device.DeviceGrantType;
import org.passport.protocol.oidc.grants.device.clientpolicy.context.DeviceAuthorizationRequestContext;
import org.passport.protocol.oidc.utils.AuthorizeClientUtil;
import org.passport.representations.OAuth2DeviceAuthorizationResponse;
...
import static org.passport.protocol.oidc.grants.device.DeviceGrantType.OAUTH2_DEVICE_USER_CODE;
...
public class DeviceEndpoint extends AuthorizationEndpointBase implements RealmResourceProvider {
    ...
    public DeviceEndpoint(PassportSession session, EventBuilder event) {
        super(session, event);
    ...
    public static OAuth2DeviceCodeModel getDeviceByUserCode(PassportSession session, RealmModel realm, String userCode) {
        SingleUseObjectProvider singleUseStore = session.singleUseObjects();
