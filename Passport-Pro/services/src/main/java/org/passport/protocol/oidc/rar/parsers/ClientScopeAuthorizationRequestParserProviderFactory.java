...
import org.passport.protocol.oidc.rar.AuthorizationRequestParserProviderFactory;
...
public class ClientScopeAuthorizationRequestParserProviderFactory implements AuthorizationRequestParserProviderFactory {
    ...
    @Override
    public AuthorizationRequestParserProvider create(PassportSession session) {
