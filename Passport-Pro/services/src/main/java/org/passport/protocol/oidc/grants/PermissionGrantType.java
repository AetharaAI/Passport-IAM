...
import org.passport.authorization.authorization.AuthorizationTokenService;
...
public class PermissionGrantType extends OAuth2GrantTypeBase {
    ...
    public Response process(Context context) {
        ...
        AuthorizationTokenService.PassportAuthorizationRequest authorizationRequest = new AuthorizationTokenService.PassportAuthorizationRequest(session.getProvider(AuthorizationProvider.class),
