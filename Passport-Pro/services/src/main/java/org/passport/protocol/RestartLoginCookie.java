...
public class RestartLoginCookie implements Token {
    ...
    public static void setRestartCookie(PassportSession session, AuthenticationSessionModel authSession) {
    ...
    public static void expireRestartCookie(PassportSession session) {
        session.getProvider(CookieProvider.class).expire(CookieType.AUTH_RESTART);
    }

    public static String getRestartCookie(PassportSession session){
    ...
    public static AuthenticationSessionModel restartSession(PassportSession session, RealmModel realm,
    ...
    private static RestartLoginCookie decryptAndDecode(PassportSession session, String encodedToken) {
        try {
    ...
    private static String encodeAndEncrypt(PassportSession session, RestartLoginCookie cookie) {
        try {
