...
import org.passport.protocol.oidc.rar.InvalidAuthorizationDetailsException;
...
import static org.passport.protocol.oid4vc.issuance.OID4VCAuthorizationDetailResponse.CLAIMS;
import static org.passport.protocol.oid4vc.issuance.OID4VCAuthorizationDetailResponse.CREDENTIAL_CONFIGURATION_ID;
import static org.passport.protocol.oid4vc.issuance.OID4VCAuthorizationDetailResponse.CREDENTIAL_IDENTIFIERS;
import static org.passport.protocol.oid4vc.model.ClaimsDescription.MANDATORY;
import static org.passport.protocol.oid4vc.model.ClaimsDescription.PATH;
...
public class OID4VCAuthorizationDetailsProcessor implements AuthorizationDetailsProcessor<OID4VCAuthorizationDetailResponse> {
    ...
    public OID4VCAuthorizationDetailsProcessor(PassportSession session) {
     ...
     * This performs semantic validation by checking if Passport supports the requested claims.
     *
