...
package org.passport.protocol.oid4vc.issuance.signing;
...
import org.passport.protocol.oid4vc.issuance.signing.vcdm.LinkedDataCryptographicSuite;
...
public class LDCredentialSigner extends AbstractCredentialSigner<VerifiableCredential> {
    ...
    public LDCredentialSigner(PassportSession passportSession, TimeProvider timeProvider) {
