 ...
 */
package org.passport.protocol.oidc.par.endpoints.request;
...
import org.passport.protocol.oidc.endpoints.request.AuthzEndpointQueryStringParser;
...
public class ParEndpointRequestParserProcessor {
    ...
    public static AuthorizationEndpointRequest parseRequest(EventBuilder event, PassportSession session, ClientModel client, MultivaluedMap<String, String> requestParams) {
        try {
