...
public class CredentialRequest {
    ...
    public Optional<CredentialScopeModel> findCredentialScope(PassportSession passportSession) {
        ...
        RealmModel currentRealm = passportSession.getContext().getRealm();
        final boolean useOrExpression = false;
        return passportSession.clientScopes()
