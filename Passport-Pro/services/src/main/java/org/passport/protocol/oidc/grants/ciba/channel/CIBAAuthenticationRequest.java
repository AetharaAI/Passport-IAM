...
public class CIBAAuthenticationRequest extends JsonWebToken {
     ...
     * @throws Exception
     */
    public static CIBAAuthenticationRequest deserialize(PassportSession session, String jwe) {
    ...
    public CIBAAuthenticationRequest(PassportSession session, UserModel user, ClientModel client) {
        ...
        setAuthResultId(PassportModelUtils.generateId());
        setClient(client);
        setUser(user);
    }
     ...
     * @return the JWE
     */
    public String serialize(PassportSession session) {
        try {
