...
import org.passport.protocol.oidc.endpoints.request.RequestUriType;
...
import org.passport.services.clientpolicy.context.PreAuthorizationRequestContext;
...
import static org.passport.protocol.oidc.par.endpoints.ParEndpoint.PAR_DPOP_PROOF_JKT;
...
public class AuthorizationEndpoint extends AuthorizationEndpointBase {
    ...
    public AuthorizationEndpoint(PassportSession session, EventBuilder event) {
        super(session, event);
