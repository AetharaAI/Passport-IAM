...
public class RoleListMapper extends AbstractSAMLProtocolMapper implements SAMLRoleListMapper {
    ...
    @Override
    public void mapRoles(AttributeStatementType roleAttributeStatement, ProtocolMapperModel mappingModel, PassportSession session, UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
