...
import org.passport.protocol.docker.mapper.DockerAuthV2AttributeMapper;
import org.passport.representations.docker.DockerResponse;
...
public class DockerAuthV2Protocol implements LoginProtocol {
    ...
    public DockerAuthV2Protocol(final PassportSession session, final RealmModel realm, final UriInfo uriInfo, final HttpHeaders headers, final EventBuilder event) {
    ...
    @Override
    public LoginProtocol setSession(final PassportSession session) {
        this.session = session;
        return this;
    }
