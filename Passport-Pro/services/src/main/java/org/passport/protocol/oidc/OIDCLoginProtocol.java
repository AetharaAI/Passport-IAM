...
import org.passport.TokenIdGenerator;
...
import org.passport.services.clientpolicy.context.ImplicitHybridTokenResponse;
...
import static org.passport.protocol.oidc.grants.device.DeviceGrantType.approveOAuth2DeviceAuthorization;
import static org.passport.protocol.oidc.grants.device.DeviceGrantType.denyOAuth2DeviceAuthorization;
...
public class OIDCLoginProtocol implements LoginProtocol {
    ...
    /**
     * This is just for legacy setups which expect an unencoded, non-RFC6749 compliant client secret send from Passport to an IdP.
     */
    ...
    public OIDCLoginProtocol(PassportSession session, RealmModel realm, UriInfo uriInfo, HttpHeaders headers, EventBuilder event) {
    ...
    @Override
    public OIDCLoginProtocol setSession(PassportSession session) {
        this.session = session;
        return this;
    }
    ...
    public Response authenticated(AuthenticationSessionModel authSession, UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
        ...
        if (responseType.isImplicitOrHybridFlow()) {
            org.passport.protocol.oidc.TokenManager tokenManager = new org.passport.protocol.oidc.TokenManager();
            org.passport.protocol.oidc.TokenManager.AccessTokenResponseBuilder responseBuilder = tokenManager.responseBuilder(realm, clientSession.getClient(), event, session, userSession, clientSessionCtx)
                .generateAccessToken();
     ...
     *
     * @see https://github.com/passport/passport/issues/31086
     */
