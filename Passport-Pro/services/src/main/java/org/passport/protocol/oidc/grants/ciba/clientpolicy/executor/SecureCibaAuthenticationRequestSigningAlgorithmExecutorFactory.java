...
import org.passport.services.clientpolicy.executor.ClientPolicyExecutorProviderFactory;
...
public class SecureCibaAuthenticationRequestSigningAlgorithmExecutorFactory implements ClientPolicyExecutorProviderFactory {
    ...
    @Override
    public ClientPolicyExecutorProvider create(PassportSession session) {
