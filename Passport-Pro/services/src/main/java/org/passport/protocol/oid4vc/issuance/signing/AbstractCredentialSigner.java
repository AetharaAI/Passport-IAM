...
public abstract class AbstractCredentialSigner<T> implements CredentialSigner<T> {
    ...
    protected AbstractCredentialSigner(PassportSession passportSession) {
    ...
    protected SignatureSignerContext getSigner(CredentialBuildConfig credentialBuildConfig) {
        ...
        SignatureProvider signatureProvider = passportSession
     ...
     * Additionally, the function clones the key retrieved from Passport, replacing the original
    ...
    protected KeyWrapper getKey(String keyId, String algorithm) {
        ...
        KeyManager keys = passportSession.keys();
