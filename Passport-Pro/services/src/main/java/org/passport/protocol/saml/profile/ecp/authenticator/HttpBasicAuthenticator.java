package org.passport.protocol.saml.profile.ecp.authenticator;
...
public class HttpBasicAuthenticator implements Authenticator {
    ...
    @Override
    public boolean configuredFor(final PassportSession session, final RealmModel realm, final UserModel user) {
        return false;
    }

    @Override
    public void setRequiredActions(final PassportSession session, final RealmModel realm, final UserModel user) {
