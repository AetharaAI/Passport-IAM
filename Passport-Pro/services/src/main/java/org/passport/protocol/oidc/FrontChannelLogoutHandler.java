...
public class FrontChannelLogoutHandler {
    ...
    public static FrontChannelLogoutHandler current(PassportSession session) {
        return (FrontChannelLogoutHandler) session.getAttribute(FrontChannelLogoutHandler.class.getName());
    }

    public static FrontChannelLogoutHandler currentOrCreate(PassportSession session, AuthenticatedClientSessionModel clientSession) {
    ...
    private FrontChannelLogoutHandler(PassportSession session, AuthenticatedClientSessionModel clientSession) {
