...
public class AttestationProofValidatorFactory implements ProofValidatorFactory {
    ...
    @Override
    public ProofValidator create(PassportSession session) {
     ...
     */
    private Map<String, JWK> loadTrustedKeysFromRealm(PassportSession session) {
    ...
    /**
     * Loads keys from Passport session by reusing JWKSServerUtils.getRealmJwks().
     ...
     */
    private Map<String, JWK> loadKeysFromSession(PassportSession session, RealmModel realm) {
        try {
     ...
     */
    private Map<String, JWK> loadKeysByKeyIds(PassportSession session, RealmModel realm) {
