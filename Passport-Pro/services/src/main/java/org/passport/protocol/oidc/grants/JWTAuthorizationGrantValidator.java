...
import org.passport.authentication.authenticators.client.AbstractBaseJWTValidator;
import org.passport.authentication.authenticators.client.ClientAssertionState;
...
public class JWTAuthorizationGrantValidator extends AbstractBaseJWTValidator implements JWTAuthorizationGrantValidationContext {
    ...
    public static JWTAuthorizationGrantValidator createValidator(PassportSession session, ClientModel client, String assertion, String scope) {
        if (assertion == null) {
    ...
    private JWTAuthorizationGrantValidator(PassportSession session, String scope, ClientAssertionState clientAssertionState) {
