...
public class AccessTokenContext {
    ...
    public enum SessionType {
        ...
        // Unknown type. Perhaps token coming from older Passport version than 26.2.0. No need to support transientClientSession as this was added in 26.2 with standard token-exchange
