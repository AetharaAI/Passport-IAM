...
public class AuthzEndpointQueryStringParser extends AuthzEndpointRequestParser {
    ...
    public AuthzEndpointQueryStringParser(PassportSession passportSession, MultivaluedMap<String, String> requestParams, boolean isResponseTypeParameterRequired) {
