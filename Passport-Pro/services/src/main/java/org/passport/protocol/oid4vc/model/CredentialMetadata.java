...
public class CredentialMetadata {
     ...
     *
     * @param passportSession The Passport session
     ...
     */
    public static CredentialMetadata parse(PassportSession passportSession, CredentialScopeModel credentialScope) {
        ...
        Claims formatSpecificClaims = Claims.parse(passportSession, credentialScope);
