...
public class OAuth2CodeParser {
     ...
     */
    public static String persistCode(PassportSession session, AuthenticatedClientSessionModel clientSession, OAuth2Code codeData) {
     ...
     */
    public static ParseResult parseCode(PassportSession session, String code, RealmModel realm, EventBuilder event) {
