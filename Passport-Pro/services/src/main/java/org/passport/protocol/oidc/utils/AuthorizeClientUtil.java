...
public class AuthorizeClientUtil {
    ...
    public static ClientAuthResult authorizeClient(PassportSession session, EventBuilder event, Cors cors) {
    ...
    public static AuthenticationProcessor getAuthenticationProcessor(PassportSession session, EventBuilder event) {
    ...
    public static ClientAuthenticatorFactory findClientAuthenticatorForOIDCAuthMethod(PassportSession session, String oidcAuthMethod) {
