 ...
 */
package org.passport.protocol.oidc.grants.ciba.endpoints;
...
import org.passport.protocol.oidc.grants.ciba.channel.AuthenticationChannelProvider;
import org.passport.protocol.oidc.grants.ciba.channel.CIBAAuthenticationRequest;
import org.passport.protocol.oidc.grants.ciba.clientpolicy.context.BackchannelAuthenticationRequestContext;
import org.passport.protocol.oidc.grants.ciba.endpoints.request.BackchannelAuthenticationEndpointRequest;
import org.passport.protocol.oidc.grants.ciba.endpoints.request.BackchannelAuthenticationEndpointRequestParserProcessor;
import org.passport.protocol.oidc.grants.ciba.resolvers.CIBALoginUserResolver;
...
import static org.passport.protocol.oidc.OIDCLoginProtocol.ID_TOKEN_HINT;
...
public class BackchannelAuthenticationEndpoint extends AbstractCibaEndpoint {
    ...
    public BackchannelAuthenticationEndpoint(PassportSession session, EventBuilder event) {
        super(session, event);
