...
import static org.passport.protocol.oidc.mappers.OIDCAttributeMapperHelper.INCLUDE_IN_ID_TOKEN;
...
public abstract class AbstractOIDCProtocolMapper implements ProtocolMapper {
    ...
    @Override
    public final ProtocolMapper create(PassportSession session) {
    ...
    public static boolean getShouldUseLightweightToken(PassportSession session) {
     ...
     * @param mappingModel
     * @param userSession
     * @deprecated override {@link #setClaim(IDToken, ProtocolMapperModel, UserSessionModel, PassportSession, ClientSessionContext)} instead.
     */
    @Deprecated
     ...
     * @param mappingModel
     * @param userSession
     * @param passportSession
     * @param clientSessionCtx
     */
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, PassportSession passportSession,
                            ClientSessionContext clientSessionCtx) {
     ...
     * @param clientSessionCtx
     */
    protected void setClaim(AccessTokenResponse accessTokenResponse, ProtocolMapperModel mappingModel, UserSessionModel userSession, PassportSession passportSession,
                            ClientSessionContext clientSessionCtx) {

    }

    @Override
    public ProtocolMapperModel getEffectiveModel(PassportSession session, RealmModel realm, ProtocolMapperModel protocolMapperModel) {
        // Effectively clone
