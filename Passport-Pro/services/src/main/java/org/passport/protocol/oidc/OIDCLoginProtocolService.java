...
import org.passport.protocol.oidc.endpoints.LoginStatusIframeEndpoint;
import org.passport.protocol.oidc.endpoints.LogoutEndpoint;
import org.passport.protocol.oidc.endpoints.ThirdPartyCookiesIframeEndpoint;
import org.passport.protocol.oidc.endpoints.TokenEndpoint;
import org.passport.protocol.oidc.endpoints.TokenRevocationEndpoint;
import org.passport.protocol.oidc.endpoints.UserInfoEndpoint;
import org.passport.protocol.oidc.ext.OIDCExtProvider;
...
public class OIDCLoginProtocolService {
    ...
    public OIDCLoginProtocolService(PassportSession session, EventBuilder event) {
    ...
    @GET
    @Path("certs")
    @Produces({MediaType.APPLICATION_JSON, org.passport.utils.MediaType.APPLICATION_JWKS})
    @NoCache
    public Response certs() {
        ...
        boolean isJwksRequest = org.passport.utils.MediaType.APPLICATION_JWKS.equals(this.headers.getHeaderString(HttpHeaders.ACCEPT));
        if (isJwksRequest) {
            responseBuilder.header(CONTENT_TYPE, org.passport.utils.MediaType.APPLICATION_JWKS);
        } else {
