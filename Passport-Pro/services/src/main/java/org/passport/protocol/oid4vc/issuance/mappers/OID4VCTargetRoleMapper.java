...
package org.passport.protocol.oid4vc.issuance.mappers;
...
import org.passport.protocol.oid4vc.model.Role;
...
public class OID4VCTargetRoleMapper extends OID4VCMapper {
	...
	public OID4VCTargetRoleMapper(PassportSession passportSession) {
	...
	@Override
	public ProtocolMapper create(PassportSession session) {
