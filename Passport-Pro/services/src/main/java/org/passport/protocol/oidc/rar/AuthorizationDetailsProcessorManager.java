...
public class AuthorizationDetailsProcessorManager {
    ...
    public List<AuthorizationDetailsJSONRepresentation> processAuthorizationDetails(PassportSession session, UserSessionModel userSession, ClientSessionContext clientSessionCtx,
    ...
    public List<AuthorizationDetailsJSONRepresentation> processStoredAuthorizationDetails(PassportSession session, UserSessionModel userSession,
    ...
    public List<AuthorizationDetailsJSONRepresentation> handleMissingAuthorizationDetails(PassportSession session, UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
    ...
    private List<AuthorizationDetailsJSONRepresentation> processAuthzDetailsImpl(PassportSession session, String authorizationDetailsParam,
    ...
    private Map<String, AuthorizationDetailsProcessor<?>> getProcessors(PassportSession session) {
        return session.getPassportSessionFactory()
                .getProviderFactoriesStream(AuthorizationDetailsProcessor.class)
