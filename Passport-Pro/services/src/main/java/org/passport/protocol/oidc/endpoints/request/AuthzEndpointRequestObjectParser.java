...
public class AuthzEndpointRequestObjectParser extends AuthzEndpointRequestParser {
    ...
    public AuthzEndpointRequestObjectParser(PassportSession session, String requestObject, ClientModel client) {
        super(session);
    ...
    private BiConsumer<JOSE, ClientModel> createRequestObjectValidator(PassportSession session) {
