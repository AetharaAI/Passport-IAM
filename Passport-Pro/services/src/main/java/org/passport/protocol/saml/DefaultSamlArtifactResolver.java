...
import static org.passport.protocol.saml.DefaultSamlArtifactResolverFactory.TYPE_CODE;
import static org.passport.protocol.saml.SamlConfigAttributes.SAML_ARTIFACT_BINDING_IDENTIFIER;
...
public class DefaultSamlArtifactResolver implements ArtifactResolver {
    ...
    @Override
    public ClientModel selectSourceClient(PassportSession session, String artifact) throws ArtifactResolverProcessingException {
