...
public class SamlSessionUtils {
    ...
    public static AuthenticatedClientSessionModel getClientSession(PassportSession session, RealmModel realm, String sessionIndex) {
    ...
    public static Iterator<SamlAuthenticationPreprocessor> getSamlAuthenticationPreprocessorIterator(PassportSession session) {
        return session.getPassportSessionFactory().getProviderFactoriesStream(SamlAuthenticationPreprocessor.class)
