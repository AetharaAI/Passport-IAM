...
public class PairwiseSubMapperValidator {
    ...
    public static void validate(PassportSession session, ClientModel client, ProtocolMapperModel mapperModel) throws ProtocolMapperConfigException {
    ...
    public static void validate(PassportSession session, String rootUrl, Set<String> redirectUris, String sectorIdentifierUri) throws ProtocolMapperConfigException {
    ...
    private static void validateSectorIdentifierUri(PassportSession session, String rootUrl, Set<String> redirectUris, String sectorIdentifierUri) throws ProtocolMapperConfigException {
    ...
    private static Set<String> getSectorRedirects(PassportSession session, String sectorIdentifierUri) throws ProtocolMapperConfigException {
        try {
