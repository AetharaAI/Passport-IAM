...
package org.passport.protocol.oidc.endpoints.request;
...
import org.passport.protocol.oidc.par.endpoints.request.AuthzEndpointParParser;
...
public class AuthorizationEndpointRequestParserProcessor {
    ...
    public static AuthorizationEndpointRequest parseRequest(EventBuilder event, PassportSession session, ClientModel client, MultivaluedMap<String, String> requestParams, EndpointType endpointType) {
        try {
    ...
    public static String getClientId(EventBuilder event, PassportSession session, MultivaluedMap<String, String> requestParams) {
