...
import org.passport.broker.oidc.AbstractOAuth2IdentityProvider;
...
public class OpenshiftV4IdentityProvider extends AbstractOAuth2IdentityProvider<OpenshiftV4IdentityProviderConfig> implements SocialIdentityProvider<OpenshiftV4IdentityProviderConfig> {
    ...
    public OpenshiftV4IdentityProvider(PassportSession session, OpenshiftV4IdentityProviderConfig config) {
    ...
    Map<String, Object> getAuthJson(PassportSession session, String baseUrl) {
        try {
    ...
    InputStream getOauthMetadataInputStream(PassportSession session, String baseUrl) throws IOException {
