 ...
 */
package org.passport.social.twitter;
...
public class TwitterIdentityProvider extends AbstractIdentityProvider<OAuth2IdentityProviderConfig> implements
    ...
    public TwitterIdentityProvider(PassportSession session, OAuth2IdentityProviderConfig config) {
    ...
    protected static class Endpoint {
        ...
        public Endpoint(PassportSession session, AuthenticationCallback callback, EventBuilder event, TwitterIdentityProvider provider) {
