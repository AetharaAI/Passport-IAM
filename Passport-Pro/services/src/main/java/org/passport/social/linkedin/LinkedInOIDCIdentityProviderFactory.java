...
public class LinkedInOIDCIdentityProviderFactory extends AbstractIdentityProviderFactory<LinkedInOIDCIdentityProvider> implements SocialIdentityProviderFactory<LinkedInOIDCIdentityProvider> {
    ...
    @Override
    public LinkedInOIDCIdentityProvider create(PassportSession session, IdentityProviderModel model) {
    ...
    private static OIDCConfigurationRepresentation getWellKnownMetadata(PassportSession session) {
