...
public class WebAuthnCredentialModelInput implements CredentialInput {
    ...
    private PassportWebAuthnAuthenticationParameters authenticationParameters; // not persisted because it can only be used on authentication operation.
    ...
    public PassportWebAuthnAuthenticationParameters getAuthenticationParameters() {
        return authenticationParameters;
    }

    public void setAuthenticationParameters(PassportWebAuthnAuthenticationParameters authenticationParameters) {
    ...
    public static class PassportWebAuthnAuthenticationParameters{

        private final ServerProperty serverProperty;
        private final boolean userVerificationRequired;

        public PassportWebAuthnAuthenticationParameters(ServerProperty serverProperty, boolean userVerificationRequired) {
