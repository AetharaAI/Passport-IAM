...
import org.passport.models.credential.dto.WebAuthnCredentialPresentationData;
...
public class WebAuthnCredentialProvider implements CredentialProvider<WebAuthnCredentialModel>, CredentialInputValidator {
    ...
    public WebAuthnCredentialProvider(PassportSession session, WebAuthnMetadataService metadataService, ObjectConverter objectConverter) {
    ...
    protected PassportSession getPassportSession() {
        return session;
    }
    @Override
