...
public class PasswordCredentialProviderFactory implements CredentialProviderFactory<PasswordCredentialProvider> {
    public static final String PROVIDER_ID = "passport-password";
    private static final String HASHES_COUNTER_TAGS = "validations-counter-tags";
    private static final String PASSPORT_METER_NAME_PREFIX = "passport.";
    private static final String LOGIN_PASSWORD_VERIFY_METER_NAME = PASSPORT_METER_NAME_PREFIX + "credentials.password.hashing";
    ...
    @Override
    public PasswordCredentialProvider create(PassportSession session) {
