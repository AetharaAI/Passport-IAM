...
public class CryptoUtils {
    ...
    public static List<String> getSupportedAsymmetricSignatureAlgorithms(PassportSession session) {
        return session.getPassportSessionFactory().getProviderFactoriesStream(SignatureProvider.class)
     ...
     * @return List of asymmetric signature algorithm names
     */
    public static List<String> getSupportedAsymmetricEncryptionAlgorithms(PassportSession session) {
        return session.keys()
