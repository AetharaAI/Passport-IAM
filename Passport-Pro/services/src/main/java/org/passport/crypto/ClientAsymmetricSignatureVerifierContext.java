...
public class ClientAsymmetricSignatureVerifierContext extends AsymmetricSignatureVerifierContext {
    ...
    public ClientAsymmetricSignatureVerifierContext(PassportSession session, ClientModel client, JWSInput input) throws VerificationException {
        super(getKey(session, client, input));
    }

    private static KeyWrapper getKey(PassportSession session, ClientModel client, JWSInput input) throws VerificationException {
