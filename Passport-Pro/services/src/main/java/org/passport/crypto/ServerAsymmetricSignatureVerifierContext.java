...
public class ServerAsymmetricSignatureVerifierContext extends AsymmetricSignatureVerifierContext {
    ...
    public ServerAsymmetricSignatureVerifierContext(PassportSession session, String kid, String algorithm) throws VerificationException {
    ...
    static KeyWrapper getKey(PassportSession session, String kid, String algorithm) throws VerificationException {
