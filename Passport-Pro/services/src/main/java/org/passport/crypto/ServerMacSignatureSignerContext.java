...
public class ServerMacSignatureSignerContext extends MacSignatureSignerContext {
    ...
    public ServerMacSignatureSignerContext(PassportSession session, String algorithm) throws SignatureException {
    ...
    private static KeyWrapper getKey(PassportSession session, String algorithm) {
