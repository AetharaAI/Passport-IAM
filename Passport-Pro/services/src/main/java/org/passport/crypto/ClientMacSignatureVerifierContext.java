...
public class ClientMacSignatureVerifierContext extends MacSignatureVerifierContext {
    ...
    public ClientMacSignatureVerifierContext(PassportSession session, ClientModel client, String algorithm) throws VerificationException {
        super(getKey(session, client, algorithm));
    }

    private static KeyWrapper getKey(PassportSession session, ClientModel client, String algorithm) throws VerificationException {
