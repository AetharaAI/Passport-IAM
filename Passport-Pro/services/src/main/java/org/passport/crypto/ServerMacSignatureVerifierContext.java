...
public class ServerMacSignatureVerifierContext extends MacSignatureVerifierContext {
    ...
    public ServerMacSignatureVerifierContext(PassportSession session, String kid, String algorithm) throws VerificationException {
    ...
    private static KeyWrapper getKey(PassportSession session, String kid, String algorithm) throws VerificationException {
