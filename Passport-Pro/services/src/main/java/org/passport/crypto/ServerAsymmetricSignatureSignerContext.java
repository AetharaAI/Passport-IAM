...
public class ServerAsymmetricSignatureSignerContext extends AsymmetricSignatureSignerContext {
    ...
    public ServerAsymmetricSignatureSignerContext(PassportSession session, String algorithm) throws SignatureException {
    ...
    static KeyWrapper getKey(PassportSession session, String algorithm) {
