...
public class WebAuthnConditionalUIAuthenticator extends WebAuthnPasswordlessAuthenticator {
    ...
    public WebAuthnConditionalUIAuthenticator(PassportSession session, Function<AuthenticationFlowContext, Response> errorChallenge) {
        super(session);
    ...
    static public boolean isPasskeysEnabled(PassportSession session) {
