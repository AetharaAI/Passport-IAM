...
public class FormAuthenticationFlow implements AuthenticationFlow {
    ...
    public Response processAction(String actionExecution) {
        ...
        for (AuthenticationExecutionModel formActionExecution : formActionExecutions) {
            ...
            FormActionFactory factory = (FormActionFactory)processor.getSession().getPassportSessionFactory().getProviderFactory(FormAction.class, formActionExecution.getAuthenticator());
    ...
    public Response processFlow() {
        ...
        // PASSPORT-16143: Propagate forwarded error messages if present
