...
import org.passport.scripting.InvocableScriptAdapter;
import org.passport.scripting.ScriptExecutionException;
 ...
 * <li>{@code session} the active {@link PassportSession}</li>
 * <li>{@code authenticationSession} the current {@link org.passport.sessions.AuthenticationSessionModel}</li>
 * <li>{@code httpRequest} the current {@link org.passport.http.HttpRequest}</li>
