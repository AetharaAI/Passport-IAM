...
import static org.passport.authentication.authenticators.browser.AbstractUsernameFormAuthenticator.USER_SET_BEFORE_USERNAME_PASSWORD_AUTH;
...
public final class AuthenticatorUtils {
    ...
    public static String getDisabledByBruteForceEventError(BruteForceProtector protector, PassportSession session, RealmModel realm, UserModel user) {
