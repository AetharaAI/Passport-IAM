...
import org.passport.authentication.AbstractFormAuthenticator;
...
import static org.passport.services.validation.Validation.FIELD_PASSWORD;
...
public abstract class AbstractUsernameFormAuthenticator extends AbstractFormAuthenticator {
    ...
    private UserModel getUserFromForm(AuthenticationFlowContext context, MultivaluedMap<String, String> inputData) {
        ...
        UserModel user = null;
        try {
            user = PassportModelUtils.findUserByNameOrEmail(context.getSession(), context.getRealm(), username);
