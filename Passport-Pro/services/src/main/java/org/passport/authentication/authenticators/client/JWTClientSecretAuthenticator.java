...
import static org.passport.models.TokenManager.DEFAULT_VALIDATOR;
 ...
 * org.passport.adapters.authentication.JWTClientSecretCredentialsProvider
 * <p>
 */
public class JWTClientSecretAuthenticator extends AbstractClientAuthenticator {
    ...
    public Map<String, Object> getAdapterConfiguration(PassportSession session, ClientModel client) {
        // e.g. client adapter's passport.json
        // "credentials": {
        //   "secret-jwt": {
