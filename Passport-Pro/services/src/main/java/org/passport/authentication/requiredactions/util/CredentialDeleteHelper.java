...
package org.passport.authentication.requiredactions.util;
...
public class CredentialDeleteHelper {
     ...
     */
    public static CredentialModel removeCredential(PassportSession session, UserModel user, String credentialId, Supplier<Integer> currentLoAProvider) {
    ...
    private static void checkIfCanBeRemoved(PassportSession session, UserModel user, String credentialType, Supplier<Integer> currentLoAProvider) {
    ...
    private static void checkAuthenticatedLoASufficientForCredentialRemove(PassportSession session, String credentialType, Supplier<Integer> currentLoAProvider) {
    ...
    private static int getRequestedLoaForCredential(PassportSession session, RealmModel realm, String credentialType) {
