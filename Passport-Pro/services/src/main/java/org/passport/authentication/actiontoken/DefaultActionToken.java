...
package org.passport.authentication.actiontoken;
...
import org.passport.models.SingleUseObjectValueModel;
...
public class DefaultActionToken extends DefaultActionTokenKey implements SingleUseObjectValueModel {
     ...
     * @param absoluteExpirationInSecs Absolute expiration time in seconds in timezone of Passport.
     ...
     * @return
     */
    public String serialize(PassportSession session, RealmModel realm, UriInfo uri) {
