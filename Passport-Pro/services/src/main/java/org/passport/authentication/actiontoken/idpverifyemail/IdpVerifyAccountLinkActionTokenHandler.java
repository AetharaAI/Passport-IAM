 ...
 */
package org.passport.authentication.actiontoken.idpverifyemail;
...
import org.passport.authentication.authenticators.broker.IdpEmailVerificationAuthenticator;
...
public class IdpVerifyAccountLinkActionTokenHandler extends AbstractActionTokenHandler<IdpVerifyAccountLinkActionToken> {
    ...
    public Response handleToken(IdpVerifyAccountLinkActionToken token, ActionTokenContext<IdpVerifyAccountLinkActionToken> tokenContext) {
        ...
        final PassportSession session = tokenContext.getSession();
    ...
    private void setUserVerifiedSingleObject(IdpVerifyAccountLinkActionToken token, RealmModel realm, PassportSession session, UserModel user) {
    ...
    public static boolean runIfUserVerified(PassportSession session, UserModel user, IdentityProviderModel broker, Runnable runnable) {
        if (user == null) {
            return false;
        }
    ...
    private Response sendEmailAlreadyVerified(PassportSession session, EventBuilder event, UserModel user) {
