...
import org.passport.authentication.actiontoken.DefaultActionToken;
...
import static org.passport.services.managers.AuthenticationManager.FORCED_REAUTHENTICATION;
import static org.passport.services.managers.AuthenticationManager.PASSWORD_VALIDATED;
import static org.passport.services.managers.AuthenticationManager.SSO_AUTH;
...
public class AuthenticatorUtil {
    ...
    private static void logoutOtherSessions(PassportSession session, RealmModel realm, UserModel user,
    ...
    private static void backchannelLogout(PassportSession session, RealmModel realm, ClientConnection conn, HttpRequest req, EventBuilder event, UserSessionModel s) {
     ...
     */
    public static Stream<CredentialProvider> getCredentialProviders(PassportSession session) {
