...
public class IdpCreateUserIfUniqueAuthenticatorFactory implements AuthenticatorFactory {
    ...
    public String getHelpText() {
        return "Detect if there is existing Passport account with same email like identity provider. If no, create new user";
    }
    ...
    static {
        ...
        property.setHelpText("If this option is true and new user is successfully imported from Identity Provider to Passport (there is no duplicated email or username detected in Passport DB), then this user is required to update his password");
