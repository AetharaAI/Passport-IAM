...
import static org.passport.utils.CredentialHelper.createRecoveryCodesCredential;
...
public class RecoveryAuthnCodesAction implements RequiredActionProvider, RequiredActionFactory, EnvironmentDependentProviderFactory, CredentialRegistrator {
    ...
    @Override
    public void validateConfig(PassportSession session, RealmModel realm, RequiredActionConfigModel model) {
