...
import org.passport.authentication.actiontoken.idpverifyemail.IdpVerifyAccountLinkActionToken;
...
public class IdpEmailVerificationAuthenticator extends AbstractIdpAuthenticator {
    ...
    private void sendVerifyEmail(PassportSession session, AuthenticationFlowContext context, UserModel existingUser, BrokeredIdentityContext brokerContext) throws UriBuilderException, IllegalArgumentException {
