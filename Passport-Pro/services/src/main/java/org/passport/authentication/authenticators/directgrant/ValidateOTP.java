...
package org.passport.authentication.authenticators.directgrant;
...
public class ValidateOTP extends AbstractDirectGrantAuthenticator implements CredentialValidator<OTPCredentialProvider> {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        // PASSPORT-12908 Backwards compatibility. If paramter "otp" is null, then assign "totp".
    ...
    public OTPCredentialProvider getCredentialProvider(PassportSession session) {
        return (OTPCredentialProvider)session.getProvider(CredentialProvider.class, "passport-otp");
    }
