...
import org.passport.credential.WebAuthnCredentialModelInput;
import org.passport.credential.WebAuthnCredentialProvider;
import org.passport.credential.WebAuthnCredentialProviderFactory;
import org.passport.events.Details;
import org.passport.events.Errors;
import org.passport.forms.login.LoginFormsProvider;
import org.passport.forms.login.freemarker.model.WebAuthnAuthenticatorsBean;
...
import static org.passport.WebAuthnConstants.AUTH_ERR_DETAIL_LABEL;
import static org.passport.WebAuthnConstants.AUTH_ERR_LABEL;
import static org.passport.services.messages.Messages.WEBAUTHN_ERROR_API_GET;
import static org.passport.services.messages.Messages.WEBAUTHN_ERROR_AUTH_VERIFICATION;
import static org.passport.services.messages.Messages.WEBAUTHN_ERROR_DIFFERENT_USER;
import static org.passport.services.messages.Messages.WEBAUTHN_ERROR_REGISTRATION;
import static org.passport.services.messages.Messages.WEBAUTHN_ERROR_USER_NOT_FOUND;
...
public class WebAuthnAuthenticator implements Authenticator, CredentialValidator<WebAuthnCredentialProvider> {
    ...
    public WebAuthnAuthenticator(PassportSession session) {
    ...
    public void action(AuthenticationFlowContext context) {
        ...
        WebAuthnCredentialModelInput.PassportWebAuthnAuthenticationParameters authenticationParameters = new WebAuthnCredentialModelInput.PassportWebAuthnAuthenticationParameters(
                server,
                isUVFlagChecked
                );
    ...
    public List<RequiredActionFactory> getRequiredActions(PassportSession session) {
        return Collections.singletonList((WebAuthnRegisterFactory)session.getPassportSessionFactory().getProviderFactory(RequiredActionProvider.class, WebAuthnRegisterFactory.PROVIDER_ID));
    }
    ...
    @Override
    public WebAuthnCredentialProvider getCredentialProvider(PassportSession session) {
