...
public class ClientAuthenticationFlow implements AuthenticationFlow {
    ...
    public Response processFlow() {
        ...
        for (AuthenticationExecutionModel model : executions) {
            ClientAuthenticatorFactory factory = (ClientAuthenticatorFactory) processor.getSession().getPassportSessionFactory().getProviderFactory(ClientAuthenticator.class, model.getAuthenticator());
            if (factory == null) {
            ...
            if (client != null) {
                ...
                if (expectedClientAuthType == null || client.isPublicClient()) {
                    ...
                    expectedClientAuthType = PassportModelUtils.getDefaultClientAuthenticatorType();
                }
