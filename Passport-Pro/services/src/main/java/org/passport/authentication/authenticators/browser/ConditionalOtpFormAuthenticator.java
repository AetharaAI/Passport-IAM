...
import static org.passport.authentication.authenticators.browser.ConditionalOtpFormAuthenticator.OtpDecision.ABSTAIN;
import static org.passport.authentication.authenticators.browser.ConditionalOtpFormAuthenticator.OtpDecision.SHOW_OTP;
import static org.passport.authentication.authenticators.browser.ConditionalOtpFormAuthenticator.OtpDecision.SKIP_OTP;
import static org.passport.models.utils.PassportModelUtils.getRoleFromString;
...
public class ConditionalOtpFormAuthenticator extends OTPFormAuthenticator {
    ...
    private boolean isOTPRequired(PassportSession session, RealmModel realm, UserModel user) {
