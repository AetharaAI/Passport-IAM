...
import org.passport.common.crypto.UserIdentityExtractor;
import org.passport.common.crypto.UserIdentityExtractorProvider;
import org.passport.crypto.HashException;
...
import org.passport.services.x509.X509ClientCertificateLookup;
...
public abstract class AbstractX509ClientCertificateAuthenticator implements Authenticator {
    ...
    protected static class CertificateValidatorConfigBuilder {
        ...
        static CertificateValidator.CertificateValidatorBuilder fromConfig(PassportSession session, X509AuthenticatorConfigModel config) throws Exception {
    ...
    public CertificateValidator.CertificateValidatorBuilder certificateValidationParameters(PassportSession session, X509AuthenticatorConfigModel config) throws Exception {
