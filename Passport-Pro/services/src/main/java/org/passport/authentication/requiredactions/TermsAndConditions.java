...
public class TermsAndConditions implements RequiredActionProvider, RequiredActionFactory {
    ...
    public void processAction(RequiredActionContext context) {
        // Passport 21.0.0 changed the user attribute name from lowercase to uppercase
        // this change was reverted, but it is still possible some attributes created
        // in Passport 21.0.0 will be present in the database, we need to remove it too.
        // See https://github.com/passport/passport/issues/17277 for more details
