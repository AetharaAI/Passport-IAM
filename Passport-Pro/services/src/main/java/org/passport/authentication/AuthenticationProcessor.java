...
import org.passport.authentication.authenticators.client.ClientAuthUtil;
...
public class AuthenticationProcessor {
    ...
    public AuthenticationProcessor setSession(PassportSession session) {
    ...
    public static String getClientData(PassportSession session, AuthenticationSessionModel authSession) {
    ...
    public class Result implements AuthenticationFlowContext, ClientAuthenticationFlowContext {
        ...
        public AuthenticationExecutionModel.Requirement getCategoryRequirementFromCurrentFlow(String authenticatorCategory) {
            return realm.getAuthenticationExecutionsStream(execution.getParentFlow())
                    .filter(e -> {
                        AuthenticatorFactory factory = (AuthenticatorFactory) getSession().getPassportSessionFactory()
    ...
    public static AuthenticationSessionModel recreate(PassportSession session, AuthenticationSessionModel authSession) {
        AuthenticationSessionManager authenticationSessionManager =  new AuthenticationSessionManager(session);
    ...
    public static AuthenticationSessionModel clone(PassportSession session, AuthenticationSessionModel authSession) {
    ...
    public static ClientSessionContext attachSession(AuthenticationSessionModel authSession, UserSessionModel userSession, PassportSession session, RealmModel realm, ClientConnection connection, EventBuilder event) {
