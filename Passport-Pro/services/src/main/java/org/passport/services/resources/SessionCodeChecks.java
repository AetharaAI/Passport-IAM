...
import static org.passport.services.managers.AuthenticationManager.authenticateIdentityCookie;
...
public class SessionCodeChecks {
    ...
    public SessionCodeChecks(RealmModel realm, UriInfo uriInfo, HttpRequest request, ClientConnection clientConnection, PassportSession session, EventBuilder event,
