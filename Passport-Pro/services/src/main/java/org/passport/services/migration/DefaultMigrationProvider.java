...
package org.passport.services.migration;
...
public class DefaultMigrationProvider implements MigrationProvider {
    ...
    public DefaultMigrationProvider(PassportSession session) {
    ...
    public Map<String, ProtocolMapperModel> getBuiltinMappers(String protocol) {
        LoginProtocolFactory providerFactory = (LoginProtocolFactory) session.getPassportSessionFactory().getProviderFactory(LoginProtocol.class, protocol);
    ...
    private OIDCLoginProtocolFactory getOIDCLoginProtocolFactory() {
        return (OIDCLoginProtocolFactory) session.getPassportSessionFactory().getProviderFactory(LoginProtocol.class, OIDCLoginProtocol.LOGIN_PROTOCOL);
    }
    ...
    private static Map<String, ProtocolMapperRepresentation> getAllDefaultMappers(PassportSession session) {
