...
import org.passport.rar.AuthorizationRequestSource;
...
public class DefaultClientSessionContext implements ClientSessionContext {
    ...
    private DefaultClientSessionContext(AuthenticatedClientSessionModel clientSession, Set<ClientScopeModel> requestedScopes, Set<String> restrictedScopes, PassportSession session) {
     ...
     */
    public static DefaultClientSessionContext fromClientSessionScopeParameter(AuthenticatedClientSessionModel clientSession, PassportSession session) {
        return fromClientSessionAndScopeParameter(clientSession, clientSession.getNote(OAuth2Constants.SCOPE), session);
    }


    public static DefaultClientSessionContext fromClientSessionAndScopeParameter(AuthenticatedClientSessionModel clientSession, String scopeParam, PassportSession session) {
    ...
    public static DefaultClientSessionContext fromClientSessionAndClientScopes(AuthenticatedClientSessionModel clientSession,
            Set<ClientScopeModel> requestedScopes, Set<String> restrictedScopes, PassportSession session) {
    ...
    public boolean isOfflineTokenRequested() {
        ...
        ClientScopeModel offlineAccessScope = PassportModelUtils.getClientScopeByName(clientSession.getRealm(), OAuth2Constants.OFFLINE_ACCESS);
