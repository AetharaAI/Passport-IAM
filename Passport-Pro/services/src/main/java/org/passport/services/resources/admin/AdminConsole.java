...
public class AdminConsole {
    ...
    public AdminConsole(PassportSession session) {
    ...
    protected RealmModel getAdminstrationRealm(RealmManager realmManager) {
        return realmManager.getPassportAdministrationRealm();
    }
    ...
    public Response getMainPage() throws IOException, FreeMarkerException {
        ...
        if (!adminUriInfo.getRequestUri().getPath().endsWith("/")) {
            ...
            map.put("resourceCommonUrl", Urls.themeRoot(adminBaseUri).getPath() + "/common/passport");
