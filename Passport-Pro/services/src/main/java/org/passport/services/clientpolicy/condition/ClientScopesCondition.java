...
package org.passport.services.clientpolicy.condition;
...
import org.passport.protocol.oidc.grants.ciba.clientpolicy.context.BackchannelTokenRequestContext;
import org.passport.protocol.oidc.grants.ciba.clientpolicy.context.BackchannelTokenResponseContext;
...
import org.passport.services.clientpolicy.ClientPolicyVote;
...
import org.passport.services.clientpolicy.context.ServiceAccountTokenRequestContext;
import org.passport.services.clientpolicy.context.ServiceAccountTokenResponseContext;
import org.passport.services.clientpolicy.context.TokenExchangeRequestContext;
import org.passport.services.clientpolicy.context.TokenRequestContext;
import org.passport.services.clientpolicy.context.TokenResponseContext;
...
public class ClientScopesCondition extends AbstractClientPolicyConditionProvider<ClientScopesCondition.Configuration> {
    ...
    public ClientScopesCondition(PassportSession session) {
        super(session);
    }
