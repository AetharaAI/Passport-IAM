 ...
 */
@Provider
public class PassportMismatchedInputExceptionHandler implements ExceptionMapper<MismatchedInputException> {
    ...
    public Response toResponse(MismatchedInputException exception) {
        return PassportErrorHandler.getResponse(session, exception);
    }
}