...
public class AppAuthManager extends AuthenticationManager {
    ...
    public static class BearerTokenAuthenticator {
        ...
        public BearerTokenAuthenticator(PassportSession session) {
            this.session = session;
        }

        public BearerTokenAuthenticator setSession(PassportSession session) {
            this.session = session;
            return this;
        }
        ...
        public AuthResult authenticate() {
            PassportContext ctx = session.getContext();
