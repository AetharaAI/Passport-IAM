...
class MgmtPermissionsV2 extends MgmtPermissions {
    ...
    public MgmtPermissionsV2(PassportSession session, RealmModel realm) {
        super(session, realm);
    }

    public MgmtPermissionsV2(PassportSession session, RealmModel realm, AdminAuth auth) {
        super(session, realm, auth);
    }

    public MgmtPermissionsV2(PassportSession session, AdminAuth auth) {
        super(session, auth);
    }

    public MgmtPermissionsV2(PassportSession session, RealmModel adminsRealm, UserModel admin) {
