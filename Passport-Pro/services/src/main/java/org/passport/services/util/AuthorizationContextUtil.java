...
import org.passport.protocol.oidc.rar.AuthorizationRequestParserProvider;
import org.passport.protocol.oidc.rar.parsers.ClientScopeAuthorizationRequestParserProviderFactory;
...
public class AuthorizationContextUtil {
     ...
     */
    public static AuthorizationRequestContext getAuthorizationRequestContextFromScopes(PassportSession session, String scope) {
     ...
     */
    public static AuthorizationRequestContext getAuthorizationRequestContextFromScopesWithClient(PassportSession session, String scope) {
     ...
     */
    public static Stream<AuthorizationDetails> getAuthorizationRequestsStreamFromScopesWithClient(PassportSession session, String scope) {
     ...
     */
    public static Stream<ClientScopeModel> getClientScopesStreamFromAuthorizationRequestContextWithClient(PassportSession session, String scope) {
