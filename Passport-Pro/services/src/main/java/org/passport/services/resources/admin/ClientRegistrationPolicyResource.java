...
import org.passport.services.clientregistration.policy.ClientRegistrationPolicyFactory;
...
public class ClientRegistrationPolicyResource {
    ...
    public ClientRegistrationPolicyResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.CLIENT_REGISTRATION_POLICY)
    ...
    public Stream<ComponentTypeRepresentation> getProviders() {
        ...
        return session.getPassportSessionFactory().getProviderFactoriesStream(ClientRegistrationPolicy.class)
