...
import org.passport.authentication.ExplainedVerificationException;
...
import org.passport.authentication.actiontoken.ActionTokenHandler;
import org.passport.authentication.actiontoken.ExplainedTokenVerificationException;
import org.passport.authentication.actiontoken.resetcred.ResetCredentialsActionTokenHandler;
...
import org.passport.exceptions.TokenNotActiveException;
import org.passport.forms.login.LoginFormsProvider;
import org.passport.forms.login.MessageType;
import org.passport.forms.login.freemarker.DetachedInfoStateChecker;
import org.passport.forms.login.freemarker.DetachedInfoStateCookie;
...
import org.passport.protocol.oidc.grants.device.DeviceGrantType;
...
import org.passport.services.util.LocaleUtil;
import org.passport.sessions.AuthenticationSessionModel;
import org.passport.sessions.RootAuthenticationSessionModel;

import org.jboss.logging.Logger;

import static org.passport.authentication.actiontoken.DefaultActionToken.ACTION_TOKEN_BASIC_CHECKS;
...
public class LoginActionsService {
    ...
    public LoginActionsService(PassportSession session, EventBuilder event) {
    ...
    protected <T extends JsonWebToken & SingleUseObjectKeyModel> Response handleActionToken(String tokenString, String execution, String clientId, String tabId, String clientData, 
        ...
        PassportContext sessionContext = session.getContext();
    ...
    public static Response redirectToAfterBrokerLoginEndpoint(PassportSession session, RealmModel realm, UriInfo uriInfo, AuthenticationSessionModel authSession, boolean firstBrokerLogin) {
    ...
    public Response processConsent() {
        ...
        for (String clientScopeId : authSession.getClientScopes()) {
            ClientScopeModel clientScope = PassportModelUtils.findClientScopeById(realm, client, clientScopeId);
            if (clientScope != null) {
    ...
    private Response processRequireAction(final String authSessionId, final String code, String action, String clientId, String tabId, String clientData) {
        ...
        RequiredActionFactory factory = (RequiredActionFactory)session.getPassportSessionFactory().getProviderFactory(RequiredActionProvider.class, getDefaultRequiredActionCaseInsensitively(action));
        if (factory == null) {
