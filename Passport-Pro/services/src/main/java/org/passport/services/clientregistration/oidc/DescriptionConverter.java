...
package org.passport.services.clientregistration.oidc;
...
import org.passport.protocol.oidc.mappers.PairwiseSubMapperHelper;
...
import org.passport.protocol.oidc.utils.SubjectType;
...
import org.passport.services.clientregistration.ClientRegistrationException;
...
import static org.passport.OAuth2Constants.AUTHORIZATION_CODE;
import static org.passport.OAuth2Constants.IMPLICIT;
import static org.passport.models.CibaConfig.OIDC_CIBA_GRANT_ENABLED;
import static org.passport.models.OAuth2DeviceConfig.OAUTH2_DEVICE_AUTHORIZATION_GRANT_ENABLED;
import static org.passport.protocol.oidc.utils.OIDCResponseType.CODE;
...
public class DescriptionConverter {
    ...
    public static ClientRepresentation toInternal(PassportSession session, OIDCClientRepresentation clientOIDC) throws ClientRegistrationException {
        ...
        if ("none".equals(authMethod)) {
            ...
            if (authMethod == null) {
                clientAuthFactory = (ClientAuthenticatorFactory) session.getPassportSessionFactory().getProviderFactory(ClientAuthenticator.class, PassportModelUtils.getDefaultClientAuthenticatorType());
            } else {
    ...
    private static boolean setPublicKey(OIDCClientRepresentation clientOIDC, ClientRepresentation clientRep) {
        ...
        if (clientOIDC.getJwks() != null) {
            ...
            String publicKeyPem = PassportModelUtils.getPemFromKey(publicKey);
    ...
    public static OIDCClientRepresentation toExternalResponse(PassportSession session, ClientRepresentation client, URI uri) {
        ...
        if ("none".equals(client.getClientAuthenticatorType())) {
            ...
            ClientAuthenticatorFactory clientAuth = (ClientAuthenticatorFactory) session.getPassportSessionFactory().getProviderFactory(ClientAuthenticator.class, client.getClientAuthenticatorType());
