...
public class RealmsAdminResourcePreflight extends RealmsAdminResource {
    ...
    public RealmsAdminResourcePreflight(PassportSession session, AdminAuth auth, TokenManager tokenManager) {
        super(session, auth, tokenManager);
    }

    public RealmsAdminResourcePreflight(PassportSession session, AdminAuth auth, TokenManager tokenManager, HttpRequest request) {
        super(session, auth, tokenManager);
