...
import org.passport.services.clientpolicy.context.AdminClientRegisterContext;
...
import org.passport.services.clientpolicy.context.DynamicClientRegisterContext;
import org.passport.services.clientpolicy.context.DynamicClientRegisteredContext;
import org.passport.services.clientpolicy.context.DynamicClientUpdateContext;
...
public class ClientUpdaterSourceRolesCondition extends AbstractClientPolicyConditionProvider<ClientUpdaterSourceRolesCondition.Configuration> {
    ...
    public ClientUpdaterSourceRolesCondition(PassportSession session) {
        super(session);
    }
    ...
    private boolean isRolesMatched(UserModel user) {
        ...
        for (String roleName : expectedRoles) {
            RoleModel role = PassportModelUtils.getRoleFromString(realm, roleName);
