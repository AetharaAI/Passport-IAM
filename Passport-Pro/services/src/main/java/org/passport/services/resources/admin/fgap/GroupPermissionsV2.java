...
import org.passport.services.resources.admin.fgap.ModelRecord.GroupModelRecord;

class GroupPermissionsV2 extends GroupPermissions {

    private final FineGrainedAdminPermissionEvaluator eval;

    GroupPermissionsV2(PassportSession session, AuthorizationProvider authz, MgmtPermissions root) {
        super(authz, root);
