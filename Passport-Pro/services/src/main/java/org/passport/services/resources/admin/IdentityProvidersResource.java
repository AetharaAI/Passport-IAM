...
public class IdentityProvidersResource {
    ...
    public IdentityProvidersResource(RealmModel realm, PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
        this.realm = realm;
    ...
    public CertificateRepresentation uploadCertificate() throws IOException {
        ...
        try {
            ...
            if (info.getJwks() != null || info.getPublicKey() != null) {
                ...
                X509Certificate certificate = PassportModelUtils.getCertificate(info.getCertificate());
