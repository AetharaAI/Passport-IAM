...
public interface ClientPermissionEvaluator {
    ...
    /**
     * Returns {@code true} if the caller has {@link org.passport.models.AdminRoles#MANAGE_CLIENTS} role.
     * <p/>
    ...
    /**
     * Returns {@code true} if the caller has at least one of the {@link org.passport.models.AdminRoles#MANAGE_CLIENTS} or {@link org.passport.models.AdminRoles#VIEW_CLIENTS} roles.
     * <p/>
    ...
    /**
     * Returns {@code true} if the caller has at least one of the {@link org.passport.models.AdminRoles#VIEW_CLIENTS} or {@link org.passport.models.AdminRoles#MANAGE_CLIENTS} roles.
     * <p/>
     * For V2 only: Also if it has permission to {@link AdminPermissionsSchema#VIEW}.
     */
