...
import org.passport.common.util.MimeTypeUtil;
...
public class WelcomeResource {
    ...
    private Response createWelcomePage(String successMessage, String errorMessage) {
        try {
            ...
            String commonPath = themeProperties.getProperty("common", "common/passport");
    ...
    public static boolean isLocal(PassportSession session) {
