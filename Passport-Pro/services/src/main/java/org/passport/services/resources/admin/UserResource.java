...
import org.passport.authentication.actiontoken.execactions.ExecuteActionsActionToken;
import org.passport.authentication.actiontoken.verifyemail.VerifyEmailActionToken;
import org.passport.authentication.requiredactions.util.RequiredActionsValidator;
...
public class UserResource {
    ...
    public UserResource(PassportSession session, UserModel user, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.USERS)
    ...
    public static Response validateUserProfile(UserProfile profile, PassportSession session, AdminAuth adminAuth) {
        try {
            profile.validate();
    ...
    public static void updateUserFromRep(UserProfile profile, UserModel user, UserRepresentation rep, PassportSession session, boolean isUpdateExistingUser) {
        ...
        if (reqActions != null) {
            session.getPassportSessionFactory()
