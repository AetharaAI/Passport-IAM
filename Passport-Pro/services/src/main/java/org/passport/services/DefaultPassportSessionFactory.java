...
import org.passport.component.ComponentFactoryProvider;
...
import org.passport.provider.ProviderManagerDeployer;
...
import org.passport.theme.ThemeManagerFactory;

import org.jboss.logging.Logger;

public abstract class DefaultPassportSessionFactory implements PassportSessionFactory, ProviderManagerDeployer {

    private static final Logger logger = Logger.getLogger(DefaultPassportSessionFactory.class);
    ...
    public void init() {
        ...
        ProviderManager pm = new ProviderManager(PassportDeploymentInfo.create().services(), getClass().getClassLoader(), Config.scope().getArray("providers"));
    ...
    @Override
    public <T extends Provider> ProviderFactory<T> getProviderFactory(Class<T> clazz, String realmId, String componentId, Function<PassportSessionFactory, ComponentModel> modelGetter) {
    ...
    @Override
    public void invalidate(PassportSession session, InvalidableObjectType type, Object... ids) {
    ...
    /**
     * @return timestamp of Passport server startup
     */
    @Override
