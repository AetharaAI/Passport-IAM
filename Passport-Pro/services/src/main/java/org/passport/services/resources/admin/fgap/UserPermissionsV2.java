...
import org.passport.services.resources.admin.fgap.ModelRecord.UserModelRecord;

class UserPermissionsV2 extends UserPermissions {

    private final FineGrainedAdminPermissionEvaluator eval;

    UserPermissionsV2(PassportSession session, AuthorizationProvider authz, MgmtPermissionsV2 root) {
