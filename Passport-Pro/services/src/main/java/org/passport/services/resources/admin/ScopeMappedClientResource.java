...
public class ScopeMappedClientResource {
    ...
    public ScopeMappedClientResource(RealmModel realm, AdminPermissionEvaluator auth, ScopeContainerModel scopeContainer, PassportSession session, ClientModel scopedClient, AdminEventBuilder adminEvent,
    ...
    @NoCache
    @Tag(name = PassportOpenAPI.Admin.Tags.SCOPE_MAPPINGS)
    ...
    public Stream<RoleRepresentation> getClientScopeMappings() {
        ...
        return PassportModelUtils.getClientScopeMappingsStream(scopedClient, scopeContainer)
    ...
    public void deleteClientScopeMapping(List<RoleRepresentation> roles) {
        ...
        if (roles == null) {
            roles = PassportModelUtils.getClientScopeMappingsStream(scopedClient, scopeContainer)
