...
import org.passport.authorization.common.ClientModelIdentity;
...
import static org.passport.authorization.fgap.AdminPermissionsSchema.CLIENTS_RESOURCE_TYPE;
import static org.passport.services.resources.admin.fgap.AdminPermissionManagement.TOKEN_EXCHANGE;
...
class ClientPermissions implements ClientPermissionEvaluator,  ClientPermissionManagement {
    ...
    public ClientPermissions(PassportSession session, RealmModel realm, AuthorizationProvider authz, MgmtPermissions root) {
