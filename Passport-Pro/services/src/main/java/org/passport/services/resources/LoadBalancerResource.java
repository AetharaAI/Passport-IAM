...
import org.passport.health.LoadBalancerCheckProvider;
...
/**
 * Prepare information for the load balancer (possibly in a multi-site setup) whether this Passport cluster should receive traffic.
 * <p>
 * This is non-blocking, so that the load balancer can still retrieve the status even if the Passport instance is
...
public class LoadBalancerResource {
    ...
    /**
     * Return the status for a load balancer in a multi-site setup if this Passport site should receive traffic.
     * <p />
     ...
     * <p />
     * In contrast to other management endpoints of Quarkus, no information is returned to the caller about the internal state of Passport
