...
import org.passport.representations.idm.SecurityProfileConfiguration;
...
public class DefaultSecurityProfileProviderFactory implements SecurityProfileProviderFactory {
    ...
    @Override
    public SecurityProfileProvider create(PassportSession session) {
    ...
    protected SecurityProfileConfiguration readConfiguration(PassportSession session) {
