...
import org.passport.services.clientpolicy.executor.SecureRedirectUrisEnforcerExecutorFactory.UriType;
...
public class SecureRedirectUrisEnforcerExecutor implements ClientPolicyExecutorProvider<SecureRedirectUrisEnforcerExecutor.Configuration> {
    ...
    public SecureRedirectUrisEnforcerExecutor(PassportSession session) {
