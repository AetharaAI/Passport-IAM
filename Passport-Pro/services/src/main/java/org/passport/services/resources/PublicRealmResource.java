...
import org.passport.representations.idm.PublishedRealmRepresentation;
...
public class PublicRealmResource {
    ...
    public PublicRealmResource(PassportSession session) {
    ...
    public static PublishedRealmRepresentation realmRep(PassportSession session, RealmModel realm, UriInfo uriInfo) {
