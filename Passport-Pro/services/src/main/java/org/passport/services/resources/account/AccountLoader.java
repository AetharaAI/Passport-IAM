...
import org.passport.protocol.oidc.AccessTokenIntrospectionProvider;
import org.passport.protocol.oidc.AccessTokenIntrospectionProviderFactory;
import org.passport.protocol.oidc.TokenIntrospectionProvider;
...
public class AccountLoader {
    ...
    public AccountLoader(PassportSession session, EventBuilder event) {
    ...
    public Object getAccountService() {
        ...
        } else if ((accepts.contains(MediaType.APPLICATION_JSON_TYPE) || MediaType.APPLICATION_JSON_TYPE.equals(content)) && !uriInfo.getPath().endsWith("passport.json")) {
    ...
    private Theme getTheme(PassportSession session) {
        try {
