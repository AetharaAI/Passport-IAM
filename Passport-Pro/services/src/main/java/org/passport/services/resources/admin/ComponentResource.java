...
public class ComponentResource {
    ...
    public ComponentResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @NoCache
    @Tag(name = PassportOpenAPI.Admin.Tags.COMPONENT)
    @Operation()
    ...
    public Stream<ComponentTypeRepresentation> getSubcomponentConfig(@PathParam("id") String parentId, @QueryParam("type") String subtype) {
        ...
        return session.getPassportSessionFactory().getProviderFactoriesStream(providerClass)
