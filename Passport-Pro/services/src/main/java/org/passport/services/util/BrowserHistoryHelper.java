...
public abstract class BrowserHistoryHelper {
    ...
    public abstract Response saveResponseAndRedirect(PassportSession session, AuthenticationSessionModel authSession, Response response, boolean actionRequest, HttpRequest httpRequest);

    public abstract Response loadSavedResponse(PassportSession session, AuthenticationSessionModel authSession);


    protected boolean shouldReplaceBrowserHistory(boolean actionRequest, PassportSession session) {
        if (actionRequest) {
            return true;
        }
    ...
    private static class JavascriptHistoryReplace extends BrowserHistoryHelper {
        ...
        @Override
        public Response saveResponseAndRedirect(PassportSession session, AuthenticationSessionModel authSession, Response response, boolean actionRequest, HttpRequest httpRequest) {
        ...
        @Override
        public Response loadSavedResponse(PassportSession session, AuthenticationSessionModel authSession) {
            return null;
        }
