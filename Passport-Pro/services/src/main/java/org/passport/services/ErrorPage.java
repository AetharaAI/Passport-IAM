...
public class ErrorPage {
    ...
    public static Response error(PassportSession session, AuthenticationSessionModel authenticationSession, Response.Status status, String message, Object... parameters) {
