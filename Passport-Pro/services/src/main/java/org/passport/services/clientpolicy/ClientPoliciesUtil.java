...
package org.passport.services.clientpolicy;
...
import org.passport.component.JsonConfigComponentModel;
...
import org.passport.services.clientpolicy.condition.ClientPolicyConditionProvider;
import org.passport.services.clientpolicy.condition.ClientPolicyConditionProviderFactory;
import org.passport.services.clientpolicy.executor.ClientPolicyExecutorProvider;
import org.passport.util.JsonSerialization;
import org.passport.utils.FileUtils;
...
public class ClientPoliciesUtil {
    ...
    public static List<ClientProfileRepresentation> readGlobalClientProfilesRepresentation(PassportSession session, String name) throws ClientPolicyException {
        if (name == null) {
    ...
    public static List<ClientPolicyRepresentation> readGlobalClientPoliciesRepresentation(PassportSession session, String name,
     ...
     * not return null.
     */
    static ClientProfilesRepresentation getClientProfilesRepresentation(PassportSession session, RealmModel realm) throws ClientPolicyException {
     ...
     */
    static ClientProfile getClientProfileModel(PassportSession session, RealmModel realm, ClientProfilesRepresentation profilesRep, List<ClientProfileRepresentation> globalClientProfiles, String profileName) throws ClientPolicyException {
    ...
    private static ClientPolicyExecutorProvider getExecutorProvider(PassportSession session, RealmModel realm, String providerId, JsonNode config) {
    ...
    /**
     * get validated and modified global (built-in) client profiles set on passport app as representation.
     * it is loaded from json file enclosed in passport's binary.
     * not return null.
     */
    static List<ClientProfileRepresentation> getValidatedGlobalClientProfilesRepresentation(PassportSession session, InputStream is) throws ClientPolicyException {
        ...
        // construct validated and modified profiles from builtin profiles in JSON file enclosed in passport binary.
    ...
    /**
     * get validated and modified global (built-in) client policies set on passport app as representation.
     * it is loaded from json file enclosed in passport's binary.
     * not return null.
     */
    static List<ClientPolicyRepresentation> getValidatedGlobalClientPoliciesRepresentation(PassportSession session, InputStream is, List<ClientProfileRepresentation> profiles) throws ClientPolicyException {
     ...
     * not return null.
     */
    static ClientProfilesRepresentation getValidatedClientProfilesForUpdate(PassportSession session, RealmModel realm,
    ...
    /**
     * check whether the proposed executor's provider can be found in passport's ClientPolicyExecutorProvider list.
     * not return null.
     */
    private static boolean isValidExecutor(PassportSession session, ClientPolicyExecutorRepresentation executorRep) {
     ...
     * not return null.
     */
    static ClientPoliciesRepresentation getClientPoliciesRepresentation(PassportSession session, RealmModel realm) throws ClientPolicyException {
    ...
    static List<ClientProfileRepresentation> getGlobalClientProfiles(PassportSession session) {
    ...
    static List<ClientPolicyRepresentation> getGlobalClientPolicies(PassportSession session) {
        SecurityProfileProvider securityProfile = session.getProvider(SecurityProfileProvider.class);
     ...
     * not return null.
     */
    static List<ClientPolicy> getEnabledClientPolicies(PassportSession session, RealmModel realm) {
    ...
    private static ClientPolicyConditionProvider getConditionProvider(PassportSession session, RealmModel realm, String providerId, JsonNode config) {
     ...
     */
    static private List<ClientPolicyRepresentation> validatePolicies(PassportSession session, List<ClientPolicyRepresentation> proposedPoliciesRepList,
     ...
     */
    static ClientPoliciesRepresentation getValidatedClientPoliciesForUpdate(PassportSession session, RealmModel realm,
    ...
    /**
     * check whether the proposed condition's provider can be found in passport's ClientPolicyConditionProvider list.
     * not return null.
     */
    private static boolean isValidCondition(PassportSession session, String conditionProviderId) {
    ...
    private static void validateConditionConfig(PassportSession session, ClientPolicyConditionRepresentation conditionRep) throws ClientPolicyException {
    ...
    private static ClientPolicyConditionProviderFactory getClientPolicyConditionFactory(PassportSession session, String providerId) {
