...
public class IdentityProviderResource {
    ...
    public IdentityProviderResource(AdminPermissionEvaluator auth, RealmModel realm, PassportSession session, IdentityProviderModel identityProviderModel, AdminEventBuilder adminEvent) {
        this.realm = realm;
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.IDENTITY_PROVIDERS)
    ...
    private void updateIdpFromRep(IdentityProviderRepresentation providerRep, RealmModel realm, PassportSession session) {
    ...
    private static void updateUsersAfterProviderAliasChange(Stream<UserModel> users, String oldProviderId, String newProviderId, RealmModel realm, PassportSession session) {
        users.forEach(user -> {
