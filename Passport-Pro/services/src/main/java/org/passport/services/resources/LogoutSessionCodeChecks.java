...
public class LogoutSessionCodeChecks extends SessionCodeChecks {
    ...
    public LogoutSessionCodeChecks(RealmModel realm, UriInfo uriInfo, HttpRequest request, ClientConnection clientConnection, PassportSession session, EventBuilder event,
