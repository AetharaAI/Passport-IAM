...
import org.passport.protocol.oidc.mappers.AbstractPairwiseSubMapper;
...
import org.passport.services.clientregistration.AbstractClientRegistrationProvider;
import org.passport.services.clientregistration.ClientRegistrationException;
import org.passport.services.clientregistration.ErrorCodes;
...
public class OIDCClientRegistrationProvider extends AbstractClientRegistrationProvider {
    ...
    public OIDCClientRegistrationProvider(PassportSession session) {
        super(session);
    }
