...
import org.passport.representations.idm.AuthenticatorConfigInfoRepresentation;
...
import org.passport.representations.idm.ErrorRepresentation;
import org.passport.representations.idm.RequiredActionConfigInfoRepresentation;
...
public class AuthenticationManagementResource {
    ...
    public AuthenticationManagementResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.AUTHENTICATION_MANAGEMENT)
    ...
    public Stream<Map<String, Object>> getFormProviders() {
        ...
        return buildProviderMetadata(session.getPassportSessionFactory().getProviderFactoriesStream(FormAuthenticator.class));
    }
    ...
    public Stream<Map<String, Object>> getAuthenticatorProviders() {
        ...
        return buildProviderMetadata(session.getPassportSessionFactory().getProviderFactoriesStream(Authenticator.class));
    }
    ...
    public Stream<Map<String, Object>> getClientAuthenticatorProviders() {
        ...
        Stream<ProviderFactory> factories =  session.getPassportSessionFactory().getProviderFactoriesStream(ClientAuthenticator.class);
    ...
    public Stream<Map<String, Object>> getFormActionProviders() {
        ...
        return buildProviderMetadata(session.getPassportSessionFactory().getProviderFactoriesStream(FormAction.class));
    }
    ...
    public void deleteFlow(@Parameter(description = "Flow id") @PathParam("id") String id) {
        ...
        PassportModelUtils.deepDeleteAuthenticationFlow(session, realm, flow,
    ...
    public static AuthenticationFlowModel copyFlow(PassportSession session, RealmModel realm, AuthenticationFlowModel flow, String newName) {
    ...
    public static void copy(PassportSession session, RealmModel realm, String newName, AuthenticationFlowModel from, AuthenticationFlowModel to) {
    ...
    private ProviderFactory getProviderFactory(AuthenticationFlowModel parentFlow, String provider) {
        ...
        if (parentFlow.getProviderId().equals(AuthenticationFlow.CLIENT_FLOW)) {
            f = session.getPassportSessionFactory().getProviderFactory(ClientAuthenticator.class, provider);
        } else if (parentFlow.getProviderId().equals(AuthenticationFlow.FORM_FLOW)) {
            f = session.getPassportSessionFactory().getProviderFactory(FormAction.class, provider);
        } else {
            f = session.getPassportSessionFactory().getProviderFactory(Authenticator.class, provider);
        }
        if (f == null) {
    ...
    public void removeExecution(@Parameter(description = "Execution id") @PathParam("executionId") String execution) {
        ...
        PassportModelUtils.deepDeleteAuthenticationExecutor(session, realm, model,
                () -> {}, // allow deleting even with missing references
                () -> {
                    throw new BadRequestException("It is illegal to remove execution from a built in flow");
                }
    ...
    public Stream<Map<String, String>> getUnregisteredRequiredActions() {
        ...
        return session.getPassportSessionFactory().getProviderFactoriesStream(RequiredActionProvider.class)
    ...
    public void registerRequiredAction(@Parameter(description = "JSON containing 'providerId', and 'name' attributes.") Map<String, String> data) {
        ...
        if (providerId == null || session.getPassportSessionFactory().getProviderFactory(RequiredActionProvider.class, providerId) == null) {
    ...
    public Map<String, List<ConfigPropertyRepresentation>> getPerClientConfigDescription() {
        ...
        return session.getPassportSessionFactory().getProviderFactoriesStream(ClientAuthenticator.class)
