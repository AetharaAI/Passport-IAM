...
public class AttackDetectionResource {
    ...
    public AttackDetectionResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.ATTACK_DETECTION)
    ...
    private boolean isUserDisabledOrLockedByBruteForce(PassportSession session, RealmModel realm, UserModel user) {
