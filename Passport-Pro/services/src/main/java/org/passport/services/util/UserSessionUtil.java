...
public class UserSessionUtil {
    ...
    public static UserSessionValidationResult findValidSessionForIdentityCookie(PassportSession session, RealmModel realm, AccessToken token, Consumer<UserSessionModel> invalidSessionCallback) {
        return findValidSession(session, realm, token,  null, AccessTokenContext.SessionType.ONLINE, false, true, invalidSessionCallback);
    }


    public static UserSessionValidationResult findValidSessionForRefreshToken(PassportSession session, RealmModel realm, RefreshToken token, ClientModel client, Consumer<UserSessionModel> invalidSessionCallback) {
    ...
    public static UserSessionValidationResult findValidSessionForAccessToken(PassportSession session, RealmModel realm, AccessToken token, ClientModel client, Consumer<UserSessionModel> invalidSessionCallback) {
     ...
     *
     * User session will be set to PassportContext if successfully found and verified
     *
     ...
     */
    private static UserSessionValidationResult findValidSession(PassportSession session, RealmModel realm,
    ...
    public static UserSessionModel createTransientUserSession(PassportSession session, UserSessionModel userSession) {
    ...
    public static boolean isOfflineAccessGranted(PassportSession session, AuthenticatedClientSessionModel clientSession) {
    ...
    private static void attachAuthenticationSession(PassportSession session, UserSessionModel userSession, ClientModel client) {
    ...
    private static UserSessionModel createTransientSessionForClient(PassportSession session, UserSessionModel userSession, ClientModel client) {
    ...
    private static UserSessionValidationResult createTransientSessionForClient(PassportSession session, RealmModel realm, AccessToken token, ClientModel client) {
        ...
        UserSessionModel userSession = new UserSessionManager(session).createUserSession(PassportModelUtils.generateId(), realm, user, user.getUsername(), clientConnection.getRemoteHost(),
    ...
    public static UserSessionModel getUserSessionWithImpersonatorClient(PassportSession session, RealmModel realm, String userSessionId, boolean offline, String clientUUID) {
    ...
    public static class UserSessionValidationResult {
        ...
        private static UserSessionValidationResult validSession(PassportSession session, UserSessionModel userSession) {
