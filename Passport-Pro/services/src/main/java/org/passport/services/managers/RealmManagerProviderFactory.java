...
import org.passport.partialimport.PartialImportManager;
...
import org.passport.storage.SetDefaultsForNewRealm;
...
public class RealmManagerProviderFactory implements ProviderFactory<RealmManagerProviderFactory>, Provider {
    @Override
    public RealmManagerProviderFactory create(PassportSession session) {
