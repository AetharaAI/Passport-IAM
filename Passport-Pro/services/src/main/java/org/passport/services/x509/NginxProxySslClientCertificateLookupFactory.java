...
import org.passport.truststore.TruststoreProviderFactory;
...
public class NginxProxySslClientCertificateLookupFactory extends AbstractClientCertificateFromHttpHeadersLookupFactory {
    ...
    @Override
    public X509ClientCertificateLookup create(PassportSession session) {
        loadPassportTrustStore(session);
     ...
     *
     * @param kcSession passport session
     */
    private void loadPassportTrustStore(PassportSession kcSession) {
        ...
        synchronized (this) {
            ...
            logger.debug(" Loading Passport truststore ...");
            PassportSessionFactory factory = kcSession.getPassportSessionFactory();
            ...
            if (provider != null && provider.getTruststore() != null) {
                ...
                logger.debug("Passport truststore loaded for NGINX x509cert-lookup provider.");
