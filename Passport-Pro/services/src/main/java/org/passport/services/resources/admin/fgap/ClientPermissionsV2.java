...
import org.passport.services.resources.admin.fgap.ModelRecord.ClientModelRecord;
...
class ClientPermissionsV2 extends ClientPermissions {
    ...
    ClientPermissionsV2(PassportSession session, RealmModel realm, AuthorizationProvider authz, MgmtPermissionsV2 root) {
