...
import org.passport.services.resources.admin.fgap.ModelRecord.RoleModelRecord;

import static org.passport.authorization.fgap.AdminPermissionsSchema.ROLES_RESOURCE_TYPE;

class RolePermissionsV2 extends RolePermissions {

    private final FineGrainedAdminPermissionEvaluator eval;

    RolePermissionsV2(PassportSession session, RealmModel realm, AuthorizationProvider authz, MgmtPermissions root) {
