...
public class ClientScopeResource {
    ...
    public ClientScopeResource(RealmModel realm, AdminPermissionEvaluator auth, ClientScopeModel clientScope, PassportSession session, AdminEventBuilder adminEvent) {
        this.realm = realm;
        this.auth = auth;
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.CLIENT_SCOPES)
    ...
    public Response update(final ClientScopeRepresentation rep) {
        ...
        try {
            LoginProtocolFactory loginProtocolFactory = //
                    (LoginProtocolFactory) session.getPassportSessionFactory().getProviderFactory(LoginProtocol.class,
    ...
    public static void validateClientScopeProtocol(PassportSession session, String protocol)
            throws ErrorResponseException {
     ...
     */
    public static void validateClientScope(PassportSession session, ClientScopeRepresentation clientScope)
            throws ErrorResponseException {
