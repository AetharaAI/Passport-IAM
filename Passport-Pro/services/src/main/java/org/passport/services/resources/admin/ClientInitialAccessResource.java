...
public class ClientInitialAccessResource {
    ...
    public ClientInitialAccessResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.CLIENT_INITIAL_ACCESS)
