...
import org.passport.services.clientpolicy.context.ClientCRUDContext;
import org.passport.services.clientpolicy.context.ClientSecretRotationContext;
import org.passport.services.clientpolicy.context.DynamicClientUpdatedContext;

import com.fasterxml.jackson.annotation.JsonProperty;
import org.jboss.logging.Logger;

import static org.passport.services.clientpolicy.executor.ClientSecretRotationExecutorFactory.DEFAULT_SECRET_EXPIRATION_PERIOD;
import static org.passport.services.clientpolicy.executor.ClientSecretRotationExecutorFactory.DEFAULT_SECRET_REMAINING_ROTATION_PERIOD;
import static org.passport.services.clientpolicy.executor.ClientSecretRotationExecutorFactory.DEFAULT_SECRET_ROTATED_EXPIRATION_PERIOD;
...
public class ClientSecretRotationExecutor implements
    ...
    public ClientSecretRotationExecutor(PassportSession session) {
    ...
    private void rotateSecret(ClientCRUDContext crudContext,
        ...
        if (crudContext instanceof ClientSecretRotationContext) {
            ...
            PassportModelUtils.generateSecret(crudContext.getTargetClient());
            updateClientConfigProperties(clientConfigWrapper);
        }
