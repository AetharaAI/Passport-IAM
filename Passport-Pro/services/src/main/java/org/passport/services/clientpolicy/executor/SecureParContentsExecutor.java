...
import org.passport.protocol.oidc.endpoints.request.AuthzEndpointRequestObjectParser;
import org.passport.protocol.oidc.endpoints.request.AuthzEndpointRequestParser;
...
public class SecureParContentsExecutor implements ClientPolicyExecutorProvider<ClientPolicyExecutorConfigurationRepresentation> {
    ...
    public SecureParContentsExecutor(PassportSession session) {
