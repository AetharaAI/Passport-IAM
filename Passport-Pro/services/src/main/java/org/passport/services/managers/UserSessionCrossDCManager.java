...
public class UserSessionCrossDCManager {
    ...
    public UserSessionCrossDCManager(PassportSession session) {
    ...
    /**
     * @deprecated To be removed in Passport 27+. Use
    ...
    /**
     * @deprecated To be removed in Passport 27+. Use
     * {@link UserSessionUtil#getUserSessionWithImpersonatorClient(PassportSession, RealmModel, String, boolean, String)}
     */
    @Deprecated(since = "26", forRemoval = true)
