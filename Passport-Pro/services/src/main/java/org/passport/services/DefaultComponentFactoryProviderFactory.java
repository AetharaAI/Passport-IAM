...
import org.passport.component.ComponentModelScope;
...
public class DefaultComponentFactoryProviderFactory implements ComponentFactoryProviderFactory {
    ...
    public <T extends Provider> ProviderFactory<T> getProviderFactory(Class<T> clazz, String realmId, String componentId, Function<PassportSessionFactory, ComponentModel> modelGetter) {
        ...
        if (modelGetter == null) {
            ...
            cm = PassportModelUtils.getComponentModel(factory, realmId, componentId);
        } else {
    ...
    private void propagateInvalidation(PassportSession session, ConcurrentMap<String, ProviderFactory> componentsMap, InvalidableObjectType type, Object[] ids) {
