...
import org.passport.models.RoleMapperModel;
...
public class ClientRoleMappingsResource {
    ...
    public ClientRoleMappingsResource(UriInfo uriInfo, PassportSession session, RealmModel realm, AdminPermissionEvaluator auth,
    ...
    @NoCache
    @Tag(name = PassportOpenAPI.Admin.Tags.CLIENT_ROLE_MAPPINGS)
