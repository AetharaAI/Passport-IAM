...
import org.passport.representations.account.AccountLinkUriRepresentation;
import org.passport.representations.account.LinkedAccountRepresentation;
...
import org.passport.utils.BrokerUtil;
import org.passport.utils.StreamsUtil;

import org.jboss.logging.Logger;

import static org.passport.models.Constants.ACCOUNT_CONSOLE_CLIENT_ID;
...
public class LinkedAccountsResource {
    ...
    public LinkedAccountsResource(PassportSession session,
                                  HttpRequest request,
                                  Auth auth,
                                  EventBuilder event,
                                  UserModel user) {
        ...
        this.socialIds = session.getPassportSessionFactory().getProviderFactoriesStream(SocialIdentityProvider.class)
    ...
    private LinkedAccountRepresentation toLinkedAccount(IdentityProviderModel provider, String fedIdentity, Set<IdentityProviderShowInAccountConsole> includedShowInAccountConsoleValues) {
        ...
        rep.setDisplayName(PassportModelUtils.getIdentityProviderDisplayName(session, provider));
    ...
    @Deprecated
    public List<LinkedAccountRepresentation> getLinkedAccounts(PassportSession session, RealmModel realm, UserModel user) {
    ...
    private LinkedAccountRepresentation toLinkedAccountRepresentation(IdentityProviderModel provider, Stream<FederatedIdentityModel> identities) {
        ...
        String displayName = PassportModelUtils.getIdentityProviderDisplayName(session, provider);
