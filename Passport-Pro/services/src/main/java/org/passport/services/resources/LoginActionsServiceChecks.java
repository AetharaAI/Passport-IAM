...
public class LoginActionsServiceChecks {
     ...
     */
    public static void checkIsUserValid(PassportSession session, RealmModel realm, String userId, Consumer<UserModel> userSetter, EventBuilder event) throws VerificationException {
     ...
     */
    public static void checkIsClientValid(PassportSession session, ClientModel client) throws VerificationException {
        if (client == null) {
