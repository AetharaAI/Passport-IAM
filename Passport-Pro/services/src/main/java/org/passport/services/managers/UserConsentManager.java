...
public class UserConsentManager {
     ...
     */
    public static boolean revokeConsentToClient(PassportSession session, ClientModel client, UserModel user) {
     ...
     */
    public static void addConsent(PassportSession session, RealmModel realm, UserModel user, UserConsentModel consent) {
     ...
     */
    public static UserConsentModel getConsentByClient(PassportSession session, RealmModel realm, UserModel user, String clientInternalId) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
     ...
     */
    public static Stream<UserConsentModel> getConsentsStream(PassportSession session, RealmModel realm, UserModel user) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
     ...
     */
    public static void updateConsent(PassportSession session, RealmModel realm, UserModel user, UserConsentModel consent) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
     ...
     */
    public static boolean revokeConsentForClient(PassportSession session, RealmModel realm, UserModel user, String clientInternalId) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
