...
public class GroupResource {
    ...
    public GroupResource(RealmModel realm, GroupModel group, PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
        this.realm = realm;
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.GROUPS)
    @Operation()
    ...
    public static void updateGroup(GroupRepresentation rep, GroupModel model, RealmModel realm, PassportSession session) {
        String newName = rep.getName();
        if (newName != null) {
            String existingName = model.getName();
            if (!newName.equals(existingName)) {
                String previousPath = PassportModelUtils.buildGroupPath(model);

                model.setName(newName);

                String newPath = PassportModelUtils.buildGroupPath(model);
