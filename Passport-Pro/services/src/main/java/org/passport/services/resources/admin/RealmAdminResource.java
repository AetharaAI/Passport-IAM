...
import org.passport.KeyPairVerifier;
import org.passport.authentication.CredentialRegistrator;
...
import org.passport.email.EmailAuthenticator;
...
import org.passport.exportimport.ClientDescriptionConverter;
import org.passport.exportimport.ClientDescriptionConverterFactory;
...
import org.passport.organization.admin.resource.OrganizationsResource;
import org.passport.partialimport.PartialImportResult;
import org.passport.partialimport.PartialImportResults;
import org.passport.representations.adapters.action.GlobalRequestResult;
...
import org.passport.services.managers.ResourceAdminManager;
...
import org.passport.services.util.DateUtil;
...
import static org.passport.util.JsonSerialization.readValue;
...
public class RealmAdminResource {
    ...
    public RealmAdminResource(PassportSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    public ClientRepresentation convertClientDescription(String description) {
        ...
        return session.getPassportSessionFactory().getProviderFactoriesStream(ClientDescriptionConverter.class)
    ...
    public Response updateRealm(final RealmRepresentation rep) {
        ...
        try {
            ...
            // This populates the map in DefaultPassportContext to be used when treating the event
            ...
            throw ErrorResponse.error(e.getMessage(), Status.BAD_REQUEST);
        } catch (org.passport.services.ErrorResponseException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
    ...
    public Response partialImport(InputStream requestBody) {
        ...
        try {
            return Response.ok(
                    PassportModelUtils.runJobInTransactionWithResult(session.getPassportSessionFactory(), session.getContext(), kcSession -> {
    ...
    private static PartialImportResults getPartialImportResults(InputStream requestBody, PassportSession kcSession, RealmModel kcRealm, AdminEventBuilder adminEventClone) {
