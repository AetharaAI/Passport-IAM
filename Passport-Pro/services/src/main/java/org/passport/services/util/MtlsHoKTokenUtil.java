...
public class MtlsHoKTokenUtil {
    ...
    public static AccessToken.Confirmation bindTokenWithClientCertificate(HttpRequest request, PassportSession session) {
    ...
    public static boolean verifyTokenBindingWithClientCertificate(AccessToken token, HttpRequest request, PassportSession session) {
        if (token == null) {
    ...
    private static X509Certificate[] getCertificateChain(HttpRequest request, PassportSession session) {
        try {
