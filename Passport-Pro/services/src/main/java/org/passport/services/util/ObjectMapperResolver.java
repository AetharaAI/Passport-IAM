...
public class ObjectMapperResolver implements ContextResolver<ObjectMapper> {
    ...
    public static ObjectMapper createStreamSerializer() {
        ...
        if (Boolean.parseBoolean(System.getProperty("passport.jsonPrettyPrint", "false"))) {
            mapper.enable(SerializationFeature.INDENT_OUTPUT);
        }

        // allow to discover jackson mappers on the classpath
        if (Boolean.parseBoolean(System.getProperty("passport.jsonEnableJacksonModuleDiscovery", "true"))) {
