...
public class ClientScopeEvaluateScopeMappingsResource {
    ...
    public ClientScopeEvaluateScopeMappingsResource(PassportSession session, RoleContainerModel roleContainer, AdminPermissionEvaluator auth, ClientModel client,
                                                    String scopeParam) {
    ...
    private Stream<RoleModel> getGrantedRoles(PassportSession session) {
