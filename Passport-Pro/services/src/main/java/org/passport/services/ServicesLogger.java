...
/**
 * Main logger for the Passport Services module.
 *
...
public interface ServicesLogger extends BasicLogger {
    ...
    ServicesLogger LOGGER = Logger.getMessageLogger(MethodHandles.lookup(), ServicesLogger.class, "org.passport.services");
