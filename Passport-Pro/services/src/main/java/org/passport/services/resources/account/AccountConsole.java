...
import org.passport.authentication.requiredactions.DeleteAccount;
...
import org.passport.services.util.ViteManifest;
...
public class AccountConsole implements AccountResourceProvider {
    ...
    public AccountConsole(PassportSession session, ClientModel client, Theme theme) {
    ...
    protected Response renderAccountConsole() throws IOException, FreeMarkerException {
        ...
        map.put("resourceCommonUrl", Urls.themeRoot(serverBaseUri).getPath() + "/common/passport");
