...
import static org.passport.utils.CredentialHelper.createUserStorageCredentialRepresentation;
...
public class AccountCredentialResource {
    ...
    public AccountCredentialResource(PassportSession session, UserModel user, Auth auth, EventBuilder event) {
