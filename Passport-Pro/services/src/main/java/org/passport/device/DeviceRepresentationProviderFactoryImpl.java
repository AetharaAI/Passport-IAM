...
import org.passport.cache.LocalCache;
import org.passport.cache.LocalCacheConfiguration;
...
public class DeviceRepresentationProviderFactoryImpl implements DeviceRepresentationProviderFactory {
    ...
    @Override
    public DeviceRepresentationProvider create(PassportSession session) {
