...
import org.passport.common.util.StringPropertyReplacer.PropertyResolver;
...
import static org.passport.common.util.StringPropertyReplacer.replaceProperties;
...
public class NotifyUserStepProvider implements WorkflowStepProvider {
    ...
    public NotifyUserStepProvider(PassportSession session, ComponentModel model) {
    ...
    private class NotificationPropertyResolver implements PropertyResolver {
        ...
        public NotificationPropertyResolver(PassportSession session, WorkflowExecutionContext context) {
            this.session = session;
