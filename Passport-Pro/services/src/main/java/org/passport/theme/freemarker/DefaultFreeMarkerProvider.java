...
public class DefaultFreeMarkerProvider implements FreeMarkerProvider {
    ...
    private final PassportSanitizerMethod kcSanitizeMethod;

    public DefaultFreeMarkerProvider(ConcurrentHashMap<String, Template> cache, PassportSanitizerMethod kcSanitizeMethod) {
        this.cache = cache;
