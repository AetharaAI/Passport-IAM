...
public class ClasspathThemeProviderFactory implements ThemeProviderFactory {
    ...
    public static final String PASSPORT_THEMES_JSON = "META-INF/passport-themes.json";
    ...
    public ClasspathThemeProviderFactory(String id, ClassLoader classLoader) {
        this.id = id;
        loadThemes(classLoader, classLoader.getResourceAsStream(PASSPORT_THEMES_JSON));
    }
    ...
    @Override
    public ThemeProvider create(PassportSession session) {
