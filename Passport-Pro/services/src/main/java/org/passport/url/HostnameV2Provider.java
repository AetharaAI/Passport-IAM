...
public class HostnameV2Provider implements HostnameProvider {
    ...
    public HostnameV2Provider(PassportSession session, String hostname, URI hostnameUrl, URI adminUrl, Boolean backchannelDynamic) {
