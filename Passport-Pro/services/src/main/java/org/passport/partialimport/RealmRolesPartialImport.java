...
import org.passport.services.resources.admin.RoleResource;
...
public class RealmRolesPartialImport extends AbstractPartialImport<RoleRepresentation> {
    ...
    @Override
    public String getModelId(RealmModel realm, PassportSession session, RoleRepresentation roleRep) {
    ...
    @Override
    public boolean exists(RealmModel realm, PassportSession session, RoleRepresentation roleRep) {
    ...
    @Override
    public void remove(RealmModel realm, PassportSession session, RoleRepresentation roleRep) {
    ...
    @Override
    public void create(RealmModel realm, PassportSession session, RoleRepresentation roleRep) {
