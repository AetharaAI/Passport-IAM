...
public class ClientRolesPartialImport {
    ...
    public boolean exists(RealmModel realm, PassportSession session, String clientId, RoleRepresentation roleRep) {
    ...
    public void prepare(PartialImportRepresentation partialImportRep, RealmModel realm, PassportSession session) {
