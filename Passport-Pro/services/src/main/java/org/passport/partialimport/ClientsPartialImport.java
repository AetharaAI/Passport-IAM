...
public class ClientsPartialImport extends AbstractPartialImport<ClientRepresentation> {
    ...
    @Override
    public String getModelId(RealmModel realm, PassportSession session, ClientRepresentation clientRep) {
        return realm.getClientByClientId(getName(clientRep)).getId();
    }

    @Override
    public boolean exists(RealmModel realm, PassportSession session, ClientRepresentation clientRep) {
    ...
    @Override
    public void remove(RealmModel realm, PassportSession session, ClientRepresentation clientRep) {
    ...
    @Override
    public void create(RealmModel realm, PassportSession session, ClientRepresentation clientRep) {
        clientRep.setId(PassportModelUtils.generateId());

        List<ProtocolMapperRepresentation> mappers = clientRep.getProtocolMappers();
        if (mappers != null) {
            for (ProtocolMapperRepresentation mapper : mappers) {
                mapper.setId(PassportModelUtils.generateId());
            }
        }
