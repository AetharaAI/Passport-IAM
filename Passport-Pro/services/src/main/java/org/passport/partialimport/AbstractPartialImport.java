...
public abstract class AbstractPartialImport<T> implements PartialImport<T> {
    ...
    public abstract String getModelId(RealmModel realm, PassportSession session, T resourceRep);
    public abstract boolean exists(RealmModel realm, PassportSession session, T resourceRep);
    public abstract String existsMessage(RealmModel realm, T resourceRep);
    public abstract ResourceType getResourceType();
    public abstract void remove(RealmModel realm, PassportSession session, T resourceRep);
    public abstract void create(RealmModel realm, PassportSession session, T resourceRep);
    ...
    @Override
    public PartialImportResults doImport(PartialImportRepresentation partialImportRep, RealmModel realm, PassportSession session) {
