 ...
 * by the Passport Provider SPI configuration mechanism
 * <p>
 * If TruststoreProvider is not available this SSLSocketFactory will delegate all operations to the SSLSocketFactory
 * returned by {@link org.passport.common.crypto.CryptoProvider#wrapFactoryForTruststore(javax.net.ssl.SSLSocketFactory)},
