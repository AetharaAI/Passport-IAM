...
package org.passport.truststore;
...
public class FileTruststoreProviderFactory implements TruststoreProviderFactory {
    ...
    @Override
    public TruststoreProvider create(PassportSession session) {
        return provider;
    }
    ...
    private static class TruststoreCertificatesLoader {
        ...
        /**
         * Get all certificates from Passport Truststore, and classify them in two lists : root CAs and intermediates CAs
         */
        private void readTruststore(KeyStore truststore) {
            ...
            try {
                ...
                log.error("Error while reading Passport truststore "+e.getMessage(),e);
            }
        }
        ...
        private void readTruststoreEntry(KeyStore truststore, String alias) {
            try {
                ...
                log.warnf("Error while reading Passport truststore entry [%s]. Exception message: %s", alias, e.getMessage(), e);
            }
        }
