...
import org.passport.truststore.JSSETruststoreConfigurator;
...
public class DefaultEmailSenderProvider implements EmailSenderProvider {
    ...
    public DefaultEmailSenderProvider(PassportSession session, Map<EmailAuthenticator.AuthenticatorType, EmailAuthenticator> authenticators) {
