...
package org.passport.email.freemarker;
...
import org.passport.email.freemarker.beans.EventBean;
...
import org.passport.theme.beans.LinkExpirationFormatterMethod;
...
public class FreeMarkerEmailTemplateProvider implements EmailTemplateProvider {
    ...
    public FreeMarkerEmailTemplateProvider(PassportSession session) {
