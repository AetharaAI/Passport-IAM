package org.passport.workflow.admin.resource;
...
public class WorkflowsResource {
    ...
    public WorkflowsResource(PassportSession session, AdminPermissionEvaluator auth) {
    ...
    @Tag(name = PassportOpenAPI.Admin.Tags.WORKFLOWS)
    @Operation(
