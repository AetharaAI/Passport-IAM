...
public class OrganizationMemberResource {
    ...
    public OrganizationMemberResource(PassportSession session, OrganizationModel organization, AdminEventBuilder adminEvent) {
    ...
    public Response addMember(String id) {
        id = id.trim().replaceAll("^\"|\"$", ""); // fixes https://github.com/passport/passport/issues/34401
