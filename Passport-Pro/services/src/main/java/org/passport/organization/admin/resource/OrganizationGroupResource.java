...
public class OrganizationGroupResource {
    ...
    public OrganizationGroupResource(PassportSession session, OrganizationProvider organizationProvider, OrganizationModel organization, GroupModel group, AdminEventBuilder adminEvent) {
