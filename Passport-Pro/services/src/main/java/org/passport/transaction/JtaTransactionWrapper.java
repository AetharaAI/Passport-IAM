...
import org.passport.provider.ExceptionConverter;
 ...
 * @version $Revision: 1 $
 */
public class JtaTransactionWrapper implements PassportTransaction {
    ...
    public JtaTransactionWrapper(PassportSession session, TransactionManager tm) {
        this.tm = tm;
    ...
    public void handleException(Throwable e) {
        ...
        session.getPassportSessionFactory().getProviderFactoriesStream(ExceptionConverter.class)
