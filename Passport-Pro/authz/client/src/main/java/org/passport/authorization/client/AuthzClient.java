 ...
 */
package org.passport.authorization.client;

import java.io.IOException;
import java.io.InputStream;

import org.passport.authorization.client.representation.ServerConfiguration;
import org.passport.authorization.client.resource.AuthorizationResource;
import org.passport.authorization.client.resource.ProtectionResource;
import org.passport.authorization.client.util.Http;
import org.passport.authorization.client.util.TokenCallable;
...
import static org.passport.constants.ServiceUrlConstants.AUTHZ_DISCOVERY_URL;

/**
 * <p>This is class serves as an entry point for clients looking for access to Passport Authorization Services.
 *
 * <p>When creating a new instances make sure you have a Passport Server running at the location specified in the client
...
public class AuthzClient {
     ...
     *
     * <p>This method expects a <code>passport.json</code> in the classpath, otherwise an exception will be thrown.
     *
     * @return a new instance
     * @throws RuntimeException in case there is no <code>passport.json</code> file in the classpath or the file could not be parsed
     */
    public static AuthzClient create() throws RuntimeException {
        InputStream configStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("passport.json");
    ...
    private AuthzClient(Configuration configuration) {
        ...
        configurationUrl = PassportUriBuilder.fromUri(configurationUrl).clone().path(AUTHZ_DISCOVERY_URL).build(configuration.getRealm()).toString();
