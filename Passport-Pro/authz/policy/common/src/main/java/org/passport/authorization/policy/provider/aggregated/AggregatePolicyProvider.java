 ...
 *
 */
package org.passport.authorization.policy.provider.aggregated;
...
import org.passport.authorization.policy.evaluation.DecisionResultCollector;
...
public class AggregatePolicyProvider implements PolicyProvider, PartialEvaluationPolicyProvider {
    ...
    @Override
    public boolean evaluate(PassportSession session, Policy policy, UserModel subject) {
