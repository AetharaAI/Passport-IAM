 ...
 *
 */
package org.passport.authorization.policy.provider.role;
...
import org.passport.authorization.attribute.Attributes.Entry;
import org.passport.authorization.fgap.evaluation.partial.PartialEvaluationPolicyProvider;
import org.passport.authorization.identity.Identity;
import org.passport.authorization.identity.UserModelIdentity;
...
import static org.passport.models.utils.RoleUtils.getDeepUserRoleMappings;
...
public class RolePolicyProvider implements PolicyProvider, PartialEvaluationPolicyProvider {
    ...
    public void evaluate(Evaluation evaluation) {
        ...
        RealmModel realm = authorizationProvider.getPassportSession().getContext().getRealm();
    ...
    private UserModel getSubject(Identity identity, RealmModel realm, AuthorizationProvider authorizationProvider) {
        PassportSession session = authorizationProvider.getPassportSession();
    ...
    @Override
    public Stream<Policy> getPermissions(PassportSession session, ResourceType resourceType, ResourceType groupResourceType, UserModel subject) {
    ...
    @Override
    public boolean evaluate(PassportSession session, Policy policy, UserModel adminUser) {
        RealmModel realm = session.getContext().getRealm();
