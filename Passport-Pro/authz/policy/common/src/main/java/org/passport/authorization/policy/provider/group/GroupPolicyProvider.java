 ...
 */
package org.passport.authorization.policy.provider.group;
...
public class GroupPolicyProvider implements PolicyProvider, PartialEvaluationPolicyProvider {
    ...
    @Override
    public Stream<Policy> getPermissions(PassportSession session, ResourceType resourceType, ResourceType groupResourceType, UserModel user) {
