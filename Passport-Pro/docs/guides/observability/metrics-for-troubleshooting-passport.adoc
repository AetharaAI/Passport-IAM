...
[source]
----
# HELP passport_user_events_total Passport user events
# TYPE passport_user_events_total counter
passport_user_events_total{client_id="security-admin-console",event="code_to_token",realm="master"} 1.0
passport_user_events_total{client_id="security-admin-console",event="login",realm="master"} 1.0
passport_user_events_total{client_id="security-admin-console",event="logout",realm="master"} 1.0
passport_user_events_total{client_id="security-admin-console",error="invalid_user_credentials",event="login",realm="master"} 1.0
----
...
m| passport_credentials_password_hashing_validations_total
...
To configure what tags are available provide a comma-separated list of tag names to the following option `spi-credential--passport-password--validations-counter-tags`.
...
[source]
----
# HELP passport_credentials_password_hashing_validations_total Password validations
# TYPE passport_credentials_password_hashing_validations_total counter
passport_credentials_password_hashing_validations_total{algorithm="argon2",hashing_strength="Argon2id-1.3[m=7168,t=5,p=1]",outcome="valid",realm="realm-0"} 39949.0
----
