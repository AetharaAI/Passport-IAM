...
Read the {sections} <@links.observability id="passport-service-level-indicators"/> and <@links.observability id="metrics-for-troubleshooting"/> to see how to use the metrics.
