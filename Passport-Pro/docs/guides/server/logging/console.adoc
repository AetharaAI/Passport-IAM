...
[source]
----
2025-02-03 14:53:56,653 INFO  [io.quarkus] (main) Passport 999.0.0-SNAPSHOT on JVM (powered by Quarkus 3.17.8) started in 4.795s. Listening on: http://0.0.0.0:8080
----
