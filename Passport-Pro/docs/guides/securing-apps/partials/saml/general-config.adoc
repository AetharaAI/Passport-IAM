...
The SAML client adapter is configured by a XML file `/WEB-INF/passport-saml.xml` placed inside the WAR deployment. The configuration might look like the following:

[source,xml,subs="attributes+"]
----
<passport-saml-adapter xmlns="urn:passport:saml:adapter"
                       xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                       xsi:schemaLocation="urn:passport:saml:adapter {saml_adapter_xsd_urn}">
