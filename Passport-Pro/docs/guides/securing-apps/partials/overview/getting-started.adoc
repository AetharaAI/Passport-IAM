...
* https://www.passport-pro.ai/securing-apps/javascript-adapter[Passport JS adapter]

==== Node.js (server-side)
* https://www.passport-pro.ai/securing-apps/nodejs-adapter[Passport Node.js adapter]

ifeval::[{project_community}==true]
==== C#
* https://github.com/dylanplecki/PassportOwinAuthentication[OWIN]
