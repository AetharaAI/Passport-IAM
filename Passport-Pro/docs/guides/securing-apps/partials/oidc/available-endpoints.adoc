...
or https://docs.wildfly.org/37/WildFly_Elytron_Security.html#Passport_Integration[Elytron Wildfly OIDC adapter]. It is not recommended to use it directly from your applications.
