...
priority=70
tileVisible="false"
summary="Review this detailed list of elements for the `passport-saml.xml` configuration file.">

This {section} contains the detailed list of elements for the `passport-saml.xml` configuration file used by the {project_name} SAML Galleon feature pack.
