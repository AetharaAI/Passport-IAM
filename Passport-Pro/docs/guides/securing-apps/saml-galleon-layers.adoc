...
in the https://docs.wildfly.org/32/WildFly_Elytron_Security.html#Passport_SAML_Integration[WildFly documentation].
...
For an example about how to integrate Passport with JakartaEE applications running on latest Wildfly/EAP, take a look at the `servlet-saml-service-provider` Jakarta folder in the https://github.com/passport/passport-quickstarts[Passport Quickstart GitHub Repository].
