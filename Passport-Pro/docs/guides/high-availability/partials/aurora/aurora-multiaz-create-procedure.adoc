...
aws ec2 create-vpc \
  ...
  --tag-specifications "ResourceType=vpc, Tags=[{Key=AuroraCluster,Value=passport-aurora}]" \# <1>
  --region eu-west-1
----
...
aws rds create-db-subnet-group \
  --db-subnet-group-name passport-aurora-subnet-group \
...
aws ec2 create-security-group \
  --group-name passport-aurora-security-group \
...
----
{
    "DBCluster": {
        ...
        "DBClusterIdentifier": "passport-aurora",
        "DBClusterParameterGroup": "default.aurora-postgresql15",
        "DBSubnetGroup": "passport-aurora-subnet-group",
        "Status": "creating",
        "Endpoint": "passport-aurora.cluster-clhthfqe0h8p.eu-west-1.rds.amazonaws.com",
        "ReaderEndpoint": "passport-aurora.cluster-ro-clhthfqe0h8p.eu-west-1.rds.amazonaws.com",
        "MultiAZ": false,
        "Engine": "aurora-postgresql",
        "EngineVersion": "15.5",
        "Port": 5432,
        "MasterUsername": "passport",
        ...
        "DBClusterArn": "arn:aws:rds:eu-west-1:606671647913:cluster:passport-aurora",
        "AssociatedRoles": [],
...
----
  aws rds create-db-instance \
    ...
    --db-cluster-identifier passport-aurora \
    --db-instance-identifier "passport-aurora-instance-1" \
...
----
  aws rds create-db-instance \
    --no-auto-minor-version-upgrade \
    --db-cluster-identifier passport-aurora \
    --db-instance-identifier "passport-aurora-instance-2" \
    --db-instance-class db.t4g.large \
    --engine aurora-postgresql \
    --region eu-west-1
----
...
[source,bash]
----
aws rds wait db-instance-available --db-instance-identifier passport-aurora-instance-1 --region eu-west-1
aws rds wait db-instance-available --db-instance-identifier passport-aurora-instance-2 --region eu-west-1
----
+
. [[aurora-writer-url]]Obtain the Writer endpoint URL for use by Passport
+
.Command:
[source,bash]
----
...
----
[
    "passport-aurora.cluster-clhthfqe0h8p.eu-west-1.rds.amazonaws.com"
]
----
