# Changing the Default *passport-subsystem* Configuration

If you need to make a change to the default passport-subsystem 
configuration that is packaged with our distributions, you will need to edit this file:
https://github.com/passport/passport/blob/main/wildfly/server-subsystem/src/main/config/default-server-subsys-config.properties
...
https://github.com/passport/passport/blob/main/wildfly/server-subsystem/src/main/resources/cli/default-passport-subsys-config.cli
