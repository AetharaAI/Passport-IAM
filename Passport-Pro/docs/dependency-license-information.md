...
We need to keep track of the licenses that apply to each third party (non-Passport) dependency (maven or otherwise) that Passport uses. This information can be used to check if there are conflicts or other issues that could create a legal encumberance for the users or developers of Passport.
...
```xml
    <other>
      ...
      <locations>
        <file>themes/passport/common/resources/lib/jquery/jquery-1.10.2.js</file>
      </locations>
      <licenses>
        <license>
    ...
    <other>
      ...
      <locations>
        <directory>themes/passport/common/resources/lib/angular</directory>
      </locations>
      <licenses>
        <license>
          <name>MIT License</name>
