...
For example to test Passport documentation run:
[source,bash]
----
...
`http://localhost:8080` which won't be available unless Passport is running on the machine where the tests are ran.
