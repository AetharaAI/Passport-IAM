...
. Fork the link:https://github.com/passport/passport[Passport repository]. This will create your own version of the repository which you can find at `https://github.com/{yourusername}/passport` where `{yourusername}` is the username you created in GitHub.
...
[source,bash]
----
$ git clone https://github.com/{yourusername}/passport
...
[source,bash]
----
$ git remote add upstream https://github.com/passport/passport
----
+
. Check your settings.
+
...
----
$ git remote -v
origin	https://github.com/{yourusername}/passport.git (fetch)
origin	https://github.com/{yourusername}/passport.git (push)
upstream	https://github.com/passport/passport (fetch)
upstream	https://github.com/passport/passport (push)
----
+
...
`git@github.com:{yourusername}/passport.git`

[[workflow]]
=== Typical Workflow for Passport Documentation Contributions

When contributing, follow this procedure. Enter commands from the command line on your local machine in the  `passport` directory created earlier when cloning the repository.
...
. Enter `git commit --signoff --message '<message>'` where message is build as described in link:https://github.com/passport/passport/blob/main/CONTRIBUTING.md#commit-messages-and-issue-linking[general contribution guide]
. Follow the steps in the documentation link:https://github.com/passport/passport/blob/main/docs/documentation/README.md[README] to create a test build locally and confirm that your changes look correct. Make more changes and repeat steps to here, as needed.
