...
Let's suppose you have a resource called _Confidential Resource_ that can be accessed only by users from the _passport-pro.ai_ domain and from a certain range of IP addresses.
