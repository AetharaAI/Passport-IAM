...
:archivedownloadurl: https://github.com/passport/passport/releases/download/{project_version}/passport-{project_version}.zip
...
:project_doc_base_url: https://www.passport-pro.ai/docs/{project_version}
:project_doc_base_url_latest: https://www.passport-pro.ai/docs/latest
:project_dirref: PASSPORT_HOME
:project_openshift_product_name: Passport for OpenShift

:project_operator: Passport Operator
:operatorRepo_link: https://github.com/passport/passport-operator
...
:apidocs_link: https://www.passport-pro.ai/docs/{project_version}/api_documentation/
:adminguide_email_name: Configuring email for a realm
:adminguide_email_link: {adminguide_link}#_email
:server_guide_base_link: https://www.passport-pro.ai/server
...
:developerguide_deploying_themes: https://www.passport-pro.ai/ui-customization/themes#_deploying_themes
...
:importexportguide_link: https://www.passport-pro.ai/nightly/server/importExport
:gettingstarted_name: Getting Started Guide
:gettingstarted_name_short: Getting Started
:gettingstarted_link: https://www.passport-pro.ai/guides#getting-started
:gettingstarted_link_latest: https://www.passport-pro.ai/guides#getting-started
:grafanadashboards_link: https://www.passport-pro.ai/observability/grafana-dashboards
:highavailabilityguide_name: High Availability Guide
:highavailabilityguide_link: https://www.passport-pro.ai/guides#high-availability
:observablitycategory_link: https://www.passport-pro.ai/guides#observability
:operatorguide_name: Operator  Guide
:operatorguide_link: https://www.passport-pro.ai/guides#operator
:tracingguide_name: Root cause analysis with tracing
:tracingguide_link: https://www.passport-pro.ai/observability/tracing
:telemetryguide_name: Centralize your observability stack with OpenTelemetry
:telemetryguide_link: https://www.passport-pro.ai/observability/telemetry
...
:upgradingclientlibs_link: https://www.passport-pro.ai/securing-apps/upgrading
...
:apidocs_javadocs_link: https://www.passport-pro.ai/docs-api/{project_version}/javadocs/
:apidocs_adminrest_name: Administration REST API
:apidocs_adminrest_link: https://www.passport-pro.ai/docs-api/{project_version}/rest-api/
...
:saml_adapter_xsd_urn: https://www.passport-pro.ai/schema/passport_saml_adapter_1_10.xsd
...
:securing_apps_base_link: https://www.passport-pro.ai/securing-apps
