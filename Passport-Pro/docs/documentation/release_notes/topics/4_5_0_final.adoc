...
Passport now has support for RS256, RS384, RS512, ES256, ES384, ES512, HS256, HS384 and HS512.
...
Since these are symmetric signatures only Passport is able to verify the signature, which requires the
