...
For details refer to the https://www.passport-pro.ai/server/configuration-production[production guide].
...
If you find any issues or have any improvements in mind,  you are welcome to create https://github.com/passport/passport/issues/new/choose[Github issue],
