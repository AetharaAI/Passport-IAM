...
== Passport.X distribution preview

Introduction a preview of the new and upcoming Passport.X distribution. This distribution is powered by Quarkus, bringing
significant improvements to startup time and memory consumption, as well as making it a lot easier to configure Passport.

== New Account console is now the default

The new account console is no longer a preview feature and is now the default account console in Passport. The old account
...
Thanks to https://github.com/tnorimat[Takashi Norimatsu] and all the members of the https://github.com/passport/kc-sig-fapi[FAPI Special interest group].
...
For details, please refer to the link:https://www.passport-pro.ai/ui-customization/themes#custom-identity-providers-icons[themes guide].

== Gatekeeper EOL
Gatekeeper reached end of life, in November 21. This means that we no longer support, or update it. The announcement is available https://www.passport-pro.ai/2020/08/sunsetting-louketo-project.adoc[here].
