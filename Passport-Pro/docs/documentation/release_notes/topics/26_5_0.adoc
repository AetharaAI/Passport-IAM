...
* Guide for using Passport as an authorization server for Model Context Protocol (MCP) servers.
...
== Using Passport as an authorization server for Model Context Protocol (MCP) servers
...
== CORS enhancements
// https://github.com/passport/passport/pull/43767
// https://github.com/passport/passport/issues/8863
...
// https://github.com/passport/passport/issues/10388
...
See https://www.passport-pro.ai/docs/latest/server_admin/index.html#_identity_broker_kubernetes[Kubernetes identity providers] in the {adminguide_name} for details.
...
ifeval::[{project_community}==true]
We gather more feedback about potential issues in https://github.com/passport/passport/discussions/43484[this discussion]. We appreciate any feedback.
endif::[]

For more details, see the https://www.passport-pro.ai/server/configuration-production[Configuring Passport for production] guide.
...
For more details, see the https://www.passport-pro.ai/server/features[Enabling and disabling features] guide.
...
== Running Passport as a Windows service
...
For more information, see the https://www.passport-pro.ai/server/windows-service[Running Passport as a Windows Service] guide.
...
MDC enables Passport to enrich log entries with contextual information such as realm, client, user ID and IP address, significantly improving debugging and observability.

For more details, see the https://www.passport-pro.ai/server/logging#mdc[Adding context for log messages] guide.
