...
Finally thanks to all the members of the https://github.com/passport/kc-sig-fapi/blob/main/members.adoc[FAPI Special interest group] for their help and feedback.
