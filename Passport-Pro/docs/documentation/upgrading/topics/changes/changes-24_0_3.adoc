...
= Changes to the `org.passport.userprofile.UserProfileDecorator` interface

To properly support multiple user storage providers within a realm, the `org.passport.userprofile.UserProfileDecorator`
