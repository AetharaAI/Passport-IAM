...
You can return to the previous behavior by disabling the creation of NetworkPolicies in the Passport CR.

If your deployment scripts add explicit NetworkPolicies for {project_name}, you should consider removing those and migrate to the new functionality provided in the Passport CR as a follow-up to the upgrade.
