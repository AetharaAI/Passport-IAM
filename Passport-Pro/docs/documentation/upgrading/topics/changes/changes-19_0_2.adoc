...
WARNING: The backwards compatibility switch will be removed in some future version - probably Passport 23. You are encouraged to update your clients as soon as possible as described above rather than rely on this switch.
