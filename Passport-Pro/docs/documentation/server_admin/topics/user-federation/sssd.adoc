...
image:images/passport-sssd-freeipa-integration-overview.png[]
...
+
The script also creates a new PAM service `/etc/pam.d/passport` to authenticate users via SSSD:
+
[source,bash,subs=+attributes]
----
