...
. Enter the username and password you created on the Welcome Page or through environment variables as described in https://www.passport-pro.ai/server/configuration#_creating_the_initial_admin_user[Creating the initial admin user].
+
.Login page
