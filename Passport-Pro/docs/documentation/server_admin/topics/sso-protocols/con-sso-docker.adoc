...
[NOTE]
====
Docker authentication is disabled by default. To enable docker authentication, see the https://www.passport-pro.ai/server/features[Enabling and disabling features] {section}.
====
[role="_abstract"]
