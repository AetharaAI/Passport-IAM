...
the legacy {project_name} Java OIDC adapters or by the link:https://docs.wildfly.org/37/WildFly_Elytron_Security.html#Passport_Integration[Elytron Wildfly OIDC adapter].
