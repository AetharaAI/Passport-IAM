...
. A {project_name} server configured in order to use the truststore. For more information, see the https://www.passport-pro.ai/server/passport-truststore[Configuring a Truststore] {section}.
