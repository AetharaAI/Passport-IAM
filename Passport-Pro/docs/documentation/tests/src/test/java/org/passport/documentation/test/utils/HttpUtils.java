package org.passport.documentation.test.utils;
...
public class HttpUtils {
    ...
    private Response exec(HttpUriRequestBase method) {
        ...
        try {
            ...
            method.addHeader(HttpHeaders.USER_AGENT, "Java/" + System.getProperty("java.version") + " (https://www.passport-pro.ai; passport-dev@googlegroups.com)");
