...
There are other model classes within the `org.passport.models` package that represent other parts of the {project_name} metamodel: `RealmModel`, `RoleModel`, `GroupModel`, and `ClientModel`.
...
----
            ...
            throws ComponentValidationException
    {
        ...
        if (model.getId() == null) {
            ...
            model.setId(PassportModelUtils.generateShortId());
        }
    }
----
