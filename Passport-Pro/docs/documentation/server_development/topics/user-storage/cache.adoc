...
You can access the user cache by calling `PassportSession.getProvider(UserCache.class)`.
...
has a callback whenever a user is cached: `org.passport.models.cache.OnUserCache`.
