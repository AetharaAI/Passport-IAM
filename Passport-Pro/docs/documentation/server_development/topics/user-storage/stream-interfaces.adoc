...
sub-interface to be implemented include a few _<<_provider_capability_interfaces,capability interfaces>>_, all interfaces in the `org.passport.storage.federated`
...
| `org.passport.credential` | `CredentialInputUpdater`(*), `UserCredentialStore`
| `org.passport.models` | `GroupModel`, `RoleMapperModel`, `UserCredentialManager`, `UserModel`, `UserProvider`
| `org.passport.models.cache` | `CachedUserModel`, `UserCache`
| `org.passport.storage.federated` | All interfaces
| `org.passport.storage.user` | `UserQueryProvider`(*)
endif::[]
ifeval::[{project_product}==true]
| `org.passport.credential` | `CredentialInputUpdater`(*)
| `org.passport.models` | `GroupModel`, `RoleMapperModel`, `UserModel`
| `org.passport.storage.federated` | All interfaces
| `org.passport.storage.user` | `UserQueryProvider`(*)
endif::[]
|===
