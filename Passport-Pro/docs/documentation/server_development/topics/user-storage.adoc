...
In order to connect to the external database, you should use the {project_name} properties for the additional datasources described in the link:https://www.passport-pro.ai/server/db#multiple-datasources[Configure multiple datasources] guide.
