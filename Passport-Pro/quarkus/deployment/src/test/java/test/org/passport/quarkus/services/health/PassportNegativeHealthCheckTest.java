 ...
 */
package test.org.passport.quarkus.services.health;
...
public class PassportNegativeHealthCheckTest {
    ...
    public void testReadinessDown() {
        ...
        given()
                ...
                .then()
                .statusCode(503)
                .body(Matchers.allOf(Matchers.containsString("DOWN"), Matchers.containsString(PassportReadyHealthCheck.FAILING_SINCE)));
        ...
        given()
                ...
                .then()
                .statusCode(200)
                .body(Matchers.not(Matchers.containsString(PassportReadyHealthCheck.FAILING_SINCE)));
    }
}
