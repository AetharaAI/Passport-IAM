...
package org.passport.quarkus.runtime.services;
 ...
 * of the double slashes that Passport performs.
 */
public class RejectNonNormalizedPathFilter implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext routingContext) {
        if (!Objects.equals(routingContext.request().path(), routingContext.normalizedPath())) {
            ...
            // Passport does not use @MatrixParam, therefore any URL containing a semicolon is treated as invalid.
            // Once Passport starts using them in any of its APIs, consider enabling them only for specific paths,
