...
/**
 * <p>This interceptor is responsible for ignoring disabled Passport properties
 *
...
public class DisabledMappersInterceptor implements ConfigSourceInterceptor {
    ...
    private <T> boolean isDisabledMapper(String property) {
        return property.startsWith(NS_PASSPORT_PREFIX) && PropertyMappers.isDisabledMapper(property);
    }
