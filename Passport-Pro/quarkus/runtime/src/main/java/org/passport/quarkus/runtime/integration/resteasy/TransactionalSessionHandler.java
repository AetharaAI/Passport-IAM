...
public final class TransactionalSessionHandler implements ServerRestHandler, org.passport.quarkus.runtime.transaction.TransactionalSessionHandler {

    @Override
    public void handle(ResteasyReactiveRequestContext requestContext) {
        requestContext.requireCDIRequestScope();
        PassportSession currentSession = Arc.container().instance(PassportSession.class).get();
        ...
        if (PassportSessionUtil.setPassportSession(currentSession) == null) {
