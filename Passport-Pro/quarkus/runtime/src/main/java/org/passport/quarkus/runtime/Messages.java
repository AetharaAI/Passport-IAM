...
public final class Messages {
    ...
    public static String httpsConfigurationNotSet() {
        ...
        if (!org.passport.common.util.Environment.DEV_PROFILE_VALUE.equals(org.passport.common.util.Environment.getProfile())) {
    ...
    public static String devProfileNotAllowedError(String cmd) {
        return String.format("You can not '%s' the server in %s mode. Please re-build the server first, using '%s build' for the default production mode.%n", cmd, Environment.getPassportModeFromProfile(org.passport.common.util.Environment.DEV_PROFILE_VALUE), Environment.getCommand());
    }
    ...
    public static String invalidLogCategoryFormat(String category) {
        return "Invalid log category format: " + category + ". The format is 'category:level' such as 'org.passport:debug'.";
    }
