...
@PreMatching
@Priority(1)
public class CloseSessionFilter implements ContainerResponseFilter, org.passport.quarkus.runtime.transaction.TransactionalSessionHandler {
    ...
    private void closeSession() {
        close(PassportSessionUtil.getPassportSession());
    }
}
