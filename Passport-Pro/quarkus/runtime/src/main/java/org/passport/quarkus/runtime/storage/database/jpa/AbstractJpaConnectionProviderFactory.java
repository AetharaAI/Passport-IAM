...
import org.passport.connections.jpa.DefaultJpaConnectionProvider;
...
public abstract class AbstractJpaConnectionProviderFactory implements JpaConnectionProviderFactory {
    ...
    protected EntityManager createEntityManager(EntityManagerFactory emf, PassportSession session, boolean sessionManaged) {
