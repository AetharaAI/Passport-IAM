...
package org.passport.quarkus.runtime.logging;
 ...
 */
public abstract class PassportLogFilter implements Filter {

    private static final Logger logger = Logger.getLogger(PassportLogFilter.class);
    ...
    public boolean isLoggable(LogRecord record) {
        ...
        if (MultiSiteUtils.isPersistentSessionsEnabled()) {
            ...
            // https://github.com/passport/passport/issues/39816
    ...
    public record RecordLogger(LogRecord record, PassportLogFilter filter) implements Runnable {
        @Override
        public void run() {
    ...
    @LoggingFilter(name = "passport-filter-console")
    private static final class PassportConsoleLogFilter extends PassportLogFilter {
        @Override
    ...
    @LoggingFilter(name = "passport-filter-file")
    private static final class PassportFileLogFilter extends PassportLogFilter {
        @Override
        protected Class<? extends Handler> getHandlerClass() {
    ...
    @LoggingFilter(name = "passport-filter-syslog")
    private static final class PassportSyslogLogFilter extends PassportLogFilter {
        protected Class<? extends Handler> getHandlerClass() {
