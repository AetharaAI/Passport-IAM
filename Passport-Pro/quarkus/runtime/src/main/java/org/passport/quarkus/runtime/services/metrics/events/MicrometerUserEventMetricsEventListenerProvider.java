...
public class MicrometerUserEventMetricsEventListenerProvider implements EventListenerProvider {
    ...
    public MicrometerUserEventMetricsEventListenerProvider(PassportSession session, boolean withIdp, boolean withRealm, boolean withClientId, HashSet<String> events, Meter.MeterProvider<Counter> meterProvider) {
