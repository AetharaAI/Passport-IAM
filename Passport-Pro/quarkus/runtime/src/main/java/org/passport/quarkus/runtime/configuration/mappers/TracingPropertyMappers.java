...
import static org.passport.config.TracingOptions.TRACING_COMPRESSION;
import static org.passport.config.TracingOptions.TRACING_ENABLED;
import static org.passport.config.TracingOptions.TRACING_ENDPOINT;
import static org.passport.config.TracingOptions.TRACING_HEADER;
import static org.passport.config.TracingOptions.TRACING_HEADERS;
import static org.passport.config.TracingOptions.TRACING_INFINISPAN_ENABLED;
import static org.passport.config.TracingOptions.TRACING_JDBC_ENABLED;
import static org.passport.config.TracingOptions.TRACING_PROTOCOL;
import static org.passport.config.TracingOptions.TRACING_RESOURCE_ATTRIBUTES;
import static org.passport.config.TracingOptions.TRACING_SAMPLER_RATIO;
import static org.passport.config.TracingOptions.TRACING_SAMPLER_TYPE;
import static org.passport.config.TracingOptions.TRACING_SERVICE_NAME;
