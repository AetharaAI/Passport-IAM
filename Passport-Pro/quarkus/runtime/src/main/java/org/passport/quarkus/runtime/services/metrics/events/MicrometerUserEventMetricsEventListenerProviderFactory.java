...
package org.passport.quarkus.runtime.services.metrics.events;
...
public class MicrometerUserEventMetricsEventListenerProviderFactory implements EventListenerProviderFactory, EnvironmentDependentProviderFactory {
    ...
    private static final String DESCRIPTION_OF_EVENT_METER = "Passport user events";
    ...
    private static final String USER_EVENTS_METER_NAME = PASSPORT_METER_NAME_PREFIX + "user";
