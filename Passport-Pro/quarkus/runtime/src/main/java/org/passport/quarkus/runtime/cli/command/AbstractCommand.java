...
import static org.passport.quarkus.runtime.Messages.cliExecutionError;
    ...
    public String getInitProfile() {
        ...
        return Optional.ofNullable(this.getDefaultProfile())
                .or(() -> Optional.ofNullable(
                        PersistedConfigSource.getInstance().getValue(org.passport.common.util.Environment.PROFILE)))
