...
import org.passport.connections.httpclient.HttpClientFactory;
...
/**
 * The traced {@link HttpClientFactory} for {@link HttpClientProvider HttpClientProvider's} used by Passport for outbound HTTP calls which are traced.
 */
