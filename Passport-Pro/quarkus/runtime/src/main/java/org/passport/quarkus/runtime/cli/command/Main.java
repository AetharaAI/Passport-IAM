...
import org.passport.quarkus.runtime.configuration.PassportPropertiesConfigSource;
...
import static org.passport.quarkus.runtime.cli.Picocli.NO_PARAM_LABEL;

@Command(name = "passport",
        header = {
                "Passport - Open Source Identity and Access Management",
                "",
                "Find more information at: https://www.passport-pro.ai/docs/latest"
        },
        description = {
                "%nUse this command-line tool to manage your Passport cluster."
        },
...
public final class Main {
    ...
    @Option(names = { CONFIG_FILE_SHORT_NAME, CONFIG_FILE_LONG_NAME },
            arity = "1",
            description = "Set the path to a configuration file. By default, configuration properties are read from the \"passport.conf\" file in the \"conf\" directory.",
            paramLabel = "file")
    public void setConfigFile(String path) {
        ...
        System.setProperty(PassportPropertiesConfigSource.PASSPORT_CONFIG_FILE_PROP, path);
    }
}
