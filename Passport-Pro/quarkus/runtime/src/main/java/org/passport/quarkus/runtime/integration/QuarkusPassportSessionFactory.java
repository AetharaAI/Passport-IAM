...
import org.passport.quarkus.runtime.themes.QuarkusJarThemeProviderFactory;
...
public final class QuarkusPassportSessionFactory extends DefaultPassportSessionFactory {

    public static QuarkusPassportSessionFactory getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new QuarkusPassportSessionFactory();
        }

        return INSTANCE;
    }

    public static void setInstance(QuarkusPassportSessionFactory instance) {
        INSTANCE = instance;
    }

    private static QuarkusPassportSessionFactory INSTANCE;

    public QuarkusPassportSessionFactory(
    ...
    private QuarkusPassportSessionFactory() {
    }
    ...
    public PassportSession create() {
        return new QuarkusPassportSession(this);
    }
}
