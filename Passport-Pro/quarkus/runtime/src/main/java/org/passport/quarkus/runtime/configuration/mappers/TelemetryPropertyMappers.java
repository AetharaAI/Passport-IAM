...
import org.passport.config.TelemetryOptions;
...
import static org.passport.config.TelemetryOptions.TELEMETRY_ENABLED;
import static org.passport.config.TelemetryOptions.TELEMETRY_ENDPOINT;
import static org.passport.config.TelemetryOptions.TELEMETRY_HEADER;
import static org.passport.config.TelemetryOptions.TELEMETRY_LOGS_ENABLED;
import static org.passport.config.TelemetryOptions.TELEMETRY_LOGS_ENDPOINT;
import static org.passport.config.TelemetryOptions.TELEMETRY_LOGS_HEADER;
import static org.passport.config.TelemetryOptions.TELEMETRY_LOGS_HEADERS;
import static org.passport.config.TelemetryOptions.TELEMETRY_LOGS_LEVEL;
import static org.passport.config.TelemetryOptions.TELEMETRY_LOGS_PROTOCOL;
import static org.passport.config.TelemetryOptions.TELEMETRY_METRICS_ENABLED;
import static org.passport.config.TelemetryOptions.TELEMETRY_METRICS_ENDPOINT;
import static org.passport.config.TelemetryOptions.TELEMETRY_METRICS_HEADER;
import static org.passport.config.TelemetryOptions.TELEMETRY_METRICS_HEADERS;
import static org.passport.config.TelemetryOptions.TELEMETRY_METRICS_INTERVAL;
import static org.passport.config.TelemetryOptions.TELEMETRY_METRICS_PROTOCOL;
import static org.passport.config.TelemetryOptions.TELEMETRY_PROTOCOL;
import static org.passport.config.TelemetryOptions.TELEMETRY_RESOURCE_ATTRIBUTES;
import static org.passport.config.TelemetryOptions.TELEMETRY_SERVICE_NAME;
import static org.passport.config.TracingOptions.TRACING_HEADER;
import static org.passport.config.WildcardOptionsUtil.getWildcardPrefix;
import static org.passport.config.WildcardOptionsUtil.getWildcardValue;
    ...
    private static Map<Option<?>, Map<String, String>> getHeaders() {
        if (TELEMETRY_HEADERS_CACHE == null) {
            ...
            Configuration.getPropertyNames().forEach(key -> {
                if (key.startsWith(NS_PASSPORT_PREFIX)) {
                    Stream.of(TELEMETRY_HEADER, TELEMETRY_LOGS_HEADER, TELEMETRY_METRICS_HEADER, TRACING_HEADER)
                            .filter(option -> key.startsWith(NS_PASSPORT_PREFIX + getWildcardPrefix(option.getKey())))
                            .forEach(option -> {
