...
public class PassportConfigSourceProvider implements ConfigSourceProvider, ConfigBuilder {
    ...
    public PassportConfigSourceProvider() {
    ...
    private static void initializeSources() {
        ...
        PassportPropertiesConfigSource.InFileSystem inFileSystem = new PassportPropertiesConfigSource.InFileSystem();
