...
package org.passport.quarkus.runtime.transaction;
...
public interface TransactionalSessionHandler {
    ...
    /**
     * Creates a {@link PassportSession}.
     *
     * @return a passport session
     */
    default PassportSession create() {
        PassportSessionFactory sessionFactory = QuarkusPassportSessionFactory.getInstance();
     ...
     */
    default void beginTransaction(PassportSession session) {
        session.getTransactionManager().begin();
    }

    /**
     * Closes a {@link PassportSession}.
     *
     * @param session a session
     */
    default void close(PassportSession session) {
