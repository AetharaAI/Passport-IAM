...
/**
 * Passport Healthcheck Readiness Probe.
 * <p>
 ...
 *
 * @see <a href="https://github.com/passport/passport-community/pull/55">Healthcheck API Design</a>
 */
@Readiness
@ApplicationScoped
public class PassportReadyHealthCheck implements AsyncHealthCheck {
    ...
    public Uni<HealthCheckResponse> call() {
        HealthCheckResponseBuilder builder = HealthCheckResponse.named("Passport database connections async health check").up();
