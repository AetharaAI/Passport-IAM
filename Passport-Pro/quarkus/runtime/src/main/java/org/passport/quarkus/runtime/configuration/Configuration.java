...
import static org.passport.quarkus.runtime.cli.Picocli.ARG_PREFIX;
...
public final class Configuration {
    ...
    public static final String KC_OPTIMIZED = NS_PASSPORT_PREFIX + "optimized";
    ...
    public static boolean isTrue(Option<Boolean> option) {
        return getOptionalBooleanValue(NS_PASSPORT_PREFIX + option.getKey()).orElse(false);
    }
    ...
    public static boolean isUserModifiable(ConfigValue configValue) {
        ...
        return configValue.getConfigSourceName() != null && configValue.getConfigSourceOrdinal() >= PassportPropertiesConfigSource.PROPERTIES_FILE_ORDINAL;
    }
    ...
    public static boolean contains(Option<?> option, String value) {
        return getOptionalValue(NS_PASSPORT_PREFIX + option.getKey())
    ...
    /**
     * Raw persisted passport properties will match the resolved value of what was originally specified by the user
     */
    ...
    public static ConfigValue getKcConfigValue(String propertyName) {
        return getConfigValue(NS_PASSPORT_PREFIX.concat(propertyName));
    }
    ...
    public static Optional<String> getOptionalKcValue(String propertyName) {
        return getOptionalValue(NS_PASSPORT_PREFIX.concat(propertyName));
    }
    ...
    public static Optional<Boolean> getOptionalBooleanKcValue(String propertyName) {
        return getOptionalValue(NS_PASSPORT_PREFIX.concat(propertyName)).map(Boolean::parseBoolean);
    }
    ...
    public static Optional<Integer> getOptionalIntegerValue(String propertyName) {
        return getConfig().getOptionalValue(NS_PASSPORT_PREFIX.concat(propertyName), Integer.class);
    }
