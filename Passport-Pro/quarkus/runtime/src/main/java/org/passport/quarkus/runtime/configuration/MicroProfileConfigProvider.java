...
import org.passport.Config.AbstractScope;
...
public class MicroProfileConfigProvider implements Config.ConfigProvider {
    ...
    public static final String NS_PASSPORT = "kc";
    public static final String NS_PASSPORT_PREFIX = NS_PASSPORT + ".";
    public static final String SPI_PREFIX = NS_PASSPORT_PREFIX + "spi" + OPTION_PART_SEPARATOR;
    ...
    public class MicroProfileScope extends AbstractScope {
        ...
        protected <T> T getValue(String key, Function<String, T> conversion, Class<T> clazz, T defaultValue) {
            if (NS_PASSPORT_PREFIX.equals(separatorPrefix)) {
        ...
        @Override
        public Scope root() {
            return new MicroProfileScope(NS_PASSPORT_PREFIX);
        }
