...
public class KcEnvConfigSource extends PropertiesConfigSource {
    ...
    private static Map<String, String> buildProperties(Map<String, String> env) {
        ...
        String kcPrefix = replaceNonAlphanumericByUnderscores(NS_PASSPORT_PREFIX.toUpperCase());
        ...
        for (Map.Entry<String, String> entry : env.entrySet()) {
            ...
            if (actualKey != null) {
                ...
                transformedKey = NS_PASSPORT_PREFIX + actualKey;
            } else {
                // determine the mapping by convention / wildcard handling
                transformedKey = NS_PASSPORT_PREFIX + baseKey.toLowerCase().replace("_", "-");
