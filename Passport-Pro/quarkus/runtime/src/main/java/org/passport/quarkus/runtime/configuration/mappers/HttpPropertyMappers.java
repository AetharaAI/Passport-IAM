...
import static org.passport.quarkus.runtime.configuration.mappers.PropertyMapper.fromFeature;
...
public final class HttpPropertyMappers implements PropertyMapperGrouping {
    ...
    private static boolean isHttpEnabled(String value) {
        if (Environment.isDevMode() || org.passport.common.util.Environment.isNonServerMode()) {
            return true;
        }
