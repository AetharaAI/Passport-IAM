    ...
    public File getTmpDirectory() {
        if (tmpDir == null) {
            ...
            if (dataDir == null) {
                ...
                try {
                    tmpDir = Path.of(System.getProperty("java.io.tmpdir"), "passport-quarkus-tmp").toFile();
                    if (tmpDir.exists()) {
                    ...
                    throw new RuntimeException("It was not possible to create temporary directory passport-quarkus-tmp", ioex);
                }
            } else {
