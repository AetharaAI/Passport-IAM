...
public class BootstrapAdmin {
    ...
    public static final String PASSPORT_BOOTSTRAP_ADMIN_EXPIRATION_ENV_VAR = "PASSPORT_BOOTSTRAP_ADMIN_EXPIRATION";
    ...
    /*@Option(names = {
            "--expiration" }, description = "Specifies the number of minutes after which the account expires. Defaults to "
                    ...
                    + PASSPORT_BOOTSTRAP_ADMIN_EXPIRATION_ENV_VAR + " env variable if set", defaultValue = "${env:"
                            + PASSPORT_BOOTSTRAP_ADMIN_EXPIRATION_ENV_VAR + "}", scope = ScopeType.INHERIT)
    */Integer expiration;
