...
import org.passport.config.HostnameV2Options;
import org.passport.config.HttpOptions;
import org.passport.config.ProxyOptions;
...
public final class HostnameV2PropertyMappers implements PropertyMapperGrouping {
    ...
    public static void validateConfig(Consumer<String> warn) {
        ...
        boolean isProd = Environment.PROD_PROFILE_VALUE.equals(org.passport.common.util.Environment.getProfile());
