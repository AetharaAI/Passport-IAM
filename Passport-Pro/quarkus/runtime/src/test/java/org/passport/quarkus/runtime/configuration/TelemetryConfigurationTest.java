...
public class TelemetryConfigurationTest extends AbstractConfigurationTest {
    ...
    public void rootDefaults() {
        ...
        assertConfig(Map.of(
                ...
                "telemetry-service-name", "passport",
        ...
        assertExternalConfig(Map.of(
                ...
                "quarkus.otel.service.name", "passport",
    ...
    public void logsPriority() {
        ...
        ConfigArgsConfigSource.setCliArgs("--features=opentelemetry-logs", "--telemetry-endpoint=http://passport-pro.ai:1234", "--telemetry-protocol=grpc", "--telemetry-logs-enabled=true", "--telemetry-logs-endpoint=my-domain:2001", "--telemetry-logs-protocol=http/protobuf");
        initConfig();
        assertConfig(Map.of(
                "telemetry-logs-enabled", "true",
                "telemetry-logs-endpoint", "my-domain:2001",
                "telemetry-logs-protocol", "http/protobuf",
                "telemetry-endpoint", "http://passport-pro.ai:1234",
                "telemetry-protocol", "grpc"
        ));
        assertExternalConfig(Map.of(
                "quarkus.otel.logs.enabled", "true",
    ...
    public void metricsPriorities() {
        ...
        ConfigArgsConfigSource.setCliArgs("--features=opentelemetry-metrics", "--metrics-enabled=true", "--telemetry-endpoint=http://passport-pro.ai:1234", "--telemetry-protocol=grpc", "--telemetry-metrics-enabled=true", "--telemetry-metrics-endpoint=my-domain:2001", "--telemetry-metrics-protocol=http/protobuf");
        initConfig();
        assertConfig(Map.of(
                "telemetry-metrics-enabled", "true",
