...
public class TracingConfigurationTest extends AbstractConfigurationTest {
    ...
    public void defaultValues() {
        ...
        assertConfig("tracing-service-name", "passport");
    ...
    public void differentValues() {
        ...
        putEnvVars(Map.of(
                "KC_TRACING_SERVICE_NAME", "passport-42",
        ...
        assertConfig(Map.of(
                ...
                "tracing-service-name", "passport-42",
        ...
        assertExternalConfig(Map.of(
                ...
                "quarkus.otel.service.name", "passport-42",
    ...
    public void serviceNameResourceAttributes() {
        ...
        assertExternalConfig("quarkus.otel.service.name", "passport");
    }
