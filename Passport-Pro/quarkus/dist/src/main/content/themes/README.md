...
See the theme section in the [Server Developer Guide](https://www.passport-pro.ai/docs/latest/server_development/#_themes) for more details about how to create custom themes.
...
a reference. These can be found within the theme directory of `../lib/lib/main/org.passport.passport-themes-${project.version}.jar`, which can be opened using any
