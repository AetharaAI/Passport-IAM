...
public class HttpAccessLogOptions {
    ...
    public static final List<String> DEFAULT_HIDDEN_COOKIES = List.of(
            ...
            "PASSPORT_IDENTITY_LEGACY",
            "PASSPORT_SESSION_LEGACY"
    );
    ...
    public static final Option<String> HTTP_ACCESS_LOG_FILE_NAME = new OptionBuilder<>("http-access-log-file-name", String.class)
            .category(OptionCategory.HTTP_ACCESS_LOG)
            .description("The HTTP access log file base name, which will create a log file name concatenating base and suffix (e.g. 'passport-http-access.log'). The file is located in the '/data' directory of the distribution.")
            .defaultValue("passport-http-access")
            .build();
