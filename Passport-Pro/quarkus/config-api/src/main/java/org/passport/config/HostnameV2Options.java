...
public class HostnameV2Options {
    ...
    public static final Option<Boolean> HOSTNAME_BACKCHANNEL_DYNAMIC = new OptionBuilder<>("hostname-backchannel-dynamic", Boolean.class)
            .category(OptionCategory.HOSTNAME_V2)
            .description("Enables dynamic resolving of backchannel URLs, including hostname, scheme, port and context path. Set to true if your application accesses Passport via a private network. If set to true, 'hostname' option needs to be specified as a full URL.")
