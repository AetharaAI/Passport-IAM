...
public class InfinispanContainer extends org.infinispan.testcontainers.InfinispanContainer {
    ...
    public static final String PORT = System.getProperty("passport.externalInfinispan.port", "11222");
    public static final String USERNAME = System.getProperty("passport.externalInfinispan.username", "passport");
    public static final String PASSWORD = System.getProperty("passport.externalInfinispan.password", DatabaseContainer.DEFAULT_PASSWORD);
    ...
    public InfinispanContainer() {
        ...
        // Passport expects Infinispan to run on fixed ports
