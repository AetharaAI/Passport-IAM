...
import org.passport.crypto.fips.FIPS1402Provider;
...
public class FipsDistTest {
    ...
    @Test
    void testFipsNonApprovedMode(PassportDistribution dist) {
    ...
    @Test
    void testFipsApprovedMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
    ...
    @Test
    void testUnsupportedHttpsJksKeyStoreInStrictMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
    ...
    @Test
    void testHttpsBcfksKeyStoreInStrictMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
    ...
    @Test
    void testHttpsBcfksTrustStoreInStrictMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
            dist.copyOrReplaceFileFromClasspath("/server.keystore.bcfks", Path.of("conf", "server.keystore"));
    ...
    @Test
    void testUnencryptedPkcs12TrustStoreInStrictMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
            String truststoreName = "passport-truststore.p12";
    ...
    @Test
    void testUnsupportedHttpsPkcs12KeyStoreInStrictMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
    ...
    @Test
    void testHttpsPkcs12KeyStoreInNonApprovedMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
            dist.copyOrReplaceFileFromClasspath("/server.keystore.pkcs12", Path.of("conf", "server.keystore"));
    ...
    @Test
    void testHttpsPkcs12TrustStoreInNonApprovedMode(PassportDistribution dist) {
        runOnFipsEnabledDistribution(dist, () -> {
            dist.copyOrReplaceFileFromClasspath("/server.keystore.pkcs12", Path.of("conf", "server.keystore"));
            ...
            rawDist = dist.unwrap(RawPassportDistribution.class);
    ...
    private void runOnFipsEnabledDistribution(PassportDistribution dist, Runnable runnable) {
        installBcFips(dist);
        runnable.run();
    }

    private void installBcFips(PassportDistribution dist) {
        RawPassportDistribution rawDist = dist.unwrap(RawPassportDistribution.class);
