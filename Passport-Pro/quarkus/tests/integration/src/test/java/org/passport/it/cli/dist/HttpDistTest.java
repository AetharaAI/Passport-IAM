...
public class HttpDistTest {
    ...
    public void maxQueuedRequestsTest(PassportDistribution dist) {
    ...
    @Test
    @Launch({"start-dev", "--log-level=INFO,org.passport.quarkus.runtime.services.RejectNonNormalizedPathFilter:debug", "--http-access-log-enabled=true"})
    ...
    @Test
    public void httpStoreTypeValidation(PassportDistribution dist) {
