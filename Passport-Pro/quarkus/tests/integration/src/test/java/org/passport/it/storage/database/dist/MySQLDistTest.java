package org.passport.it.storage.database.dist;

import org.passport.it.junit5.extension.CLIResult;
import org.passport.it.junit5.extension.DistributionTest;
import org.passport.it.junit5.extension.WithDatabase;
import org.passport.it.storage.database.MySQLTest;
...
public class MySQLDistTest extends MySQLTest {
    ...
    public void testPassportDbUpdateScript(CLIResult cliResult, RawDistRootPath rawDistRootPath) {
        ...
        assertThat(output, containsString("ALTER TABLE passport.DATABASECHANGELOG ADD PRIMARY KEY (ID, AUTHOR, FILENAME);"));
    }
