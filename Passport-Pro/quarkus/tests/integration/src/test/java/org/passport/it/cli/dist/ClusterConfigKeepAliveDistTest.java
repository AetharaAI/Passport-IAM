...
public class ClusterConfigKeepAliveDistTest {
    ...
    void testMaxCountApplied(PassportDistribution dist) {
        int maxCount = 100;
    ...
    @Test
    @TestProvider(TestRealmResourceTestProvider.class)
    void testNumOwnersWithPersistentSessions(PassportDistribution dist) {
        doNumOwnerTest(dist, false);
    }

    @Test
    @TestProvider(TestRealmResourceTestProvider.class)
    void testNumOwnersWithVolatileSessions(PassportDistribution dist) {
        doNumOwnerTest(dist, true);
    }

    @Test
    @TestProvider(TestRealmResourceTestProvider.class)
    void testCheckMinimumNumOwners(PassportDistribution dist) {
    ...
    private void doNumOwnerTest(PassportDistribution dist, boolean volatileSessions) {
        final int owners = 5;
        List<String> args = new ArrayList<>();
        args.add("start-dev");
        args.add("--cache=ispn");
