...
public class ExportDistTest {
    ...
    @Test
    void testExport(PassportDistribution dist) {
    ...
    @Test
    void testExportRealmFGAPEnabled(PassportDistribution dist) {
    ...
    @Test
    void testExportNonExistent(PassportDistribution dist) {
        CLIResult cliResult = dist.run("build");
