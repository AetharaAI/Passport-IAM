...
public class StartAutoBuildDistTest {
    ...
    @Order(10)
    void testSpiAutoBuild(PassportDistribution dist) {
    ...
    @Test
    @Order(11)
    void testLogLevelNotPeristed(PassportDistribution dist) {
    ...
    @Test
    @Order(12)
    void testLogLevelWildcardNotPeristed(PassportDistribution dist) {
