...
public class OpenApiDistTest {
  ...
  void testOpenApiEndpointNotEnabled(PassportDistribution distribution) {
  ...
  void testOpenApiEndpointEnabled(PassportDistribution distribution) {
  ...
  void testOpenApiUiEndpointEnabled(PassportDistribution distribution) {
  ...
  @DryRun
  @Test
  void testOpenApiRequiresFeatures(PassportDistribution dist) {
    ...
    @Test
    @Launch({"start-dev", "--openapi-enabled=true", FEATURES_OPTION})
    void testOpenApiFilter(PassportDistribution distribution) {
