...
import org.passport.quarkus.runtime.cli.command.BootstrapAdmin;
import org.passport.quarkus.runtime.cli.command.BootstrapAdminService;
import org.passport.quarkus.runtime.cli.command.BootstrapAdminUser;
import org.passport.quarkus.runtime.cli.command.Build;
import org.passport.quarkus.runtime.cli.command.Export;
import org.passport.quarkus.runtime.cli.command.Import;
...
import static org.passport.quarkus.runtime.cli.command.AbstractAutoBuildCommand.OPTIMIZED_BUILD_OPTION_LONG;

@WithEnvVars({"PASSPORT_COMMAND_MODE", "ALL", "PASSPORT_HELP_WIDTH", "80"})
@DistributionTest
...
public class HelpCommandDistTest {
    ...
    public static final String REPLACE_EXPECTED = "PASSPORT_REPLACE_EXPECTED";
    ...
    @Test
    public void testHelpDoesNotStartReAugJvm(PassportDistribution dist) {
