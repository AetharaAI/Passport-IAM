...
public class CacheEmbeddedMtlsDistTest {
    ...
    public void testCacheEmbeddedMtlsDisabled(PassportDistribution dist) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsFileValidation(PassportDistribution dist) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsFileExistsValidation(PassportDistribution dist) throws IOException {
        var result = dist.run(
              "start-dev",
              "--cache=ispn",
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsValidation(PassportDistribution dist) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsEnabled(PassportDistribution dist) {
    ...
    private void doFileAndPasswordValidation(PassportDistribution dist, Option<String> fileOption, Option<String> passwordOption) {
