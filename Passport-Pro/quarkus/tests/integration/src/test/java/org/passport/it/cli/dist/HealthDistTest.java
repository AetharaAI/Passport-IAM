...
public class HealthDistTest {
    ...
    @Test
    @Launch({ "start-dev" })
    void testHealthEndpointNotEnabled(PassportDistribution distribution) {
    ...
    void testHealthEndpoint(PassportDistribution distribution) {
        when().get("/health").then()
                .statusCode(200);
    ...
    void testHealthEndpointOnMain(PassportDistribution distribution) {
        distribution.setRequestPort(8080);
