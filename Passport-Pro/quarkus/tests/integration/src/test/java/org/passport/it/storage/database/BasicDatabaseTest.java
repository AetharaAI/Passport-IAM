...
package org.passport.it.storage.database;
...
public abstract class BasicDatabaseTest {
    ...
    public String assertManualDbInitialization(CLIResult cliResult, RawDistRootPath rawDistRootPath) {
        ...
        var output = readPassportDbUpdateScript(rawDistRootPath);

        assertThat(output, notNullValue());
        assertThat(output, containsString("Passport database creation script - apply this script to empty DB"));
    ...
    protected static String readPassportDbUpdateScript(RawDistRootPath path) {
        final String defaultScriptName = "passport-database-update.sql";
        ...
        try {
            ...
            Log.infof("Deleting Passport DB update script '%s'", defaultScriptName);
