...
public class QuarkusPropertiesAutoBuildDistTest {
    ...
    public static class EnableAdditionalConsoleHandler implements Consumer<PassportDistribution> {
        @Override
    ...
    public static class DisableAdditionalConsoleHandler implements Consumer<PassportDistribution> {
    ...
    public static class AddAdditionalDatasource implements Consumer<PassportDistribution> {
        @Override
        public void accept(PassportDistribution distribution) {
    ...
    public static class AddAdditionalDatasource2 implements Consumer<PassportDistribution> {
        @Override
        public void accept(PassportDistribution distribution) {
    ...
    public static class AddNonXADatasource implements Consumer<PassportDistribution> {
        @Override
        public void accept(PassportDistribution distribution) {
    ...
    public static class ChangeAdditionalDatasourceUsername implements Consumer<PassportDistribution> {
        @Override
        public void accept(PassportDistribution distribution) {
    ...
    public static class ChangeAdditionalDatasourceDbKind implements Consumer<PassportDistribution> {
        @Override
        public void accept(PassportDistribution distribution) {
            distribution.setProperty("db-kind-user-store", "dev-mem");
        }
    ...
    public static class SetDatabaseKind implements Consumer<PassportDistribution> {
        @Override
        public void accept(PassportDistribution distribution) {
