...
public class CredentialTypeMetadata implements Comparable<CredentialTypeMetadata> {
   ...
   /**
    ...
    public static class CredentialTypeMetadataBuilder {
         ...
         * @return metadata
         */
        public CredentialTypeMetadata build(PassportSession session) {
        ...
        private boolean verifyRequiredAction(PassportSession session, String requiredActionProviderId) {
