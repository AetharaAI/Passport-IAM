...
public class StorageId implements Serializable {
     ...
     * @return
     */
    public static String passportId(ComponentModel model, String externalId) {
        return new StorageId(model.getId(), externalId).getId();
    }

    public static String externalId(String passportId) {
        return new StorageId(passportId).getExternalId();
    }
    public static String providerId(String passportId) {
        return new StorageId(passportId).getProviderId();
    }
