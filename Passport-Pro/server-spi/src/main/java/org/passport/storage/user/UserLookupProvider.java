 ...
 * implement this interface if you want to be able to log in to passport using users from your storage.
 * <p/>
...
public interface UserLookupProvider {
     ...
     * @param realm the realm model
     * @return found user model, or {@code null} if no such user exists
     * @throws org.passport.models.ModelDuplicateException when searched with case 
     ...
     * @return found user model, or {@code null} if no such user exists
     *
     * @throws org.passport.models.ModelDuplicateException when there are more users with same email
     */
