...
/**
 * At boot time, passport discovers all factories.  For each discovered factory, the init() method is called.  After
...
public interface ProviderFactory<T extends Provider> {
    ...
    T create(PassportSession session);
     ...
     */
    void postInit(PassportSessionFactory factory);
