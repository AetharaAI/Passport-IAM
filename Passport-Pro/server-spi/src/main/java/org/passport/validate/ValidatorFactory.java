...
public interface ValidatorFactory extends ProviderFactory<Validator> {
     ...
     * <p>
     * Implementations can use the {@link PassportSession} to validate the given {@link ValidatorConfig}.
     *
     * @param session the {@link PassportSession}
     * @param config  the config to be validated
     * @return the validation result
     */
    default ValidationResult validateConfig(PassportSession session, ValidatorConfig config) {
