...
public class ValidationContext {
    ...
    /**
     * Holds the {@link PassportSession} in which the validation is performed.
     */
    ...
    /**
     * Creates a new {@link ValidationContext} without a {@link PassportSession}.
     */
    ...
    /**
     * Creates a new {@link ValidationContext} with a {@link PassportSession}.
     *
     * @param session
     */
    public ValidationContext(PassportSession session) {
     ...
     * @param errors
     */
    protected ValidationContext(PassportSession session, Set<ValidationError> errors) {
