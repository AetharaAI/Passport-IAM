...
public interface RoleModel {
    ...
    interface RoleGrantedEvent extends RoleModel.RoleEvent {
        static void fire(RoleModel role, UserModel user, PassportSession session) {
            session.getPassportSessionFactory().publish(new RoleModel.RoleGrantedEvent() {
                @Override
    ...
    interface RoleRevokedEvent extends RoleModel.RoleEvent {
        static void fire(RoleModel role, UserModel user, PassportSession session) {
            session.getPassportSessionFactory().publish(new RoleModel.RoleRevokedEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
