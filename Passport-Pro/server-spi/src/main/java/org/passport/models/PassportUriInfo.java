...
import static org.passport.common.util.UriUtils.parseQueryParameters;

public class PassportUriInfo implements UriInfo {
    ...
    public PassportUriInfo(PassportSession session, UrlType type, UriInfo delegate) {
