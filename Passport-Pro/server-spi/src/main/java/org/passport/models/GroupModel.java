...
public interface GroupModel extends RoleMapperModel {
    ...
    interface GroupCreatedEvent extends GroupEvent {
        static void fire(GroupModel group, PassportSession session) {
            session.getPassportSessionFactory().publish(new GroupCreatedEvent() {
                @Override
    ...
    interface GroupUpdatedEvent extends GroupEvent {
        static void fire(GroupModel group, PassportSession session) {
            session.getPassportSessionFactory().publish(new GroupUpdatedEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
    ...
    interface GroupMemberJoinEvent extends GroupEvent {
        static void fire(GroupModel group, UserModel user, PassportSession session) {
            session.getPassportSessionFactory().publish(new GroupMemberJoinEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
    ...
    interface GroupMemberLeaveEvent extends GroupEvent {
        static void fire(GroupModel group, UserModel user, PassportSession session) {
            session.getPassportSessionFactory().publish(new GroupMemberLeaveEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
    ...
    interface GroupPathChangeEvent extends GroupEvent {
        ...
        static void fire(GroupModel group, String newPath, String previousPath, PassportSession session) {
            session.getPassportSessionFactory().publish(new GroupPathChangeEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
