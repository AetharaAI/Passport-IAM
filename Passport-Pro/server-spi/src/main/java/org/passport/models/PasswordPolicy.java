...
import org.passport.policy.PasswordPolicyConfigException;
...
public class PasswordPolicy implements Serializable {
    ...
    public static PasswordPolicy parse(PassportSession session, String policyString) {
    ...
    public static class Builder {
        ...
        public PasswordPolicy build(PassportSession session) {
