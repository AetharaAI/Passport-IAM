...
/**
 * <p>A model type representing the configuration for identity providers. It provides some common properties and also a {@link org.passport.models.IdentityProviderModel#config}
...
public class IdentityProviderModel implements Serializable {
    ...
    /**
     * Returns flag whether the users within this IdP should be transient, ie. not stored in Passport database.
    ...
    /**
     * Configures the IdP to not store users in Passport database. Default value: {@code false}.
     * @return
     */
