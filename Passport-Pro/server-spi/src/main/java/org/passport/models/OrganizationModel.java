...
public interface OrganizationModel {
    ...
    interface OrganizationMemberJoinEvent extends OrganizationMembershipEvent {
        static void fire(OrganizationModel organization, UserModel user, PassportSession session) {
            session.getPassportSessionFactory().publish(new OrganizationModel.OrganizationMemberJoinEvent() {
                @Override
    ...
    interface OrganizationMemberLeaveEvent extends OrganizationMembershipEvent {
        static void fire(OrganizationModel organization, UserModel user, PassportSession session) {
            session.getPassportSessionFactory().publish(new OrganizationModel.OrganizationMemberLeaveEvent() {
                @Override
                public UserModel getUser() {
                    return user;
                }
