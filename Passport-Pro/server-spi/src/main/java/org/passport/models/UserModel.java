...
public interface UserModel extends RoleMapperModel {
    ...
    String IDP_ALIAS = "passport.session.realm.users.query.idp_alias";
    String IDP_USER_ID = "passport.session.realm.users.query.idp_user_id";
    String INCLUDE_SERVICE_ACCOUNT = "passport.session.realm.users.query.include_service_account";
    String GROUPS = "passport.session.realm.users.query.groups";
    String SEARCH = "passport.session.realm.users.query.search";
    String EXACT = "passport.session.realm.users.query.exact";
