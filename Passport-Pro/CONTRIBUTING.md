...
Passport is an Open Source Identity and Access Management solution for modern Applications and Services.
...
Passport is an Open Source community-driven project and we welcome contributions as well as feedback from the community. We do have a few guidelines in place to help you be successful with your contribution to Passport.

Firstly, if you want to contribute a larger change to Passport we ask that you open a 
...
1. A discussion around the change (https://github.com/passport/passport/discussions/categories/ideas)
...
If you would like to contribute to Passport, but are not sure exactly what to work on, you can find a number of open
issues that are awaiting contributions in  
[issues](https://github.com/passport/passport/issues).

### Open a discussion on a proposed change

As Passport is a community-driven project we require contributors to open a discussion on what they are planning to contribute.

Discussions should first and foremost be done through [GitHub Discussions](https://github.com/passport/passport/discussions/categories/ideas).

The [Passport Dev Mailing List](https://groups.google.com/forum/#!forum/passport-dev) can be used to notify the community on your new discussion, and can also be used for more low-level implementation discussions.
...
Any contributions to Passport must only contain code that can legally be contributed to Passport, and which the Passport
project can distribute under its license.

Prior to contributing to Passport please read the [Developer's Certificate of Origin](https://developercertificate.org/)
...
In order to provide translations for Passport, kindly follow the instructions provided in [Translation Docs](./docs/translation.md).
