...
public class TimeOffsetTest extends PassportModelTest {
    ...
    public void testOffset() {
        ...
        withRealm(realmId, (session, realmModel) -> {
            ...
            ProviderFactory<EventStoreProvider> providerFactory = session.getPassportSessionFactory().getProviderFactory(EventStoreProvider.class);
