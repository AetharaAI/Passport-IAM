...
public class FederatedUserTest extends PassportModelTest {
    ...
    private record TestContext (PassportSession session, RealmModel realm, String previousUserId, String previousLdapId) {};
    ...
    private void assertAttributeDifferentThanExternalStorage(Consumer<TestContext> assertion) {
        ...
        withRealm(realmId, (BiFunction<PassportSession, RealmModel, Void>) (session, realm) -> {
    ...
    public void testInvalidUsernameWhenDifferentThanExternalStorageNoCache() {
        ...
        assertAttributeDifferentThanExternalStorage((context) -> {
            PassportSession session = context.session();
