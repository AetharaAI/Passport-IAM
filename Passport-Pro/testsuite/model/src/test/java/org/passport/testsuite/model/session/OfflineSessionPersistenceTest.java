...
import org.passport.models.sessions.infinispan.InfinispanUserSessionProvider;
...
public class OfflineSessionPersistenceTest extends PassportModelTest {
    ...
    private static RealmModel prepareRealm(PassportSession s, String name) {
    ...
    public void cleanEnvironment(PassportSession s) {
        ...
        s.getContext().setRealm(realm);
        new RealmManager(s).removeRealm(realm);  // See https://issues.redhat.com/browse/PASSPORT-17876
    }
     ...
     */
    private Stream<UserSessionModel> createOfflineSessions(PassportSession session, RealmModel realm, String userId, Consumer<? super UserSessionModel> alterUserSession) {
    ...
    private UserSessionModel createOfflineSession(PassportSession session, RealmModel realm, String userId, int sessionIndex) {
