...
/**
 * Checks if the correct embedded or remote cache is started based on {@link org.passport.common.Profile.Feature}.
 */
@RequireProvider(InfinispanConnectionProvider.class)
public class FeatureEnabledTest extends PassportModelTest {
