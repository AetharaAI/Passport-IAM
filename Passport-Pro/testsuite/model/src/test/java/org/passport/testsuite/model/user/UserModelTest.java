...
public class UserModelTest extends PassportModelTest {
    ...
    private Void addRemoveUser(PassportSession session, int i) {
    ...
    public void testAddDirtyRemoveFederationUser() {
        ...
        // Remove user _from the federation_, simulates eg. user being removed from LDAP without Passport knowing
    ...
    public void testAddDirtyRemoveFederationUsersInTheSameGroupConcurrent() {
        ...
        // Remove users _from the federation_, simulates eg. user being removed from LDAP without Passport knowing
        withRealm(realmId, (session, realm) -> {
    ...
    private UserStorageProvider getUserFederationInstance(PassportSession session, final RealmModel realm) throws RuntimeException {
