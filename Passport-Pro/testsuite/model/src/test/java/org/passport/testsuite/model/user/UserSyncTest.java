...
package org.passport.testsuite.model.user;
...
import org.passport.storage.ldap.idm.store.ldap.LDAPOperationManager;
...
import static org.passport.models.LDAPConstants.LDAP_ID;
import static org.passport.storage.UserStorageProviderModel.REMOVE_INVALID_USERS_ENABLED;
...
public class UserSyncTest extends PassportModelTest {
    ...
    public void createEnvironment(PassportSession s) {
        ...
        getParameters(UserStorageProviderModel.class).forEach(fs -> inComittedTransaction(session -> {
            ...
            UserStorageProviderFactory userStorageProviderFactory = (UserStorageProviderFactory) session.getPassportSessionFactory().getProviderFactory(UserStorageProvider.class, res.getProviderId());
    ...
    public void testManyUsersImport() {
        ...
        SynchronizationResult res = withRealm(realmId, (session, realm) -> {
            ...
            return UserStoragePrivateUtil.runFullSync(session.getPassportSessionFactory(), providerModel);
        });
    ...
    public void testAlwaysReadValueFromLDAPWorksWithNoCachePolicy() {
        ...
        withRealm(realmId, (session, realm) -> {
            ...
            // Create mapper
            ComponentModel mapperModel = PassportModelUtils.createComponentModel("My-street-mapper", providerModel.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
