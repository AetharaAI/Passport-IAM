...
public class RetryAndBackOffTest extends PassportModelTest {
    ...
    @Override
    public void createEnvironment(PassportSession session) {
        ...
        ProviderFactory<?> provider = session.getPassportSessionFactory().getProviderFactory(UserLoginFailureProvider.class);
