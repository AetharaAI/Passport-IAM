...
package org.passport.testsuite.model.group;
...
public class GroupModelTest extends PassportModelTest {
    ...
    public void testFindGroupByPath() {
        ...
        withRealm(realmId, (session, realm) -> {
            GroupModel group1 = PassportModelUtils.findGroupByPath(session, realm, "/parent-1");
            GroupModel group2 = PassportModelUtils.findGroupByPath(session, realm, "/parent-2");
            assertThat(group1.getName(), equalTo("parent-1"));
            assertThat(group2.getName(), equalTo("parent-2"));

            GroupModel subGroup1 = PassportModelUtils.findGroupByPath(session, realm, "/parent-1/sub-group-1");
            GroupModel subGroup2 = PassportModelUtils.findGroupByPath(session, realm, "/parent-2/sub-group/1");
            assertThat(subGroup1.getId(), equalTo(subGroupId1));
