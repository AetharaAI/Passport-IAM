 ...
 */
package org.passport.testsuite.model.events;
...
public class AdminEventQueryTest extends PassportModelTest {
    ...
    private AdminEvent createClientEvent(RealmModel realm, PassportSession session, OperationType operation) {
