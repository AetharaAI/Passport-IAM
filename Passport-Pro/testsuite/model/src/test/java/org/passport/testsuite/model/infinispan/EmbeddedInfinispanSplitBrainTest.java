...
/**
  Tests to ensure that Passport correctly handles various split-brain scenarios when an Embedded Infinispan instance
  is used for clustering.
 */
@RequireProvider(CacheRealmProvider.class)
@RequireProvider(InfinispanConnectionProvider.class)
public class EmbeddedInfinispanSplitBrainTest extends PassportModelTest {
   ...
   /**
    * A Test to ensure that when Infinispan recovers from a split-brain event, all Passport local caches are cleared
    * and subsequent user requests read from the DB.
    * <p>
    * <a href="https://github.com/passport/passport/issues/25837" />
    */
   @Test
