...
public class SessionTimeoutsTest extends PassportModelTest {
    ...
    protected static UserSessionModel createUserSession(PassportSession session, RealmModel realm, UserModel user, boolean offline) {
    ...
    protected static AuthenticatedClientSessionModel createClientSession(PassportSession session, String realmId, ClientModel client,
    ...
    protected static UserSessionModel getUserSession(PassportSession session, RealmModel realm, String id, boolean offline) {
        return offline
