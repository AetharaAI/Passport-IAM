...
public class ClientScopeModelTest extends PassportModelTest {
    ...
    private static void assertionsForClientScopesCaching(List<String> clientScopes, PassportSession session, RealmModel realm) {
