...
public class UserSessionInitializerTest extends PassportModelTest {
    ...
    // Create sessions in persister + infinispan, but then delete them from infinispan cache by reinitializing passport session factory
