package org.passport.testsuite.model.role;
...
public class RoleModelTest extends PassportModelTest {
    ...
    private void createRoles(PassportSession session, RealmModel realm) {
