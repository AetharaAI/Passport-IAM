...
import org.passport.testsuite.federation.UserPropertyFileStorage;
import org.passport.testsuite.federation.UserPropertyFileStorage.UserPropertyFileStorageCall;
...
public class UserPaginationTest extends PassportModelTest {
    ...
    public void testPaginationFirstResultIsInSecondProvider() {
        ...
        // https://github.com/passport/passport/issues/44860 brings an optimization where the count method is not invoked.
        expectedStorageCalls(
