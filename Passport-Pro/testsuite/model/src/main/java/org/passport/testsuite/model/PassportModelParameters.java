 ...
 * @author hmlnarik
 */
public class PassportModelParameters {
    ...
    public PassportModelParameters(Set<Class<? extends Spi>> allowedSpis, Set<Class<? extends ProviderFactory>> allowedFactories) {
