...
import static org.passport.testsuite.arquillian.AppServerTestEnricher.getAppServerQualifiers;
...
public final class TestContext {
    ...
    private PassportTestingClient testingClient;
    ...
    public void setAdminClient(Passport adminClient) {
    ...
    public PassportTestingClient getTestingClient() {
        if (testingClient == null) {
            String authServerContextRoot = suiteContext.getAuthServerInfo().getContextRoot().toString();
            testingClient = PassportTestingClient.getInstance(authServerContextRoot + "/auth");
        }
        return testingClient;
    }

    public void setTestingClient(PassportTestingClient testingClient) {
