...
import static org.passport.testsuite.utils.io.IOUtil.PROJECT_BUILD_DIRECTORY;
...
public class AdminClientUtil {
    ...
    public static Passport createAdminClient(boolean ignoreUnknownProperties, String authServerContextRoot) throws Exception {
    ...
    public static Passport createAdminClient(boolean ignoreUnknownProperties, String realmName, String username,
    ...
    public static Passport createAdminClient(boolean ignoreUnknownProperties, String authServerContextRoot, String realmName,
        ...
        return PassportBuilder.builder()
    ...
    public static SSLContext getSSLContextWithTruststore() {
        try {
            if ("true".equals(System.getProperty("auth.server.ssl.required"))) {
                File truststore = new File(PROJECT_BUILD_DIRECTORY, "dependency/keystore/passport.truststore");
