package org.passport.testsuite.cli;
...
import org.passport.testsuite.cli.exec.AbstractExec;
import org.passport.testsuite.cli.exec.AbstractExecBuilder;
...
public class KcAdmExec extends AbstractExec {
    ...
    public static final String WORK_DIR = System.getProperty("user.dir") + "/target/containers/passport-client-tools";
