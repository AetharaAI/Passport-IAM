...
public class SqlUtils {
    ...
    // -DsqlFilePath=/tmp/passport-database-update.sql -Dpassport.connectionsJpa.password=passport -Dpassport.connectionsJpa.user=passport -Dpassport.connectionsJpa.driver=oracle.jdbc.driver.OracleDriver -Dpassport.connectionsJpa.url="jdbc:oracle:thin:@localhost:1251:xe"
    public static void main(String[] args) {
        String sqlFilePath = readProperty("sqlFilePath");
        String jdbcDriverClass = readProperty("passport.connectionsJpa.driver");
        String dbUrl = readProperty("passport.connectionsJpa.url");
        String dbUsername = readProperty("passport.connectionsJpa.user");
        String dbPassword = readProperty("passport.connectionsJpa.password");
