...
public interface TestOIDCEndpointsApplicationResource {
    ...
    /**
     * Invoke client notification endpoint. This will be called by Passport itself (by CIBA callback endpoint) not by testsuite
     * @param request
     */
    @POST
    ...
    /**
     * Return the authReqId in case that clientNotificationEndpoint was already called by Passport for the given clientNotificationToken. Otherwise underlying value of
