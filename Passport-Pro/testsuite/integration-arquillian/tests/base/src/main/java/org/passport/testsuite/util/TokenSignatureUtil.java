...
public class TokenSignatureUtil {
    ...
    public static void changeRealmTokenSignatureProvider(Passport adminClient, String toSigAlgName) {
        changeRealmTokenSignatureProvider(TEST_REALM_NAME, adminClient, toSigAlgName);
    }

    public static void changeRealmTokenSignatureProvider(String realm, Passport adminClient, String toSigAlgName) {
    ...
    public static boolean verifySignature(String sigAlgName, String token, Passport adminClient) throws Exception {
    ...
    public static void registerKeyProvider(String jwaAlgorithmName, Passport adminClient, TestContext testContext) {
        registerKeyProvider(TEST_REALM_NAME, jwaAlgorithmName, adminClient, testContext);
    }

    public static void registerKeyProvider(String realm, String jwaAlgorithmName, Passport adminClient, TestContext testContext) {
    ...
    private static void registerKeyProvider(String realm, String providerSpecificKey, String providerSpecificValue, String providerId, Passport adminClient, TestContext testContext) {
    ...
    private static ComponentRepresentation createKeyRep(String name, String providerId, Passport adminClient) {
    ...
    private static PublicKey getRealmPublicKey(String realm, String sigAlgName, Passport adminClient) {
