...
import org.passport.representations.adapters.config.AdapterConfig;
...
import static org.passport.testsuite.arquillian.AppServerTestEnricher.isRelative;
import static org.passport.testsuite.arquillian.AppServerTestEnricher.isWASAppServer;
import static org.passport.testsuite.arquillian.AppServerTestEnricher.isWLSAppServer;
import static org.passport.testsuite.util.ServerURLs.getAuthServerContextRoot;
import static org.passport.testsuite.utils.io.IOUtil.documentToString;
import static org.passport.testsuite.utils.io.IOUtil.loadJson;
import static org.passport.testsuite.utils.io.IOUtil.loadXML;
import static org.passport.testsuite.utils.io.IOUtil.modifyDocElementAttribute;
...
public class DeploymentArchiveProcessor implements ApplicationArchiveProcessor {
    ...
    public static final String ADAPTER_CONFIG_PATH = "/WEB-INF/passport.json";
    public static final String ADAPTER_CONFIG_PATH_TENANT1 = "/WEB-INF/classes/tenant1-passport.json";
    public static final String ADAPTER_CONFIG_PATH_TENANT2 = "/WEB-INF/classes/tenant2-passport.json";
    public static final String ADAPTER_CONFIG_PATH_JS = "/passport.json";
    public static final String SAML_ADAPTER_CONFIG_PATH = "/WEB-INF/passport-saml.xml";
    public static final String JBOSS_DEPLOYMENT_XML_PATH = "/WEB-INF/jboss-deployment-structure.xml";
    public static final String SAML_ADAPTER_CONFIG_PATH_TENANT1 = "/WEB-INF/classes/tenant1-passport-saml.xml";
    public static final String SAML_ADAPTER_CONFIG_PATH_TENANT2 = "/WEB-INF/classes/tenant2-passport-saml.xml";
    ...
    public void process(Archive<?> archive, TestClass testClass) {
        ...
        // org.passport.testsuite.arquillian.wildfly.container.WildflyDeploymentArchiveProcessor
        if (isWLSAppServer() || isWASAppServer()) {
            ...
            ((WebArchive) archive)
                    ...
                    .addClass(org.passport.testsuite.arquillian.annotation.AppServerContainer.class);
        }
    }
    ...
    protected void modifyAdapterConfig(Archive<?> archive, String adapterConfigPath, boolean relative) {
        if (archive.contains(adapterConfigPath)) {
            ...
            if (adapterConfigPath.endsWith(".xml")) { // SAML adapter config
                ...
                ((WebArchive) archive).addAsResource(new File(DeploymentArchiveProcessor.class.getResource("/keystore/passport.truststore").getFile()));
