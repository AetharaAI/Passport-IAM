...
import static org.passport.testsuite.updaters.ServerResourceUpdater.updateViaAddRemove;
...
public class UserAttributeUpdater extends ServerResourceUpdater<UserAttributeUpdater, UserResource, UserRepresentation> {
     ...
     * @return
     */
    public static UserAttributeUpdater forUserByUsername(Passport adminClient, String realm, String userName) {
