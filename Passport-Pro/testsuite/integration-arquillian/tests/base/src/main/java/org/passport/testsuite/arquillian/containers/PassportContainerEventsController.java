 ...
 * @author mabartos
 */
public class PassportContainerEventsController extends ContainerEventController {

    protected static final Logger log = Logger.getLogger(PassportContainerEventsController.class);
