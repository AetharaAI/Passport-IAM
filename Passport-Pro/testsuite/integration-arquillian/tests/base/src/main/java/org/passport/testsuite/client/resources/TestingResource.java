...
package org.passport.testsuite.client.resources;
...
public interface TestingResource {
    ...
    /**
     * Will set Inifispan's {@link TimeService} that is aware of Passport time shifts to the infinispan {@code CacheManager} before the test.
     * This will allow infinispan expiration to be aware of Passport {@link org.passport.common.util.Time#setOffset}
     */
    @POST
     ...
     *
     * @param providerType           fully qualified class name of provider (subclass of org.passport.provider.Provider)
    ...
    /**
     * @param providerClass Full name of class such as for example "org.passport.authentication.Authenticator"
