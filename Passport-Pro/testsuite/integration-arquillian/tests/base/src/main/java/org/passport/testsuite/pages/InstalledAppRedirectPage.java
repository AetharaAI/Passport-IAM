...
/**
 * Page represented by code.ftl. It is used by "Installed applications" (PassportInstalled)
 *
...
public class InstalledAppRedirectPage extends AbstractPage {
    ...
    public void open(String realmName, String code, String error, String errorDescription) {
        try {
            PassportUriBuilder kcUriBuilder = PassportUriBuilder.fromUri(Urls.realmInstalledAppUrnCallback(new URI(oauth.AUTH_SERVER_ROOT), realmName));
            if (code != null) {
