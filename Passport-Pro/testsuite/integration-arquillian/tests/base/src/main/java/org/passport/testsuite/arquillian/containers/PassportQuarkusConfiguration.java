 ...
 * @author mhajas
 */
public class PassportQuarkusConfiguration implements ContainerConfiguration {

    protected static final Logger log = Logger.getLogger(PassportQuarkusConfiguration.class);
    ...
    private String passportConfigPropertyOverrides;
    ...
    public void validate() throws ConfigurationException {
        ...
        log.infof("Passport will listen for http on port: %d, for https on port: %d, and for management on port: %d\n", newPort, newHttpsPort, managementPort);
    }
    ...
    // https://github.com/passport/passport/issues/20455 Overloading fails time to time with a mismatch error, most probably an Arquillian class reflection bug.
