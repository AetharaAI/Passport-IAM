...
public class LDAPTestConfiguration {
    ...
    static {
        ...
        DEFAULT_VALUES.put(LDAPConstants.BASE_DN, "dc=passport,dc=org");
        DEFAULT_VALUES.put(LDAPConstants.USERS_DN, "ou=People,dc=passport,dc=org");
        ...
        DEFAULT_VALUES.put(KerberosConstants.KERBEROS_REALM, "PASSPORT.ORG");
        DEFAULT_VALUES.put(KerberosConstants.SERVER_PRINCIPAL, "HTTP/localhost@PASSPORT.ORG");
