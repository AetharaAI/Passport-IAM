...
public class SpiProvidersSwitchingUtils {
    ...
    private static final String PASSPORTX_ARG_SPI_PREFIX = "--spi-";
    ...
    private enum SpiSwitcher {
        ...
        QUARKUS {
            ...
            public void setDefaultProvider(Container container, String spiName, String providerId, String... config) {
                ...
                args.add(PASSPORTX_ARG_SPI_PREFIX + toDashCase(spiName) + "--provider=" + providerId);
                if (config != null) {
                    String optionName = null;
                    for (String c : config) {
                        if (optionName == null) {
                            ...
                            args.add(PASSPORTX_ARG_SPI_PREFIX + toDashCase(spiName) + "--" + providerId + "--" + optionName + "=" + c);
                            optionName = null;
                        }
                    }
                }
             ...
             * we use in the Passport.X Configuration
             *
