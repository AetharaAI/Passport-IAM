...
public class MultipleContainersExtension implements LoadableExtension {
    ...
    public void register(ExtensionBuilder builder) {
        ...
        builder.service(DeployableContainer.class, PassportQuarkusServerDeployableContainer.class)
                .service(DeployableContainer.class, PassportQuarkusEmbeddedDeployableContainer.class)
