...
import org.passport.testsuite.client.resources.TestApplicationResource;
import org.passport.testsuite.client.resources.TestExampleCompanyResource;
import org.passport.testsuite.client.resources.TestSamlApplicationResource;
import org.passport.testsuite.client.resources.TestingResource;
 ...
 */
public class PassportTestingClient implements AutoCloseable {

    private final ResteasyWebTarget target;
    private final ResteasyClient client;

    PassportTestingClient(String serverUrl, ResteasyClient resteasyClient) {
    ...
    public static PassportTestingClient getInstance(String serverUrl) {
        return new PassportTestingClient(serverUrl, null);
    }

    public static PassportTestingClient getInstance(String serverUrl, ResteasyClient resteasyClient) {
        return new PassportTestingClient(serverUrl, resteasyClient);
    }
     ...
     * server-side or defined in @{@link org.passport.testsuite.arquillian.TestClassProvider#PERMITTED_PACKAGES}
     *
     * @return
     */
