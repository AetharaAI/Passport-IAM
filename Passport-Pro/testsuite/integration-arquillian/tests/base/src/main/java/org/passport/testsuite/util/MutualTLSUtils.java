 ...
 *
 * @see https://issues.jboss.org/browse/PASSPORT-6771
...
public class MutualTLSUtils {
    ...
    public static final String DEFAULT_KEYSTORE_SUBJECT_DN = "EMAILADDRESS=test-user@localhost, CN=test-user@localhost, OU=Passport, O=Red Hat, L=Westford, ST=MA, C=US";
