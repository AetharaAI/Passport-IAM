...
package org.passport.testsuite.drone;
 ...
 */
public class PassportDronePostSetup {
    ...
    protected static final Logger log = org.jboss.logging.Logger.getLogger(PassportDronePostSetup.class);
