...
import org.passport.testsuite.arquillian.ModelTestExecutor;
...
/**
 * PassportContainerTestExtension
 * 
 ...
 * @version $Revision: $
 */
public class PassportContainerTestExtension implements LoadableExtension {
    @Override
    public void register(ExtensionBuilder builder) {
        registerOriginal(builder);
        
//      Overriden ContainerEventController
        builder.observer(PassportContainerEventsController.class);
        
        // overriden ContainerDeployController
        builder.observer(PassportContainerDeployController.class);
    }
...
//            .observer(LocalTestExecuter.class)
            ...
            .observer(PassportContainerFeaturesController.class);
    }
}
