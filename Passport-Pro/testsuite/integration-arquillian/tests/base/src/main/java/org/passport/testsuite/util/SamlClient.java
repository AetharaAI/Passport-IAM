...
import org.passport.testsuite.util.saml.StepWithCheckers;
...
import static org.passport.saml.common.constants.GeneralConstants.RELAY_STATE;
import static org.passport.testsuite.util.Matchers.statusCodeIsHC;
import static org.passport.testsuite.util.SamlUtils.getSamlDeploymentForClient;
            ...
            private HttpPost createSamlPostMessage(URI samlEndpoint, String relayState, Document samlRequest, String messageType, String privateKeyStr, String publicKeyStr, String certificateStr) {
                ...
                try {
                    ...
                    if (privateKeyStr != null && (publicKeyStr != null || certificateStr != null)) {
                        PrivateKey privateKey = org.passport.testsuite.util.KeyUtils.privateKeyFromString(privateKeyStr);
                        PublicKey publicKey = publicKeyStr != null? org.passport.testsuite.util.KeyUtils.publicKeyFromString(publicKeyStr) : null;
                        X509Certificate cert = org.passport.common.util.PemUtils.decodeCertificate(certificateStr);
                        if (publicKey == null) {
            ...
            public HttpUriRequest createSamlSignedResponse(URI samlEndpoint, String relayState, Document samlRequest, String realmPrivateKey, String realmPublicKey, String certificateStr) {
                ...
                try {
                    ...
                    if (realmPrivateKey != null && realmPublicKey != null) {
                        PrivateKey privateKey = org.passport.testsuite.util.KeyUtils.privateKeyFromString(realmPrivateKey);
                        PublicKey publicKey = org.passport.testsuite.util.KeyUtils.publicKeyFromString(realmPublicKey);
                        X509Certificate cert = org.passport.common.util.PemUtils.decodeCertificate(certificateStr);
                        binding
                                .signatureAlgorithm(SignatureAlgorithm.RSA_SHA256)
                                .signWith(KeyUtils.createKeyId(privateKey), privateKey, publicKey, cert)
        ...
        if (realmPublicKey != null) {
            ...
            try {
                KeyLocator locator = new KeyLocator() {
                    ...
                    private final Key key = org.passport.testsuite.util.KeyUtils.publicKeyFromString(realmPublicKey);
