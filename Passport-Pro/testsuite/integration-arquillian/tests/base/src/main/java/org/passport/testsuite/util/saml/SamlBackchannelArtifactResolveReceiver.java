...
public class SamlBackchannelArtifactResolveReceiver implements AutoCloseable {
    ...
    public SamlBackchannelArtifactResolveReceiver(int port, ClientRepresentation samlClient, String publicKeyStr, String privateKeyStr) {
        ...
        publicKey = publicKeyStr == null ? null : org.passport.testsuite.util.KeyUtils.publicKeyFromString(publicKeyStr);
        privateKey = privateKeyStr == null ? null : org.passport.testsuite.util.KeyUtils.privateKeyFromString(privateKeyStr);
        try {
