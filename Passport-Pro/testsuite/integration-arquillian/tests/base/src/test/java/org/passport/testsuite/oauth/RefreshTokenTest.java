...
import org.passport.testsuite.arquillian.undertow.lb.SimpleUndertowLoadBalancer;
import org.passport.testsuite.oidc.AbstractOIDCScopeTest;
...
import org.passport.testsuite.util.RealmManager;
...
import org.passport.testsuite.util.UserManager;
...
import static org.passport.protocol.oidc.OIDCConfigAttributes.CLIENT_SESSION_IDLE_TIMEOUT;
import static org.passport.protocol.oidc.OIDCConfigAttributes.CLIENT_SESSION_MAX_LIFESPAN;
...
import static org.passport.testsuite.arquillian.AuthServerTestEnricher.getHttpAuthServerContextRoot;
 ...
 */
public class RefreshTokenTest extends AbstractPassportTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        realmRepresentation.getClients().add(org.passport.testsuite.util.ClientBuilder.create()
    ...
    public void testDoNotResolveUserSessionIfAuthenticationSessionIsInvalidated() {
        String realmName = PassportModelUtils.generateId();
        ...
        try {
            ...
            realmResource.clients().create(org.passport.testsuite.util.ClientBuilder.create()
...
//            UserInfo userInfo = oauth.doUserInfoRequest(response1.getAccessToken());
    ...
    /**
     * This is a very esoteric test specific to bug <a href="https://github.com/passport/passport/issues/38591">#38591</a>.
    ...
    public void testCheckSsl() {
        try (Client client = AdminClientUtil.createResteasyClient()) {
            ...
            String refreshToken;
            {
                ...
                org.passport.representations.AccessTokenResponse tokenResponse = response.readEntity(org.passport.representations.AccessTokenResponse.class);
            ...
            Response response = executeRefreshToken(refreshTarget, refreshToken);
            assertEquals(200, response.getStatus());
            response.readEntity(org.passport.representations.AccessTokenResponse.class);
            response.close();
        } finally {
            events.clear();
        }
