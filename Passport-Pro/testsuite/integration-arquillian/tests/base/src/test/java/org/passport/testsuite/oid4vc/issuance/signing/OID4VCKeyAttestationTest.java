...
import org.passport.protocol.oid4vc.issuance.VCIssuerException;
import org.passport.protocol.oid4vc.issuance.keybinding.AttestationKeyResolver;
import org.passport.protocol.oid4vc.issuance.keybinding.AttestationProofValidator;
import org.passport.protocol.oid4vc.issuance.keybinding.AttestationProofValidatorFactory;
...
import org.passport.protocol.oid4vc.issuance.keybinding.StaticAttestationKeyResolver;
...
public class OID4VCKeyAttestationTest extends OID4VCIssuerEndpointTest {
    ...
    private static void runAttestationWithValidResistanceLevels(PassportSession session, String cNonce) {
        try {
    ...
    private static void runValidAttestationProofTest(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
            KeyWrapper proofKey = getECKey("proofKey");
    ...
    private static void runInvalidAttestationProofTest(PassportSession session) {
        KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runValidJwtProofWithKeyAttestationTest(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
            KeyWrapper proofKey = getECKey("proofKey");
            JWK proofJwk = JWKBuilder.create().ec(proofKey.getPublicKey());
    ...
    private static void runInvalidJwtProofWithKeyAttestationTest(PassportSession session) {
        KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runInvalidAttestationSignatureTest(PassportSession session, String cNonce) {
        KeyWrapper attestationKey = getECKey("attestationKey");
        KeyWrapper proofKey = getECKey("proofKey");
        JWK proofJwk = JWKBuilder.create().ec(proofKey.getPublicKey());
    ...
    private static void runMissingRequiredAttestationClaimsTest(PassportSession session) {
        KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runAttestationWithMultipleAttestedKeys(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runAttestationWithX5cCertificateChain(PassportSession session, String cNonce) {
        try {
    ...
    private static void runAttestationWithInvalidResistanceLevels(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
            KeyWrapper proofKey = getECKey("proofKey");
    ...
    private static void runAttestationWithMissingAttestedKeys(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
