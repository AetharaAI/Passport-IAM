...
import org.passport.broker.saml.mappers.XPathAttributeMapper;
...
import org.passport.protocol.saml.mappers.HardcodedAttributeMapper;
 ...
 * extracting it using the {@link org.passport.saml.processing.core.parsers.saml.assertion.SAMLAttributeValueParser},
 * and parsing it using {@link XPathAttributeMapper}, finally ending up in a user attribute in the database.
 *
 * This contains only the happy path. Have a look at <code>org.passport.test.broker.saml.XPathAttributeMapperTest</code>
