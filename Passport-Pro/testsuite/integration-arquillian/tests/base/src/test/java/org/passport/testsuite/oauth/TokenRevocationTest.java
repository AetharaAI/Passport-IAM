...
import static org.passport.testsuite.AssertEvents.isTokenId;
 ...
 */
public class TokenRevocationTest extends AbstractPassportTest {
    ...
    private void isAccessTokenDisabled(String accessTokenString, String clientId) throws IOException {
        ...
        try (Passport adminClient = Passport.getInstance(OAuthClient.AUTH_SERVER_ROOT, "test", "test-app", accessTokenString, AdminClientUtil.getSSLContextWithTruststore())) {
            try {
