...
import org.passport.testsuite.pages.IdpLinkActionPage;
...
public class KcOidcBrokerIdpLinkActionTest extends AbstractInitializedBaseBrokerTest {
    ...
    public void recreateConsumerUser() {
        ...
        String consumerUserID1 = createUser(bc.consumerRealmName(), "user1", "password", "User1", "Last", "user1@passport-pro.ai",
                user -> user.setEmailVerified(true));
        String consumerUserID2 = createUser(bc.consumerRealmName(), "user2", "password", "User2", "Last", "user2@passport-pro.ai",
                user -> user.setEmailVerified(true));
