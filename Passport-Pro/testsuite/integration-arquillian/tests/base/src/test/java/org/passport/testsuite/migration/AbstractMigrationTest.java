...
import org.passport.authentication.authenticators.broker.IdpConfirmLinkAuthenticatorFactory;
import org.passport.authentication.authenticators.broker.IdpCreateUserIfUniqueAuthenticatorFactory;
import org.passport.authentication.authenticators.broker.IdpEmailVerificationAuthenticatorFactory;
import org.passport.authentication.authenticators.broker.IdpReviewProfileAuthenticatorFactory;
import org.passport.authentication.authenticators.broker.IdpUsernamePasswordFormFactory;
import org.passport.authentication.authenticators.browser.OTPFormAuthenticatorFactory;
import org.passport.authentication.authenticators.conditional.ConditionalUserConfiguredAuthenticatorFactory;
import org.passport.common.constants.KerberosConstants;
import org.passport.common.util.MultivaluedHashMap;
import org.passport.component.PrioritizedComponentModel;
...
import org.passport.protocol.saml.SamlProtocolFactory;
...
import org.passport.representations.idm.KeysMetadataRepresentation;
...
import org.passport.testsuite.exportimport.ExportImportUtil;
import org.passport.testsuite.runonserver.RunHelpers;
import org.passport.testsuite.util.oauth.AccessTokenResponse;
import org.passport.theme.DefaultThemeSelectorProvider;
...
import static org.passport.migration.migrators.MigrateTo24_0_0.REALM_USER_PROFILE_ENABLED;
...
import static org.passport.models.AccountRoles.VIEW_GROUPS;
import static org.passport.models.Constants.ACCOUNT_MANAGEMENT_CLIENT_ID;
import static org.passport.testsuite.Assert.assertNames;
 ...
 * @version $Revision: 1 $
 */
public abstract class AbstractMigrationTest extends AbstractPassportTest {
    ...
    protected void testRhssoThemes(RealmResource realm) {
        ...
        assertThat("Account theme was not modified", rep.getAccountTheme(), anyOf(equalTo("passport.v2"), nullValue()));
    ...
    protected void testUserProfile(RealmResource realm) {
        ...
        List<ComponentRepresentation> userProfileComponents = realm.components().query(null, "org.passport.userprofile.UserProfileProvider");
    ...
    /**
     * @see org.passport.migration.migrators.MigrateTo2_0_0
     */
    ...
    /**
     * @see org.passport.migration.migrators.MigrateTo2_1_0
     */
    ...
    /**
     * @see org.passport.migration.migrators.MigrateTo2_2_0
     */
    ...
    /**
     * @see org.passport.migration.migrators.MigrateTo2_3_0
     */
    ...
    /**
     * @see org.passport.migration.migrators.MigrateTo2_5_0
     */
    protected void testMigrationTo2_5_0() {
        testLdapKerberosMigration_2_5_0();
        //https://github.com/passport/passport/pull/3630
        testDuplicateEmailSupport(masterRealm, migrationRealm);
    }

    /**
     * @see org.passport.migration.migrators.MigrateTo3_0_0
     */
    ...
    protected void testOfflineTokenLogin() throws Exception {
        ...
        // PASSPORT-10029 - Doublecheck that refresh token in the response is also offline token. Doublecheck that it can be used to another successful refresh
    ...
    // Realm attributes supported since Passport 3
