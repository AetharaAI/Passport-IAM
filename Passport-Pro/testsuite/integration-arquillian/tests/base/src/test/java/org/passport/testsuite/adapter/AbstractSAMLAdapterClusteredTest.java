...
import org.passport.testsuite.adapter.page.EmployeeServletDistributable;
...
import static org.passport.testsuite.utils.io.IOUtil.loadRealm;
...
public abstract class AbstractSAMLAdapterClusteredTest extends AbstractAdapterClusteredTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        testRealms.add(loadRealm("/adapter-test/passport-saml/testsaml-behind-lb.json"));
