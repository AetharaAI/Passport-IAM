...
public class CustomRegistrationTemplateTest extends AbstractTestRealmPassportTest {
    ...
    protected UserRepresentation register() {
        ...
        registerPage.register("firstName", "lastName", username + "@passport-pro.ai", username, "password", "password", CUSTOM_ATTRIBUTES);
