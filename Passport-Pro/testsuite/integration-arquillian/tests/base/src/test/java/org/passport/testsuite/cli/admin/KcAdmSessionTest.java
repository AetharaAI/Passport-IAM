...
public class KcAdmSessionTest extends AbstractAdmCliTest {
    ...
    public void test() throws IOException {
        ...
        try (TempFileResource configFile = new TempFileResource(FileConfigHandler.getConfigFile())) {
            ...
            // create user
            exe = execute("create users --config '" + configFile.getName() + "' -r demorealm -s username=testuser -s firstName=testuser -s lastName=testuser -s email=testuser@passport-pro.ai -s enabled=true -i");
