...
package org.passport.testsuite.domainextension;
...
// It looks like the problem is, that in the time of loading spis during passport deployment, the deployment of Testsuite providers
...
// is not loaded
public class CustomExtensionTest extends AbstractPassportTest {
