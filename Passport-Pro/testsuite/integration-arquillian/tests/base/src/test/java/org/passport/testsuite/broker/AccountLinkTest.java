...
import org.passport.testsuite.federation.PassThroughFederatedUserStorageProvider;
import org.passport.testsuite.federation.PassThroughFederatedUserStorageProviderFactory;
...
import static org.passport.testsuite.admin.ApiUtil.createUserAndResetPasswordWithAdminClient;
 ...
 * @version $Revision: 1 $
 */
public class AccountLinkTest extends AbstractPassportTest {
    ...
    @Test
    @Ignore // Ignore should be removed by https://github.com/passport/passport/issues/20441
    ...
    private static void checkEmptyFederatedIdentities(PassportSession session) {
