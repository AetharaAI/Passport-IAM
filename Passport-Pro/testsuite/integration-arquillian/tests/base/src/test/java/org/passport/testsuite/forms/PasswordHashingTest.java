...
import org.passport.credential.hash.PasswordHashProviderFactory;
import org.passport.credential.hash.Pbkdf2PasswordHashProvider;
import org.passport.credential.hash.Pbkdf2PasswordHashProviderFactory;
import org.passport.credential.hash.Pbkdf2Sha256PasswordHashProviderFactory;
...
import org.passport.testsuite.util.DefaultPasswordHash;
 ...
 */
public class PasswordHashingTest extends AbstractTestRealmPassportTest {
    ...
    public void testPbkdf2Sha256WithPadding() throws Exception {
        ...
        int originalPaddingLength = configurePaddingForPassport(14);
        try {
            ...
            configurePaddingForPassport(65);
            ...
            configurePaddingForPassport(originalPaddingLength);
        }
    }
    ...
    private int configurePaddingForPassport(int paddingLength) {
        return testingClient.server("test").fetch(session -> {
            Pbkdf2Sha256PasswordHashProviderFactory factory = (Pbkdf2Sha256PasswordHashProviderFactory) session.getPassportSessionFactory().getProviderFactory(PasswordHashProvider.class, Pbkdf2Sha256PasswordHashProviderFactory.ID);
