...
import static org.passport.testsuite.util.KeyUtils.generateNewRealmKey;
...
public class KcSamlSpDescriptorTest extends AbstractBrokerTest {
    ...
    @Test
    public void testMetadataBindingEqualsPassportPOSTBindingSettingsOn()
    ...
    @Test
    public void testMetadataBindingEqualsPassportPOSTBindingSettingsOff()
            throws IOException, ParsingException, URISyntaxException {
        try (Closeable idpUpdater = new IdentityProviderAttributeUpdater(identityProviderResource)
    ...
    @Test
    public void testMetadataBindingEqualsPassportSLOBindingSettingsIsDefault()
            throws IOException, ParsingException, URISyntaxException {
