...
package org.passport.testsuite.policy;
...
import org.passport.policy.BlacklistPasswordPolicyProvider;
import org.passport.policy.BlacklistPasswordPolicyProviderFactory;
import org.passport.policy.MaximumLengthPasswordPolicyProviderFactory;
 ...
 */
public class PasswordPolicyTest extends AbstractPassportTest {
    ...
    public void testBlacklistPasswordPolicyDefaultPath() throws Exception {
        ...
        testingClient.server("passwordPolicy").run(session -> {
            ProviderFactory<PasswordPolicyProvider> passPolicyFact = session.getPassportSessionFactory().getProviderFactory(
