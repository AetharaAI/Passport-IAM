...
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.configurePostBrokerLoginWithOTP;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.disablePostBrokerLoginFlow;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.grantReadTokenRole;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.revokeReadTokenRole;
...
import static org.passport.testsuite.broker.BrokerTestTools.waitForElementEnabled;
...
public abstract class AbstractAdvancedBrokerTest extends AbstractBrokerTest {
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testAccountManagementLinkIdentity
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testAccountManagementLinkedIdentityAlreadyExists
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testTokenStorageAndRetrievalByApplication
     */
    @Test
    public void testRetrieveToken() throws Exception {
        ...
        Client client = PassportTestingClient.getRestEasyClientBuilder().register((ClientRequestFilter) request -> request.getHeaders().add(HttpHeaders.AUTHORIZATION, "Bearer " + accessToken.get())).build();
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest.testDisabledUser
     */
    @Test
    ...
    /**
     * Refers to in old testsuite: org.passport.testsuite.broker.PostBrokerFlowTest#testPostBrokerLoginWithOTP()
     */
    @Test
    ...
    /**
     * Refers to in old testsuite: org.passport.testsuite.broker.OIDCPassportServerBrokerBasicTest#testLogoutWorksWithTokenTimeout()
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testWithLinkedFederationProvider
     */
    @Test
