...
import org.passport.broker.oidc.mappers.ExternalPassportRoleToRoleMapper;
import org.passport.broker.oidc.mappers.UserAttributeMapper;
...
import static org.passport.testsuite.broker.KcOidcBrokerConfiguration.CONSUMER_BROKER_APP_CLIENT_ID;
import static org.passport.testsuite.broker.KcOidcBrokerConfiguration.CONSUMER_BROKER_APP_SECRET;
...
public final class KcOidcBrokerTransientSessionsTest extends AbstractAdvancedBrokerTest {
    ...
    protected Iterable<IdentityProviderMapperRepresentation> createIdentityProviderMappers(IdentityProviderMapperSyncMode syncMode) {
        ...
        attrMapper1.setIdentityProviderMapper(ExternalPassportRoleToRoleMapper.PROVIDER_ID);
        ...
        attrMapper2.setIdentityProviderMapper(ExternalPassportRoleToRoleMapper.PROVIDER_ID);
    ...
    protected void createAdditionalMapperWithCustomSyncMode(IdentityProviderMapperSyncMode syncMode) {
        ...
        friendlyManagerMapper.setIdentityProviderMapper(ExternalPassportRoleToRoleMapper.PROVIDER_ID);
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.OIDCBrokerUserPropertyTest
     */
    @Test
