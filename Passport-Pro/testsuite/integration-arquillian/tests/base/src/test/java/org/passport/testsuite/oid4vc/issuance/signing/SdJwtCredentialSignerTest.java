...
import org.passport.protocol.oid4vc.issuance.credentialbuilder.LDCredentialBody;
import org.passport.protocol.oid4vc.issuance.credentialbuilder.SdJwtCredentialBody;
...
import org.passport.protocol.oid4vc.issuance.signing.SdJwtCredentialSigner;
...
import static org.passport.OID4VCConstants.CLAIM_NAME_SD;
import static org.passport.OID4VCConstants.CLAIM_NAME_SD_HASH_ALGORITHM;
import static org.passport.OID4VCConstants.SDJWT_DELIMITER;
...
public class SdJwtCredentialSignerTest extends OID4VCTest {
    ...
    public static void testSignSDJwtCredential(PassportSession session, String signingKeyId, String overrideKeyId, String
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        if (testRealm.getComponents() != null) {
            testRealm.getComponents().add("org.passport.keys.KeyProvider", getRsaKeyProvider(rsaKey));
        } else {
            testRealm.setComponents(new MultivaluedHashMap<>(
                    Map.of("org.passport.keys.KeyProvider", List.of(getRsaKeyProvider(rsaKey)))));
        }
    }
