...
public class ValidatorsTest extends AbstractPassportTest {
    ...
    @Test
    @ModelTest
    public void simpleValidationWithContext(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void simpleValidationFluent(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void simpleValidationLookup(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void simpleValidationError(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void forEachError(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void formatError(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void multipleValidations(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void multipleValidationsError(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigSimple(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void validateEmailValidator(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigMultipleOptions(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigMultipleOptionsInvalidValues(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigViaValidatorFactory(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void nestedValidation(PassportSession session) {
