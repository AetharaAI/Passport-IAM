...
import org.passport.admin.ui.rest.model.UIRealmInfo;
import org.passport.admin.ui.rest.model.UIRealmRepresentation;
 ...
 * @author rmartinc
 */
public class UIRealmResourceTest extends AbstractTestRealmPassportTest {
    ...
    private static Passport passportAdminClientViewUsers;
    private static Passport passportAdminClientWithoutAdminRoles;
    ...
    public static void initHttpClients() {
        httpClient = Passport.getClientProvider().newRestEasyClient(null, null, true);

        passportAdminClientViewUsers = PassportBuilder.builder().serverUrl(getPassportServerUrl())
        ...
        passportAdminClientWithoutAdminRoles = PassportBuilder.builder().serverUrl(getPassportServerUrl())
                .realm(TEST_REALM_NAME)
    ...
    public static void closeHttpClients() {
        if (passportAdminClientViewUsers != null) {
            passportAdminClientViewUsers.close();
        }
        if (passportAdminClientWithoutAdminRoles != null) {
            passportAdminClientWithoutAdminRoles.close();
        }
        if (httpClient != null) {
            httpClient.close();
        }
    ...
    public void uiRealmInfoSucceedsWithAnyAdminRole() {
        final var response = getUiRealmInfo(passportAdminClientViewUsers.tokenManager());
    ...
    public void uiRealmInfoFailsWhenNoAdminRoleIsAssigned() {
        final var response = getUiRealmInfo(passportAdminClientWithoutAdminRoles.tokenManager());
    ...
    private static String getPassportServerUrl() {
    ...
    private WebTarget prepareHttpRequest(final String realmName, final String subPath, final TokenManager tokenManager) {
        ...
        return httpClient.target(getPassportServerUrl())
