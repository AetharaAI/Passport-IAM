...
import org.passport.authentication.authenticators.resetcred.ResetCredentialEmail;
...
import org.passport.testsuite.federation.kerberos.AbstractKerberosTest;
...
import org.passport.testsuite.util.KerberosUtils;
 ...
 */
public class ResetPasswordTest extends AbstractTestRealmPassportTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        RealmBuilder.edit(testRealm)
                .client(org.passport.testsuite.util.ClientBuilder.create().clientId("client-user").serviceAccount());
    }
    ...
    // PASSPORT-15239
    @Test
    @IgnoreBrowserDriver(FirefoxDriver.class) // TODO: https://github.com/passport/passport/issues/20526
    ...
    private void resetPasswordInNewTab(UserRepresentation user, String clientId, String redirectUri) throws IOException {
        try (BrowserTabUtil browserTabUtil = BrowserTabUtil.getInstanceAndSetEnv(driver)) {
            ...
            if (driver instanceof HtmlUnitDriver) {
                ...
                PassportUriBuilder builder = PassportUriBuilder.fromUri(tab1Url);
