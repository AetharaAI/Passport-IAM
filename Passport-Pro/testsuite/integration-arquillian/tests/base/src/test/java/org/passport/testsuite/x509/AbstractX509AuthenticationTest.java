...
package org.passport.testsuite.x509;
...
import org.passport.admin.client.resource.AuthenticationManagementResource;
import org.passport.admin.client.resource.UserProfileResource;
import org.passport.authentication.AuthenticationFlow;
import org.passport.authentication.authenticators.x509.ValidateX509CertificateUsernameFactory;
import org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel;
import org.passport.authentication.authenticators.x509.X509ClientCertificateAuthenticatorFactory;
import org.passport.common.util.Encode;
...
import org.passport.testsuite.pages.AbstractPage;
import org.passport.testsuite.pages.AppPage;
import org.passport.testsuite.pages.LoginPage;
import org.passport.testsuite.pages.x509.X509IdentityConfirmationPage;
import org.passport.testsuite.updaters.SetSystemProperty;
import org.passport.testsuite.util.AdminEventPaths;
import org.passport.testsuite.util.AssertAdminEvents;
import org.passport.testsuite.util.ClientBuilder;
import org.passport.testsuite.util.DroneUtils;
import org.passport.testsuite.util.HtmlUnitBrowser;
...
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.IdentityMapperType.USERNAME_EMAIL;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.IdentityMapperType.USER_ATTRIBUTE;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.ISSUERDN;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTALTNAME_EMAIL;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTALTNAME_OTHERNAME;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTDN;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTDN_CN;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTDN_EMAIL;
import static org.passport.testsuite.drone.PassportDronePostSetup.HTML_UNIT_SSL_KEYSTORE_PASSWORD_PROP;
import static org.passport.testsuite.drone.PassportDronePostSetup.HTML_UNIT_SSL_KEYSTORE_PROP;
import static org.passport.testsuite.drone.PassportDronePostSetup.HTML_UNIT_SSL_KEYSTORE_TYPE_PROP;
import static org.passport.testsuite.util.ServerURLs.AUTH_SERVER_SSL_REQUIRED;
import static org.passport.utils.StringUtil.isBlank;
 ...
 * @since 10/28/2016
 */
public abstract class AbstractX509AuthenticationTest extends AbstractTestRealmPassportTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        UserRepresentation user = UserBuilder.create()
                ...
                .enabled(true)
                .password("password")
                .addAttribute("x509_issuer_identity", "Passport Intermediate CA")
                .build();
    ...
    public void importTestRealms() {
        ...
        userId2 = adminClient.realm("test").users().search("passport", true).get(0).getId();
    }
    ...
    AuthenticationFlowRepresentation createFlow(AuthenticationFlowRepresentation flowRep) {
        ...
        try {
            org.passport.testsuite.Assert.assertEquals(201, response.getStatus());
        }
        finally {
            response.close();
        }
    ...
    protected AssertEvents.ExpectedEvent addX509CertificateDetails(AssertEvents.ExpectedEvent expectedEvent) {
        return expectedEvent
                ...
                .detail(Details.X509_CERTIFICATE_ISSUER_DISTINGUISHED_NAME, Matchers.startsWith("EMAILADDRESS=contact@passport-pro.ai"));
    }
}
