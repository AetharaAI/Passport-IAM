...
public class LDAPGroupMapperSyncWithGroupsPathTest extends AbstractLDAPTest {
    ...
    public void before() {
        testingClient.server().run(session -> {
            ...
            GroupModel groupsPathGroup = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH);
    ...
    public void test01_syncWithGroupInheritance() {
        testingClient.server().run(session -> {
            ...
            GroupModel kcGroup1 = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1");
            Assert.assertNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group11"));
            Assert.assertNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group12"));
            GroupModel kcGroup11 = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11");
            GroupModel kcGroup12 = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12");
            ...
            kcGroup1 = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1");
            kcGroup12 = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12");
    ...
    public void test02_syncWithDropNonExistingGroups() throws Exception {
        testingClient.server().run(session -> {
            ...
            // Assert groups are imported to passport including their inheritance from LDAP
            GroupModel kcGroup1 = PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1");
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12"));
            ...
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/model1"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/model2"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, "/outside"));
            ...
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12"));
            Assert.assertNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/model1"));
            Assert.assertNull(PassportModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/model2"));
            Assert.assertNotNull(PassportModelUtils.findGroupByPath(session, realm, "/outside"));
        });
    }
