...
import org.passport.testsuite.auth.page.login.LoginActions;
...
import static org.passport.testsuite.arquillian.DeploymentTargetModifier.APP_SERVER_CURRENT;
...
public abstract class AbstractAdapterClusteredTest extends AbstractServletsAdapterTest {
    ...
    public static void checkPropertiesSet() {
        // Remove once https://github.com/passport/passport/issues/19834 is resolved
