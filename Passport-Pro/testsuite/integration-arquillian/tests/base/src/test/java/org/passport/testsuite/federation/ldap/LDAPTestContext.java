...
public class LDAPTestContext {
    ...
    public static LDAPTestContext init(PassportSession session) {
        return init(session, null);
    }

    public static LDAPTestContext init(PassportSession session, String providerName) {
        return init(session, AbstractLDAPTest.TEST_REALM_NAME, providerName);
    }

    public static LDAPTestContext init(PassportSession session, String realmName, String providerName) {
