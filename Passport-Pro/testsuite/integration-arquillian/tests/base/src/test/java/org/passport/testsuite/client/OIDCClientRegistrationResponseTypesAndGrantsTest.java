...
import org.passport.client.registration.HttpErrorException;
...
import static org.passport.OAuth2Constants.CLIENT_CREDENTIALS;
import static org.passport.OAuth2Constants.DEVICE_CODE_GRANT_TYPE;
import static org.passport.OAuth2Constants.IMPLICIT;
import static org.passport.OAuth2Constants.PASSWORD;
import static org.passport.OAuth2Constants.REFRESH_TOKEN;
import static org.passport.OAuth2Constants.TOKEN_EXCHANGE_GRANT_TYPE;
...
import static org.passport.protocol.oidc.utils.OIDCResponseType.ID_TOKEN;
import static org.passport.protocol.oidc.utils.OIDCResponseType.NONE;
...
public class OIDCClientRegistrationResponseTypesAndGrantsTest extends AbstractClientRegistrationTest {
    ...
    public void testClientWithoutResponseTypesAndGrantTypes() throws Exception {
        ...
        assertPassportClient(response, true, false, false, false, true, false, false);
    }
    ...
    // Limitation of Passport switches (Standard flow, Implicit flow) means that enabling any hybrid grant type enables also implicit flow.
    ...
    public void testResponseTypeCodeIDTokenWithoutGrantTypes() throws Exception {
        ...
        assertPassportClient(response, true, true, false, false, true, false, false);
    }
    ...
    public void testWithoutResponseTypeClientCredentialsGrant() throws Exception {
        ...
        assertPassportClient(response, false, false, false, true, false, false, false);
    }
    ...
    public void testWithoutResponseTypePasswordGrant() throws Exception {
        ...
        assertPassportClient(response, false, false, true, false, false, false, false);
    }
    ...
    public void testWithoutResponseTypePasswordClientCredentialsRefreshTokensGrants() throws Exception {
        ...
        assertPassportClient(response, false, false, true, true, true, false, false);
    }
    ...
    public void testClientWithoutRefreshToken() throws Exception {
        ...
        assertPassportClient(response, true, false, false, false, false, false, false);
    }
    ...
    public void testNoResponseTypesWithDeviceGrant() throws Exception {
        ...
        assertPassportClient(response, false, false, false, false, false, true, false);
    }
    ...
    public void testGrantTypeTokenExchange() throws Exception {
        ...
        assertPassportClient(response, true, false, false, false, true, false, true);
    }
    ...
    public void testCodeResponseTypeWithMoreGrants() throws Exception {
        ...
        assertPassportClient(response, true, false, true, true, true, false, false);
    }
    ...
    private void assertPassportClient(OIDCClientRepresentation response,
