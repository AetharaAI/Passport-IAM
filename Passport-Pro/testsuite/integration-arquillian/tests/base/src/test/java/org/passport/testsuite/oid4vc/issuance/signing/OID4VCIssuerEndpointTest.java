...
package org.passport.testsuite.oid4vc.issuance.signing;
...
import org.passport.OID4VCConstants.KeyAttestationResistanceLevels;
...
import org.passport.protocol.oid4vc.issuance.JWTVCIssuerWellKnownProviderFactory;
...
import org.passport.protocol.oid4vc.issuance.credentialbuilder.JwtCredentialBuilder;
import org.passport.protocol.oid4vc.issuance.credentialbuilder.SdJwtCredentialBuilder;
...
import org.passport.protocol.oid4vc.model.DisplayObject;
...
import org.passport.protocol.oidc.utils.OAuth2Code;
import org.passport.protocol.oidc.utils.OAuth2CodeParser;
...
import org.passport.testsuite.util.oauth.oid4vc.CredentialIssuerMetadataResponse;
import org.passport.testsuite.util.oauth.oid4vc.Oid4vcCredentialResponse;
...
import static org.passport.OID4VCConstants.CLAIM_NAME_VC;
import static org.passport.constants.OID4VCIConstants.CREDENTIAL_OFFER_CREATE;
import static org.passport.jose.jwe.JWEConstants.A256GCM;
import static org.passport.jose.jwe.JWEConstants.RSA_OAEP;
import static org.passport.jose.jwe.JWEConstants.RSA_OAEP_256;
import static org.passport.protocol.oid4vc.issuance.OID4VCIssuerEndpoint.CREDENTIAL_OFFER_URI_CODE_SCOPE;
import static org.passport.protocol.oid4vc.model.ProofType.JWT;
import static org.passport.testsuite.forms.PassThroughClientAuthenticator.clientId;
import static org.passport.testsuite.forms.PassThroughClientAuthenticator.namedClientId;
import static org.passport.userprofile.DeclarativeUserProfileProvider.UP_COMPONENT_CONFIG_KEY;
import static org.passport.util.JsonSerialization.valueAsPrettyString;
...
public abstract class OID4VCIssuerEndpointTest extends OID4VCTest {
    ...
    protected static OAuth2CodeEntry prepareSessionCode(PassportSession session, AppAuthManager.BearerTokenAuthenticator authenticator, String note) {
    ...
    protected static OID4VCIssuerEndpoint prepareIssuerEndpoint(PassportSession session,
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        // Add key providers
        testRealm.getComponents().add("org.passport.keys.KeyProvider", getKeyProvider());
        testRealm.getComponents().add("org.passport.keys.KeyProvider",
        ...
        testRealm.getComponents().add("org.passport.userprofile.UserProfileProvider", getUserProfileProvider());
