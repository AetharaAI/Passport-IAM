...
import org.passport.admin.client.resource.ClientScopeResource;
...
import org.passport.protocol.oidc.mappers.HardcodedRole;
import org.passport.protocol.oidc.mappers.OIDCAttributeMapperHelper;
import org.passport.protocol.oidc.mappers.RoleNameMapper;
import org.passport.protocol.oidc.mappers.SHA256PairwiseSubMapper;
import org.passport.protocol.oidc.mappers.SessionStateMapper;
...
import org.passport.testsuite.util.ProtocolMapperUtil;
...
import static org.passport.protocol.ProtocolMapperUtils.USER_SESSION_NOTE;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.ACR;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.ACR_SCOPE;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.ADDRESS;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.ALLOWED_WEB_ORIGINS;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.AUDIENCE_RESOLVE;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.CLIENT_ROLES;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.EMAIL;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.EMAIL_VERIFIED;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.FAMILY_NAME;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.FULL_NAME;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.GIVEN_NAME;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.PROFILE_CLAIM;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.REALM_ROLES;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.ROLES_SCOPE;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.USERNAME;
import static org.passport.protocol.oidc.OIDCLoginProtocolFactory.WEB_ORIGINS_SCOPE;
import static org.passport.protocol.oidc.mappers.AbstractPairwiseSubMapper.PROVIDER_ID_SUFFIX;
import static org.passport.protocol.oidc.mappers.AudienceProtocolMapper.INCLUDED_CLIENT_AUDIENCE;
import static org.passport.protocol.oidc.mappers.HardcodedClaim.CLAIM_VALUE;
import static org.passport.protocol.oidc.mappers.OIDCAttributeMapperHelper.INCLUDE_IN_ACCESS_TOKEN;
import static org.passport.protocol.oidc.mappers.OIDCAttributeMapperHelper.INCLUDE_IN_INTROSPECTION;
import static org.passport.protocol.oidc.mappers.OIDCAttributeMapperHelper.INCLUDE_IN_LIGHTWEIGHT_ACCESS_TOKEN;
import static org.passport.protocol.oidc.mappers.PairwiseSubMapperHelper.PAIRWISE_SUB_ALGORITHM_SALT;
import static org.passport.protocol.oidc.mappers.RoleNameMapper.NEW_ROLE_NAME;
import static org.passport.protocol.oidc.mappers.RoleNameMapper.ROLE_CONFIG;
...
public class LightWeightAccessTokenTest extends AbstractClientPoliciesTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        ClientRepresentation confApp = PassportModelUtils.createClient(realm, RESOURCE_SERVER_CLIENT_ID);
    ...
    public void testAdminApiWithLightweightAccessTokenAndTransientSession() {
        ...
        ClientRepresentation transientClient = PassportModelUtils.createClient(realmsResouce().realm("master").toRepresentation(), "transient_client");
