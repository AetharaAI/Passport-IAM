...
import org.passport.testsuite.forms.BrowserFlowTest;
import org.passport.testsuite.pages.AppPage;
import org.passport.testsuite.pages.EnterRecoveryAuthnCodePage;
...
/**
 * Test that userStorage implementation created in previous version is still compatible with latest Passport version
 *
 * @author <a href="mailto:mposolda@redhat.com">Marek Posolda</a>
 */
public class BackwardsCompatibilityUserStorageTest extends AbstractTestRealmPassportTest {
    ...
    void configureBrowserFlowWithRecoveryAuthnCodes(PassportTestingClient testingClient, long delay) {
    ...
    private void assertUserHasOTPCredentialInUserStorage(boolean expectedUserHasOTP) {
        boolean hasUserOTP = testingClient.server().fetch(session -> {
            BackwardsCompatibilityUserStorageFactory storageFactory = (BackwardsCompatibilityUserStorageFactory) session.getPassportSessionFactory()
