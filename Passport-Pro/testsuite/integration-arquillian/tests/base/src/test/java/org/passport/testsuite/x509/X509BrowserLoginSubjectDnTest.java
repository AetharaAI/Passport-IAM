...
public class X509BrowserLoginSubjectDnTest extends AbstractX509AuthenticationTest {
    ...
    private String setup(boolean canonicalDnEnabled) throws Exception {
        String subjectDn = canonicalDnEnabled ?
            "1.2.840.113549.1.9.1=#1613746573742d75736572406c6f63616c686f7374,cn=test-user,ou=passport,o=red hat,l=boston,st=ma,c=us" :
            "EMAILADDRESS=test-user@localhost, CN=test-user, OU=Passport, O=Red Hat, L=Boston, ST=MA, C=US";
