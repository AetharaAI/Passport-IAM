package org.passport.testsuite.docker;
...
import static org.passport.testsuite.util.ServerURLs.AUTH_SERVER_PORT_HTTP;
...
public class DockerClientTest extends AbstractPassportTest {
    ...
    public static void verifyEnvironment() {
        ...
        Assert.assertNotNull("Could not resolve host machine's IP address for docker adapter, and 'host.ip' system poperty not set. Client will not be able to authenticate against the passport server!", hostIp);
    }
    ...
    public void beforeAbstractPassportTest() throws Exception {
        ...
        File tmpCertFile = File.createTempFile("passport-docker-realm-cert-", ".pem");
