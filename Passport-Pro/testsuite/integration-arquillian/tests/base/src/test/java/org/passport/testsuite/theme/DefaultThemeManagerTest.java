 ...
 */
public class DefaultThemeManagerTest extends AbstractPassportTest {
    ...
    public void setUp() {
        testingClient.server().run(session -> {
            System.setProperty("existing_system_property", "Passport is awesome");
    ...
    public void systemPropertiesSubstitutionInThemeProperties() {
        testingClient.server().run(session -> {
            try {
                ...
                Assert.assertEquals("Passport is awesome", theme.getProperties().getProperty("system.property.found"));
