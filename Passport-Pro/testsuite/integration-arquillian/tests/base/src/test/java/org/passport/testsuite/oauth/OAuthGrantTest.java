 ...
 */
public class OAuthGrantTest extends AbstractPassportTest {
    ...
    // PASSPORT-16006 - tests that after revoke consent from single client, the SSO session is still valid and not automatically logged-out
    @Test
