...
public class OrganizationMemberWithLdapTest extends AbstractOrganizationTest {
    ...
    public void testLdapUserJoiningAndLeavingOrganization() {
        testingClient.server().run(session -> {
            ...
            GroupModel testGroup = PassportModelUtils.findGroupByPath(session, appRealm, "/group1");
        ...
        UserRepresentation ldapUser = testRealm().users().searchByUsername("johnpassport", true).get(0);
