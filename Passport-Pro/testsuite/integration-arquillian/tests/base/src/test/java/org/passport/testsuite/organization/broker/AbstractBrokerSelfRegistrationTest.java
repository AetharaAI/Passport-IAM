...
package org.passport.testsuite.organization.broker;
...
import org.passport.admin.client.resource.OrganizationIdentityProviderResource;
import org.passport.admin.client.resource.OrganizationMemberResource;
...
public abstract class AbstractBrokerSelfRegistrationTest extends AbstractOrganizationTest {
    ...
    public void testFailUpdateEmailNotAssociatedOrganizationUsingAdminAPI() {
        ...
        member.setEmail(PassportModelUtils.generateId() + "@user.org");
