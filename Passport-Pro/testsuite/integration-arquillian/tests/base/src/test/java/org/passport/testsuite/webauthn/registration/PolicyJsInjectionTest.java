...
package org.passport.testsuite.webauthn.registration;
...
public class PolicyJsInjectionTest extends AbstractWebAuthnVirtualTest {
    ...
    protected final String REDIRECT_SCRIPT = "required\"; window.location.href = \"http://www.passport-pro.ai\";\"";
    ...
    public void attestationConveyancePreference() {
        final String expectedMessage = getExpectedMessageByDriver(
                ...
                "The provided value 'required\"; window.location.href = \"http://www.passport-pro.ai\";\"' is not a valid enum value of type AttestationConveyancePreference.");
    ...
    public void authenticatorAttachment() {
        final String expectedMessage = getExpectedMessageByDriver(
                ...
                "The provided value 'required\"; window.location.href = \"http://www.passport-pro.ai\";\"' is not a valid enum value of type AuthenticatorAttachment.");
