...
import org.passport.testsuite.federation.ldap.LDAPMultipleAttributesTest;
...
public class LDAPMultipleAttributesNoImportTest extends LDAPMultipleAttributesTest {
    ...
    public void testUserImport() {
        testingClient.server().run(session -> {
            ...
            LDAPTestAsserts.assertUserImported(session.users(), appRealm, "jbrown", "James", "Brown", "jbrown@passport-pro.ai", "88441");
        });
    }
