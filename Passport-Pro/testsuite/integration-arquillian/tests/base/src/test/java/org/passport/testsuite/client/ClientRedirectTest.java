 ...
 */
public class ClientRedirectTest extends AbstractTestRealmPassportTest {
    ...
    /**
     * Integration test for {@link org.passport.services.resources.RealmsResource#getRedirect(String, String)}.
     *
     * @throws Exception
     */
    @Test
    ...
    public void testRedirectToDisabledClientRedirectURI() throws Exception {
        ...
        try {
            ...
            URI logout = PassportUriBuilder.fromUri(suiteContext.getAuthServerInfo().getBrowserContextRoot().toURI())
