...
import org.passport.protocol.oidc.mappers.ClaimsParameterWithValueIdTokenMapper;
import org.passport.protocol.oidc.utils.OIDCResponseType;
import org.passport.representations.ClaimsRepresentation;
...
import org.passport.services.clientpolicy.executor.IntentClientBindCheckExecutorFactory;
import org.passport.services.clientpolicy.executor.PKCEEnforcerExecutorFactory;
import org.passport.services.clientpolicy.executor.RejectImplicitGrantExecutorFactory;
import org.passport.services.clientpolicy.executor.RejectRequestExecutorFactory;
import org.passport.services.clientpolicy.executor.RejectResourceOwnerPasswordCredentialsGrantExecutorFactory;
...
import org.passport.services.clientpolicy.executor.SuppressRefreshTokenRotationExecutorFactory;
...
import org.passport.testsuite.services.clientpolicy.condition.TestRaiseExceptionConditionFactory;
...
import static org.passport.testsuite.util.ClientPoliciesUtil.createConsentRequiredExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createFullScopeDisabledExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createGrantTypeConditionConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createHolderOfKeyEnforceExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createIntentClientBindCheckExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createPKCEEnforceExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createRejectImplicitGrantExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createRejectisResourceOwnerPasswordCredentialsGrantExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createSecureClientAuthenticatorExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createSecureSigningAlgorithmForSignedJwtEnforceExecutorConfig;
import static org.passport.testsuite.util.ClientPoliciesUtil.createTestRaiseExeptionConditionConfig;
...
public class ClientPoliciesTest extends AbstractClientPoliciesTest {
    ...
    public void whenUpdateDynamicClientRotationMustFollowConfiguration() throws Exception {
        ...
        updateClientDynamically(clientId, (OIDCClientRepresentation clientRep) -> clientRep.setContacts(Collections.singletonList("passport@passport-pro.ai")));
