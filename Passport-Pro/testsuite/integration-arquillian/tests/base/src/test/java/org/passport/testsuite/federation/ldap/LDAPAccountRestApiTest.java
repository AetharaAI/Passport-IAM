...
import org.passport.federation.kerberos.KerberosFederationProvider;
...
public class LDAPAccountRestApiTest extends AbstractLDAPTest {
    ...
    @Rule
    public TokenUtil tokenUtil = new TokenUtil("johnpassport", "Password1");
    ...
    protected void afterImportTestRealm() {
        ...
        testingClient.server().run(session -> {
            ...
            if (isEmbeddedServer) {
                ...
                LDAPObject john = LDAPTestUtils.addLDAPUser(ctx.getLdapProvider(), appRealm, "johnpassport", "John", "Doe", "john@email.org", otherAttrs);
    ...
    public void testUpdateProfile() throws IOException {
        ...
        org.passport.representations.idm.UserRepresentation adminRestUserRep = testRealm().users()
    ...
    public void testUpdateProfileSimple() throws IOException {
        ...
        assertEquals("johnpassport", usernew.getUsername());
    ...
    public void testIgnoreReadOnlyAttributes() throws IOException {
        ...
        org.passport.representations.idm.UserRepresentation userRep = testRealm().users()
