...
import org.passport.models.sessions.infinispan.changes.sessions.AbstractLastSessionRefreshStore;
 ...
 */
public class LastSessionRefreshUnitTest extends AbstractPassportTest {
    ...
    public static abstract class LastSessionRefreshServerTest implements RunOnServer {
        ...
        AbstractLastSessionRefreshStore createStoreInstance(PassportSession session, long timerIntervalMs, int maxIntervalBetweenMessagesSeconds) {
            PersisterLastSessionRefreshStoreFactory factory = new PersisterLastSessionRefreshStoreFactory() {
                ...
                protected PersisterLastSessionRefreshStore createStoreInstance(int maxIntervalBetweenMessagesSeconds, int maxCount, boolean offline) {
                    return new PersisterLastSessionRefreshStore(maxIntervalBetweenMessagesSeconds, maxCount, offline) {
                        ...
                        @Override
                        protected void sendMessage(PassportSession kcSession, Map<String, SessionData> refreshesToSend) {
