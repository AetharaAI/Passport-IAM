...
import org.passport.testsuite.util.saml.SamlDocumentStepBuilder.Saml2DocumentTransformer;
    ...
    public void testWithExpiredBrokerCertificate() throws Exception {
            ...
            .update())
        {
            ...
            new SamlClientBuilder()
              ...
              .assertResponse(org.passport.testsuite.util.Matchers.statusCodeIsHC(Status.BAD_REQUEST));
        }
