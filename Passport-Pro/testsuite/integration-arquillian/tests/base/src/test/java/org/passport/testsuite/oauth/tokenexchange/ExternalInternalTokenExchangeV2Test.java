...
import org.passport.testsuite.broker.AbstractInitializedBaseBrokerTest;
import org.passport.testsuite.broker.BrokerConfiguration;
import org.passport.testsuite.broker.BrokerTestConstants;
...
import static org.passport.broker.oidc.OAuth2IdentityProviderConfig.TOKEN_ENDPOINT_URL;
import static org.passport.broker.oidc.OAuth2IdentityProviderConfig.TOKEN_INTROSPECTION_URL;
import static org.passport.testsuite.broker.BrokerTestConstants.CLIENT_ID;
...
public class ExternalInternalTokenExchangeV2Test extends AbstractInitializedBaseBrokerTest {
    ...
    private static void setupRealm(PassportSession session) {
    ...
    public void testSuccess_externalTokenIssuedToBrokerClient() throws Exception {
        ...
        org.passport.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client(brokerApp.getClientId(), brokerApp.getSecret()).doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
    ...
    public void testSuccess_brokerClientAsAudienceOfExternalToken() throws Exception {
        ...
        org.passport.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client("client-with-brokerapp-audience", "secret").doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
        assertThat(tokenResponse.getIdToken(), notNullValue());
    ...
    public void testSuccess_consumerRealmIssuerAsAudienceOfExternalToken() throws Exception {
        ...
        org.passport.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client("client-with-consumer-realm-issuer-audience", "secret").doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
        assertThat(tokenResponse.getIdToken(), notNullValue());
    ...
    public void testFailure_externalTokenIssuedToInvalidClient() throws Exception {
        ...
        org.passport.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client("client-without-valid-audience", "secret").doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
        assertThat(tokenResponse.getIdToken(), notNullValue());
