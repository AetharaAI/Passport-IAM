 ...
 */
public class UserStorageGracefulDegradationTest extends AbstractTestRealmPassportTest implements Serializable {
    ...
    public void addUserStorageProvider() {
        ...
        testingClient.server().run(session -> {
            ...
            failingProvider.setId(PassportModelUtils.generateId());
    ...
    @Test
    @ModelTest
    public void testGracefulDegradationOnSearchFailure(PassportSession session) {
        RealmModel realm = session.realms().getRealm("test");
    ...
    @Test
    @ModelTest
    public void testGracefulDegradationWithSearchString(PassportSession session) {
        RealmModel realm = session.realms().getRealm("test");
    ...
    @Test
    @ModelTest
    public void testGracefulDegradationOnCountFailure(PassportSession session) {
        RealmModel realm = session.realms().getRealm("test");
