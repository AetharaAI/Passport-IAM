...
import org.passport.representations.AddressClaimSet;
...
import static org.passport.OAuth2Constants.SCOPE_PROFILE;
...
import static org.passport.testsuite.util.ProtocolMapperUtil.createAddressMapper;
import static org.passport.testsuite.util.ProtocolMapperUtil.createClaimMapper;
import static org.passport.testsuite.util.ProtocolMapperUtil.createHardcodedClaim;
import static org.passport.testsuite.util.ProtocolMapperUtil.createHardcodedRole;
 ...
 */
public class OIDCProtocolMappersTest extends AbstractPassportTest {
    ...
    public void testUserRolesMovedFromAccessTokenProperties() throws Exception {
        ...
        try {
            ...
            // PASSPORT-8481 Assert that accessToken JSON doesn't have "realm_access" or "resource_access" fields in it
    ...
    // PASSPORT-8148 -- Test the scenario where:
    ...
    // PASSPORT-17252 -- Test the scenario where:
