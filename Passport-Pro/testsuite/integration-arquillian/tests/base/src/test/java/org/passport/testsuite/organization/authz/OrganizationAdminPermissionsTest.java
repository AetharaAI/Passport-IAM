...
package org.passport.testsuite.organization.authz;
...
public class OrganizationAdminPermissionsTest extends AbstractOrganizationTest {
    ...
    public void testManageRealmRole() throws Exception {
        try (
                Passport manageRealmAdminClient = AdminClientUtil.createAdminClient(suiteContext.isAdapterCompatTesting(),
                        TEST_REALM_NAME, "realmAdmin", "password", Constants.ADMIN_CLI_CLIENT_ID, null);
                Passport userAdminClient = AdminClientUtil.createAdminClient(suiteContext.isAdapterCompatTesting(),
