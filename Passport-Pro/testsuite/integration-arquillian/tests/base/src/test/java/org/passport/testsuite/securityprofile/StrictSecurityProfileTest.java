 ...
 */
package org.passport.testsuite.securityprofile;
...
public class StrictSecurityProfileTest extends AbstractTestRealmPassportTest {
    ...
    public void testUpdatingGlobalPoliciesNotAllowed() throws Exception {
        ...
        clientPoliciesRep = getClientPolicies();
        org.passport.testsuite.Assert.assertEquals(origGlobalPolicies, clientPoliciesRep.getGlobalPolicies());
    }
    ...
    public void testCreatePublicOpenIdConnectClientSecure() {
        ...
        ClientRepresentation clientRep = ClientBuilder.create()
                ...
                .baseUrl("https://www.passport-pro.ai")
                .redirectUris("https://www.passport-pro.ai")
                .build();
        ...
        wrapper.setPostLogoutRedirectUris(Collections.singletonList("https://www.passport-pro.ai"));
        wrapper.setPkceCodeChallengeMethod(OIDCLoginProtocol.PKCE_METHOD_PLAIN);

        // set the redirect uri to unsecure http
        clientRep.setRedirectUris(Collections.singletonList("http://www.passport-pro.ai"));
        ...
        clientRep.setRedirectUris(Collections.singletonList("https://www.passport-pro.ai"));
    ...
    public void testCreateSamlClientSecure() {
        ...
        ClientRepresentation clientRep = ClientBuilder.create()
                ...
                .baseUrl("https://www.passport-pro.ai")
                .redirectUris("https://www.passport-pro.ai")
                .adminUrl("https://www.passport-pro.ai")
        ...
        clientRep.setBaseUrl("http://www.passport-pro.ai");
        Response resp = realm.clients().create(clientRep);
        Assert.assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), resp.getStatus());
        OAuth2ErrorRepresentation error = resp.readEntity(OAuth2ErrorRepresentation.class);
        ...
        clientRep.setBaseUrl("https://www.passport-pro.ai");
