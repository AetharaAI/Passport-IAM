...
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SERIALNUMBER;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SERIALNUMBER_ISSUERDN;
import static org.passport.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SHA256_THUMBPRINT;
...
public class X509BrowserLoginTest extends AbstractX509AuthenticationTest {
    ...
    public void loginAsUserFromCertSerialnumberAndIssuerDNMappedToUserAttribute() {
        ...
        user.singleAttribute("x509_issuer_dn", "EMAILADDRESS=contact@passport-pro.ai, CN=Passport Intermediate CA, OU=Passport, O=Red Hat, ST=MA, C=US");
        ...
        x509BrowserLogin(createLoginWithSpecifiedSourceTypeToCustomAttributeConfig(SERIALNUMBER_ISSUERDN, "x509_certificate_serialnumber##x509_issuer_dn"),
                userId2, "passport", "4105##EMAILADDRESS=contact@passport-pro.ai, CN=Passport Intermediate CA, OU=Passport, O=Red Hat, ST=MA, C=US");
    }
    ...
    public void loginAsUserFromHexCertSerialnumberAndIssuerDNMappedToUserAttribute() {
        ...
        x509BrowserLogin(config, userId2, "passport", "1009##EMAILADDRESS=contact@passport-pro.ai, CN=Passport Intermediate CA, OU=Passport, O=Red Hat, ST=MA, C=US");
    }
    ...
    public void loginAsUserFromCertIssuerDNMappedToUserAttribute() {
        ...
        x509BrowserLogin(createLoginIssuerDN_OU2CustomAttributeConfig(), userId2, "passport", "Red Hat");
    }
    ...
    public void loginAsUserFromCertSHA256MappedToUserAttribute() {
        ...
        x509BrowserLogin(createLoginWithSpecifiedSourceTypeToCustomAttributeConfig(SHA256_THUMBPRINT, "x509_cert_sha256thumbprint"),
                userId2, "passport", "71237a14c118a90cc8406f14d039ed3431c9065f68e535293ee919d4c33b5e15");
    }
    ...
    public void loginAsUserFromHexCertSerialNumberMappedToUserAttribute() {
        ...
        config.setSerialnumberHex(true);
        x509BrowserLogin(config, userId2, "passport", "1009");
    }
    ...
    public void loginValidCertificateDisabledUser() {
        ...
        try {
            ...
            // PASSPORT-1741 - assert form field values kept
            Assert.assertEquals("test-user@localhost", loginPage.getUsername());
            Assert.assertEquals("", loginPage.getPassword());
    ...
    public void loginWithCertificateAddedLater() throws Exception {
        ...
        // Now setup certificate and login with certificate in existing authenticationSession (Not 100% same scenario as PASSPORT-5466, but very similar)
