...
import org.passport.authorization.client.resource.ProtectionResource;
...
public class AuthzClientCredentialsTest extends AbstractAuthzTest {
    ...
    public void beforeAbstractPassportTest() throws Exception {
        ...
        testContext.getTestRealmReps().forEach(realmRepresentation -> {
            Passport adminClient = getAdminClient();
    ...
    public void testSuccessfulJWTAuthentication() {
        assertAccessProtectionAPI(getAuthzClient("passport-with-jwt-authentication.json").protection());
    }
    ...
    public void testSuccessfulAuthorizationRS256Request() throws Exception {
        testSuccessfulAuthorizationRequest("passport-with-jwt-authentication.json");
    }

    @Test
    public void testSuccessfulAuthorizationRS512Request() throws Exception {
        testSuccessfulAuthorizationRequest("passport-with-jwt-rs512-authentication.json");
    }

    @Test
    public void testSuccessfulAuthorizationHS512Request() throws Exception {
        testSuccessfulAuthorizationRequest("passport-with-jwt-hs512-authentication.json");
    }

    @Test
    public void testSuccessfulAuthorizationES512Request() throws Exception {
        testSuccessfulAuthorizationRequest("passport-with-jwt-es512-authentication.json");
    }

    @Test
    public void testSuccessfulAuthorizationEd25519Request() throws Exception {
        testSuccessfulAuthorizationRequest("passport-with-jwt-Ed25519-authentication.json");
    }

    @Test
    public void failJWTAuthentication() {
        try {
            getAuthzClient("passport-with-invalid-keys-jwt-authentication.json").protection().resource().findAll();
    ...
    public void testSuccessfulClientSecret() {
        ProtectionResource protection = getAuthzClient("default-passport.json").protection();
    ...
    private void testReusingAccessAndRefreshTokens(int expectedUserSessionsCount) throws Exception {
        ...
        AuthzClient authzClient = getAuthzClient("default-session-passport.json");
        ProtectionResource protection = authzClient.protection();
    ...
    public void testPermissionWhenResourceServerIsCurrentUser() throws Exception {
        ...
        AuthzClient authzClient = getAuthzClient("default-session-passport.json");
        org.passport.authorization.client.resource.AuthorizationResource authorization = authzClient.authorization(authzClient.obtainAccessToken().getToken());
    ...
    public void testSingleSessionPerUser() throws Exception {
        ...
        AuthzClient authzClient = getAuthzClient("default-session-passport.json");
        org.passport.authorization.client.resource.AuthorizationResource authorization = authzClient.authorization("marta", "password");
        AuthorizationResponse response = authorization.authorize();
        AccessToken accessToken = toAccessToken(response.getToken());
    ...
    public void testNoRefreshToken() throws Exception {
        ...
        AuthzClient authzClient = getAuthzClient("default-session-passport-no-rt.json");
        org.passport.authorization.client.resource.AuthorizationResource authorization = authzClient.authorization();
        AuthorizationResponse response = authorization.authorize();
        AccessToken accessToken = toAccessToken(response.getToken());
