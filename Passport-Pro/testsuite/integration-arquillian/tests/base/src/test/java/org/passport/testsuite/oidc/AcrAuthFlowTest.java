...
import org.passport.services.clientpolicy.condition.AcrCondition;
import org.passport.services.clientpolicy.condition.AcrConditionFactory;
import org.passport.services.clientpolicy.executor.AuthenticationFlowSelectorExecutor;
import org.passport.services.clientpolicy.executor.AuthenticationFlowSelectorExecutorFactory;
...
public class AcrAuthFlowTest extends AbstractOIDCScopeTest{
    ...
    private ClientScopeRepresentation createScope(){
        ...
        return new ClientScopeRepresentation(){{
            setId(PassportModelUtils.generateId());
    ...
    private void setAcrClientPolicy(Passport adminClient, String realm, String acr, String alias) {
        setAcrClientPolicy(adminClient, realm, acr, alias, null);
    }

    public static void setAcrClientPolicy(Passport adminClient, String realm, String acr, String alias, Integer loa) {
     ...
     * @param userId The passport identifier of the user
     ...
     * @param userId The passport ID of the user to check
