...
public class AssertAdminEvents implements TestRule {
    ...
    private AbstractPassportTest context;

    public AssertAdminEvents(AbstractPassportTest ctx) {
        context = ctx;
    }
    ...
    public static Matcher<String> isExpectedPrefixFollowedByUuid(final String prefix) {
        return new TypeSafeMatcher<String>() {
            ...
            protected boolean matchesSafely(String item) {
                int expectedLength = prefix.length() + 1 + org.passport.models.utils.PassportModelUtils.generateId().length();
