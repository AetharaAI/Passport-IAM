...
/**
 * This is test only for migration of client policies from Passport 13. As the format JSON format of client policies changed between Passport 13 and 14
 *
...
public class JsonFileImport1301MigrationClientPoliciesTest extends AbstractJsonFileImportMigrationTest {
    ...
    public void migration13_0_1_Test() throws Exception {
        ...
        // Stick to null for now. No support for proper migration from Passport 13 as client policies was preview and JSON format was changed significantly
