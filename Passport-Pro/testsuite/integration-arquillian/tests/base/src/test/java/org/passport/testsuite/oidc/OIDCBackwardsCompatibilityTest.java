 ...
 */
public class OIDCBackwardsCompatibilityTest extends AbstractTestRealmPassportTest {
    ...
    public void testExcludeSessionStateParameter() {
        ...
        oauth.openLoginForm();
        org.passport.testsuite.Assert.assertEquals(AppPage.RequestType.AUTH_RESPONSE, appPage.getRequestType());
