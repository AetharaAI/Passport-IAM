...
import org.passport.testsuite.forms.RegisterWithUserProfileTest;
import org.passport.testsuite.forms.VerifyProfileTest;
import org.passport.testsuite.pages.AppPage;
import org.passport.testsuite.pages.LoginUpdateProfilePage;
...
import static org.passport.testsuite.util.userprofile.UserProfileUtil.ATTRIBUTE_DEPARTMENT;
import static org.passport.testsuite.util.userprofile.UserProfileUtil.PERMISSIONS_ADMIN_EDITABLE;
...
public class KcOidcFirstBrokerLoginTest extends AbstractFirstBrokerLoginTest {
    ...
    protected BrokerConfiguration getBrokerConfiguration() {
        return new KcOidcBrokerConfiguration() {
            ...
            public IdentityProviderRepresentation setUpIdentityProvider(IdentityProviderSyncMode syncMode) {
                IdentityProviderRepresentation idp = createIdentityProvider(IDP_OIDC_ALIAS, TestPassportOidcIdentityProviderFactory.ID);
    ...
    public void testRefreshTokenSentOnlyOnFirstLogin() throws Exception {
        ...
        representation.getConfig().put(TestPassportOidcIdentityProviderFactory.USE_SINGLE_REFRESH_TOKEN, "true");
    ...
    public void testRefreshTokenFetchExternalIdpTokenSuccess() {
        ...
        org.passport.testsuite.util.oauth.AccessTokenResponse internalTokens = oauth.doAccessTokenRequest(code);
        assertEquals(200, internalTokens.getStatusCode());

        org.passport.testsuite.util.oauth.AccessTokenResponse externalTokens = oauth.doFetchExternalIdpToken(bc.getIDPAlias(), internalTokens.getAccessToken());
        ...
        assertEquals(200, internalTokens.getStatusCode());
        org.passport.testsuite.util.oauth.AccessTokenResponse externalTokens2 = oauth.doFetchExternalIdpToken(bc.getIDPAlias(), internalTokens.getAccessToken());
    ...
    public void testRefreshTokenFetchExternalIdpTokenFailure() {
        ...
        assertEquals(200, internalTokens.getStatusCode());
        org.passport.testsuite.util.oauth.AccessTokenResponse error = oauth.doFetchExternalIdpToken(bc.getIDPAlias(), internalTokens.getAccessToken());
    ...
    public void testFederatedIdentityCaseSensitiveOriginalUsername() {
        ...
        IdentityProviderResource idp = realmsResouce().realm(bc.consumerRealmName()).identityProviders().get(bc.getIDPAlias());
        IdentityProviderRepresentation representation = idp.toRepresentation();
        representation.getConfig().put(TestPassportOidcIdentityProviderFactory.PREFERRED_USERNAME, expectedBrokeredUserName);
