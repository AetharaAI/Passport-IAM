...
package org.passport.testsuite.url;
...
import org.passport.testsuite.arquillian.containers.AbstractQuarkusDeployableContainer;
import org.passport.testsuite.arquillian.containers.RemoteContainer;
 ...
 * It is NOT testing that correct URL types are used at various places in Passport.
 *
 * @author Vaclav Muzikar <vmuzikar@redhat.com>
 */
public class HostnameV2Test extends AbstractPassportTest {
...
//    }
    ...
    private void setHostnameOptions(String hostname, String hostnameAdmin, Boolean hostnameBackchannelDynamic, Boolean hostnameStrict) {
        if (suiteContext.getAuthServerInfo().isQuarkus()) {
            ...
            setConfigProperty("passport.hostname", hostname);
            setConfigProperty("passport.hostname-admin", hostnameAdmin);
            setConfigProperty("passport.hostname-backchannel-dynamic", hostnameBackchannelDynamic == null ? null : String.valueOf(hostnameBackchannelDynamic));
            setConfigProperty("passport.hostname-strict", hostnameStrict == null ? null : String.valueOf(hostnameStrict));
        }
    }
    ...
    public void resetHostnameSettings() {
        if (suiteContext.getAuthServerInfo().isQuarkus()) {
            ...
            setConfigProperty("passport.hostname.provider", null);
        }
    }
