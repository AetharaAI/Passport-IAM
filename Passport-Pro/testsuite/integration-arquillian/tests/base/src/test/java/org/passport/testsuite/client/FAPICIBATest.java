...
import static org.passport.protocol.oidc.OIDCLoginProtocol.LOGIN_HINT_PARAM;
import static org.passport.protocol.oidc.grants.ciba.CibaGrantType.AUTH_REQ_ID;
import static org.passport.protocol.oidc.grants.ciba.CibaGrantType.BINDING_MESSAGE;
...
public class FAPICIBATest extends AbstractFAPITest {
    ...
    public void testFAPICIBALoginWithPrivateKeyJWT() throws Exception {
        ...
        String signedJwt = createSignedRequestToken(clientId, privateKey, publicKey, org.passport.crypto.Algorithm.PS256);
        ...
        String signedJwt2 = createSignedRequestToken(clientId, privateKey, publicKey, org.passport.crypto.Algorithm.PS256);
    ...
    private void setClientAuthMethodNeutralSettings(ClientRepresentation clientRep) {
        // for passport to get client key to verify signed authentication request by client
