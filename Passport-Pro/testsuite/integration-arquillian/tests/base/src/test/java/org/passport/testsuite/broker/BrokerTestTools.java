...
public class BrokerTestTools {
    ...
    /**
     * Expects a child idp and parent idp running on same Passport instance.  Links the two with non-signature checks.
     *
     * @param adminClient
     * @param childRealm
     * @param idpRealm
     */
    public static void createKcOidcBroker(Passport adminClient, String childRealm, String idpRealm) {
    ...
    public static void createKcOidcBroker(Passport adminClient, String childRealm, String idpRealm, String alias, boolean linkOnly) {
