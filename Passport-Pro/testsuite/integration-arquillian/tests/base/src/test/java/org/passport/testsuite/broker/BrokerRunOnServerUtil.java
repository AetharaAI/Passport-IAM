...
final class BrokerRunOnServerUtil {
    ...
    static void configureBrokerFlowToReAuthenticationWithPasswordForm(PassportTestingClient testingClient, String consumerRealmName, String idpAlias, String newFlowAlias) {
    ...
    static void configureBrokerFlowToReAuthenticationWithPasswordOrTotp(PassportTestingClient testingClient, String consumerRealmName, String idpAlias, String newFlowAlias) {
        testingClient.server(consumerRealmName).run(session -> FlowUtil.inCurrentRealm(session).copyFirstBrokerLoginFlow(newFlowAlias));
