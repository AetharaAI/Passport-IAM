...
public class UserInfoEndpointCorsTest extends AbstractPassportTest {
    ...
    // PASSPORT-15719 error response should still contain CORS headers
    @Test
    ...
    public void userInfoCorsInvalidSession() throws Exception {
        ...
        // remove the session in passport
