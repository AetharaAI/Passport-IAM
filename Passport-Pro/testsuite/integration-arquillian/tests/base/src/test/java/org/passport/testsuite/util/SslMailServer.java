...
import static org.passport.testsuite.util.MailServerConfiguration.FROM;
import static org.passport.testsuite.util.MailServerConfiguration.HOST;
import static org.passport.testsuite.util.MailServerConfiguration.PORT;
import static org.passport.testsuite.util.MailServerConfiguration.PORT_SSL;
import static org.passport.testsuite.util.MailServerConfiguration.STARTTLS;

public class SslMailServer {

    private static final Logger log = Logger.getLogger(MailServer.class);

    public static final String PRIVATE_KEY = "keystore/passport.jks";

    public static final String TRUSTED_CERTIFICATE = "keystore/passport.truststore";
