...
public class ResourceServerManagementTest extends AbstractAuthorizationTest {
    ...
    public void testImportSettingsToDifferentClient() throws Exception {
        ...
        clientRep.setClientId(PassportModelUtils.generateId());
        ...
        ClientRepresentation anotherClientRep = ClientBuilder.create().clientId(PassportModelUtils.generateId()).secret("secret").authorizationServicesEnabled(true).serviceAccount().enabled(true).build();
