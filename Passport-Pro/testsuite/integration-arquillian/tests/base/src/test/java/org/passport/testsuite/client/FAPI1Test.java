...
import org.passport.protocol.oidc.client.authentication.JWTClientSecretCredentialsProvider;
...
import static org.passport.testsuite.util.ClientPoliciesUtil.ClientPoliciesBuilder;
import static org.passport.testsuite.util.ClientPoliciesUtil.ClientPolicyBuilder;
...
public class FAPI1Test extends AbstractFAPITest {
    ...
    public void testFAPIBaselineRedirectUri() throws Exception {
        ...
        // Try to register client with valid root URL. Makes sure that there is not auto-created redirect URI with wildcard at the end (See PASSPORT-19556)
    ...
    public void testFAPIAdvancedLoginWithPrivateKeyJWT() throws Exception {
        ...
        // Check HoK required
        String signedJwt = createSignedRequestToken("foo", privateKey, publicKey, org.passport.crypto.Algorithm.PS256);
        ...
        String signedJwt2 = createSignedRequestToken("foo", privateKey, publicKey, org.passport.crypto.Algorithm.PS256);
