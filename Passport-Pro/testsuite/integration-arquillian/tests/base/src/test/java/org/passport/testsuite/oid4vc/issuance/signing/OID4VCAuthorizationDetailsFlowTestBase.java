...
public abstract class OID4VCAuthorizationDetailsFlowTestBase extends OID4VCIssuerEndpointTest {
    ...
    public void testStandardTokenAllowedAtEndpoint() throws Exception {
        ...
        // This ensures the fail-closed logic doesn't accidentally block standard Passport flows.

        // 1. Get standard token
        oauth.realm("test");
        oauth.client("test-app", "password");
        org.passport.testsuite.util.oauth.AccessTokenResponse response = oauth.doPasswordGrantRequest("test-user@localhost", "password");
