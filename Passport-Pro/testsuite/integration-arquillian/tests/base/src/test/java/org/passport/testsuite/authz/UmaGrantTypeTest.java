...
public class UmaGrantTypeTest extends AbstractResourceServerTest {
    ...
    public void testObtainRptWithUpgradeWithUnauthorizedResourceFromRpt() throws Exception {
        ...
        ResourceRepresentation resourceA = addResource(PassportModelUtils.generateId(), "ScopeA", "ScopeB", "ScopeC");
        ...
        ResourceRepresentation resourceB = addResource(PassportModelUtils.generateId(), "ScopeA", "ScopeB", "ScopeC");
    ...
    public void testObtainRptOnlyAuthorizedScopes() throws Exception {
        ResourceRepresentation resourceA = addResource(PassportModelUtils.generateId(), "READ", "WRITE");
        ScopePermissionRepresentation permissionA = new ScopePermissionRepresentation();

        permissionA.setName(PassportModelUtils.generateId());
        ...
        permissionB.setName(PassportModelUtils.generateId());
