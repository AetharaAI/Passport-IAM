...
import org.passport.broker.oauth.OAuth2IdentityProviderFactory;
...
public final class OAuth2BrokerTest extends AbstractAdvancedBrokerTest {
    ...
    protected BrokerConfiguration getBrokerConfiguration() {
        return new KcOidcBrokerConfiguration() {
            ...
            public List<ClientRepresentation> createProviderClients() {
                ...
                ProtocolMapperModel emailClaim = HardcodedClaim.create("email-claim", "email-claim", "email-claim@passport-pro.ai", "String", true, true, true);
    ...
    public void testFetchUserProfileClaims() {
        ...
        Assert.assertEquals("email-claim@passport-pro.ai", user.getEmail());
