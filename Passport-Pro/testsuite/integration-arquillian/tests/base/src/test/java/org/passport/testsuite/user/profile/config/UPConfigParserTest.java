 ...
 */
package org.passport.testsuite.user.profile.config;
...
import static org.passport.userprofile.config.UPConfigUtils.readConfig;
import static org.passport.userprofile.config.UPConfigUtils.validate;
 ...
 *
 */
public class UPConfigParserTest extends AbstractTestRealmPassportTest {
    ...
    public static void validateConfiguration_OK(PassportSession session) throws IOException {
    ...
    public static void validateConfiguration_attributeNameErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
        //we run this test without PassportSession so validator configs are not validated here
    ...
    public static void validateConfiguration_attributePermissionsErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
        //we run this test without PassportSession so validator configs are not validated here
    ...
    public static void validateConfiguration_attributeRequirementsErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
        //we run this test without PassportSession so validator configs are not validated here
    ...
    private static void validateConfiguration_attributeValidationsErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
    ...
    private static void validateConfiguration_attributeGroupConfigurationErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
    ...
    private static void validateConfiguration_attributeGroupReferenceErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
    ...
    private static void validateConfiguration_attributeAnnotationsErrors(PassportSession session) throws IOException {
        UPConfig config = loadValidConfig();
