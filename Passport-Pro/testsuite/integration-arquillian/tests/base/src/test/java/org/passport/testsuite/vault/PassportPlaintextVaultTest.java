...
public class PassportPlaintextVaultTest extends AbstractPassportVaultTest {

    @Test
    public void testPassportPlaintextVault() {
        ...
        testingClient.server().run(new PassportVaultServerTest("${vault.smtp_key}", "secure_master_smtp_secret"));
        testingClient.server("test").run(new PassportVaultServerTest("${vault.smtp_key}", "secure_test_smtp_secret"));
    }
