package org.passport.testsuite.cli.registration;
...
import org.passport.testsuite.cli.KcRegExec;
import org.passport.testsuite.util.TempFileResource;
import org.passport.testsuite.util.oauth.OAuthClient;

import org.junit.Assert;
import org.junit.Test;

import static org.passport.client.cli.util.OsUtil.EOL;
import static org.passport.client.registration.cli.KcRegMain.CMD;
import static org.passport.client.registration.cli.KcRegMain.DEFAULT_CONFIG_FILE_PATH;
import static org.passport.testsuite.cli.KcRegExec.execute;
...
public class KcRegTruststoreTest extends AbstractRegCliTest {
    ...
    public void testTruststore() throws IOException {
        ...
        File truststore = new File("src/test/resources/keystore/passport.truststore");
        ...
        // only run the rest of this test if ssl protected passport server is available
