 ...
 */
public class PassportSPNegoSchemeFactory extends SPNegoSchemeFactory {
    ...
    public PassportSPNegoSchemeFactory(CommonKerberosConfig kerberosConfig) {
        super(true, false);
    ...
    public AuthScheme newInstance(HttpParams params) {
        return new PassportSPNegoScheme(isStripPort(), isUseCanonicalHostname());
    }
    ...
    public class PassportSPNegoScheme extends SPNegoScheme {

        public PassportSPNegoScheme(boolean stripPort, boolean useCanonicalHostname) {
