...
import org.passport.events.log.JBossLoggingEventListenerProviderFactory;
import org.passport.representations.idm.RealmRepresentation;
import org.passport.testsuite.events.TestEventsListenerProviderFactory;
 ...
 */
public abstract class AbstractAdminTest extends AbstractTestRealmPassportTest {
    ...
    // Taken from Passport class in old testsuite.
    // So, code in old testsuite calling this looks like Passport.loadJson(.....)
