...
import org.passport.broker.saml.mappers.AttributeToRoleMapper;
import org.passport.broker.saml.mappers.UserAttributeMapper;
...
import org.passport.testsuite.updaters.IdentityProviderAttributeUpdater;
...
import org.passport.testsuite.util.saml.ModifySamlResponseStepBuilder;
...
import static org.passport.testsuite.saml.RoleMapperTest.ROLE_ATTRIBUTE_NAME;
...
import static org.passport.testsuite.util.SamlStreams.assertionsUnencrypted;
import static org.passport.testsuite.util.SamlStreams.attributeStatements;
import static org.passport.testsuite.util.SamlStreams.attributesUnecrypted;
import static org.passport.testsuite.util.ServerURLs.AUTH_SERVER_HOST2;
...
public final class KcSamlBrokerTest extends AbstractAdvancedBrokerTest {
    ...
    public void emptyAttributeToRoleMapperTest() throws ParsingException, ConfigurationException, ProcessingException {
        ...
        SAMLDocumentHolder samlResponse = new SamlClientBuilder()
                ...
                .processSamlResponse(Binding.POST)    // Response from producer IdP
                    .transformObject(ob -> {
                        assertThat(ob, org.passport.testsuite.util.Matchers.isSamlResponse(JBossSAMLURIConstants.STATUS_SUCCESS));
