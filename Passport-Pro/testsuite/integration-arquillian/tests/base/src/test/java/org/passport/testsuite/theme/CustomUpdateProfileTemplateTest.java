...
public class CustomUpdateProfileTemplateTest extends AbstractTestRealmPassportTest {
    ...
    private void navigateToUpdateProfilePage() {
        loginPage.open();
        loginPage.login("tom@passport-pro.ai", "password");
