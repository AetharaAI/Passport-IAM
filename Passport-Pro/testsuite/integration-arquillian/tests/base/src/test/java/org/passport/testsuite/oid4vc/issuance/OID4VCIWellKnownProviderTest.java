...
import static org.passport.common.crypto.CryptoConstants.A128KW;
...
public class OID4VCIWellKnownProviderTest extends OID4VCTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        if (testRealm.getComponents() != null) {
            ...
            testRealm.getComponents().add("org.passport.keys.KeyProvider", getRsaKeyProvider(RSA_KEY));
            testRealm.getComponents().add("org.passport.keys.KeyProvider", getAesKeyProvider(A128KW, "aes-enc", "ENC", "aes-generated"));
            testRealm.getComponents().add("org.passport.keys.KeyProvider", getAesKeyProvider(Algorithm.HS256, "aes-sig", "SIG", "hmac-generated"));
        } else {
            testRealm.setComponents(new MultivaluedHashMap<>(
                    Map.of("org.passport.keys.KeyProvider",
                            List.of(
                                    getRsaEncKeyProvider(RSA_OAEP_256, "enc-key-oaep256", 100),
