...
public class X509BrowserLoginIssuerDnTest extends AbstractX509AuthenticationTest {
    ...
    private String setup(boolean canonicalDnEnabled) throws Exception {
        String issuerDn = canonicalDnEnabled ?
            "1.2.840.113549.1.9.1=#1614636f6e74616374406b6579636c6f616b2e6f7267,cn=passport intermediate ca,ou=passport,o=red hat,st=ma,c=us" :
            "EMAILADDRESS=contact@passport-pro.ai, CN=Passport Intermediate CA, OU=Passport, O=Red Hat, ST=MA, C=US";
