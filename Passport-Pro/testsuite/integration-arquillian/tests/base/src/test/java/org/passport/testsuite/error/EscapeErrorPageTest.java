...
public class EscapeErrorPageTest extends AbstractPassportTest {
    ...
    public void innerURL() {
        checkMessage("\"See https://www.passport-pro.ai/docs\"", "\"See https://www.passport-pro.ai/docs\"");
    }
    ...
    private void checkMessage(String queryParam, String expected) {
        try {
            final URI uri = PassportUriBuilder.fromUri(suiteContext.getAuthServerInfo().getContextRoot().toURI())
