 ...
 */
public class ClientStorageTest extends AbstractTestRealmPassportTest {
    @Rule
    ...
    public void testIsCached() {
        testingClient.server().run(session -> {
            ...
            ClientModel hardcoded = realm.getClientByClientId("hardcoded-client");
            Assert.assertNotNull(hardcoded);
            Assert.assertTrue(hardcoded instanceof org.passport.models.cache.infinispan.ClientAdapter);
        });
    }
