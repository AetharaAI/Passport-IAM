...
import org.passport.testsuite.authentication.ExpectedParamAuthenticator;
import org.passport.testsuite.authentication.ExpectedParamAuthenticatorFactory;
...
public class AuthenticatorSubflowsTest extends AbstractChangeImportedUserPasswordsTest {
    ...
    public void setupFlows() {
        testingClient.server().run(session -> {
            ...
            config.put(ExpectedParamAuthenticator.LOGGED_USER, "passport-user@localhost");
            configModel.setConfig(config);
            configModel = realm.addAuthenticatorConfig(configModel);
            execution.setAuthenticatorConfig(configModel.getId());
...
//        // Fill foo=bar3. I am login automatically as "passport-user@localhost"
//
//
//    }
