 ...
 */
package org.passport.testsuite.oauth.par;
...
public class ParWithDPoPTest extends AbstractClientPoliciesTest {
    ...
    private String generateRequestObject(String clientId, String dpopJkt) throws IOException {
        ...
        client.generateKeys(org.passport.crypto.Algorithm.RS256);
        client.registerOIDCRequest(encodedRequestObject, org.passport.crypto.Algorithm.RS256);
