...
import org.passport.protocol.oid4vc.issuance.credentialbuilder.JwtCredentialBody;
import org.passport.protocol.oid4vc.issuance.credentialbuilder.LDCredentialBody;
import org.passport.protocol.oid4vc.issuance.credentialbuilder.LDCredentialBuilder;
import org.passport.protocol.oid4vc.issuance.signing.CredentialSignerException;
import org.passport.protocol.oid4vc.issuance.signing.LDCredentialSigner;
import org.passport.protocol.oid4vc.issuance.signing.vcdm.Ed255192018Suite;
...
import org.passport.protocol.oid4vc.model.vcdm.LdProof;
...
public class LDCredentialSignerTest extends OID4VCTest {
    ...
    public static void testSignLdCredential(
            PassportSession session, String signingKeyId, Map<String, Object> claims,
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        if (testRealm.getComponents() != null) {
            testRealm.getComponents().add("org.passport.keys.KeyProvider", getEdDSAKeyProvider());
        } else {
            testRealm.setComponents(new MultivaluedHashMap<>(
                    Map.of("org.passport.keys.KeyProvider", List.of(getEdDSAKeyProvider()))));
        }
    }
}
