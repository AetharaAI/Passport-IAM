package org.passport.testsuite.cli.admin;

import java.io.File;
import java.io.IOException;

import org.passport.client.admin.cli.KcAdmMain;
import org.passport.client.cli.config.ConfigData;
import org.passport.client.cli.config.FileConfigHandler;
import org.passport.testsuite.cli.KcAdmExec;
...
import static org.passport.client.admin.cli.KcAdmMain.DEFAULT_CONFIG_FILE_PATH;
import static org.passport.client.cli.util.OsUtil.EOL;
import static org.passport.testsuite.cli.KcAdmExec.execute;
...
public class KcAdmTruststoreTest extends AbstractAdmCliTest {
    ...
    public void testTruststore() throws IOException {
        ...
        // only run this test if ssl protected passport server is available
