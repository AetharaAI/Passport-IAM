...
package org.passport.testsuite.federation.ldap.noimport;
...
import org.passport.testsuite.federation.ldap.AbstractLDAPTest;
...
public class LDAPRoleMappingsNoImportTest extends AbstractLDAPTest {
    ...
    public void test01ReadMappings() {
        ...
        testingClient.server().run(session -> {
            ...
            Assert.assertNull(UserStoragePrivateUtil.userLocalStorage(session).getUserByUsername(appRealm, "marypassport"));
    ...
    public void test03_newUserDefaultRolesNoImportModeTest() throws Exception {
        ...
        testingClient.server().run(session -> {
            ...
            // make sure we are in no-import mode
            Assert.assertNull(UserStoragePrivateUtil.userLocalStorage(session).getUserByUsername(appRealm, "davidpassport"));
