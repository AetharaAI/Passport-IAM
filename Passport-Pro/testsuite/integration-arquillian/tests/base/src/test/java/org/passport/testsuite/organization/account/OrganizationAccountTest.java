...
package org.passport.testsuite.organization.account;
...
import org.passport.representations.account.OrganizationRepresentation;
...
public class OrganizationAccountTest extends AbstractOrganizationTest {
    ...
    public void testGetOrganizations() throws Exception {
        ...
        org.passport.representations.idm.OrganizationRepresentation orgA = createOrganization("orga");
        testRealm().organizations().get(orgA.getId()).members().addMember(member.getId()).close();
        org.passport.representations.idm.OrganizationRepresentation orgB = createOrganization("orgb");
