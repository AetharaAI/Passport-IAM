...
import org.passport.testsuite.client.resources.TestingCacheResource;
...
public class KcOIDCBrokerWithSignatureTest extends AbstractBaseBrokerTest {
    ...
    public void testSignatureVerificationHardcodedPublicKey() throws Exception {
        ...
        KeysMetadataRepresentation.KeyMetadataRepresentation key = org.passport.testsuite.util.KeyUtils.findActiveSigningKey(providerRealm(), Algorithm.RS256);
    ...
    public void testSignatureVerificationHardcodedPublicKeyES256() throws Exception {
        ...
        KeysMetadataRepresentation.KeyMetadataRepresentation key = org.passport.testsuite.util.KeyUtils.findActiveSigningKey(providerRealm(), Algorithm.ES256);
        cfg.setPublicKeySignatureVerifier(key.getPublicKey());
        updateIdentityProvider(idpRep);
    ...
    public void testSignatureVerificationHardcodedPublicKeyPS512() throws Exception {
        ...
        KeysMetadataRepresentation.KeyMetadataRepresentation key = org.passport.testsuite.util.KeyUtils.findActiveSigningKey(providerRealm(), Algorithm.PS512);
        cfg.setPublicKeySignatureVerifier(key.getPublicKey());
        updateIdentityProvider(idpRep);
    ...
    public void testSignatureVerificationHardcodedPublicKeyEd25519() throws Exception {
        ...
        KeysMetadataRepresentation.KeyMetadataRepresentation key = org.passport.testsuite.util.KeyUtils.findActiveSigningKey(providerRealm(), Algorithm.EdDSA);
        cfg.setPublicKeySignatureVerifier(key.getPublicKey());
        updateIdentityProvider(idpRep);
    ...
    private void createHSKey(String algorithm, String size, String secret) {
        ...
        keys.getConfig().putSingle("kid", PassportModelUtils.generateId());
