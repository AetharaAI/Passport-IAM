...
public class LDAPReadOnlyTest extends AbstractLDAPTest  {
    ...
    public void testReadOnlyWithTOTPEnabled() {
        ...
        // PASSPORT-11753 - Verify OTP label element present on "Configure OTP" required action form
    ...
    public void testReadOnlyUserDoesNotThrowIfUnchanged() {
        ...
        // assert
        user = ApiUtil.findUserByUsernameId(testRealm(), "johnpassport");
    ...
    public void testReadOnlyUserGetsPermanentlyLocked(){
        ...
        try {
            ...
            UserRepresentation user = adminClient.realm("test").users().search("johnpassport", 0, 1).get(0);
            ...
            loginInvalidPassword("johnpassport");
            loginInvalidPassword("johnpassport");
            ...
            user = adminClient.realm("test").users().search("johnpassport", 0, 1).get(0);
