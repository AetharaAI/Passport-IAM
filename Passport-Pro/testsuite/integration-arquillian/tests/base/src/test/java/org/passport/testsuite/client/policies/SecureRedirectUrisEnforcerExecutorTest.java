...
import org.passport.services.clientpolicy.executor.SecureRedirectUrisEnforcerExecutorFactory;
...
import static org.passport.testsuite.util.ClientPoliciesUtil.createSecureRedirectUrisEnforcerExecutorConfig;
...
public class SecureRedirectUrisEnforcerExecutorTest extends AbstractClientPoliciesTest {
    ...
    public void testSecureRedirectUrisEnforcerExecutor_IPv4LoopbackAddress() throws Exception {
        ...
        // authorization request - fail
        // invalid uri form
        testSecureRedirectUrisEnforcerExecutor_failAuthorizationRequest(alphaClientId, "https://passport-pro.ai\n");
