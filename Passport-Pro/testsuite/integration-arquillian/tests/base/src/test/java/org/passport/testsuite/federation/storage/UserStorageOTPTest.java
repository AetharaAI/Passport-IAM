...
import static org.passport.testsuite.federation.storage.UserStorageTest.addComponent;

/**
 * @author <a href="mailto:mposolda@redhat.com">Marek Posolda</a>
 */
public class UserStorageOTPTest extends AbstractTestRealmPassportTest {
    ...
    protected String componentId = PassportModelUtils.generateId();
    ...
    public void testNormalUser() {
        // Add some other user to the Passport
        UserRepresentation user = UserBuilder.create()
                .username("test-user2")
