...
import static org.passport.models.Constants.CLIENT_DATA;
import static org.passport.testsuite.AssertEvents.DEFAULT_REDIRECT_URI;
...
public class MultipleTabsLoginTest extends AbstractChangeImportedUserPasswordsTest {
    ...
    // Simulating scenario described in https://github.com/passport/passport/issues/24112
    @Test
    ...
    public void testEmptyBaseUrl() throws Exception {
        try (BrowserTabUtil tabUtil = BrowserTabUtil.getInstanceAndSetEnv(driver)) {
            ...
            String clientUuid = PassportModelUtils.generateId();
