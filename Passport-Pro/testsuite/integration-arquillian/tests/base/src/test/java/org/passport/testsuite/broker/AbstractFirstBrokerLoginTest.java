...
import org.passport.authentication.authenticators.broker.IdpReviewProfileAuthenticatorFactory;
import org.passport.broker.provider.HardcodedUserSessionAttributeMapper;
...
import org.passport.testsuite.util.MailServer;
import org.passport.testsuite.util.MailServerConfiguration;
import org.passport.testsuite.util.SecondBrowser;
...
import static org.passport.testsuite.admin.ApiUtil.removeUserByUsername;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.assertHardCodedSessionNote;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.configureAutoLinkFlow;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.configureConfirmOverrideLinkFlow;
import static org.passport.testsuite.broker.BrokerRunOnServerUtil.grantReadTokenRole;
import static org.passport.testsuite.broker.BrokerTestConstants.USER_EMAIL;
import static org.passport.testsuite.broker.BrokerTestTools.getConsumerRoot;
import static org.passport.testsuite.broker.BrokerTestTools.waitForPage;
import static org.passport.testsuite.util.MailAssert.assertEmailAndGetUrl;
...
public abstract class AbstractFirstBrokerLoginTest extends AbstractInitializedBaseBrokerTest {
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testErrorPageWhenDuplicationNotAllowed_updateProfileOn
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testLinkAccountByReauthenticationWithPassword
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testLinkAccountByReauthenticationWithPassword_browserButtons
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testLinkAccountByReauthentication_forgetPassword
     */
    @Test
     ...
     *
     * This session note is only set by {@link org.passport.authentication.authenticators.broker.IdpCreateUserIfUniqueAuthenticator}
     * or {@link org.passport.authentication.authenticators.broker.IdpDetectExistingBrokerUserAuthenticator}. However,
     * the reset password feature should work without them.
     *
     * For more info see https://github.com/passport/passport/issues/26323 .
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testLinkAccountByReauthentication_forgetPassword_differentBrowser
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testErrorPageWhenDuplicationNotAllowed_updateProfileOff
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testRegistrationWithPasswordUpdateRequired
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testFixDuplicationsByReviewProfile
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testHardcodedUserSessionNoteIsSetAfterFristBrokerLogin()
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testRegistrationWithEmailAsUsername
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testSuccessfulAuthenticationWithoutUpdateProfile_newUser_emailAsUsername()
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testSuccessfulAuthenticationWithoutUpdateProfile_emailProvided_emailVerifyEnabled
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testSuccessfulAuthenticationWithoutUpdateProfile_emailNotProvided_emailVerifyEnabled
     *
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testSuccessfulAuthenticationWithoutUpdateProfile_emailProvided_emailVerifyEnabled_emailTrustEnabled
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest#testSuccessfulAuthentication_emailTrustEnabled_emailVerifyEnabled_emailUpdatedOnFirstLogin
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testLinkAccountByEmailVerificationTwice
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractFirstBrokerLoginTest#testLinkAccountByEmailVerificationResendEmail
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest.testSuccessfulAuthenticationUpdateProfileOnMissing_missingEmail
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest.testSuccessfulAuthenticationUpdateProfileOnMissing_nothingMissing
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.passport.testsuite.broker.AbstractPassportIdentityProviderTest.testSuccessfulAuthenticationWithoutUpdateProfile
     */
    @Test
     ...
     * account without prompt (PASSPORT-7270).
     */
    @Test
