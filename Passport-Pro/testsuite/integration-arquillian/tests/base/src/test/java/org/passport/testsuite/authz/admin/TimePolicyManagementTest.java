...
import org.passport.admin.client.resource.TimePoliciesResource;
import org.passport.admin.client.resource.TimePolicyResource;
...
public class TimePolicyManagementTest extends AbstractPolicyManagementTest {
    ...
    public void testInvalidDateFormat() {
        AuthorizationResource authorization = getClient().authorization();
        TimePolicyRepresentation representation = createRepresentation(PassportModelUtils.generateId());
