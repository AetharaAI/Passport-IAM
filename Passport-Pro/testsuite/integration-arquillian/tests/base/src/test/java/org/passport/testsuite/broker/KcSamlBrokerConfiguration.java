...
import org.passport.protocol.saml.mappers.UserAttributeStatementMapper;
import org.passport.protocol.saml.mappers.UserPropertyAttributeStatementMapper;
...
import static org.passport.broker.saml.SAMLIdentityProviderConfig.ARTIFACT_BINDING_RESPONSE;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.ARTIFACT_RESOLUTION_SERVICE_URL;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.BACKCHANNEL_SUPPORTED;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.FORCE_AUTHN;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.NAME_ID_POLICY_FORMAT;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.POST_BINDING_AUTHN_REQUEST;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.POST_BINDING_RESPONSE;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.SINGLE_LOGOUT_SERVICE_URL;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.SINGLE_SIGN_ON_SERVICE_URL;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.VALIDATE_SIGNATURE;
import static org.passport.broker.saml.SAMLIdentityProviderConfig.WANT_AUTHN_REQUESTS_SIGNED;
import static org.passport.protocol.saml.SamlProtocol.SAML_ASSERTION_CONSUMER_URL_POST_ATTRIBUTE;
import static org.passport.protocol.saml.SamlProtocol.SAML_IDP_INITIATED_SSO_URL_NAME;
import static org.passport.testsuite.broker.BrokerTestConstants.IDP_SAML_ALIAS;
import static org.passport.testsuite.broker.BrokerTestConstants.IDP_SAML_PROVIDER_ID;
...
import static org.passport.testsuite.broker.BrokerTestConstants.USER_LOGIN;
import static org.passport.testsuite.broker.BrokerTestConstants.USER_PASSWORD;
