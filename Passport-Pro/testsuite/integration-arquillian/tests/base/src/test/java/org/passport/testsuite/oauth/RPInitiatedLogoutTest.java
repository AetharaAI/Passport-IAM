...
import static org.passport.testsuite.util.URLAssert.assertCurrentUrlEquals;
 ...
 */
public class RPInitiatedLogoutTest extends AbstractTestRealmPassportTest {
    ...
    public void logoutWithExpiredIdToken() throws Exception {
        ...
        // Logout should succeed with expired ID token, see PASSPORT-3399
    ...
    public void logoutWithValidIdTokenWhenLoggedOutByAdmin() throws Exception {
        ...
        // Logout with HTTP client. Logout should succeed with user already logged out, see PASSPORT-3399. But no logout event should be present
        String logoutUrl = oauth.logoutForm()
                .idTokenHint(idTokenString)
                .postLogoutRedirectUri(APP_REDIRECT_URI)
                .build();
