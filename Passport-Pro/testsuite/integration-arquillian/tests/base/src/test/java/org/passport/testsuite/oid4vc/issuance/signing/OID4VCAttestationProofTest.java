...
public class OID4VCAttestationProofTest extends OID4VCIssuerEndpointTest {
     ...
     */
    private static void configureTrustedKeysInRealm(PassportSession session, List<JWK> trustedKeys) throws IOException {
     ...
     */
    private static VCIssuanceContext createVCIssuanceContextWithAttestationProof(PassportSession session, String attestationJwt) {
    ...
    private static void runAttestationProofWithRealmAttributeTrustedKeys(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = createECKey("attestationKey");
            KeyWrapper proofKey = createECKey("proofKey");
     ...
     */
    private static void runAttestationProofExtractsAttestedKeysFromPayload(PassportSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = createECKey("attestationKey");
            KeyWrapper proofKey = createECKey("proofKey");
    ...
    private static void runAttestationProofWithInvalidTrustedKey(PassportSession session, String cNonce) throws IOException {
        KeyWrapper attestationKey = createECKey("attestationKey");
        KeyWrapper proofKey = createECKey("proofKey");
    ...
    private static void runAttestationProofWithMultipleTrustedKeys(PassportSession session, String cNonce) {
        try {
