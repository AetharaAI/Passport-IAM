...
import org.passport.authentication.authenticators.access.AllowAccessAuthenticatorFactory;
import org.passport.authentication.authenticators.browser.OTPFormAuthenticatorFactory;
import org.passport.authentication.authenticators.conditional.ConditionalClientScopeAuthenticatorFactory;
...
import static org.passport.models.utils.TimeBasedOTP.DEFAULT_INTERVAL_SECONDS;
...
public class KcOidcPostBrokerLoginTest extends AbstractInitializedBaseBrokerTest {
    ...
    static void configurePostBrokerLoginWithClientScopeConditionAndOTP(PassportTestingClient testingClient, String consumerRealmName, String idpAlias, String clientScopeName, boolean negate) {
