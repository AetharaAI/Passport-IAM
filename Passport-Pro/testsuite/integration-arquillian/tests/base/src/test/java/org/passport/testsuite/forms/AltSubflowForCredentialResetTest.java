...
import org.passport.authentication.authenticators.resetcred.ResetCredentialChooseUser;
import org.passport.authentication.authenticators.resetcred.ResetCredentialEmail;
import org.passport.authentication.authenticators.resetcred.ResetPassword;
 ...
 */
public class AltSubflowForCredentialResetTest extends AbstractTestRealmPassportTest {
    ...
    static void configureAlternativeResetCredentialsFlow(PassportTestingClient testingClient) {
