...
import org.passport.authentication.authenticators.conditional.ConditionalRoleAuthenticatorFactory;
import org.passport.authentication.authenticators.conditional.ConditionalUserAttributeValueFactory;
...
import org.passport.testsuite.ActionURIUtils;
...
import org.passport.testsuite.authentication.SetUserAttributeAuthenticatorFactory;
import org.passport.testsuite.broker.SocialLoginTest;
...
public class BrowserFlowTest extends AbstractChangeImportedUserPasswordsTest {
    ...
    public void testAlternativeNonInteractiveExecutorInSubflow() {
        ...
        try {
            ...
            // Check that Passport is redirecting us to the Passport account management page
    ...
    public void testSocialProvidersPresentOnLoginUsernameOnlyPageIfConfigured() {
        ...
        // Test setup - Configure the testing Passport instance with UsernameForm & PasswordForm (both REQUIRED) and OTPFormAuthenticator (ALTERNATIVE)
