...
import org.passport.testsuite.arquillian.KcArquillian;
import org.passport.testsuite.arquillian.SuiteContext;
import org.passport.testsuite.arquillian.TestContext;
import org.passport.testsuite.auth.page.AuthRealm;
import org.passport.testsuite.auth.page.AuthServer;
import org.passport.testsuite.auth.page.AuthServerContextRoot;
import org.passport.testsuite.auth.page.WelcomePage;
import org.passport.testsuite.auth.page.login.OIDCLogin;
import org.passport.testsuite.auth.page.login.UpdatePassword;
...
import org.passport.testsuite.util.CryptoInitRule;
import org.passport.testsuite.util.DroneUtils;
import org.passport.testsuite.util.TestCleanup;
import org.passport.testsuite.util.TestEventsLogger;
...
import static org.passport.testsuite.util.ServerURLs.AUTH_SERVER_HOST;
...
import static org.passport.testsuite.util.ServerURLs.removeDefaultPorts;
import static org.passport.testsuite.util.URLUtils.navigateToUri;
...
public abstract class AbstractPassportTest {
    ...
    protected PassportTestingClient testingClient;
    ...
    public void beforeAbstractPassportTest() throws Exception {
        ...
        beforeAbstractPassportTestRealmImport();
        ...
        if (testContext.getTestRealmReps().isEmpty()) {
            ...
            afterAbstractPassportTestRealmImport();
        }
     ...
     * In @Before block
     */
    protected void beforeAbstractPassportTestRealmImport() throws Exception {
    }
     ...
     * In @After block
     */
    protected void postAfterAbstractPassport() throws Exception {
    }

    @After
    public void afterAbstractPassportTest() throws Exception {
        if (resetTimeOffset) {
            resetTimeOffset();
        }
    ...
    public PassportTestingClient getTestingClient() {
    ...
    public Passport getAdminClient() {
        return adminClient;
    }
    ...
    public URI getAuthServerRoot() {
        try {
            return PassportUriBuilder.fromUri(suiteContext.getAuthServerInfo().getContextRoot().toURI()).path("/auth/").build();
