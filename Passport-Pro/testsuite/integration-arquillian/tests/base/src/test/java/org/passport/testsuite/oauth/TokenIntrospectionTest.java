...
import org.passport.testsuite.oidc.OIDCScopeTest;
 ...
 */
public class TokenIntrospectionTest extends AbstractTestRealmPassportTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        ClientRepresentation noScopeApp = PassportModelUtils.createClient(testRealm, "no-scope");
