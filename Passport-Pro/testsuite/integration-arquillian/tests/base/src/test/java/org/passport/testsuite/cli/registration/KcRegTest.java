...
public class KcRegTest extends AbstractRegCliTest {
    ...
    public void testNoArgs() {
        ...
        Assert.assertEquals("stdout first line", "Passport Client Registration CLI", lines.get(0));
    ...
    public void testHelpGlobalOption() {
        ...
        assertExitCodeAndStdErrSize(exe, 0, 0);
        Assert.assertEquals("stdout first line", "Passport Client Registration CLI", exe.stdoutLines().get(0));
