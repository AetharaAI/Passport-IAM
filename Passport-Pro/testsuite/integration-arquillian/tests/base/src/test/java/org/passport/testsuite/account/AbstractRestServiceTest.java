...
import static org.passport.common.Profile.Feature.ACCOUNT_API;
 ...
 */
public abstract class AbstractRestServiceTest extends AbstractTestRealmPassportTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        org.passport.representations.idm.ClientRepresentation inUseApp = ClientBuilder.create().clientId("in-use-client")
        ...
        org.passport.representations.idm.ClientRepresentation offlineApp = ClientBuilder.create().clientId("offline-client")
                .id(PassportModelUtils.generateId())
                .name("Offline Client")
        ...
        org.passport.representations.idm.ClientRepresentation offlineApp2 = ClientBuilder.create().clientId("offline-client-without-base-url")
                .id(PassportModelUtils.generateId())
        ...
        org.passport.representations.idm.ClientRepresentation alwaysDisplayApp = ClientBuilder.create().clientId("always-display-client")
                .id(PassportModelUtils.generateId())
