...
package org.passport.testsuite.validation;
...
import org.passport.validate.AbstractSimpleValidator;
import org.passport.validate.BuiltinValidators;
...
import org.passport.validate.Validator;
...
import static org.passport.validate.ValidatorConfig.configFromMap;

public class BuiltinValidatorsTest extends AbstractPassportTest {
    ...
    @Test
    @ModelTest
    public void testLengthValidator_ConfigValidation(PassportSession session) {
    ...
    public void testEmailValidator() {
        ...
        Assert.assertTrue(validator.validate("username@passport-pro.ai", "email", (ValidatorConfig) null).isValid());
        Assert.assertTrue(validator.validate("abcd012345678901234567890123456789012345678901234567890123456789@passport-pro.ai", "email").isValid());
        Assert.assertFalse(validator.validate("abcde012345678901234567890123456789012345678901234567890123456789@passport-pro.ai", "email").isValid());
        Assert.assertTrue(validator.validate("abcdef0123456789@passport-pro.ai", "email",
                new ValidatorConfig(ImmutableMap.of(EmailValidator.MAX_LOCAL_PART_LENGTH_PROPERTY, "16"))).isValid());
        Assert.assertFalse(validator.validate("abcdefg0123456789@passport-pro.ai", "email",
                new ValidatorConfig(ImmutableMap.of(EmailValidator.MAX_LOCAL_PART_LENGTH_PROPERTY, 16))).isValid());
        Assert.assertTrue(validator.validate("ab012345678901234567890123456789@passport-pro.ai", "email",
                new ValidatorConfig(ImmutableMap.of(EmailValidator.MAX_LOCAL_PART_LENGTH_PROPERTY, "32"))).isValid());
        Assert.assertFalse(validator.validate("abc012345678901234567890123456789@passport-pro.ai", "email",
                new ValidatorConfig(ImmutableMap.of(EmailValidator.MAX_LOCAL_PART_LENGTH_PROPERTY, 32))).isValid());
    }
    ...
    @Test
    @ModelTest
    public void testDoubleValidator_ConfigValidation(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void testIntegerValidator_ConfigValidation(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void testOptionsValidator_Config_Validation(PassportSession session) {
    ...
    @Test
    @ModelTest
    public void testMultivaluedValidatorConfiguration(PassportSession session) {
        // invalid min and max config values
