...
public class TokenExchangeTestUtils {
    ...
    public static void setUpUserImpersonatePermissions(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName(TEST);
        AdminPermissionManagement management = AdminPermissions.management(session, realm);
        ResourceServer server = management.realmResourceServer();
    ...
    public static void addDirectExchanger(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName(TEST);
    ...
    public static void removeDirectExchanger(PassportSession session) {
        RealmModel realm = session.realms().getRealmByName(TEST);
