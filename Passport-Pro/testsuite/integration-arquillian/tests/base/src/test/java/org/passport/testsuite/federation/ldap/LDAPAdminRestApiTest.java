...
import static org.passport.testsuite.util.userprofile.UserProfileUtil.setUserProfileConfiguration;
import static org.passport.util.JsonSerialization.writeValueAsString;
...
public class LDAPAdminRestApiTest extends AbstractLDAPTest {
    ...
    public void createUserWithAdminRest() throws Exception {
        ...
        UserRepresentation user2 = UserBuilder.create()
                ...
                .password("userpass")
                .email("admintestuser2@passport-pro.ai")
                .firstName("Some")
                .lastName("OtherUser")
                .enabled(true)
                .build();
    ...
    public void updateUserWithAdminRest() throws Exception {
        UserResource userRes = ApiUtil.findUserByUsernameId(testRealm(), "johnpassport");
