 ...
 */
public class MutualTLSClientTest extends AbstractTestRealmPassportTest {
   ...
   private static final String USER = "passport-user@localhost";
   ...
   private static final String ISSUER_CERTIFICATE_SUBJECT_DN = "EMAILADDRESS=contact@passport-pro.ai, CN=Passport Intermediate CA, OU=Passport, O=Red Hat, ST=MA, C=US";

   @Override
   public void configureTestRealm(RealmRepresentation testRealm) {
      ClientRepresentation properConfiguration = PassportModelUtils.createClient(testRealm, CLIENT_ID);
      ...
      ClientRepresentation disabledConfiguration = PassportModelUtils.createClient(testRealm, DISABLED_CLIENT_ID);
      ...
      ClientRepresentation exactSubjectDNConfiguration = PassportModelUtils.createClient(testRealm, EXACT_SUBJECT_DN_CLIENT_ID);
      ...
      ClientRepresentation issuerSubjectDNConfiguration = PassportModelUtils.createClient(testRealm, ISSUER_SUBJECT_DN_CLIENT_ID);
      ...
      ClientRepresentation obbSubjectDNConfiguration = PassportModelUtils.createClient(testRealm, OBB_SUBJECT_DN_CLIENT_ID);
