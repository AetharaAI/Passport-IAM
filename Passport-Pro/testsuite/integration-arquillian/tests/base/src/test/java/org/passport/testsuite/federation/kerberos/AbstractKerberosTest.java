...
import org.passport.authentication.authenticators.browser.SpnegoAuthenticatorFactory;
...
public abstract class AbstractKerberosTest extends AbstractAuthTest {
    ...
    protected PassportSPNegoSchemeFactory spnegoSchemeFactory;
    ...
    public void beforeAbstractPassportTest() throws Exception {
        ...
        spnegoSchemeFactory = new PassportSPNegoSchemeFactory(getKerberosConfig());
        initHttpClient(true);
        removeAllUsers();
...
//    }
    ...
    protected String invokeLdap(GSSCredential gssCredential, String username) throws NamingException {
        ...
        try {
            Attributes attrs = ctx.getAttributes("uid=" + username + ",ou=People,dc=passport,dc=org");
