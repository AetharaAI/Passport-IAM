...
import org.passport.protocol.oidc.grants.AuthorizationCodeGrantTypeFactory;
import org.passport.protocol.oidc.grants.RefreshTokenGrantTypeFactory;
import org.passport.protocol.oidc.grants.ciba.CibaGrantTypeFactory;
import org.passport.protocol.oidc.grants.device.DeviceGrantTypeFactory;
...
public class AssertEvents implements TestRule {
    ...
    private final AbstractPassportTest context;

    public AssertEvents(AbstractPassportTest ctx) {
        context = ctx;
    }
...
//                .session((String) null);
    ...
    public class ExpectedEvent {
        ...
        /**
         * Assert the expected event was sent to the listener by Passport server. Returns this event.
         *
