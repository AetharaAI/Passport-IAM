...
public class SamlMultiTenantResolver implements SamlConfigResolver {
    ...
    public SamlDeployment resolve(HttpFacade.Request request) {
        ...
        InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("/" + realm + "-passport-saml.xml");
        if (is == null) {
            throw new IllegalStateException("Not able to find the file /" + realm + "-passport-saml.xml");
        }
