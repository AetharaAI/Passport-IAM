package org.passport.testsuite.utils.tls;
   ...
   public static SSLContext initializeTLS() {
      try {
         ...
         if (keystorePath == null) {
            keystorePath = Paths.get(TLSUtils.class.getResource("/passport.jks").toURI()).toAbsolutePath().toString(); // when executed directly from IDE without Maven
         }
         ...
         if (truststorePath == null) {
            truststorePath = Paths.get(TLSUtils.class.getResource("/passport.truststore").toURI()).toAbsolutePath().toString(); // when executed directly from IDE without Maven
         }
