...
import org.passport.storage.adapter.AbstractUserAdapter;
...
public class UserPropertyFileStorage implements UserLookupProvider, UserStorageProvider, UserQueryProvider, CredentialInputValidator {
    ...
    public UserPropertyFileStorage(PassportSession session, ComponentModel model, Properties userPasswords) {
