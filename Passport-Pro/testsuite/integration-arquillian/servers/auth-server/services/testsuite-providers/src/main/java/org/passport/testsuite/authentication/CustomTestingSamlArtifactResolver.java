...
import static org.passport.testsuite.authentication.CustomTestingSamlArtifactResolverFactory.TYPE_CODE;
...
public class CustomTestingSamlArtifactResolver implements ArtifactResolver {
    ...
    @Override
    public ClientModel selectSourceClient(PassportSession session, String artifact) {
        return null;
    }
