...
import org.passport.storage.ldap.mappers.membership.role.RoleLDAPStorageMapper;
import org.passport.storage.ldap.mappers.membership.role.RoleLDAPStorageMapperFactory;
import org.passport.storage.ldap.mappers.membership.role.RoleMapperConfig;
...
public class LDAPTestUtils {
    ...
    public static UserModel addLocalUser(PassportSession session, RealmModel realm, String username, String email, String password) {
    ...
    public static void addLdapUser(PassportSession session, RealmModel appRealm, LDAPStorageProvider ldapFedProvider, String username, String password, Consumer<UserModel> userCustomizer) {
    ...
    public static LDAPStorageProvider getLdapProvider(PassportSession passportSession, ComponentModel ldapFedModel) {
        return (LDAPStorageProvider)passportSession.getProvider(UserStorageProvider.class, ldapFedModel);
    }
    ...
    public static ComponentModel addUserAttributeMapper(RealmModel realm, ComponentModel providerModel, String mapperName, String userModelAttributeName, String ldapAttributeName) {
        ComponentModel mapperModel = PassportModelUtils.createComponentModel(mapperName, providerModel.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateRoleLDAPMappers(RealmModel realm, ComponentModel providerModel, LDAPGroupMapperMode mode) {
        ...
        if (mapperModel != null) {
            ...
            mapperModel = PassportModelUtils.createComponentModel("realmRolesMapper", providerModel.getId(), RoleLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
        ...
        if (mapperModel != null) {
            ...
            String baseDn = providerModel.getConfig().getFirst(LDAPConstants.BASE_DN);
            mapperModel = PassportModelUtils.createComponentModel("financeRolesMapper", providerModel.getId(), RoleLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateHardcodedGroupMapper(RealmModel realm, ComponentModel providerModel, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            mapperModel = PassportModelUtils.createComponentModel("hardcodedGroupsMapper", providerModel.getId(),
    ...
    public static void addOrUpdateGroupMapper(String mapperName, RealmModel realm, ComponentModel providerModel, LDAPGroupMapperMode mode, String descriptionAttrName, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            String baseDn = providerModel.getConfig().getFirst(LDAPConstants.BASE_DN);
            mapperModel = PassportModelUtils.createComponentModel(mapperName, providerModel.getId(), GroupLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateHardcodedRoleMapper(RealmModel realm, ComponentModel providerModel, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            mapperModel = PassportModelUtils.createComponentModel("hardcodedRolesMapper", providerModel.getId(), HardcodedLDAPRoleStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateRoleMapper(RealmModel realm, ComponentModel providerModel, LDAPGroupMapperMode mode, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            String baseDn = providerModel.getConfig().getFirst(LDAPConstants.BASE_DN);
            mapperModel = PassportModelUtils.createComponentModel("rolesMapper", providerModel.getId(), RoleLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void syncRolesFromLDAP(RealmModel realm, LDAPStorageProvider ldapProvider, ComponentModel providerModel) {
        ...
        roleMapper.syncDataFromFederationProviderToPassport(realm);
    ...
    public static void removeAllLDAPRoles(PassportSession session, RealmModel appRealm, ComponentModel ldapModel, String mapperName) {
    ...
    public static void removeAllLDAPGroups(PassportSession session, RealmModel appRealm, ComponentModel ldapModel, String mapperName) {
        ComponentModel mapperModel = getSubcomponentByName(appRealm, ldapModel, mapperName);
        LDAPStorageProvider ldapProvider = LDAPTestUtils.getLdapProvider(session, ldapModel);
    ...
    public static void createLDAPRole(PassportSession session, RealmModel appRealm, ComponentModel ldapModel, String mapperName, String roleName) {
        ComponentModel mapperModel = getSubcomponentByName(appRealm, ldapModel, mapperName);
        LDAPStorageProvider ldapProvider = LDAPTestUtils.getLdapProvider(session, ldapModel);
        getRoleMapper(mapperModel, ldapProvider, appRealm).createLDAPRole(roleName);
    }

    public static LDAPObject createLDAPGroup(PassportSession session, RealmModel appRealm, ComponentModel ldapModel, String groupName, String... additionalAttrs) {
        return createLDAPGroup("groupsMapper", session, appRealm, ldapModel, groupName, additionalAttrs);
    }

    public static LDAPObject createLDAPGroup(String mapperName, PassportSession session, RealmModel appRealm, ComponentModel ldapModel, String groupName, String... additionalAttrs) {
        ComponentModel mapperModel = getSubcomponentByName(appRealm, ldapModel, mapperName);
        LDAPStorageProvider ldapProvider = LDAPTestUtils.getLdapProvider(session, ldapModel);
    ...
    public static LDAPObject getLdapGroupByName(PassportSession session, RealmModel realm, String mapperName, String groupName) {
    ...
    public static LDAPObject updateLDAPGroup(PassportSession session, RealmModel appRealm, ComponentModel ldapModel, LDAPObject ldapObject) {
