...
/**
 * UserStorage implementation created in Passport 4.8.3. It is used for backwards compatibility testing. Future Passport versions
 * should work fine without a need to change the code of this provider.
 * <p>
 * TODO: Have some good mechanims to make sure that source code of this provider is really compatible with Passport 4.8.3
 *
...
public class BackwardsCompatibilityUserStorage implements UserLookupProvider, UserStorageProvider, UserRegistrationProvider,
    ...
    public BackwardsCompatibilityUserStorage(PassportSession session, ComponentModel model, Map<String, MyUser> users) {
    ...
    public boolean updateCredential(RealmModel realm, UserModel user, CredentialInput input) {
        ...
        if (input.getType().equals(UserCredentialModel.PASSWORD)) {
            ...
            // Those are not supposed to be set when calling this method in Passport 4.8.3 for password credential
            ...
            newOTP.setId(PassportModelUtils.generateId());
            ...
            recoveryCodesModel.setId(PassportModelUtils.generateId());
