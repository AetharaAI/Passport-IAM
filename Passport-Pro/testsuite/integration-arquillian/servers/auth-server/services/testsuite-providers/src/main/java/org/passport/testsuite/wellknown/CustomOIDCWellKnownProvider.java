...
package org.passport.testsuite.wellknown;
...
public class CustomOIDCWellKnownProvider extends OIDCWellKnownProvider {
    ...
    public CustomOIDCWellKnownProvider(PassportSession session, Map<String, Object> openidConfigOverride, boolean includeClientScopes) {
