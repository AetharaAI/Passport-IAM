...
import org.passport.provider.ProviderLoader;
import org.passport.provider.Spi;

/**
 * Loads additional SPIs from provided PassportDeploymentInfo
 *
...
class TestsuiteProviderLoader implements ProviderLoader {
    ...
    TestsuiteProviderLoader(PassportDeploymentInfo info) {
        this.info = info;
    }
