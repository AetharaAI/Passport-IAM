...
import org.passport.testsuite.domainextension.CompanyRepresentation;
import org.passport.testsuite.domainextension.jpa.Company;
...
public class ExampleServiceImpl implements ExampleService {
    ...
    public ExampleServiceImpl(PassportSession session) {
    ...
    public CompanyRepresentation addCompany(CompanyRepresentation company) {
        ...
        String id = company.getId()==null ?  PassportModelUtils.generateId() : company.getId();
        entity.setId(id);
