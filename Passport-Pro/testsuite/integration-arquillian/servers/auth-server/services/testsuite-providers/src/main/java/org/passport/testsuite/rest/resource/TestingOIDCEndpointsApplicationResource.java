...
import org.passport.crypto.ServerEdDSASignatureSignerContext;
...
import org.passport.protocol.oidc.grants.ciba.channel.HttpAuthenticationChannelProvider;
...
import org.passport.testsuite.rest.TestApplicationResourceProviderFactory;
...
public class TestingOIDCEndpointsApplicationResource {
    ...
    @Produces(org.passport.utils.MediaType.APPLICATION_JWT)
    @NoCache
