...
public class InfinispanTestUtil {
    ...
    /**
     * Set Passport test TimeService to infinispan cacheManager. This will cause that infinispan will be aware of Passport Time offset, which is useful
     * for testing that infinispan entries are expired after moving Passport time forward with {@link org.passport.common.util.Time#setOffset} .
     */
    public static void setTestingTimeService(PassportSession session) {
    ...
    public static void revertTimeService(PassportSession session) {
