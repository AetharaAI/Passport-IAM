...
import org.passport.storage.client.AbstractReadOnlyClientStorageAdapter;
...
public class HardcodedClientStorageProvider implements ClientStorageProvider, ClientLookupProvider {
    ...
    public HardcodedClientStorageProvider(PassportSession session, ClientStorageProviderModel component) {
    ...
    public Map<String, ClientScopeModel> getClientScopes(RealmModel realm, ClientModel client, boolean defaultScope) {
        if (defaultScope) {
                ClientScopeModel rolesScope = PassportModelUtils.getClientScopeByName(realm, OIDCLoginProtocolFactory.ROLES_SCOPE);
                ClientScopeModel webOriginsScope = PassportModelUtils.getClientScopeByName(realm, OIDCLoginProtocolFactory.WEB_ORIGINS_SCOPE);
                ClientScopeModel basicScope = PassportModelUtils.getClientScopeByName(realm, OIDCLoginProtocolFactory.BASIC_SCOPE);
                ...
                ClientScopeModel offlineScope = PassportModelUtils.getClientScopeByName(realm, "offline_access");
