...
public class PassportOnUndertowConfiguration extends UndertowContainerConfiguration {

    public static final int DEFAULT_HTTPS_PORT = Integer.valueOf(System.getProperty("auth.server.https.port", "8543"));

    protected static final Logger log = Logger.getLogger(PassportOnUndertowConfiguration.class);
    ...
    public void validate() throws ConfigurationException {
        ...
        log.info("PassportOnUndertow will listen for http on port: " + newPort + " and for https on port: " + newHttpsPort);
