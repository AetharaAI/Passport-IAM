...
import org.passport.testsuite.PassportServer;
import org.passport.testsuite.UndertowRequestFilter;
import org.passport.testsuite.utils.tls.TLSUtils;
import org.passport.testsuite.utils.undertow.UndertowDeployerHelper;
import org.passport.testsuite.utils.undertow.UndertowWarClassLoader;
...
import static org.passport.testsuite.PassportServer.registerScriptProviders;

public class PassportOnUndertow implements DeployableContainer<PassportOnUndertowConfiguration> {

    protected final Logger log = Logger.getLogger(this.getClass());

    private PassportUndertowJaxrsServer undertow;
    private PassportOnUndertowConfiguration configuration;
    ...
    private DeploymentInfo createAuthServerDeploymentInfo() {
        ...
        di.addWelcomePage("theme/passport/welcome/resources/index.html");

        // This is needed as in case of clustered undertow, several undertow instances share the same JVM, hence the default
        // way accessing the factory in the UndertowRequestFilter via static reference to PassportApplication does not work:
        // There are several PassportApplication instances in the JVM with no classloader separation as in a full-blown server.
    ...
    @Override
    public Class<PassportOnUndertowConfiguration> getConfigurationClass() {
        return PassportOnUndertowConfiguration.class;
    }
    ...
    @Override
    public void setup(
            PassportOnUndertowConfiguration undertowContainerConfiguration) {
    ...
    public void start() throws LifecycleException {
        ...
        PassportServer.configureDataDirectory();
        ...
        if (undertow == null) {
            undertow = new PassportUndertowJaxrsServer();
        }
    ...
    private static class PassportUndertowJaxrsServer extends UndertowJaxrsServer {

        @Override
        public PassportUndertowJaxrsServer start(Undertow.Builder builder) {
            try {
