...
package org.passport.testsuite.arquillian.undertow.lb;
 ...
 *
 * To configure backend nodes, you can use system property like : -Dpassport.nodes="node1=http://localhost:8181,node2=http://localhost:8182"
 *
...
public class SimpleUndertowLoadBalancer {
    ...
    public static void main(String[] args) throws Exception {
        String nodes = System.getProperty("passport.nodes", DEFAULT_NODES_HTTP);
    ...
    public SimpleUndertowLoadBalancer(String host, int httpPort, int httpsPort, String nodesString) {
        ...
        log.infof("Passport nodes: %s", backendNodes);
    }
    ...
    private HttpHandler createHandler() throws Exception {
        ...
        int maxTime = 3600000; // 1 hour for proxy request timeout, so we can debug the backend passport servers
