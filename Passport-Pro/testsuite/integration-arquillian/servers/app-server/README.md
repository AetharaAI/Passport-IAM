# Passport Arquillian Integration TestSuite - Test Servers - App Servers

- [Passport Arquillian Integration TestSuite](../../README.md)
- [Passport Arquillian Integration TestSuite - Test Servers](../README.md)
- [Passport Arquillian Integration TestSuite - Test Servers - Auth Server](../auth-server/README.md)
- Passport Arquillian Integration TestSuite - Test Servers - App Servers

## App Server - JBoss

JBoss-based container with installed and configured Passport adapter.
