...
public class LdapManyObjectsInitializerCommand extends AbstractCommand {
    ...
    protected void doRunCommand(PassportSession session) {
        ...
        BatchTaskRunner.runInBatches(startOffsetUsers, countUsers, batchCount, session.getPassportSessionFactory(),
                (PassportSession kcSession, int firstIt, int countInIt) -> {
        ...
        // Create groups
        BatchTaskRunner.runInBatches(startOffsetGroups, countGroups, batchCount, session.getPassportSessionFactory(),
                (PassportSession kcSession, int firstIt, int countInIt) -> {
