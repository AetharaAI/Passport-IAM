...
public class RoleCommands {
    ...
    public static class CreateRoles extends AbstractCommand {
        ...
        protected void doRunCommand(PassportSession session) {
            ...
            BatchTaskRunner.runInBatches(first, count, batchCount, session.getPassportSessionFactory(), (PassportSession bathcSession, int firstInThisIteration, int countInThisIteration) -> {
        ...
        private void createRolesInBatch(PassportSession session, String roleContainer, String rolePrefix, int first, int count) {
        ...
        private RoleContainerModel getRoleContainer(PassportSession session, String roleContainer) {
