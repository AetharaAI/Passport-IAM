...
public class TestCacheUtils {
    ...
    public static void cacheRealmWithEverything(PassportSession session, String realmName) {
    ...
    private static void cacheRoles(PassportSession session, RealmModel realm, RoleContainerModel roleContainer) {
