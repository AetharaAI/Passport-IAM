...
class BatchTaskRunner {
    ...
    static void runInBatches(int first, int count, int batchCount, PassportSessionFactory sessionFactory, BatchTask batchTask) {
    ...
    public interface BatchTask {
        ...
        void run(PassportSession session, int firstInThisIteration, int countInThisIteration);
