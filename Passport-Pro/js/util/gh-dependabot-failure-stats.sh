...
# URL: https://github.com/passport/passport/pull/12345
# Branch: dependabot/npm_and_yarn/typescript-eslint-7.18.0
# More Info:
#   - Admin UI E2E Check: Admin UI E2E (2, chrome)
#     Details URL: https://github.com/passport/passport/actions/runs/56789/job/98765
#     Run ID: 56789
#     Run Status: completed
#     Run Conclusion: failure
#     Run HTML URL: https://github.com/passport/passport/actions/runs/56789
#     Run Attempt: 1
