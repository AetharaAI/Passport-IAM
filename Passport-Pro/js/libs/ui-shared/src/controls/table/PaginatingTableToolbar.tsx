...
type TableToolbarProps = PassportPaginationProps & {
  ...
  return (
    <TableToolbar
      ...
      toolbarItem={
        <>
          ...
          <ToolbarItem variant="pagination">
            <PassportPagination count={count} {...rest} />
          </ToolbarItem>
        </>
      }
      ...
      toolbarItemFooter={
        count !== 0 ? (
          <ToolbarItem variant="pagination">
            <PassportPagination count={count} variant="bottom" {...rest} />
          </ToolbarItem>
        ) : null
      }
