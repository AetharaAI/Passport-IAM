import type { PassportAdminClient } from "../client.js";
...
export class Groups extends Resource<{ realm?: string }> {
  ...
  /**
   * Role mappings
   * https://passport-pro.ai/docs-api/11.0/rest-api/#_role_mapper_resource
   */
   ...
   * https://passport-pro.ai/docs-api/11.0/rest-api/#_client_role_mappings_resource
   */
  ...
  constructor(client: PassportAdminClient, orgId?: string) {
    super(client, {
