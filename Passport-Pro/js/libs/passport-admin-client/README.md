## Passport Admin Client

## Features

- TypeScript supported
- Latest Passport version supported
...
```sh
npm install @passport/passport-admin-client
```

## Usage

```js
import KcAdminClient from '@passport/passport-admin-client';
...
To refresh the access token provided by Passport, an OpenID client like [panva/node-openid-client](https://github.com/panva/node-openid-client) can be used like this:

```js
import {Issuer} from 'openid-client';

const passportIssuer = await Issuer.discover(
  'http://localhost:8080/realms/master',
);

const client = new passportIssuer.Client({
...
Start the Passport server in development mode using port 8180. See the instructions in the [Passport server app](../../apps/passport-server/README.md).

```bash
cd ../../apps/passport-server
...
### [Realm admin](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_realms_admin_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/realms.spec.ts
...
### [Role](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_roles_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/roles.spec.ts
...
### [Roles (by ID)](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_roles_by_id_resource)
...
### [User](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_users_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/users.spec.ts
...
Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/users.spec.ts#L178
...
Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/users.spec.ts#L352
...
### [Group](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_groups_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/groups.spec.ts
...
Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/groups.spec.ts#L103
...
### [Client](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_clients_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/clients.spec.ts
...
### [Client roles](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_roles_resource)
...
### [Client role-mapping for group](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_role_mappings_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/groups.spec.ts#L192
...
### [Client role-mapping for user](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_role_mappings_resource)
...
### [Client Attribute Certificate](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_attribute_certificate_resource)
...
### [Identity Providers](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_identity_providers_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/idp.spec.ts
...
### [Client Scopes](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_scopes_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/clientScopes.spec.ts
...
### [Client Scopes for realm](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_scopes_resource)
...
### [Client Scopes for client](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_scopes_resource)
...
### [Scope Mappings for client scopes](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_scope_mappings_resource)
...
### [Scope Mappings for clients](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_scope_mappings_resource)
...
### [Protocol Mappers for client scopes](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_protocol_mappers_resource)
...
### [Protocol Mappers for clients](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_protocol_mappers_resource)
...
Supported for [user federation](https://www.passport-pro.ai/docs/latest/server_admin/index.html#_user-storage-federation). Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/components.spec.ts
...
### [Authentication Management: Required actions](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_authentication_management_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/authenticationManagement.spec.ts
...
### [Authorization: Permission](https://www.passport-pro.ai/docs/8.0/authorization_services/#_overview)
...
### [Authorization: Policy](https://www.passport-pro.ai/docs/8.0/authorization_services/#_overview)
...
### [Attack Detection](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_attack_detection_resource)

Demo code: https://github.com/passport/passport/blob/main/js/libs/passport-admin-client/test/attackDetection.spec.ts
...
- [Authentication Management](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_authentication_management_resource)
- [Client Initial Access](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_initial_access_resource)
- [Client Registration Policy](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_client_registration_policy_resource)
- [Key](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_key_resource)
- [User Storage Provider](https://www.passport-pro.ai/docs-api/20.0.2/rest-api/index.html#_user_storage_provider_resource)

## Maintainers

This repo is originally developed by [Canner](https://www.cannercms.com) and [InfuseAI](https://infuseai.io) before being transferred under passport-pro.aianization.
