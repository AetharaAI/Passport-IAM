...
This project is the next generation of the Passport Admin UI. It is written with React and [PatternFly 4](https://www.patternfly.org/v4/) and uses [Vite](https://vitejs.dev/guide/).
...
```bash
npm i @passport/passport-admin-ui
```
