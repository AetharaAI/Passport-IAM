...
<html lang="en">
  <head>
    ...
    <meta name="description" content="${properties.description!'The Passport-Pro Administration Console is a web-based interface for managing Passport.'}">
    <title>${properties.title!'Passport-Pro Administration Console'}</title>
    <style>
      body {
        margin: 0;
      }
  ...
  <body data-page-id="admin">
    <div id="app">
      <main class="container">
        <div class="passport__loading-container">
          ...
          <div>
            <p id="loading-text">Loading Passport-Pro</p>
          </div>
        </div>
      </main>
    </div>
