import FeatureRepresentation, {
  FeatureType,
} from "@passport/passport-admin-client/lib/defs/featureRepresentation";
import { HelpItem, label, useEnvironment } from "@passport/passport-ui-shared";
import {
  ActionList,
  ActionListItem,
  Brand,
...
const EmptyDashboard = () => {
  ...
  const realmDisplayInfo = label(t, (realmInfo?.displayName || realm).replace(/Passport/i, "Passport"), realm);
    ...
    <PageSection variant="light">
      <EmptyState variant="lg">
        <Brand
          ...
          alt="Passport icon"
          className="passport__dashboard_icon"
        />
        ...
        >
          ...
          >
            <PageSection variant="light">
              <div className="pf-v5-l-grid pf-v5-u-ml-lg">
                ...
                <div className="pf-v5-l-grid__item passport__dashboard_welcome_tab">
          ...
          >
            <PageSection variant="light">
              <Grid hasGutter>
                <GridItem lg={2} sm={12}>
                  <Card className="passport__dashboard_card">
