import type { ManagementPermissionReference } from "@passport/passport-admin-client/lib/defs/managementPermissionReference";
import { HelpItem, useFetch } from "@passport/passport-ui-shared";
import {
  Card,
  CardBody,
  CardTitle,
    ...
    <PageSection variant="light">
      ...
      {permission.enabled && (
        <>
          ...
          <Card isFlat className="passport__permission__permission-table">
