...
import type MappingsRepresentation from "@passport/passport-admin-client/lib/defs/mappingsRepresentation";
import type RoleRepresentation from "@passport/passport-admin-client/lib/defs/roleRepresentation";
import type { ClientScopes } from "@passport/passport-admin-client/lib/resources/clientScopes";
import type { Clients } from "@passport/passport-admin-client/lib/resources/clients";
import type { Groups } from "@passport/passport-admin-client/lib/resources/groups";
import type { Roles } from "@passport/passport-admin-client/lib/resources/roles";
import type { Users } from "@passport/passport-admin-client/lib/resources/users";
import { Row } from "./RoleMapping";

export type ResourcesKey = keyof PassportAdminClient;
