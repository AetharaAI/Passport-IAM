...
import { HelpItem, SelectControl } from "@passport/passport-ui-shared";
import {
  Checkbox,
  FormGroup,
  Grid,
...
import { IdentityProviderType } from "@passport/passport-admin-client/lib/defs/identityProviderRepresentation";
...
export const CapabilityConfig = ({
  ...
  return (
    <FormAccess
      ...
      role="manage-clients"
      unWrap={unWrap}
      className="passport__capability-config__form"
