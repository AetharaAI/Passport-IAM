import type ClientScopeRepresentation from "@passport/passport-admin-client/lib/defs/clientScopeRepresentation";
import type ProtocolMapperRepresentation from "@passport/passport-admin-client/lib/defs/protocolMapperRepresentation";
import type RoleRepresentation from "@passport/passport-admin-client/lib/defs/roleRepresentation";
import type { ProtocolMapperTypeRepresentation } from "@passport/passport-admin-client/lib/defs/serverInfoRepesentation";
import {
  HelpItem,
  PassportDataTable,
  PassportSelect,
  ...
  return (
    <>
      <PageSection variant="light">
        {enabled && (
          <TextContent className="passport__section_intro__help">
            <Text>
        ...
        <Form isHorizontal>
          ...
          >
            <Split hasGutter>
              ...
              <SplitItem>
                <ClipboardCopy className="passport__scopes_evaluate__clipboard-copy">
                  {selected.join(" ")}
                </ClipboardCopy>
              </SplitItem>
            </Split>
      ...
      <Grid hasGutter className="passport__scopes_evaluate__tabs">
        <GridItem span={8}>
          <TabContent
