import ComponentRepresentation from "@passport/passport-admin-client/lib/defs/componentRepresentation";
import ComponentTypeRepresentation from "@passport/passport-admin-client/lib/defs/componentTypeRepresentation";
  ...
  const onSubmit = async (component: ComponentRepresentation) => {
    ...
    try {
      const updatedComponent = {
        ...
        providerType:
          "org.passport.services.clientregistration.policy.ClientRegistrationPolicy",
        providerId,
      };
      if (id) {
