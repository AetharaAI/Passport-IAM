...
import { SelectControl, TextControl } from "@passport/passport-ui-shared";
import {
  ActionGroup,
  Button,
  Dropdown,
  ...
  return (
    <Dropdown
      ...
      toggle={(ref) => (
        <MenuToggle
          ...
          ref={ref}
          onClick={toggle}
          className="passport__client_authentication__searchdropdown"
        >
    ...
    >
      <FormProvider {...form}>
        <Form
          isHorizontal
          className="passport__client_authentication__searchdropdown_form"
