...
import { DecisionEffect } from "@passport/passport-admin-client/lib/defs/policyRepresentation";
import type PolicyResultRepresentation from "@passport/passport-admin-client/lib/defs/policyResultRepresentation";
import {
  capitalize,
  DescriptionList,
  TextContent,
        ...
        <Td colSpan={5}>
          {expanded && (
            <ExpandableRowContent>
              <DescriptionList
                isHorizontal
                className="passport_resource_details"
              >
                <TextContent>
                  <TextList>
