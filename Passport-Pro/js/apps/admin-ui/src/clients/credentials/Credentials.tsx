...
import type CredentialRepresentation from "@passport/passport-admin-client/lib/defs/credentialRepresentation";
import {
  HelpItem,
  SelectControl,
  useAlerts,
...
export const Credentials = ({ client, save, refresh }: CredentialsProps) => {
  ...
  const providerProperties = useMemo(
    () =>
      componentTypes?.["org.passport.authentication.ClientAuthenticator"]?.find(
