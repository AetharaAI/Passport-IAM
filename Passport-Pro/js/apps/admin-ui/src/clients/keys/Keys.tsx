import type CertificateRepresentation from "@passport/passport-admin-client/lib/defs/certificateRepresentation";
import type KeyStoreConfig from "@passport/passport-admin-client/lib/defs/keystoreConfig";
...
export const Keys = ({
  ...
  return (
    <PageSection variant="light" className="passport__form">
      {openGenerateKeys && (
        <GenerateKeyDialog
