import { UserProfileAttributeMetadata } from "@passport/passport-admin-client/lib/defs/userProfileMetadata";
import { isUserProfileError } from "@passport/passport-ui-shared";
