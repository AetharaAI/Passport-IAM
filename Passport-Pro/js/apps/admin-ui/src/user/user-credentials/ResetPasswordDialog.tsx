import { RequiredActionAlias } from "@passport/passport-admin-client/lib/defs/requiredActionProviderRepresentation";
...
import { FormErrorText, PasswordInput } from "@passport/passport-ui-shared";
    ...
    <>
      ...
      >
        <Form
          ...
          isHorizontal
          className="passport__user-credentials__reset-form"
        >
          <FormGroup
            name="password"
            label={t("password")}
