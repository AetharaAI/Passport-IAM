...
} from "@passport/passport-admin-client/lib/defs/identityProviderRepresentation";
import {
  Action,
  PassportDataTable,
  PassportSpinner,
...
export default function DetailSettings() {
  ...
  const providerInfo = useMemo(() => {
    const namespaces = [
      "org.passport.broker.social.SocialIdentityProvider",
      "org.passport.broker.provider.IdentityProvider",
    ];
