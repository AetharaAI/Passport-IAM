...
import ResourceRepresentation from "@passport/passport-admin-client/lib/defs/resourceRepresentation";
import ScopeRepresentation from "@passport/passport-admin-client/lib/defs/scopeRepresentation";
import {
  PassportSpinner,
  ListEmptyState,
