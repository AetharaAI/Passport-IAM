import type EventRepresentation from "@passport/passport-admin-client/lib/defs/eventRepresentation";
import type EventType from "@passport/passport-admin-client/lib/defs/eventTypes";
import {
  PassportDataTable,
  PassportSelect,
  ListEmptyState,
...
const DetailCell = (event: EventRepresentation) => (
  <DescriptionList isHorizontal className="passport_eventsection_details">
    {event.details &&
        ...
        >
          <FlexItem>
            ...
            >
              <Form
                ...
                className="passport__events_search__form"
              ...
              >
                ...
                <FormGroup
                  ...
                  className="passport__events_search__form_label"
                >
                  <Controller
                    name="type"
                    control={control}
                    render={({ field }) => (
                      <PassportSelect
                        className="passport__events_search__type_select"
          ...
          <FlexItem>
            {Object.entries(activeFilters).length > 0 && (
              <div className="passport__searchChips pf-v5-u-ml-md">
