import type { ConfigPropertyRepresentation } from "@passport/passport-admin-client/lib/defs/authenticatorConfigInfoRepresentation";
import type ClientPolicyConditionRepresentation from "@passport/passport-admin-client/lib/defs/clientPolicyConditionRepresentation";
import type ClientPolicyRepresentation from "@passport/passport-admin-client/lib/defs/clientPolicyRepresentation";
...
export default function NewClientPolicyCondition() {
  ...
  const conditionTypes =
    serverInfo.componentTypes?.[
      "org.passport.services.clientpolicy.condition.ClientPolicyConditionProvider"
    ];
