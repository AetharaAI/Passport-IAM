...
import type ClientProfileRepresentation from "@passport/passport-admin-client/lib/defs/clientProfileRepresentation";
...
export default function ExecutorForm() {
  ...
  const executorTypes =
    serverInfo.componentTypes?.[
      "org.passport.services.clientpolicy.executor.ClientPolicyExecutorProvider"
    ];
