import type { UserProfileAttribute } from "@passport/passport-admin-client/lib/defs/userProfileMetadata";
import { PassportSelect, SelectVariant } from "@passport/passport-ui-shared";
import {
  Button,
  ButtonVariant,
  Divider,
