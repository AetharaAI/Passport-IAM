...
import { useEnvironment } from "@passport/passport-ui-shared";
...
`,
  ...
  "themes": [{
    ...
    zip.file(
      ...
      `:root {
        --passport-bg-logo-url: url('../${bgimageName}');
        --passport-logo-url: url('../${logoName}');
        --passport-logo-height: 63px;
        --passport-logo-width: 300px;
        ${toCss(styles.light)}
      }
      .pf-v5-theme-dark {
        ${toCss(styles.dark)}
