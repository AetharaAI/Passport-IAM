  ...
  return (
    <PageSection variant="light">
      <FormAccess
        ...
        className="passport__otp_policies_authentication__form"
      >
        <FormProvider {...form}>
          <FormGroup
            label={t("otpType")}
                ...
                <>
                  {POLICY_TYPES.map((type) => (
                    <Radio
                      ...
                      className="passport__otp_policies_authentication__policy-type"
                    />
                  ))}
                </>
              )}
                ...
                <>
                  {NUMBER_OF_DIGITS.map((type) => (
                    <Radio
                      ...
                      label={type}
                      className="passport__otp_policies_authentication__number-of-digits"
                    />
                  ))}
                </>
              )}
