import type PasswordPolicyTypeRepresentation from "@passport/passport-admin-client/lib/defs/passwordPolicyTypeRepresentation";
import {
  Button,
  FormGroup,
  NumberInput,
...
import { FormErrorText, HelpItem } from "@passport/passport-ui-shared";
      ...
      <Split>
              ...
              render={({ field }) => {
                ...
                return (
                  <NumberInput
                    ...
                    className="passport__policies_authentication__number-field"
                  />
                );
              }}
            />
        ...
        <SplitItem>
          <Button
            ...
            variant="link"
            className="passport__policies_authentication__minus-icon"
            onClick={() => onRemove(id)}
            aria-label={t("remove")}
          >
            <MinusCircleIcon />
