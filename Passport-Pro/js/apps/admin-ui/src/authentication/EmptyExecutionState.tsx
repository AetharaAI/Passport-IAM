...
import type AuthenticationFlowRepresentation from "@passport/passport-admin-client/lib/defs/authenticationFlowRepresentation";
...
export const EmptyExecutionState = ({
  ...
  return (
    <>
      ...
      <div className="passport__empty-execution-state__block">
        {SECTIONS.map((section) => (
          <Flex key={section} className="passport__empty-execution-state__help">
