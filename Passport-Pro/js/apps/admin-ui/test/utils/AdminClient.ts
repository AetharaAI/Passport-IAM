...
import type ClientRepresentation from "@passport/passport-admin-client/lib/defs/clientRepresentation.js";
import type ClientScopeRepresentation from "@passport/passport-admin-client/lib/defs/clientScopeRepresentation.js";
import type ComponentRepresentation from "@passport/passport-admin-client/lib/defs/componentRepresentation.js";
import type OrganizationRepresentation from "@passport/passport-admin-client/lib/defs/organizationRepresentation.js";
import type PolicyRepresentation from "@passport/passport-admin-client/lib/defs/policyRepresentation.js";
import type ResourceRepresentation from "@passport/passport-admin-client/lib/defs/resourceRepresentation.js";
import type RealmRepresentation from "@passport/passport-admin-client/lib/defs/realmRepresentation.js";
import type RoleRepresentation from "@passport/passport-admin-client/lib/defs/roleRepresentation.js";
import type { RoleMappingPayload } from "@passport/passport-admin-client/lib/defs/roleRepresentation.js";
import type { UserProfileConfig } from "@passport/passport-admin-client/lib/defs/userProfileMetadata.js";
import type UserRepresentation from "@passport/passport-admin-client/lib/defs/userRepresentation.js";
import type { Credentials } from "@passport/passport-admin-client/lib/utils/auth.js";

class AdminClient {
  readonly #client = new PassportAdminClient({
  ...
  async addKeyProvider(
    ...
    await this.#client.components.create({
      ...
      providerType: "org.passport.keys.KeyProvider",
    });
  }
  ...
  async createUserFederation(
    ...
    await this.#client.components.create({
      realm: realmName,
      parentId: realm.id,
      providerType: "org.passport.storage.UserStorageProvider",
      ...federatedIdentity,
    });
  }
