...
function cloneQuickstart(type) {
  return new Promise((resolve, reject) => {
    mkdtemp(join(tmpdir(), "template-"), async (err, dir) => {
      ...
      simpleGit()
        .clone("https://github.com/passport/passport-quickstarts", dir, {
...
function done(appName) {
  ...
  console.log();
  console.log(chalk.cyan(`  npm run start-passport`));
  console.log("    Download and starts a passport server.");
  console.log();
  ...
  console.log(
    "    Bundles the app into a jar file that can be deployed to a passport ",
  );
  console.log(
